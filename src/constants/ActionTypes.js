...
export const INIT_MODAL_DATA_SUCCESS = 'INIT_MODAL_DATA_SUCCESS';

export const UPDATE_DATA_SUCCESS = 'UPDATE_DATA_SUCCESS';
export const UPDATE_DATA_PROPERTY = 'UPDATE_DATA_PROPERTY';

export const ADD_ROW_DATA = 'ADD_ROW_DATA';
export const ADD_MODAL_ROW_DATA = 'ADD_MODAL_ROW_DATA';
...
export const INIT_MODAL_LAYOUT_SUCCESS = 'INIT_MODAL_LAYOUT_SUCCESS';
