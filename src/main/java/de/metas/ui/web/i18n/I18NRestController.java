...
public class I18NRestController
{
	...
	public Map<String, Object> getMessages()
	{
		...
		Services.get(IMsgBL.class)
				.getMsgMap(userSession.getAD_Language(), AD_MESSAGE_PREFIX, true /* removePrefix */)
				.forEach((key, value) -> addMessageToMap(map, key, value));

		return map;
	}

	@SuppressWarnings("unchecked")
	private static final void addMessageToMap(final Map<String, Object> map, final String key, final String value)
	{
