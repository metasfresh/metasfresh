...
class ASIDocumentViewAttributes implements IDocumentViewAttributes
{
	private final DocumentPath documentPath;
	private final ASIDocument asiDoc;
	private DocumentViewAttributesLayout layout;

	ASIDocumentViewAttributes(final ASIDocument asiDoc, final ASILayout asiLayout)
	{
		final DocumentId documentId = asiDoc.getDocumentId();
		documentPath = DocumentPath.rootDocumentPath(DocumentType.ViewRecordAttributes, documentId, documentId);
		
		this.asiDoc = asiDoc;
		this.layout = DocumentViewAttributesLayout.of(asiLayout.getElements());
	}
...
//		return asiDoc.getFieldLookupValues(attributeName);
	...
	@Override
	public JSONDocumentViewAttributes toJSONDocument(final JSONOptions jsonOpts)
	{
