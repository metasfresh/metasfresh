...
import de.metas.ui.web.vaadin.window.prototype.order.model.PropertyValueCollection.PropertyValueCollectionEvaluatee;
...
{
	public static final StringExpressionPropertyValue of(final PropertyName name, final String stringExpressionStr)
	{
	...
	protected StringExpressionPropertyValue(final PropertyName name, final String stringExpressionStr)
	{
