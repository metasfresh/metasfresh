...
class Subheader extends Component {
    ...
    openModal = (windowType, type) => {
        const {dispatch, onClick} = this.props;
        dispatch(openModal("Advanced edit", windowType, type));
        onClick();
    }
                    ...
                    <div className="row">
                        <div className="subheader-row">
                            <div className=" subheader-column" >
                                ...
                                {dataId && <div className="subheader-item" onClick={()=> this.openModal(windowType + '&advanced=true', "window")}><i className="meta-icon-edit" /> Advanced Edit</div>}
                            ...
                            <div className=" subheader-column">
                                ...
                                { actions && !!actions.length ? actions.map((item, key) =>
                                    <div
                                        ...
                                        onClick={() => this.openModal(item.processId + "", "process")}
                                        key={key}
                                    >
                                        {item.caption}
                                    </div>
