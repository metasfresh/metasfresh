...
class Subheader extends Component {
    ...
    renderDocLinks = () => {
        ...
        if (standardActions.has('advancedEdit')) {
            docLinks.push(
                <div
                    key="advancedEdit"
