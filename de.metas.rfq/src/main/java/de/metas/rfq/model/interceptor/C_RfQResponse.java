...
public class C_RfQResponse
{
	...
	public void beforeSave(final I_C_RfQResponse response)
	{
		final IRfQWorkDatesAware workDatesAware = InterfaceWrapperHelper.create(response, IRfQWorkDatesAware.class);
