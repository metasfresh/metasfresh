...
public final class SystecCmdRN implements ISystecCmd
{
	...
	{
		// final String cmd = "(\"<RN>\\x0D\\x0A\",500)";
		return "<RN>";
	}

	@Override
	public LinkedHashMap<String, SystecResultStringElement> getResultElements()
	{
