...
public final class Constants
{
	...
	public static final String PROPS_FILE_EDI = "file:${user.home}/esb/edi.properties";

	public static final String PROPS_FILE_ESB_GENERAL = "file:${user.home}/esb/esb.properties";

	/**
	 * @see http://fusesource.com/docs/router/2.8/component_ref/_IDU_ActiveMQ.html
	 */
	public static final String EP_JMS_FROM_AD = "{{ep.jms.from.ad}}";
	public static final String EP_JMS_TO_AD = "{{ep.jms.to.ad}}";
