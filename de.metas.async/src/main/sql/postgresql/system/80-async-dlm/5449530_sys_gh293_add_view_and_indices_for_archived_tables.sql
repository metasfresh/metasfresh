...
DROP INDEX IF EXISTS c_queue_element_archived_c_queue_workpackage_id;
CREATE INDEX c_queue_element_archived_c_queue_workpackage_id
  ON dlm.c_queue_element_archived
  USING btree
  (c_queue_workpackage_id);

DROP INDEX IF EXISTS c_queue_block_archived_c_queue_block_id;
CREATE INDEX c_queue_block_archived_c_queue_block_id
  ON dlm.c_queue_workpackage_archived
  USING btree
  (c_queue_block_id);

DROP INDEX IF EXISTS c_queue_workpackage_archived_c_queue_block_id;
CREATE INDEX c_queue_workpackage_archived_c_queue_block_id
  ON dlm.c_queue_workpackage_archived
  USING btree
  (c_queue_block_id);

DROP INDEX IF EXISTS c_queue_workpackage_archived_c_queue_packageprocessor_id;
...
DROP INDEX IF EXISTS c_queue_workpackage_log_archived_c_queue_workpackage_id;
