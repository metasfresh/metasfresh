...
webapi_client_protocol=${WEBUI_API_CLIENT_PROTOCOL:-http}
webapi_client_host=${WEBUI_API_CLIENT_HOST:-localhost}
webapi_client_port=${WEBUI_API_CLIENT_PORT:-8080}

webapi_proxypass_protocol=${WEBUI_API_PROXYPASS_PROTOCOL:-http}
webapi_proxypass_host=${WEBUI_API_PROXYPASS_HOST:-localhost}
