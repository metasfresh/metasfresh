...
/** Generated Model for MKTG_ContactPerson_With_Campaign_V
 *  @author Adempiere (generated) 
 */
@SuppressWarnings("javadoc")
public class X_MKTG_ContactPerson_With_Campaign_V extends org.compiere.model.PO implements I_MKTG_ContactPerson_With_Campaign_V, org.compiere.model.I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 1004159055L;

    /** Standard Constructor */
    public X_MKTG_ContactPerson_With_Campaign_V (Properties ctx, int MKTG_ContactPerson_With_Campaign_V_ID, String trxName)
    {
      super (ctx, MKTG_ContactPerson_With_Campaign_V_ID, trxName);
      /** if (MKTG_ContactPerson_With_Campaign_V_ID == 0)
        {
			setMKTG_ContactPerson_With_Campaign_ID (0);
			setName (null);
        } */
    }

    /** Load Constructor */
    public X_MKTG_ContactPerson_With_Campaign_V (Properties ctx, ResultSet rs, String trxName)
    {
