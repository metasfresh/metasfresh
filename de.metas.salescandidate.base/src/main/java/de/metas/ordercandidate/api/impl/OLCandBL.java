...
public class OLCandBL implements IOLCandBL
{
			...
			@Nullable final OLCandOrderDefaults orderDefaults)
	{
		...
		else
		{
			...
			final int bpartnerId = BPartnerId.toRepoId(effectiveValuesBL.getBill_BPartner_Effective_ID(olCand));
			...
			final Timestamp date)
	{
		...
		final BPartnerId billBPartnerId = effectiveValuesBL.getBill_BPartner_Effective_ID(olCand);
