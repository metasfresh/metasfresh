-- 2019-04-05T06:02:39.906
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
DELETE FROM AD_Element_Link WHERE AD_Element_Link_ID=1000000
;

-- 2019-04-05T06:02:40.287
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Element_Link (AD_Client_ID,AD_Element_ID,AD_Element_Link_ID,AD_Org_ID,AD_Window_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,573988,628430,0,372,TO_TIMESTAMP('2019-04-05 06:02:40','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_TIMESTAMP('2019-04-05 06:02:40','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2019-04-05T06:02:50.760
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Window SET AD_Element_ID=2887, Description='Automatically created or manually entered System Issue', Help='System Issues are created to speed up the resolution of any system related issues (potential bugs).  If enabled, they are automatically reported to Adempiere.  No data or confidential information is transferred.', InternalName='AD_Issue',Updated=TO_TIMESTAMP('2019-04-05 06:02:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Window_ID=372
;

-- 2019-04-05T06:02:50.772
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Menu SET Description='Automatically created or manually entered System Issue', IsActive='Y', Name='System-Problem',Updated=TO_TIMESTAMP('2019-04-05 06:02:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Menu_ID=564
;

-- 2019-04-05T06:02:50.802
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
DELETE FROM AD_Element_Link WHERE AD_Element_Link_ID=628430
;

-- 2019-04-05T06:02:50.954
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Element_Link (AD_Client_ID,AD_Element_ID,AD_Element_Link_ID,AD_Org_ID,AD_Window_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,2887,628431,0,372,TO_TIMESTAMP('2019-04-05 06:02:50','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_TIMESTAMP('2019-04-05 06:02:50','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2019-04-05T06:02:50.998
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
