...
public class X_MD_EventStore extends org.compiere.model.PO implements I_MD_EventStore, org.compiere.model.I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -2100280106L;
	...
	@Override
	public de.metas.manufacturing.dispo.model.I_MD_Candidate getMD_Candidate() throws RuntimeException
	{
		return get_ValueAsPO(COLUMNNAME_MD_Candidate_ID, de.metas.manufacturing.dispo.model.I_MD_Candidate.class);
	}

	@Override
	public void setMD_Candidate(de.metas.manufacturing.dispo.model.I_MD_Candidate MD_Candidate)
	{
		set_ValueFromPO(COLUMNNAME_MD_Candidate_ID, de.metas.manufacturing.dispo.model.I_MD_Candidate.class, MD_Candidate);
	}
