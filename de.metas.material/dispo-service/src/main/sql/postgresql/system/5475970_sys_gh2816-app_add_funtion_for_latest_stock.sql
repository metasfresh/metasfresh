...
CREATE OR REPLACE FUNCTION de_metas_device.duplicate_device(
    ...
    IN p_new_device_name text DEFAULT null::text)
  RETURNS void AS
$BODY$
DECLARE
...
The paramter p_new_device_name is optional. If ommitted, the copy records are created with "de.metas.device.<p_device_name>_copy"';
