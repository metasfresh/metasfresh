...
Wenn die neue Vertragperiode nicht automatisch fertig gestellt wird, hat der Betreuer noch die Möglichkeit, z.B. die geplante Mege pro Maßeinheit anzupassen.', IsMandatory='N',Updated=TO_TIMESTAMP('2017-01-02 17:25:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=540292
;
