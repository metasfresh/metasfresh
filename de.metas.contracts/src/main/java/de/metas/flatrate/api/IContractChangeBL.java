...
public interface IContractChangeBL extends ISingletonService
{
	 ...
	 * In other words, a customer won't be charged if their {@link de.metas.flatrate.model.I_C_Flatrate_Conditions#COLUMNNAME_IsNewTermCreatesOrder} value is <code>='N'</code>.
	 * 
	 * <p>
