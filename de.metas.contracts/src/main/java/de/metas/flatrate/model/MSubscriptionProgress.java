...
public class MSubscriptionProgress extends X_C_SubscriptionProgress
{
	...
	static final String SQL_MAX_SEQNO = "SELECT coalesce(max(SeqNo),0) FROM C_SubscriptionProgress WHERE C_SubscriptionControl_ID=?";
	...
	public MSubscriptionProgress(Properties ctx, int C_SubscriptionProgress_ID,
			String trxName)
	{
