package de.metas.flatrate.ordercandidate.spi;
...
public class FlatrateGroupingProvider implements IOLCandGroupingProvider
{
	 ...
	 *         {@link de.metas.flatrate.interfaces.I_C_OLCand#getC_Flatrate_Conditions_ID()}.
	 *         
	 */
	@Override
	public List<Object> provideLineGroupingValues(final I_C_OLCand cand)
	{
		final de.metas.flatrate.interfaces.I_C_OLCand flatratesCand =
				InterfaceWrapperHelper.create(cand, de.metas.flatrate.interfaces.I_C_OLCand.class);
