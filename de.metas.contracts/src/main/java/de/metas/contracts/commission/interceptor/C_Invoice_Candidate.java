...
import de.metas.contracts.commission.services.InvoiceCandidateService;
import de.metas.contracts.commission.services.repos.CommissionInstanceRepository;
...
public class C_Invoice_Candidate
{
	...
	public void applyInvoiceCandieateChange(@NonNull final I_C_Invoice_Candidate icRecord)
	{
