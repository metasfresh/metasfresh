...
import de.metas.contracts.commission.CommissionConfig;
import de.metas.contracts.commission.CommissionType;
...
public class HierarchyConfig implements CommissionConfig
{
	...
	public Contract getContractFor(Beneficiary beneficiary)
	{
