...
public interface IOrderLineBL extends ISingletonService
{
	...
	/**
	 * Task #3835
	 * If the de.metas.order.NoPriceConditionsColorName sysconfig is set and the orderLine.M_DiscountSchemaBreak_ID is not set, the orderLine.NoPriceConditionsColor_ID will be set to the value form the sys config.
	 ...
	 * @param orderLine
	 */
	void updateNoPriceConditionsColorName(I_C_OrderLine orderLine);
}
