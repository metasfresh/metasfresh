...
{
	/**
	 * Assumes that the given record has a {@link I_C_UOM#COLUMNNAME_C_UOM_ID} value and returns it as {@link UomId}.
	 * Supposed to be helpful when working with legacy "record" code.
	 *
	 * @return never {@code null}
	 */
	public UomId ofRecord(@NonNull final Object recordModel)
	{
