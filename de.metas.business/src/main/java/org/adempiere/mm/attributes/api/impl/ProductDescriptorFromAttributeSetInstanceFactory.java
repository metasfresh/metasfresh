...
{
	public ProductDescriptorFromAttributeSetInstanceFactory()
	{
		System.out.println("Look 'ma, " + this.getClass().getName() + " is called");
	}

	// TODO test that this class is returned when we ask the spring context for a ProductDescriptorFactory
