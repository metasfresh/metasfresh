 ...
 * 
 * @author Teo Sarca, SC ARHIPAC SERVICE SRL <li>BF [ 2012439 ] DiscountSchemaBreak: setting product & category is allowed
 */
public class MDiscountSchemaBreak extends X_M_DiscountSchemaBreak
{
	...
	{
		final I_M_DiscountSchemaBreak schemaBreak = InterfaceWrapperHelper.create(this, I_M_DiscountSchemaBreak.class);
		return Services.get(IMDiscountSchemaBL.class).breakApplies(
				schemaBreak,
				Value,
				M_Product_ID,
