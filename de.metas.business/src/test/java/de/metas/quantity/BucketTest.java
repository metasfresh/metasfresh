...
public class BucketTest
{
	...
	public void addQty()
	{
		...
		final Capacity capacityTotal = Capacity.createCapacity(qtyTotal, pTomato, uomEach, allowNegativeCapacity);
	...
	{
		final Capacity capacityTotal = Capacity.createInfiniteCapacity(pTomato, uomEach);
