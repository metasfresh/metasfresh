...
public class CandidateService
{
	 ...
	 * @param segment
	 */
	public void invalidateMatches(CandidatesSegment segment)
	{
	...
	private Stream<Candidate> retrieveChildren(Candidate candidate)
	{
	...
	@VisibleForTesting
	/* package */ Stream<Candidate> retrieveDirectMatches(CandidatesSegment segment)
	{
		// TODO Auto-generated method stub
		return null;
	}

	public List<Candidate> onDemandCandidate(Candidate demandCandidate)
	{
	 ...
	 * @return
	 */
	public List<Candidate> onSupplyCandidate(Candidate supplyCandidte)
	{
		// have some collector to collect all records we create and change
		final List<Candidate> newAndChangedCandidates = new ArrayList<>();
	...
	public void onStockCandidate(Candidate stockCandidte)
	{
