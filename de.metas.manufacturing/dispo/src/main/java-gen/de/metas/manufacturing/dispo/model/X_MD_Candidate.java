...
public class X_MD_Candidate extends org.compiere.model.PO implements I_MD_Candidate, org.compiere.model.I_Persistent
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 1039223434L;
	...
	@Override
	public void setM_Warehouse(final org.compiere.model.I_M_Warehouse M_Warehouse)
	{
	...
	{
		final Integer ii = (Integer)get_Value(COLUMNNAME_M_Warehouse_ID);
		if (ii == null)
		{
			return 0;
		}
	...
	@Override
	public void setMD_Candidate_Parent(final de.metas.manufacturing.dispo.model.I_MD_Candidate MD_Candidate_Parent)
	{
	...
	{
		final Integer ii = (Integer)get_Value(COLUMNNAME_MD_Candidate_Parent_ID);
		if (ii == null)
		{
			return 0;
		}
