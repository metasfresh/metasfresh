...
@ToString
public class InvoicingParamsObject implements IInvoicingParams
{
	...
	private Boolean updateLocationAndContactForInvoice = null;

	private final IInvoicingParams defaults;

	public InvoicingParamsObject()
	{
		this(null);
	}
	 ...
	 */
	public InvoicingParamsObject(@Nullable final IInvoicingParams defaults)
	{
	...
	public InvoicingParamsObject setStoreInvoicesInResult(final boolean storeInvoicesInResult)
	{
	...
	public InvoicingParamsObject setAssumeOneInvoice(final boolean assumeOneInvoice)
	{
	...
	{
		if (updateLocationAndContactForInvoice != null)
		{
			return updateLocationAndContactForInvoice;
		}
		else if (defaults != null)
		{
			return defaults.isUpdateLocationAndContactForInvoice();
		}
		return false;
	}
	
	public void setUpdateLocationAndContactForInvoice(final boolean updateLocationAndContactForInvoice)
	{
