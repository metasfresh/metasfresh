 ...
 * <ul>
 * <li>The system is preconfigured with a {@link de.metas.contracts.flatrate.model.I_C_Flatrate_Conditions I_C_Flatrate_Conditions} record that has {@link de.metas.contracts.flatrate.model.I_C_Flatrate_Conditions#COLUMN_Type_Conditions Type_Conditions} ==
 ...
 * <li>Also, there is a vendor (<code>C_BPartner</code>) which has a running contract (i.e. {@link de.metas.contracts.flatrate.model.I_C_Flatrate_Term I_C_Flatrate_Term}) with that conditions</li>
 ...
 * <ul>
 * <li><code>C_Invoice_Candidates</code>, and will link them to the original IC (the one with <code>IsToClear='Y'</code>, see above) via {@link de.metas.contracts.flatrate.model.I_C_Invoice_Clearing_Alloc I_C_Invoice_Clearing_Alloc} records.</li>
