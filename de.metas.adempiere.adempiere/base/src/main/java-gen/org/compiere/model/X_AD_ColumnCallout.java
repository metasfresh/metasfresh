...
public class X_AD_ColumnCallout extends PO implements I_AD_ColumnCallout, I_Persistent 
{
...
// @SQL=SELECT COALESCE(MAX(SeqNo), 0) + 10 FROM AD_ColumnCallout WHERE AD_Column_ID=@AD_Column_ID@
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AD_ColumnCallout[")
    ...
    {
        return new KeyNamePair(get_ID(), getClassname());
    }
