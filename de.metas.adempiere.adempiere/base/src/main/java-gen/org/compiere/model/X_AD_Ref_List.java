...
public class X_AD_Ref_List extends org.compiere.model.PO implements I_AD_Ref_List, org.compiere.model.I_Persistent
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 43220531L;
	...
	{
		set_Value(COLUMNNAME_ValidationMessage, ValidationMessage);
	}
	...
	{
		return (java.lang.String)get_Value(COLUMNNAME_ValidationMessage);
	}
