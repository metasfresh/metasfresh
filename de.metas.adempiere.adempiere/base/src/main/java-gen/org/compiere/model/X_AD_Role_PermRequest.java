...
/** Generated Model for AD_Role_PermRequest
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_AD_Role_PermRequest extends PO implements I_AD_Role_PermRequest, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20100323L;

    /** Standard Constructor */
    public X_AD_Role_PermRequest (Properties ctx, int AD_Role_PermRequest_ID, String trxName)
    {
      super (ctx, AD_Role_PermRequest_ID, trxName);
      /** if (AD_Role_PermRequest_ID == 0)
        {
			setAD_Role_ID (0);
    ...
    /** Load Constructor */
    public X_AD_Role_PermRequest (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AD_Role_PermRequest[")
	...
	/** Set Role Permission Log.
		@param AD_Role_PermRequest_ID Role Permission Log	  */
	public void setAD_Role_PermRequest_ID (int AD_Role_PermRequest_ID)
	{
		if (AD_Role_PermRequest_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_AD_Role_PermRequest_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_AD_Role_PermRequest_ID, Integer.valueOf(AD_Role_PermRequest_ID));
	}

	/** Get Role Permission Log.
		@return Role Permission Log	  */
	public int getAD_Role_PermRequest_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_AD_Role_PermRequest_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		set_Value (COLUMNNAME_GrantPermission, GrantPermission);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_GrantPermission);
	}

	/** Set Permission Granted.
		@param IsPermissionGranted Permission Granted	  */
