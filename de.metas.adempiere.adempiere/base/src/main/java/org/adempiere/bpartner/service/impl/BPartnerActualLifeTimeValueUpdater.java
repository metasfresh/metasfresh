...
public class BPartnerActualLifeTimeValueUpdater implements IBPartnerActualLifeTimeValueUpdater
{


	@Override
	public void updateActualLifeTimeValue(Properties ctx, Set<Integer> bpartnerIds, String trxName)
	{
		// Services
