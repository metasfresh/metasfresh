...
{
	@Override
	public final boolean sameResource(final Permission access)
	{
		return getResource().equals(access.getResource());
	}
	...
	{
		if (!sameResource(permission))
		{
			throw new AdempiereException("Incompatible permission to be merged: " + this + ", " + permission);
		}

		if (this.getClass() != permission.getClass())
		{
			throw new AdempiereException("Incompatible permission to be merged: " + this + ", " + permission
					+ " Required class: " + getClass()
					+ " Actual class: " + permission.getClass());
		}

		@SuppressWarnings("unchecked")
		final PermissionType permissionCasted = (PermissionType)permission;
