...
public interface IElementLinkBL extends ISingletonService
{
	void createMissingADElementLinks();

	//@formatter:off
	void recreateADElementLinkForWindowId(AdWindowId adWindowId);
	...
	//@formatter:off
	void recreateADElementLinkForTabId(AdTabId adTabId);
	void createADElementLinkForTabId(AdTabId adTabId);
	void deleteExistingADElementLinkForTabId(AdTabId adTabId);
	//@formatter:on

	//@formatter:off
	void recreateADElementLinkForFieldId(AdFieldId adFieldId);
