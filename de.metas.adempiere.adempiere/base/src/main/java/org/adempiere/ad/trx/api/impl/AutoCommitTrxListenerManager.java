...
/**
 * An {@link ITrxListenerManager} implemetation which directly executes {@link ITrxListener#beforeCommit(ITrx)} and {@link ITrxListener#afterCommit(ITrx)} when a listener is registered.
 * 
 * @author tsa
 *
 */
