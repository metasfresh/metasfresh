...
public final class EventBusConstants
{
	...
	public static final String SYSCONFIG_Enabled = "org.adempiere.event.Enabled";
	...
	private static final String SYSCONFIG_JMS_URL = "org.adempiere.event.jms.URL";
	...
	private static final String SYSCONFIG_JMS_UseEmbeddedBroker = "org.adempiere.event.jms.UseEmbeddedBroker";
	...
	public static final Topic TOPIC_GeneralNotifications = Topic.builder()
			.setName("org.adempiere.event.GeneralNotifications")
			.setType(Type.REMOTE)
			.build();
	/**
	...
	public static final String JMX_BASE_NAME = "org.adempiere.event.EventBus";
