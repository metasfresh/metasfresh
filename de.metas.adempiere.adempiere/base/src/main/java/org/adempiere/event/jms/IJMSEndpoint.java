...
public interface IJMSEndpoint
{
	 ...
	 * Do nothing if binding is disabled according to the current config. See <a href="http://dewiki908/mediawiki/index.php/Org.adempiere.event-Overview">Org.adempiere.event-Overvie</a> and/or
