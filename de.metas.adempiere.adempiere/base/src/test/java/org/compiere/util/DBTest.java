...
public class DBTest
{
	...
	public void test_buildSqlList_null_paramsOut()
	{
		...
		DB.buildSqlList(new ArrayList<Object>(), null);
	}
	...
	{
		{
			final List<Object> paramsOut = new ArrayList<Object>();
	...
	{
		final List<Object> paramsIn = new ArrayList<Object>();
		paramsIn.add("value1");
		paramsIn.add("value2");
		
		final List<Object> paramsInExpected = new ArrayList<Object>(paramsIn);
		...
		final List<Object> paramsOutExpected = new ArrayList<Object>(paramsOut);
