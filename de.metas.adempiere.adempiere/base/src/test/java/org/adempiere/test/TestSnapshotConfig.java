...
public final class TestSnapshotConfig implements SnapshotConfig
{
	public static final SnapshotConfig INSTANCE = new TestSnapshotConfig();

	private TestSnapshotConfig()
	{
	}
