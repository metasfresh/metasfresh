...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,540399,541797,20,'show_only_pricelist_instructions',TO_TIMESTAMP('2020-04-14 17:18:43','YYYY-MM-DD HH24:MI:SS'),100,'Y','U',0,'Y','N','Y','N','N','N','p_show_only_pricelist_instructions',50,TO_TIMESTAMP('2020-04-14 17:18:43','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2020-04-14T14:18:43.802Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N') AND t.AD_Process_Para_ID=541797 AND NOT EXISTS (SELECT 1 FROM AD_Process_Para_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Process_Para_ID=t.AD_Process_Para_ID)
;

-- 2020-04-14T14:18:58.484Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET EntityType='de.metas.fresh',Updated=TO_TIMESTAMP('2020-04-14 17:18:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=541797
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Element_Trl (AD_Language,AD_Element_ID, CommitWarning,Description,Help,Name,PO_Description,PO_Help,PO_Name,PO_PrintName,PrintName,WEBUI_NameBrowse,WEBUI_NameNew,WEBUI_NameNewBreadcrumb, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Element_ID, t.CommitWarning,t.Description,t.Help,t.Name,t.PO_Description,t.PO_Help,t.PO_Name,t.PO_PrintName,t.PrintName,t.WEBUI_NameBrowse,t.WEBUI_NameNew,t.WEBUI_NameNewBreadcrumb, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Element t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Element_ID=577666 AND NOT EXISTS (SELECT 1 FROM AD_Element_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Element_ID=t.AD_Element_ID)
;

-- 2020-04-14T14:52:23.296Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET IsTranslated='Y', Name=' Nur Packanweisungen mit Preis anzeigen', PrintName=' Nur Packanweisungen mit Preis anzeigen',Updated=TO_TIMESTAMP('2020-04-14 17:52:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='de_CH'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name=' Nur Packanweisungen mit Preis anzeigen', PrintName=' Nur Packanweisungen mit Preis anzeigen',Updated=TO_TIMESTAMP('2020-04-14 17:52:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='de_DE'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET ColumnName=NULL, Name=' Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL WHERE AD_Element_ID=577666
;

-- 2020-04-14T14:52:26.021Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName=NULL, Name=' Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL WHERE AD_Element_ID=577666 AND IsCentrallyMaintained='Y'
;

-- 2020-04-14T14:52:26.022Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET Name=' Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL WHERE (AD_Column_ID IN (SELECT AD_Column_ID FROM AD_Column WHERE AD_Element_ID=577666) AND AD_Name_ID IS NULL ) OR (AD_Name_ID = 577666)
;

-- 2020-04-14T14:52:26.039Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_PrintFormatItem pi SET PrintName=' Nur Packanweisungen mit Preis anzeigen', Name=' Nur Packanweisungen mit Preis anzeigen' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c  WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=577666)
;

-- 2020-04-14T14:52:26.044Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Tab SET Name=' Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL, CommitWarning = NULL WHERE AD_Element_ID = 577666
;

-- 2020-04-14T14:52:26.045Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_WINDOW SET Name=' Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL WHERE AD_Element_ID = 577666
;

-- 2020-04-14T14:52:26.045Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Menu SET   Name = ' Nur Packanweisungen mit Preis anzeigen', Description = NULL, WEBUI_NameBrowse = NULL, WEBUI_NameNew = NULL, WEBUI_NameNewBreadcrumb = NULL WHERE AD_Element_ID = 577666
;

-- 2020-04-14T14:52:29.324Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET IsTranslated='Y',Updated=TO_TIMESTAMP('2020-04-14 17:52:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='de_DE'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Nur Packanweisungen mit Preis anzeigen', PrintName='Nur Packanweisungen mit Preis anzeigen',Updated=TO_TIMESTAMP('2020-04-14 17:52:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='de_CH'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Nur Packanweisungen mit Preis anzeigen', PrintName='Nur Packanweisungen mit Preis anzeigen',Updated=TO_TIMESTAMP('2020-04-14 17:52:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='de_DE'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element SET ColumnName='show_only_pricelist_instructions',Updated=TO_TIMESTAMP('2020-04-14 17:53:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666
;

-- 2020-04-14T14:53:05.903Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET ColumnName='show_only_pricelist_instructions', Name='Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL WHERE AD_Element_ID=577666
;

-- 2020-04-14T14:53:05.903Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName='show_only_pricelist_instructions', Name='Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL, AD_Element_ID=577666 WHERE UPPER(ColumnName)='SHOW_ONLY_PRICELIST_INSTRUCTIONS' AND IsCentrallyMaintained='Y' AND AD_Element_ID IS NULL
;

-- 2020-04-14T14:53:05.904Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName='show_only_pricelist_instructions', Name='Nur Packanweisungen mit Preis anzeigen', Description=NULL, Help=NULL WHERE AD_Element_ID=577666 AND IsCentrallyMaintained='Y'
;

-- 2020-04-14T14:54:21.472Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element SET EntityType='de.metas.fresh',Updated=TO_TIMESTAMP('2020-04-14 17:54:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666
;

-- 2020-04-14T14:55:29.100Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,577666,0,540407,541798,20,'show_only_pricelist_instructions',TO_TIMESTAMP('2020-04-14 17:55:28','YYYY-MM-DD HH24:MI:SS'),100,'Y','de.metas.fresh',0,'Y','N','Y','N','N','N','Nur Packanweisungen mit Preis anzeigen',60,TO_TIMESTAMP('2020-04-14 17:55:28','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2020-04-14T14:55:29.103Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N') AND t.AD_Process_Para_ID=541798 AND NOT EXISTS (SELECT 1 FROM AD_Process_Para_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Process_Para_ID=t.AD_Process_Para_ID)
;

-- 2020-04-14T14:55:53.399Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,577666,0,584673,541799,20,'show_only_pricelist_instructions',TO_TIMESTAMP('2020-04-14 17:55:53','YYYY-MM-DD HH24:MI:SS'),100,'Y','de.metas.fresh',0,'Y','N','Y','N','N','N','Nur Packanweisungen mit Preis anzeigen',60,TO_TIMESTAMP('2020-04-14 17:55:53','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2020-04-14T14:55:53.400Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N') AND t.AD_Process_Para_ID=541799 AND NOT EXISTS (SELECT 1 FROM AD_Process_Para_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Process_Para_ID=t.AD_Process_Para_ID)
;

-- 2020-04-14T15:32:28.026Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,577666,0,584659,541800,20,'show_only_pricelist_instructions',TO_TIMESTAMP('2020-04-14 18:32:27','YYYY-MM-DD HH24:MI:SS'),100,'Y','de.metas.fresh',0,'Y','N','Y','N','N','N','Nur Packanweisungen mit Preis anzeigen',60,TO_TIMESTAMP('2020-04-14 18:32:27','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2020-04-14T15:32:28.030Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N') AND t.AD_Process_Para_ID=541800 AND NOT EXISTS (SELECT 1 FROM AD_Process_Para_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Process_Para_ID=t.AD_Process_Para_ID)
;

-- 2020-04-14T15:34:06.840Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/NULL@, @show_only_pricelist_instructions@) where show_only_pricelist_instructions = ''N''
UNION ALL
SELECT * FROM report.fresh_pricelist_details_template_report_2(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/NULL@, @show_only_pricelist_instructions@) where show_only_pricelist_instructions = ''Y'';',Updated=TO_TIMESTAMP('2020-04-14 18:34:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-14T15:45:41.450Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @show_only_pricelist_instructions@) where show_only_pricelist_instructions = ''N''
UNION ALL
SELECT * FROM report.fresh_pricelist_details_template_report_2(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @show_only_pricelist_instructions@) where show_only_pricelist_instructions = ''Y'';',Updated=TO_TIMESTAMP('2020-04-14 18:45:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-14T15:46:48.526Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @show_only_pricelist_instructions@)',Updated=TO_TIMESTAMP('2020-04-14 18:46:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-14T15:46:52.631Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @show_only_pricelist_instructions@);',Updated=TO_TIMESTAMP('2020-04-14 18:46:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-14T15:47:05.870Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/NULL@, @show_only_pricelist_instructions@);',Updated=TO_TIMESTAMP('2020-04-14 18:47:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;
...
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @show_only_pricelist_instructions@)  where show_only_pricelist_instructions = ''N''
UNION ALL
SELECT * FROM report.fresh_pricelist_details_template_report_2(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @show_only_pricelist_instructions@) where show_only_pricelist_instructions = ''Y'';',Updated=TO_TIMESTAMP('2020-04-14 18:47:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-15T09:14:19.776Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='All packing instructions', PrintName='All packing instructions',Updated=TO_TIMESTAMP('2020-04-15 12:14:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='en_US'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='All Packing Instructions', PrintName='All Packing Instructions',Updated=TO_TIMESTAMP('2020-04-15 12:14:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='en_US'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Alle Packvorschriften', PrintName='Alle Packvorschriften',Updated=TO_TIMESTAMP('2020-04-15 12:14:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='nl_NL'
;

-- 2020-04-15T09:14:46.582Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(577666,'nl_NL') 
;

-- 2020-04-15T09:14:50.109Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Alle Packvorschriften', PrintName='Alle Packvorschriften',Updated=TO_TIMESTAMP('2020-04-15 12:14:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='de_DE'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET ColumnName='show_only_pricelist_instructions', Name='Alle Packvorschriften', Description=NULL, Help=NULL WHERE AD_Element_ID=577666
;

-- 2020-04-15T09:14:50.131Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName='show_only_pricelist_instructions', Name='Alle Packvorschriften', Description=NULL, Help=NULL, AD_Element_ID=577666 WHERE UPPER(ColumnName)='SHOW_ONLY_PRICELIST_INSTRUCTIONS' AND IsCentrallyMaintained='Y' AND AD_Element_ID IS NULL
;

-- 2020-04-15T09:14:50.134Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName='show_only_pricelist_instructions', Name='Alle Packvorschriften', Description=NULL, Help=NULL WHERE AD_Element_ID=577666 AND IsCentrallyMaintained='Y'
;

-- 2020-04-15T09:14:50.135Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET Name='Alle Packvorschriften', Description=NULL, Help=NULL WHERE (AD_Column_ID IN (SELECT AD_Column_ID FROM AD_Column WHERE AD_Element_ID=577666) AND AD_Name_ID IS NULL ) OR (AD_Name_ID = 577666)
;

-- 2020-04-15T09:14:50.162Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_PrintFormatItem pi SET PrintName='Alle Packvorschriften', Name='Alle Packvorschriften' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c  WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=577666)
;

-- 2020-04-15T09:14:50.165Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Tab SET Name='Alle Packvorschriften', Description=NULL, Help=NULL, CommitWarning = NULL WHERE AD_Element_ID = 577666
;

-- 2020-04-15T09:14:50.166Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_WINDOW SET Name='Alle Packvorschriften', Description=NULL, Help=NULL WHERE AD_Element_ID = 577666
;

-- 2020-04-15T09:14:50.167Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Menu SET   Name = 'Alle Packvorschriften', Description = NULL, WEBUI_NameBrowse = NULL, WEBUI_NameNew = NULL, WEBUI_NameNewBreadcrumb = NULL WHERE AD_Element_ID = 577666
;

-- 2020-04-15T09:14:54.949Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='All Packing Instructions', PrintName='All Packing Instructions',Updated=TO_TIMESTAMP('2020-04-15 12:14:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='nl_NL'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET Name='Alle Packvorschriften', PrintName='Alle Packvorschriften',Updated=TO_TIMESTAMP('2020-04-15 12:15:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666 AND AD_Language='de_CH'
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element SET ColumnName='p_show_product_price_pi_flag',Updated=TO_TIMESTAMP('2020-04-15 12:19:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=577666
;

-- 2020-04-15T09:19:27.463Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Column SET ColumnName='p_show_product_price_pi_flag', Name='Alle Packvorschriften', Description=NULL, Help=NULL WHERE AD_Element_ID=577666
;

-- 2020-04-15T09:19:27.464Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName='p_show_product_price_pi_flag', Name='Alle Packvorschriften', Description=NULL, Help=NULL, AD_Element_ID=577666 WHERE UPPER(ColumnName)='P_SHOW_PRODUCT_PRICE_PI_FLAG' AND IsCentrallyMaintained='Y' AND AD_Element_ID IS NULL
;

-- 2020-04-15T09:19:27.465Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process_Para SET ColumnName='p_show_product_price_pi_flag', Name='Alle Packvorschriften', Description=NULL, Help=NULL WHERE AD_Element_ID=577666 AND IsCentrallyMaintained='Y'
;

-- 2020-04-15T09:52:10.139Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @p_show_product_price_pi_flag@) where show_product_price_pi_flag = ''N'' UNION ALL SELECT * FROM report.fresh_pricelist_details_template_report_2(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @p_show_product_price_pi_flag@) where show_product_price_pi_flag = ''Y'';',Updated=TO_TIMESTAMP('2020-04-15 12:52:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-15T10:30:02.724Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @p_show_product_price_pi_flag@) where show_product_price_pi_flag = ''N'' UNION ALL SELECT * FROM report.fresh_pricelist_details_template_report_With_PP_PI(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/0@, @p_show_product_price_pi_flag@) where show_product_price_pi_flag = ''Y'';',Updated=TO_TIMESTAMP('2020-04-15 13:30:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-15T10:53:11.089Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Process SET SQLStatement='SELECT * FROM report.fresh_pricelist_details_template_report(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/NULL@, @p_show_product_price_pi_flag/NULL@) where show_product_price_pi_flag = ''N'' UNION ALL SELECT * FROM report.fresh_pricelist_details_template_report_With_PP_PI(@C_BPartner_ID/NULL@, @M_PriceList_Version_ID/NULL@,''@#AD_Language@'',@C_BPartner_Location_ID/NULL@, @p_show_product_price_pi_flag/NULL@) where show_product_price_pi_flag = ''Y'';',Updated=TO_TIMESTAMP('2020-04-15 13:53:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=584659
;

-- 2020-04-15T10:53:52.353Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,577666,0,584680,541801,20,'p_show_product_price_pi_flag',TO_TIMESTAMP('2020-04-15 13:53:52','YYYY-MM-DD HH24:MI:SS'),100,'Y','de.metas.fresh',0,'Y','N','Y','N','N','N','Alle Packvorschriften',40,TO_TIMESTAMP('2020-04-15 13:53:52','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2020-04-15T10:53:52.359Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N') AND t.AD_Process_Para_ID=541801 AND NOT EXISTS (SELECT 1 FROM AD_Process_Para_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Process_Para_ID=t.AD_Process_Para_ID)
;

-- 2020-04-15T10:54:36.028Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy,VFormat) VALUES (0,577666,0,541230,541802,20,'p_show_product_price_pi_flag',TO_TIMESTAMP('2020-04-15 13:54:35','YYYY-MM-DD HH24:MI:SS'),100,'de.metas.fresh',0,'Y','N','Y','N','N','N','Alle Packvorschriften',40,TO_TIMESTAMP('2020-04-15 13:54:35','YYYY-MM-DD HH24:MI:SS'),100,'Y')
;

-- 2020-04-15T10:54:36.029Z
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N') AND t.AD_Process_Para_ID=541802 AND NOT EXISTS (SELECT 1 FROM AD_Process_Para_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Process_Para_ID=t.AD_Process_Para_ID)
;
