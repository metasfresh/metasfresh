...
AS
$BODY$
            -- Warning about this function: if a line with a small seqno exists and has no product/category/anything, it will be selected for all the products which appear below it (have greater seqno)!
            -- in other words: be careful about having empty lines!
