...
public class ProcessCtl implements Runnable
{
	 ...
	 *  @param pi ProcessInfo process info <b>IMPORTANT:</p> the 'pi' may already contain an <code>AD_PInstance_ID > 0</code>. In that case the provided AD_Pinstance is used. Otherwise a new AD_Pinstance is created.
	 *  
	 *  @param trx Transaction
	 *  @return worker started ProcessCtl instance or null for workflow
	 */
