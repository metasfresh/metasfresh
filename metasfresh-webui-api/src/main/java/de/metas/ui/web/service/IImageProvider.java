...
public interface IImageProvider extends ISingletonService
{
	...
	public static interface IImageResource
	{
	}

	IImageResource getIconSmall(String name);
	IImageResource getImageResourceForNameWithoutExt(final String fileNameWithoutExtension);
}
