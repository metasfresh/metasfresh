...
{
	/* package */ static final PropertyValueCollection.Builder builder()
	{
		return new Builder();
	}
	...
	private PropertyValueCollection(final PropertyValueCollection.Builder builder)
	{
		...
		{
			System.out.println("--------------------------------------------------------------------------------");
			System.out.println("Build PropertyValuesCollection" + PropertyValues.toStringRecursivelly(name2value.values()));
			System.out.println("--------------------------------------------------------------------------------");
