package de.metas.ui.web.window_old.controller;
...
import de.metas.ui.web.window_old.model.WindowModel;
import de.metas.ui.web.window_old.model.WindowModelImpl;
...
{
	public static final String ENDPOINT = WebConfig.ENDPOINT_ROOT + "/old/windows";
