...
public class JSONObjectValueHolder_JSONSerializer extends JsonSerializer<JSONObjectValueHolder>
{
	public static final String PROPERTY_ValueType = "t";
	public static final String PROPERTY_Value = "v";

	@Override
	public void serialize(final JSONObjectValueHolder valueHolder, final JsonGenerator gen, final SerializerProvider serializers) throws IOException, JsonProcessingException
	{
