...
public class PackingMaterialKey extends TerminalKey
{
	...
	public String getDebugInfo()
	{
		...
		if (!restrictions.isEmpty())
		{
			...
			for (final I_M_HU_PI_Item_Product r : restrictions)
			{
				sb.append("\n").append("Product=" + r.getM_Product() + ", BPartner=" + r.getC_BPartner_ID() + ", M_HU_PI_Item_Product_ID=" + r.getM_HU_PI_Item_Product_ID());
			}
		}
		return sb.toString();
	}
	...
	public boolean isCompatible(final ITerminalContext terminalContext, final ProductKey productKey)
	{
		...
		query.setBPartnerId(productKey.getBPartnerId());
