...
FROM
	C_TaxDeclaration td
	LEFT OUTER JOIN C_TaxDeclarationline tdl ON td.C_TaxDeclaration_ID = tdl.C_TaxDeclaration_ID
	LEFT OUTER JOIN C_Tax t ON tdl.C_Tax_ID = t.C_Tax_ID
	LEFT OUTER JOIN C_BPartner bp ON bp.C_BPartner_ID = tdl.C_BPartner_ID
GROUP BY
	td.C_TaxDeclaration_ID,
	td.name,
	td.Datefrom,
