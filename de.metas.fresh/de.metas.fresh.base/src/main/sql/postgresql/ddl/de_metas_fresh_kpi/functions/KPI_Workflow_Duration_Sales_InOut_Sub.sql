--inout sales
--DROP FUNCTION IF EXISTS de_metas_fresh_kpi.KPI_Workflow_Duration_Sales_InOut_Sub (IN startdate DATE, IN enddate DATE);
CREATE OR REPLACE FUNCTION de_metas_fresh_kpi.KPI_Workflow_Duration_Sales_InOut_Sub (IN startdate DATE, IN enddate DATE)
RETURNS TABLE 
(
table_id numeric,
record_id numeric,
