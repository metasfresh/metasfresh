...
ALTER TABLE C_Allocation_Candidate DROP CONSTRAINT IF EXISTS BillBPartner_CAllocationCandid;
ALTER TABLE C_Allocation_Candidate DROP CONSTRAINT IF EXISTS BillLocation_CAllocationCandid;
ALTER TABLE C_Allocation_Candidate DROP CONSTRAINT IF EXISTS CAllocationLine_CAllocationCan;
ALTER TABLE C_Allocation_Candidate DROP CONSTRAINT IF EXISTS InvoiceCurrency_CAllocationCan;
ALTER TABLE C_Allocation_Candidate DROP CONSTRAINT IF EXISTS PaymentCurrency_CAllocationCan;
...
ALTER TABLE C_Allocation_Candidate ADD CONSTRAINT BillBPartner_CAllocationCandid FOREIGN KEY (Bill_BPartner_ID) REFERENCES C_BPartner DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE C_Allocation_Candidate ADD CONSTRAINT BillLocation_CAllocationCandid FOREIGN KEY (Bill_Location_ID) REFERENCES C_BPartner_Location DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE C_Allocation_Candidate ADD CONSTRAINT CAllocationLine_CAllocationCan FOREIGN KEY (C_AllocationLine_ID) REFERENCES C_AllocationLine DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE C_Allocation_Candidate ADD CONSTRAINT InvoiceCurrency_CAllocationCan FOREIGN KEY (Invoice_Currency_ID) REFERENCES C_Currency DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE C_Allocation_Candidate ADD CONSTRAINT PaymentCurrency_CAllocationCan FOREIGN KEY (Payment_Currency_ID) REFERENCES C_Currency DEFERRABLE INITIALLY DEFERRED;
