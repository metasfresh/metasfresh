...
-- 24.11.2015 09:50
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1582,0,540627,540825,15,'DateTo',TO_TIMESTAMP('2015-11-24 09:50:55','YYYY-MM-DD HH24:MI:SS'),100,'Enddatum eines Abschnittes','de.metas.fresh',0,'Datum bis bezeichnet das Enddatum eines Abschnittes (inklusiv)','Y','N','Y','N','Y','N','Datum bis',10,TO_TIMESTAMP('2015-11-24 09:50:55','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 24.11.2015 09:51
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAutocomplete,IsCentrallyMaintained,IsEncrypted,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1582,0,540627,540826,15,'DateTo',TO_TIMESTAMP('2015-11-24 09:51:10','YYYY-MM-DD HH24:MI:SS'),100,'Enddatum eines Abschnittes','de.metas.fresh',0,'Datum bis bezeichnet das Enddatum eines Abschnittes (inklusiv)','Y','N','Y','N','Y','N','Datum bis',10,TO_TIMESTAMP('2015-11-24 09:51:10','YYYY-MM-DD HH24:MI:SS'),100)
;
