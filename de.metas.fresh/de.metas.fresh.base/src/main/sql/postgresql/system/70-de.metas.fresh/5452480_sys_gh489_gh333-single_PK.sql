...
--
-- DDL for creating a single PK for C_Allocation_Candidate
--
-- 03.11.2016 07:22
-- URL zum Konzept
ALTER TABLE C_Allocation_Candidate ADD COLUMN C_Allocation_Candidate_ID numeric(10,0) NOT NULL DEFAULT nextval('c_allocation_candidate_seq')
;

-- 03.11.2016 07:22
-- URL zum Konzept
ALTER TABLE C_Allocation_Candidate DROP CONSTRAINT IF EXISTS c_allocation_candidate_pkey
;

-- 03.11.2016 07:22
-- URL zum Konzept
ALTER TABLE C_Allocation_Candidate ADD CONSTRAINT c_allocation_candidate_pkey PRIMARY KEY (C_Allocation_Candidate_ID)
;
...
--
-- DML for creating a single PK for C_Allocation_Candidate
--
-- 03.11.2016 07:22
-- URL zum Konzept
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,543228,0,'C_Allocation_Candidate_ID',TO_TIMESTAMP('2016-11-03 07:22:22','YYYY-MM-DD HH24:MI:SS'),100,'de.metas.allocationcandidate','Y','Zuordnungsdisposition','Zuordnungsdisposition',TO_TIMESTAMP('2016-11-03 07:22:22','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 03.11.2016 07:22
-- URL zum Konzept
INSERT INTO AD_Element_Trl (AD_Language,AD_Element_ID, Description,Help,Name,PO_Description,PO_Help,PO_Name,PO_PrintName,PrintName, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Element_ID, t.Description,t.Help,t.Name,t.PO_Description,t.PO_Help,t.PO_Name,t.PO_PrintName,t.PrintName, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Element t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Element_ID=543228 AND NOT EXISTS (SELECT * FROM AD_Element_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Element_ID=t.AD_Element_ID)
;

-- 03.11.2016 07:22
-- URL zum Konzept
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,AllowZoomTo,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsTranslated,IsUpdateable,Name,Updated,UpdatedBy,Version) VALUES (0,555413,543228,0,13,540680,'N','C_Allocation_Candidate_ID',TO_TIMESTAMP('2016-11-03 07:22:22','YYYY-MM-DD HH24:MI:SS'),100,'de.metas.allocationcandidate',10,'Y','Y','N','N','N','Y','Y','N','N','N','N','Zuordnungsdisposition',TO_TIMESTAMP('2016-11-03 07:22:22','YYYY-MM-DD HH24:MI:SS'),100,1)
;

-- 03.11.2016 07:22
-- URL zum Konzept
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Column t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Column_ID=555413 AND NOT EXISTS (SELECT * FROM AD_Column_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Column_ID=t.AD_Column_ID)
;


-- 03.11.2016 07:22
-- URL zum Konzept
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,555413,557394,0,540700,TO_TIMESTAMP('2016-11-03 07:22:22','YYYY-MM-DD HH24:MI:SS'),100,10,'de.metas.allocationcandidate','Y','Y','N','N','N','N','N','N','N','Zuordnungsdisposition',TO_TIMESTAMP('2016-11-03 07:22:22','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 03.11.2016 07:22
-- URL zum Konzept
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Field t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Field_ID=557394 AND NOT EXISTS (SELECT * FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;
