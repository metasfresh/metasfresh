...
ORDER BY bpp.iscurrentvendor desc, ProductNo, ProductName, seqno
LIMIT 1
$$;

comment on function getc_bpartner_product_vendor(p_m_product_id numeric)
is 'This function returns a VENDOR C_BPartner_Product record with a matching matching given product-Id
