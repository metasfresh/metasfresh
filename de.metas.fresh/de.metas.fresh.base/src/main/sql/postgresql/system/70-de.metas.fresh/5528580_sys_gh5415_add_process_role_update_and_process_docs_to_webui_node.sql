...
UPDATE AD_TreeNodeMM SET Parent_ID=1000098, SeqNo=(select max(seqno) from AD_TreeNodeMM where Parent_ID=1000098), Updated=now(), UpdatedBy=100 WHERE  Node_ID=540631 AND AD_Tree_ID=10
;
