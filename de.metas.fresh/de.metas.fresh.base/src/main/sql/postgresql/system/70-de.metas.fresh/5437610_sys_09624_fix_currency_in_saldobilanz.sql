	...
	(
		SELECT
			...
			CASE WHEN SUM(fa.showEur)>0 AND $3='Y' THEN
				...
				* currencyrate(c.c_currency_id, (SELECT C_Currency_ID FROM C_Currency WHERE ISO_Code = 'EUR') , $1, (SELECT C_ConversionType_ID FROM C_ConversionType where value ='P'), ci.AD_Client_ID, ci.ad_org_id) ELSE NULL END AS euroSaldo,
