...
DROP FUNCTION IF EXISTS de_metas_fresh_kpi.KPI_Printing_Performance_Shipment_Function (IN StartDate Date, IN EndDate Date);

CREATE OR REPLACE FUNCTION de_metas_fresh_kpi.KPI_Printing_Performance_Shipment_Function (IN StartDate Date, IN EndDate Date)
RETURNS TABLE (
