...
FROM
	(
		SELECT 
			...
			(de_metas_acct.acctbalanceuntildate(ev.C_ElementValue_ID, acs.C_AcctSchema_ID,$2::date, $7)).Balance AS CarryBalance,
			fa.DocStatus,
...
$$
	SELECT 	DateAcct, Fact_Acct_ID, BP_Name, Description, Account2_ID, a_Value, AmtAcctDr, AmtAcctCr, Saldo, 
		...
		ad_org_id
	FROM 	report.fresh_Account_Info_Report_Sub ($1, $2, $3, $4, $5, $6, $7 )
