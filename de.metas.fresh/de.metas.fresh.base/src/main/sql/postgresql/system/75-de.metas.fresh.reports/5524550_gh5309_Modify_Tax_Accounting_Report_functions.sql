...
SELECT  DISTINCT ON (x.vatcode,x.kontono,x.kontoname,x.dateacct, x.documentno, x.taxname, x.taxrate,x.DocType_DisplayName, x.bpName)

	x.vatcode, x.kontono,x.kontoname,x.dateacct::date, x.documentno, x.taxname, x.taxrate, x.DocType_DisplayName, x.bpName,
...
ORDER BY x.vatcode, x.kontono,x.kontoname,x.dateacct, x.documentno, x.taxname, x.taxrate, x.DocType_DisplayName, x.bpName
$$ 
LANGUAGE sql STABLE;
