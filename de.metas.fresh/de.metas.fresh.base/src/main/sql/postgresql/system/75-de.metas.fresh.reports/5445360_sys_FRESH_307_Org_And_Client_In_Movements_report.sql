...
FROM 
	...
	LEFT OUTER JOIN M_Movementline ml_before ON ml.dd_orderline_ID = ml_before.dd_orderLine_ID
	LEFT OUTER JOIN M_Locator l_from ON COALESCE(ml_before.M_Locator_ID,ml.M_Locator_ID) = l_from.M_Locator_ID
