...
public class OrderLineReceiptScheduleProducerTest extends ReceiptScheduleTestBase
{
	...
	public void createReceiptScheduleFromOrderLine()
	{
		...
		Assert.assertEquals("Invalid M_Warehouse_ID", orderWarehouse, receiptSched.get(0).getM_Warehouse());
		Assert.assertEquals("Invalid M_Warehouse_Override_ID", null, receiptSched.get(0).getM_Warehouse_Override());
		Assert.assertEquals("Invalid M_Warehouse_Dest_ID", productWarehouse, receiptSched.get(0).getM_Warehouse_Dest());
	}
}
