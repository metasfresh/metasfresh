...
INSERT INTO M_AttributeValue (AD_Client_ID,AD_Org_ID,Created,CreatedBy,IsActive,IsNullFieldValue,M_Attribute_ID,M_AttributeValue_ID,Name,Updated,UpdatedBy,Value) VALUES (0,0,TO_TIMESTAMP('2019-06-10 11:44:16','YYYY-MM-DD HH24:MI:SS'),100,'Y','N',540040,540039,'Fraud',TO_TIMESTAMP('2019-06-10 11:44:16','YYYY-MM-DD HH24:MI:SS'),100,'F')
;
