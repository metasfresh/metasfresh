...
public class M_InOutLine
{
	...
	public void onMovementQtyChange(final I_M_InOutLine inOutLine)
	{
		...
		if (!allocs.isEmpty())
		{
			...
			final BigDecimal qtyPickedToAdd = shipmentLine_movementQty.subtract(qtyPickedTotal);
			if (qtyPickedToAdd.signum() != 0)
			{
				...
				if (adjustments_alloc != null)
				{
					...
					InterfaceWrapperHelper.save(adjustments_alloc);
				}
				...
				else
				{
					...
					InterfaceWrapperHelper.save(adjustments_allocNew);
				}
			}
		}
