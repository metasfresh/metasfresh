...
{
	final Set<IPackingMaterialDocumentLineSource> sources = new HashSet<IPackingMaterialDocumentLineSource>();
	final Set<IPackingMaterialDocumentLineSource> sourcesRO = Collections.unmodifiableSet(sources);

	@Override
	public final void addSourceOrderLine(final IPackingMaterialDocumentLineSource source)
	{
