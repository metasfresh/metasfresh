...
public class M_ReceiptSchedule_GeneratePlanningHUs_UsingDefaults extends M_ReceiptSchedule_GeneratePlanningHUs_Base
{
	@Override
	...
	private String buildDefaultPackingInfo(final IProcessPreconditionsContext context)
	{
		...
		return lutuConfig.getM_HU_PI_Item_Product().getName();
	}
