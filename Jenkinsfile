	...
	configFileProvider([configFile(fileId: 'metasfresh-global-maven-settings', replaceTokens: true, variable: 'MAVEN_SETTINGS')])
	{
		...
		withMaven(jdk: 'java-8', maven: 'maven-3.5.0', mavenLocalRepo: '.repository')
		{
			...
			stage('Set versions and build endcustomer-dist')
			{
				...
				MF_ARTIFACT_URLS['metasfresh-dist'] =  misc.encodeURL("${mvnConf.deployRepoURL}/de/metas/dist/de.metas.endcustomer.mf15.dist/${MF_VERSION}/de.metas.endcustomer.mf15.dist-${MF_VERSION}-dist.tar.gz")
				MF_ARTIFACT_URLS['metasfresh-material-dispo']=  misc.encodeURL("${mvnConf.deployRepoURL}/de/metas/material/metasfresh-material-dispo/${mavenProps['metasfresh.version']}/metasfresh-material-dispo-${mavenProps['metasfresh.version']}.jar")
				MF_ARTIFACT_URLS['metasfresh-procurement-webui']=  misc.encodeURL("${mvnConf.deployRepoURL}/de/metas/procurement/de.metas.procurement.webui/${mavenProps['metasfresh-procurement-webui.version']}/de.metas.procurement.webui-${mavenProps['metasfresh-procurement-webui.version']}.jar")
