...
node('agent && linux') // shall only run on a jenkins agent with linux
{
    ...
    configFileProvider([configFile(fileId: 'metasfresh-global-maven-settings', replaceTokens: true, variable: 'MAVEN_SETTINGS')])
    {
        ...
        stage('Set versions and build metasfresh-procurement-webui')
        {
				...
				<ul>
<li><a href=\"https://repo.metasfresh.com/content/repositories/${mvnConf.mvnRepoName}/de/metas/procurement/de.metas.procurement.webui/${MF_VERSION}/de.metas.procurement.webui-${MF_VERSION}.jar\">metasfresh-procurement-${MF_VERSION}.jar</a></li>
</ul>""";
