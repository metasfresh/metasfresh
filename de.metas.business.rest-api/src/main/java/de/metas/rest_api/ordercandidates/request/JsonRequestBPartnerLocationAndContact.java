		...
		if (bpartnerLookupAdvise != null)
		{
			switch (bpartnerLookupAdvise)
			{
				case GLN:
					...
					break;
				case ExternalId:
					Check.errorUnless(hasBPartnerExternalId, "With bpartnerLookupAdvise={}, location.externalId may not be empty; this={}", bpartnerLookupAdvise, this);
					break;
				case Code:
					Check.errorUnless(hasBPartnerCode, "With bpartnerLookupAdvise={}, location.code may not be empty; this={}", bpartnerLookupAdvise, this);
					break;
				default:
