...
public interface IDDOrderDAO extends ISingletonService
{
	...
	/**
	 * Retrieve those DD_Orders which were generated to balance the Demand generated by manufacturing order's components.
	 * 
	 * @param ppOrder
	 * @return list of backward distribution orders
	 */
	List<I_DD_Order> retrieveBackwardSupplyDDOrders(I_PP_Order ppOrder);
