...
public class PPWFNodeProductDAO implements IPPWFNodeProductDAO
{
	@Override
	@Cached(cacheName = I_PP_WF_Node_Product.Table_Name + "#by#" + I_PP_WF_Node_Product.COLUMNNAME_AD_WF_Node_ID)
	public List<I_PP_WF_Node_Product> retrieveForWFNode(@CacheCtx Properties ctx, int adWFNodeId)
	{
		...
		final ICompositeQueryFilter<I_PP_WF_Node_Product> filters = queryBuilder.getCompositeFilter();
		filters.addEqualsFilter(I_PP_WF_Node_Product.COLUMNNAME_AD_WF_Node_ID, adWFNodeId);
		filters.addOnlyActiveRecordsFilter();

		queryBuilder.orderBy()
				.addColumn(I_PP_WF_Node_Product.COLUMNNAME_SeqNo);
	...
	@Override
	public List<I_PP_WF_Node_Product> retrieveForWFNode(final I_AD_WF_Node wfNode)
	{
