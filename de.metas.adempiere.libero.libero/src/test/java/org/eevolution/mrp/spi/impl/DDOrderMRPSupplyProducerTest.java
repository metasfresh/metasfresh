...
public class DDOrderMRPSupplyProducerTest
{
	private DDOrderMRPSupplyProducer ddOrderMRPSupplyProducer;

	@Before
	public void init()
	{
		this.ddOrderMRPSupplyProducer = new DDOrderMRPSupplyProducer();
	}
	...
	private void test_calculateQtyToMove(BigDecimal qtyToMoveExpected, BigDecimal qtyToMoveRequested, BigDecimal transferPercent)
	{
		final BigDecimal qtyToMoveActual = ddOrderMRPSupplyProducer.calculateQtyToMove(qtyToMoveRequested, transferPercent);
