...
public class PPOrderBOMBL_calculateQtyToIssueBasedOnFinishedGoodReceipt_Test
{
	...
	private IPPOrderBOMBL ppOrderBOMBL = Services.get(IPPOrderBOMBL.class);
	...
	private void assertQtyToIssueBasedOnFinishedGoodReceived(final String expectedStr)
	{
		...
		BigDecimal actual = ppOrderBOMBL.calculateQtyToIssueBasedOnFinishedGoodReceipt(ppOrderBOMLine, ppOrderBOMLine.getC_UOM()).getQty();
