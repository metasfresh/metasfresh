...
-- 12.12.2016 11:26
-- URL zum Konzept
UPDATE AD_Element SET Help='If you change this value for a DLM''ed table then please run  "select dlm.recreate_dlm_triggers(''tablename'')" to update the DLM triggers',Updated=TO_TIMESTAMP('2016-12-12 11:26:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=543253
;
