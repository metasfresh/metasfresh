...
/**
 * Generated Model for DLM_Partition_Record_V
 * 
 * @author Adempiere (generated)
 */
@SuppressWarnings("javadoc")
public class X_DLM_Partition_Record_V extends org.compiere.model.PO implements I_DLM_Partition_Record_V, org.compiere.model.I_Persistent
{

	/**
	 *
	 */
	private static final long serialVersionUID = 1028334929L;

	/** Standard Constructor */
	public X_DLM_Partition_Record_V(final Properties ctx, final int DLM_Partition_Record_V_ID, final String trxName)
	{
		super(ctx, DLM_Partition_Record_V_ID, trxName);
		/**
		 * if (DLM_Partition_Record_V_ID == 0)
		 * {
		 * setDLM_Partition_Record_V_ID (0);
		 * setIsDLM (false);
		 * }
		 */
	}
	...
	/** Load Constructor */
	public X_DLM_Partition_Record_V(final Properties ctx, final ResultSet rs, final String trxName)
	{
	 ...
	 * 
	 * @param DLM_Partition_Record_V_ID DLM_Partition_Record
	 */
	@Override
	public void setDLM_Partition_Record_V_ID(final int DLM_Partition_Record_V_ID)
	{
		if (DLM_Partition_Record_V_ID < 1)
		{
			set_ValueNoCheck(COLUMNNAME_DLM_Partition_Record_V_ID, null);
		}
		else
		{
			set_ValueNoCheck(COLUMNNAME_DLM_Partition_Record_V_ID, Integer.valueOf(DLM_Partition_Record_V_ID));
		}
	}
	...
	{
		final Integer ii = (Integer)get_Value(COLUMNNAME_DLM_Partition_Record_V_ID);
		if (ii == null)
		{
			return 0;
		}
