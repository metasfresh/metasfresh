...
@XmlType(name = "TradeAddressType", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", propOrder = {
    "postcodeCode",
    "lineOne",
    "lineTwo",
    "lineThree",
...
public class TradeAddressType {
    ...
    @XmlElement(name = "PostcodeCode", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected CodeType postcodeCode;
    @XmlElement(name = "LineOne", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected TextType lineOne;
    @XmlElement(name = "LineTwo", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected TextType lineTwo;
    @XmlElement(name = "LineThree", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected TextType lineThree;
    @XmlElement(name = "CityName", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected TextType cityName;
    @XmlElement(name = "CountryID", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", required = true)
    protected CountryIDType countryID;
    @XmlElement(name = "CountrySubDivisionName", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
