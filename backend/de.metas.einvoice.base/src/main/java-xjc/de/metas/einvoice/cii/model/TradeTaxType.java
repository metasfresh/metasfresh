...
@XmlType(name = "TradeTaxType", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", propOrder = {
    "calculatedAmount",
    "typeCode",
    "exemptionReason",
    "basisAmount",
...
public class TradeTaxType {
    ...
    @XmlElement(name = "CalculatedAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    ...
    @XmlElement(name = "ExemptionReason", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected TextType exemptionReason;
    @XmlElement(name = "BasisAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected AmountType basisAmount;
    @XmlElement(name = "CategoryCode", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", required = true)
    protected TaxCategoryCodeType categoryCode;
    @XmlElement(name = "ExemptionReasonCode", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected CodeType exemptionReasonCode;
    @XmlElement(name = "TaxPointDate", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected DateType taxPointDate;
    @XmlElement(name = "DueDateTypeCode", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected TimeReferenceCodeType dueDateTypeCode;
    @XmlElement(name = "RateApplicablePercent", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
