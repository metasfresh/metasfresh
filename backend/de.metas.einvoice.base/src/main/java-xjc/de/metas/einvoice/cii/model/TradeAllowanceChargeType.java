...
@XmlType(name = "TradeAllowanceChargeType", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", propOrder = {
    "chargeIndicator",
    "calculationPercent",
    "basisAmount",
    "actualAmount",
...
public class TradeAllowanceChargeType {
    ...
    @XmlElement(name = "ChargeIndicator", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", required = true)
    protected IndicatorType chargeIndicator;
    @XmlElement(name = "CalculationPercent", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    ...
    @XmlElement(name = "ActualAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", required = true)
    protected AmountType actualAmount;
    @XmlElement(name = "ReasonCode", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected AllowanceChargeReasonCodeType reasonCode;
    @XmlElement(name = "Reason", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected TextType reason;
    @XmlElement(name = "CategoryTradeTax", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
