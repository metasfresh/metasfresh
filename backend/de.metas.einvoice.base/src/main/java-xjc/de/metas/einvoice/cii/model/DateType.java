...
@XmlType(name = "DateType", namespace = "urn:un:unece:uncefact:data:standard:UnqualifiedDataType:100", propOrder = {
    "dateString"
})
public class DateType {

    @XmlElement(name = "DateString", namespace = "urn:un:unece:uncefact:data:standard:UnqualifiedDataType:100")
