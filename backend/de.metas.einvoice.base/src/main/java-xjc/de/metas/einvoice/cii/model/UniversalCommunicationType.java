...
@XmlType(name = "UniversalCommunicationType", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", propOrder = {
    "uriid",
    "completeNumber"
})
public class UniversalCommunicationType {
    ...
    @XmlElement(name = "CompleteNumber", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
