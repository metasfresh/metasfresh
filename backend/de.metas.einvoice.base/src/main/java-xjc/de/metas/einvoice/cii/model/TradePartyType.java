...
@XmlType(name = "TradePartyType", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", propOrder = {
    "id",
    "globalID",
    "name",
    "description",
...
public class TradePartyType {
    ...
    @XmlElement(name = "DefinedTradeContact", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    ...
    @XmlElement(name = "URIUniversalCommunication", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
