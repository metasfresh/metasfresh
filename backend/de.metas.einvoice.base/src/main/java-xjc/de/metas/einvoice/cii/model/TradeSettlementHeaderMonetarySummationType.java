...
@XmlType(name = "TradeSettlementHeaderMonetarySummationType", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", propOrder = {
    "lineTotalAmount",
    "chargeTotalAmount",
...
public class TradeSettlementHeaderMonetarySummationType {
    ...
    @XmlElement(name = "ChargeTotalAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected AmountType chargeTotalAmount;
    @XmlElement(name = "AllowanceTotalAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected AmountType allowanceTotalAmount;
    @XmlElement(name = "TaxBasisTotalAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", required = true)
    protected AmountType taxBasisTotalAmount;
    @XmlElement(name = "TaxTotalAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected List<AmountType> taxTotalAmount;
    @XmlElement(name = "RoundingAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected AmountType roundingAmount;
    @XmlElement(name = "GrandTotalAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", required = true)
    protected AmountType grandTotalAmount;
    @XmlElement(name = "TotalPrepaidAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected AmountType totalPrepaidAmount;
    @XmlElement(name = "DuePayableAmount", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", required = true)
