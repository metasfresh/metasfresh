...
public class CrossIndustryInvoiceType {
    ...
    @XmlElement(name = "ExchangedDocumentContext", namespace = "urn:un:unece:uncefact:data:standard:CrossIndustryInvoice:100", required = true)
    protected ExchangedDocumentContextType exchangedDocumentContext;
    @XmlElement(name = "ExchangedDocument", namespace = "urn:un:unece:uncefact:data:standard:CrossIndustryInvoice:100", required = true)
    protected ExchangedDocumentType exchangedDocument;
    @XmlElement(name = "SupplyChainTradeTransaction", namespace = "urn:un:unece:uncefact:data:standard:CrossIndustryInvoice:100", required = true)
