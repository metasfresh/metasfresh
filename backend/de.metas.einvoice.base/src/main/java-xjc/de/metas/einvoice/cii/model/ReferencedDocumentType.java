...
@XmlType(name = "ReferencedDocumentType", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100", propOrder = {
    "issuerAssignedID",
    "uriid",
    "lineID",
    "typeCode",
...
public class ReferencedDocumentType {
    ...
    @XmlElement(name = "URIID", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected IDType uriid;
    @XmlElement(name = "LineID", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    ...
    @XmlElement(name = "AttachmentBinaryObject", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected BinaryObjectType attachmentBinaryObject;
    @XmlElement(name = "ReferenceTypeCode", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
    protected ReferenceCodeType referenceTypeCode;
    @XmlElement(name = "FormattedIssueDateTime", namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100")
