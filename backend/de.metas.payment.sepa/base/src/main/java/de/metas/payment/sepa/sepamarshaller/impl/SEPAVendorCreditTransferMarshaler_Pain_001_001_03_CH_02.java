...
import de.metas.payment.sepa.jaxb.sct.pain_001_001_03_ch_02.*;
...
public class SEPAVendorCreditTransferMarshaler_Pain_001_001_03_CH_02 implements SEPAMarshaler
{
	...
	private String extractPaymentType(@NonNull final I_SEPA_Export_Line line)
	{
		...
		if (bPBankAccount.isEsrAccount() && Check.isNotBlank(line.getStructuredRemittanceInfo())  && bPBankAccount.getQR_IBAN() == null)
		{
