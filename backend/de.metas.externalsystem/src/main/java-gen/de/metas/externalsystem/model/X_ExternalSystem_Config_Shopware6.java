...
public class X_ExternalSystem_Config_Shopware6 extends org.compiere.model.PO implements I_ExternalSystem_Config_Shopware6, org.compiere.model.I_Persistent 
{
	...
	@Override
	public void setIsSyncStockToShopware6 (final boolean IsSyncStockToShopware6)
	{
		set_Value (COLUMNNAME_IsSyncStockToShopware6, IsSyncStockToShopware6);
	}

	@Override
	public boolean isSyncStockToShopware6() 
	{
		return get_ValueAsBoolean(COLUMNNAME_IsSyncStockToShopware6);
	}
