...
-- me03#30066 TODO 1: Display IsArrayFanOut on the ExternalSystem_Endpoint tab.
...
-- Placed in the HTTP element group (554995) at SeqNo=60, after Password (SeqNo=50).
...
VALUES (0, 7802600, 0, 548506, 554995,
        6519990 /*From ID Server*/, 'F',
        now(), 100, 'Y',
        'N', 'N', 'Y', 'N',
        'N', 'N', 0,
        'Array-Fan-Out', 60, 0, 0,
        now(), 100)
