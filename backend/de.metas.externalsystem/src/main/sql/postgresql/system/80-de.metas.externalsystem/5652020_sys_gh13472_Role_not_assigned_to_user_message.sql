...
UPDATE AD_Message SET MsgText='The ''{0}'' role is not assigned to user: ''{1}''.',Updated=TO_TIMESTAMP('2022-08-21 11:36:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Message_ID=545150
;
