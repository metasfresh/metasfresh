...
UPDATE AD_Process SET Description='Process used to provide a fresh Metasfresh REST-API authorization token for the Camel external-system suite. Normally, the process should only by run if the sys configs involved are updated.', Help=NULL, Name='Externe Systeme authentifizieren',Updated=TO_TIMESTAMP('2022-08-21 11:59:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=585099
;
