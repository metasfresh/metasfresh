...
public class SAP_GLJournal
{
	...
	public SAP_GLJournal(final @NonNull ExportAcctToSAPService exportAcctToSAPService)
	{
		this.exportAcctToSAPService = exportAcctToSAPService;
	}

	@DocValidate(timings = ModelValidator.TIMING_AFTER_POST)
	public void exportAfterPost(@NonNull final I_SAP_GLJournal glJournal)
	{
		trxManager.runAfterCommit(() -> exportAcctToSAPService.enqueueDocument(TableRecordReference.of(glJournal)));
	}
}
