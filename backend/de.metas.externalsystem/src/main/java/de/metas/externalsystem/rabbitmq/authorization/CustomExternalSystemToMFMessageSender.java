...
@Service
public class CustomExternalSystemToMFMessageSender
{
	private final RabbitTemplate rabbitTemplate;
	private final Queue queue;

	public CustomExternalSystemToMFMessageSender(
			@NonNull final RabbitTemplate rabbitTemplate,
			@NonNull @Qualifier(QUEUE_NAME_ES_TO_MF_AUTH) final Queue queue
	)
	{
