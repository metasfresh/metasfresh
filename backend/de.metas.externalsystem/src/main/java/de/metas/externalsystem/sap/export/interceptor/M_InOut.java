...
public class M_InOut
{
	...
	public void exportAfterPost(@NonNull final I_M_InOut inout)
	{
		trxManager.runAfterCommit(() -> exportAcctToSAPService.enqueueDocument(TableRecordReference.of(inout)));
	}
}
