...
public class C_AllocationHdr
{
	...
	public C_AllocationHdr(final @NonNull ExportAcctToSAPService exportAcctToSAPService)
	{
		this.exportAcctToSAPService = exportAcctToSAPService;
	}

	@DocValidate(timings = ModelValidator.TIMING_AFTER_POST)
	public void exportAfterPost(@NonNull final I_C_AllocationHdr allocationHdr)
	{
		trxManager.runAfterCommit(() -> exportAcctToSAPService.enqueueDocument(TableRecordReference.of(allocationHdr)));
	}
}
