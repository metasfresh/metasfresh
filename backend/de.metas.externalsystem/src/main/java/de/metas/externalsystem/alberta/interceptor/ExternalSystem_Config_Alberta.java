...
@Interceptor(I_ExternalSystem_Config_Alberta.class)
@Component
public class ExternalSystem_Config_Alberta
{
	public final ExternalSystemConfigRepository externalSystemConfigRepository;

	public ExternalSystem_Config_Alberta(final ExternalSystemConfigRepository externalSystemConfigRepository)
	{
	...
	public void checkType(final I_ExternalSystem_Config_Alberta albertaConfig)
	{
		final String parentType =
				externalSystemConfigRepository.getParentTypeById(ExternalSystemParentConfigId.ofRepoId(albertaConfig.getExternalSystem_Config_ID()));
