...
@Value
@Builder
public class ExternalSystemScriptedImportConversionConfig implements IExternalSystemChildConfig
{
	...
	{
		return (ExternalSystemScriptedImportConversionConfig)childConfig;
	}
}
