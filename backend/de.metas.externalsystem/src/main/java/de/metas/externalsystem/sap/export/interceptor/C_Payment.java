...
public class C_Payment
{
	...
	public C_Payment(final @NonNull ExportAcctToSAPService exportAcctToSAPService)
	{
		this.exportAcctToSAPService = exportAcctToSAPService;
	}

	@DocValidate(timings = ModelValidator.TIMING_AFTER_POST)
	public void exportAfterPost(@NonNull final I_C_Payment payment)
	{
		trxManager.runAfterCommit(() -> exportAcctToSAPService.enqueueDocument(TableRecordReference.of(payment)));
	}
}
