...
WHERE ad_field_id IN (SELECT ad_field_id
                      ...
                      WHERE c.columnname = 'ExternalSystem'
                        AND c.ad_table_id = get_table_id('s_failedtimebooking'))
;
...
DELETE FROM ad_column
       WHERE columnname = 'ExternalSystem'
         AND ad_table_id = get_table_id('s_failedtimebooking')
;

ALTER TABLE s_failedtimebooking DROP COLUMN ExternalSystem
;
