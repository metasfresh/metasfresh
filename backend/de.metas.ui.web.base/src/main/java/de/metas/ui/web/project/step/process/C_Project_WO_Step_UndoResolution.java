...
public class C_Project_WO_Step_UndoResolution extends ViewBasedProcessTemplate implements IProcessPrecondition
{
	@NonNull
	...
	protected String doIt() throws Exception
	{
		...
		woProjectService.resetAllocatedHours(resourceIds);
