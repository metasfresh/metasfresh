...
public class InvoicesView_UnMarkPreparedForAllocation extends InvoicesViewBasedProcess implements IProcessPrecondition
{
	@Override
	...
	{
		getView().unmarkPreparedForAllocation(getSelectedRowIds());
		return MSG_OK;
	}
	...
	public boolean hasEligibleRows()
	{
		return getView()
				...
				.anyMatch(InvoiceRow::isPreparedForAllocation);
	}
}
