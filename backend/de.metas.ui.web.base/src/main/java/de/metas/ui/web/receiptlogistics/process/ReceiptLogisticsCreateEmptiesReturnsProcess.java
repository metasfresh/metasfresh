 ...
 * {@link ReceiptLogisticsViewBasedProcess#getSelectedReceiptScheduleOrNull()}.
 */
abstract class ReceiptLogisticsCreateEmptiesReturnsProcess extends ReceiptLogisticsPassThroughProcess
{
	private final String returnMovementType;
	private final AdWindowId targetWindowId;

	protected ReceiptLogisticsCreateEmptiesReturnsProcess(
