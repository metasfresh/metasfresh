...
public class ViewRestController
{
			...
			final WebRequest request)
	{
		...
		final ViewLayout viewLayout = viewsRepo.getViewLayout(windowId, viewDataType, ViewProfileId.fromJson(profileIdStr), userSession.getUserRolePermissions());
			...
			throws Exception
	{
		...
		try (final FileOutputStream out = new FileOutputStream(tmpFile))
		{
			ViewExcelExporter.builder()
					...
					.layout(viewsRepo.getViewLayout(viewId.getWindowId(), JSONViewDataType.grid, ViewProfileId.NULL, userSession.getUserRolePermissions()))
