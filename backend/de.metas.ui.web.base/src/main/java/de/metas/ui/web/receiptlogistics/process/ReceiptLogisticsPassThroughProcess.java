 ...
 * {@code IView#getTableRecordReferenceOrNull}, which on this window yields {@code RV_ReceiptLogistics}, while
 ...
 * <p>
 * <b>Deliberately no planning guard here.</b> {@link ReceiptLogisticsReceiveProcess} refuses a selection whose
 ...
 */
abstract class ReceiptLogisticsPassThroughProcess extends ReceiptLogisticsViewBasedProcess
{
