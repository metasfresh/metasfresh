...
-- Purpose: Provides aggregated counts of HUs grouped by common characteristics for HU Editor views
--
-- This view supports the TopLevelAggregation feature which displays consolidated HU counts
-- instead of expanding the full tree structure.
...
COMMENT ON VIEW RV_HU_Editor_TopLevel_Aggregation IS 'Aggregated HU counts grouped by unit type, status, reservation, product, and attributes. Used by HU Editor TopLevelAggregation feature.';
