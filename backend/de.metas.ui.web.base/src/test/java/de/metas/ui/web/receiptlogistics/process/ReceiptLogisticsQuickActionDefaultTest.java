 ...
 * AD_Table 542644, migration {@code 5822600_sys_RV_ReceiptLogistics_receive_actions.sql} and
 * {@code 5822620_sys_RV_ReceiptLogistics_multirow_receive.sql}) once a row's actual preconditions are known.
 * <p>
 ...
 * (`WEBUI_RV_ReceiptLogistics_ReceiveHUs_UsingDefaults` et al.) already state, and mirror byte for byte, that they
 ...
 */
class ReceiptLogisticsQuickActionDefaultTest
{
