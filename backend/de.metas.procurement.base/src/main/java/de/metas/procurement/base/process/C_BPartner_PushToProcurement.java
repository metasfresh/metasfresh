...
public class C_BPartner_PushToProcurement extends JavaProcess
{
	...
	protected String doIt()
	{
		...
		final SyncBPartner syncBPartner = SyncObjectsFactory.newFactory()
				.createSyncBPartner(bpartnerId);

		agentSyncBL.syncBPartners(PutBPartnersRequest.of(syncBPartner));
