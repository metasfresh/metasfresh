...
public class PMM_PurchaseCandidate_BPartner_FacetCollector extends SingleFacetCategoryCollectorTemplate<I_PMM_PurchaseCandidate>
{
	public PMM_PurchaseCandidate_BPartner_FacetCollector()
	{
		super(FacetCategory.builder()
				.setDisplayNameAndTranslate(I_PMM_PurchaseCandidate.COLUMNNAME_C_BPartner_ID)
