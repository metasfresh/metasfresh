...
(
	...
	, p_M_HU_PI_Item_Product_ID numeric -- 4
...
$BODY$
	...
	and ($4 is null or b.M_HU_PI_Item_Product_ID=$4)
	and b.C_Flatrate_DataEntry_ID IS NOT DISTINCT FROM $5
...
select * from (
	select
		...
		, de_metas_procurement.getMonthlyQtyDelivered(
			...
			, p_M_HU_PI_Item_Product_ID := b.M_HU_PI_Item_Product_ID
