...
-- Mirrors the column order of export_fact_acct_to_datev_corrected_v5.4.sql
...
-- --------------------------------------------------------------------
-- 2. Columns  (SeqNo 10..1160, step 10)
-- DATEV_ExportFormatColumn_ID starts at 540050 (step 1)
-- NULL AD_Column_ID replaced with 592477
-- --------------------------------------------------------------------
