...
UPDATE datev_export
SET C_Period_ID = report.Get_Period((SELECT C_Calendar_ID FROM AD_ClientInfo ci WHERE ci.ad_client_id = datev_export.ad_client_id), COALESCE(DateAcctFrom, DateAcctto)::date)
