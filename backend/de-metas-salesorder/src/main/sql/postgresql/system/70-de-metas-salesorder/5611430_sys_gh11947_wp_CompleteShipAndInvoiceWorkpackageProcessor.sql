...
$$
    ...
    EXCEPTION
        WHEN unique_violation THEN
                RAISE NOTICE 'Queue Processor CompleteShipAndInvoiceWorkpackageProcessor already exists';
    END
$$
;
...
$$
    ...
    EXCEPTION
        WHEN unique_violation THEN
                RAISE NOTICE 'C_Queue_Processor_Assign de.metas.salesorder.async.CompleteShipAndInvoiceWorkpackageProcessor and CompleteShipAndInvoiceWorkpackageProcessor already exists';
    END
$$
;
