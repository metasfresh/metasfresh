...
$$
    BEGIN
        ...
        WHEN unique_violation THEN
                RAISE NOTICE 'WorkpackageProcessor de.metas.salesorder.candidate.ProcessOLCandsWorkpackageProcessor already exists';
    END
$$
;
...
$$
    ...
    EXCEPTION
        WHEN unique_violation THEN
                RAISE NOTICE 'Queue Processor ProcessOLCandsWorkpackageProcessor already exists';
    END
$$
;
...
$$
    ...
    EXCEPTION
        WHEN unique_violation THEN
                RAISE NOTICE 'C_Queue_Processor_Assign de.metas.salesorder.candidate.ProcessOLCandsWorkpackageProcessor and ProcessOLCandsWorkpackageProcessor already exists';
    END
$$
;
