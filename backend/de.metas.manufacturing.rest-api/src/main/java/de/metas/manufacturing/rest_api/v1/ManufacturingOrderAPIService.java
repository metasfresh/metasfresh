...
class ManufacturingOrderAPIService
{
	...
	{
		final de.metas.manufacturing.rest_api.v1.ManufacturingOrdersSetExportStatusCommand command = de.metas.manufacturing.rest_api.v1.ManufacturingOrdersSetExportStatusCommand.builder()
				.orderAuditRepo(orderExportAuditRepo)
	...
	{
		final de.metas.manufacturing.rest_api.v1.ManufacturingOrderReportProcessCommand command = de.metas.manufacturing.rest_api.v1.ManufacturingOrderReportProcessCommand.builder()
