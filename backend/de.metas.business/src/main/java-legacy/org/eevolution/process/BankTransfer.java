...
public class BankTransfer extends JavaProcess
{
	...
	protected void prepare()
	{
		...
		for (ProcessInfoParameter element : para)
		{
			...
			{
				p_From_C_BankAccount_ID = element.getParameterAsInt();
			}
			else if (name.equals("To_C_BP_BankAccount_ID"))
			{
				p_To_C_BankAccount_ID = element.getParameterAsInt();
			}
			...
			{
				p_C_ConversionType_ID = element.getParameterAsInt();
			}
			else if (name.equals("C_Charge_ID"))
			{
				p_C_Charge_ID = element.getParameterAsInt();
			}
			...
			{
				p_Description = (String)element.getParameter();
			}
	...
	private void generateBankTransfer()
	{
		...
		paymentBankFrom.setTenderType(TenderType.DirectDeposit.getCode());
		...
		paymentBankTo.setTenderType(TenderType.DirectDeposit.getCode());
