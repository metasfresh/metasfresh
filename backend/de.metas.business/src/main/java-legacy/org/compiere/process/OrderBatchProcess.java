...
public class OrderBatchProcess extends JavaProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		if (p_DateOrdered_From != null)
			sql.append(" AND TRUNC(o.DateOrdered) >= ").append(DB.TO_DATE(p_DateOrdered_From, DisplayType.Date));
		if (p_DateOrdered_To != null)
			sql.append(" AND TRUNC(o.DateOrdered) <= ").append(DB.TO_DATE(p_DateOrdered_To, DisplayType.Date));
