...
public class ImportOrder extends JavaProcess
{
	...
	protected String doIt() throws java.lang.Exception
	{
		...
		no = DB.executeUpdateAndSaveErrorOnFail(sql.toString(), get_TrxName());    //	Warehouse for Org
		if (no != 0)
		{
		...
		if (no > 0)
		{
			log.warn("Marked " + no + " I_Order rows as error due to ambiguous BPartner Value");
		}
		//	Default BP
		sql = new StringBuffer("UPDATE I_Order o "
						...
						|| !oldDocumentNo.equals(cmpDocumentNo))
				{
					...
					OrderDocumentLocationAdapterFactory
							...
							.setFrom(DocumentLocation.builder()
											 .bpartnerId(BPartnerId.ofRepoIdOrNull(imp.getC_BPartner_ID()))
											 .bpartnerLocationId(BPartnerLocationId.ofRepoIdOrNull(imp.getC_BPartner_ID(), imp.getC_BPartner_Location_ID()))
											 .contactId(BPartnerContactId.ofRepoIdOrNull(imp.getC_BPartner_ID(), imp.getAD_User_ID()))
											 .build());
					...
					OrderDocumentLocationAdapterFactory
							...
							.setFrom(DocumentLocation.builder()
											 .bpartnerId(BPartnerId.ofRepoIdOrNull(imp.getC_BPartner_ID()))
											 .bpartnerLocationId(BPartnerLocationId.ofRepoIdOrNull(imp.getC_BPartner_ID(), imp.getBillTo_ID()))
											 .build());
