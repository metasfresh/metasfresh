...
CREATE OR REPLACE FUNCTION report.fresh_account_info_report(account_from_id       numeric,
...
ALTER FUNCTION report.fresh_account_info_report(numeric, numeric, numeric, numeric, date, date, numeric, character varying, character varying, character varying, numeric) OWNER TO metasfresh
;
