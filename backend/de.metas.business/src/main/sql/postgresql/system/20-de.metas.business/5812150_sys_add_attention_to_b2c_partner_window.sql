...
VALUES (0,781323,0,540847,540897,652432,'F',TO_TIMESTAMP('2026-07-03 12:00:10','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,'Zu Händen, Türcode oder weitere Pflichtinformationen für das Versandetikett (max. 30 Zeichen)','Y','Y','N','Y','N','N','N',0,'z. Hd.',25,0,0,TO_TIMESTAMP('2026-07-03 12:00:10','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
