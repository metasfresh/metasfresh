DROP FUNCTION IF EXISTS fresh_account_info_report_sub(account_start_id      numeric,
...
CREATE OR REPLACE FUNCTION fresh_account_info_report_sub(account_start_id      numeric,
                                              account_end_id        numeric,
                                              c_period_start_id     numeric,
                                              c_period_end_id       numeric,
                                              startdate             date,
...
ALTER FUNCTION fresh_account_info_report_sub(numeric, numeric, numeric, numeric, date, date, numeric, varchar, varchar, varchar, numeric) OWNER TO metasfresh
;
