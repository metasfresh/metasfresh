...
-- =============================================================
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Value,Name,EntityType,IsActive,Created,CreatedBy,Updated,UpdatedBy)
VALUES (0,0,544237,541968,'B',$msg$Bestandteil Handelsstückliste$msg$,'D','Y',NOW(),100,NOW(),100)
;
...
-- =============================================================
UPDATE AD_Column
SET AD_Reference_ID=17, AD_Reference_Value_ID=541968, FieldLength=1, Updated=NOW(), UpdatedBy=100
