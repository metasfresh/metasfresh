...
-- 2022-08-10T10:21:55.356Z
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,581263,0,'Specialist_Consultant',TO_TIMESTAMP('2022-08-10 12:21:55','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','Specialist Consultant','Specialist Consultant',TO_TIMESTAMP('2022-08-10 12:21:55','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2022-08-10T10:21:55.363Z
INSERT INTO AD_Element_Trl (AD_Language,AD_Element_ID, CommitWarning,Description,Help,Name,PO_Description,PO_Help,PO_Name,PO_PrintName,PrintName,WEBUI_NameBrowse,WEBUI_NameNew,WEBUI_NameNewBreadcrumb, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Element_ID, t.CommitWarning,t.Description,t.Help,t.Name,t.PO_Description,t.PO_Help,t.PO_Name,t.PO_PrintName,t.PrintName,t.WEBUI_NameBrowse,t.WEBUI_NameNew,t.WEBUI_NameNewBreadcrumb, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Element t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Element_ID=581263 AND NOT EXISTS (SELECT 1 FROM AD_Element_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Element_ID=t.AD_Element_ID)
;

-- 2022-08-10T10:22:09.697Z
UPDATE AD_Element_Trl SET Name='Fachberater', PrintName='Fachberater',Updated=TO_TIMESTAMP('2022-08-10 12:22:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=581263 AND AD_Language='de_DE'
;

-- 2022-08-10T10:22:09.729Z
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(581263,'de_DE')
;

-- 2022-08-10T10:22:09.743Z
/* DDL */  select update_ad_element_on_ad_element_trl_update(581263,'de_DE')
;

-- 2022-08-10T10:22:09.744Z
UPDATE AD_Column SET ColumnName='Specialist_Consultant', Name='Fachberater', Description=NULL, Help=NULL WHERE AD_Element_ID=581263
;

-- 2022-08-10T10:22:09.745Z
UPDATE AD_Process_Para SET ColumnName='Specialist_Consultant', Name='Fachberater', Description=NULL, Help=NULL, AD_Element_ID=581263 WHERE UPPER(ColumnName)='SPECIALIST_CONSULTANT' AND IsCentrallyMaintained='Y' AND AD_Element_ID IS NULL
;

-- 2022-08-10T10:22:09.746Z
UPDATE AD_Process_Para SET ColumnName='Specialist_Consultant', Name='Fachberater', Description=NULL, Help=NULL WHERE AD_Element_ID=581263 AND IsCentrallyMaintained='Y'
;

-- 2022-08-10T10:22:09.747Z
UPDATE AD_Field SET Name='Fachberater', Description=NULL, Help=NULL WHERE (AD_Column_ID IN (SELECT AD_Column_ID FROM AD_Column WHERE AD_Element_ID=581263) AND AD_Name_ID IS NULL ) OR (AD_Name_ID = 581263)
;

-- 2022-08-10T10:22:09.756Z
UPDATE AD_PrintFormatItem pi SET PrintName='Fachberater', Name='Fachberater' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c  WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=581263)
;

-- 2022-08-10T10:22:09.758Z
UPDATE AD_Tab SET Name='Fachberater', Description=NULL, Help=NULL, CommitWarning = NULL WHERE AD_Element_ID = 581263
;

-- 2022-08-10T10:22:09.759Z
UPDATE AD_WINDOW SET Name='Fachberater', Description=NULL, Help=NULL WHERE AD_Element_ID = 581263
;

-- 2022-08-10T10:22:09.760Z
UPDATE AD_Menu SET   Name = 'Fachberater', Description = NULL, WEBUI_NameBrowse = NULL, WEBUI_NameNew = NULL, WEBUI_NameNewBreadcrumb = NULL WHERE AD_Element_ID = 581263
;

-- 2022-08-10T10:27:56.516Z
UPDATE AD_Element_Trl SET IsTranslated='Y',Updated=TO_TIMESTAMP('2022-08-10 12:27:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=581263 AND AD_Language='de_DE'
;

-- 2022-08-10T10:27:56.518Z
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(581263,'de_DE')
;

-- 2022-08-10T10:27:56.525Z
/* DDL */  select update_ad_element_on_ad_element_trl_update(581263,'de_DE')
;

-- 2022-08-10T10:27:59.159Z
UPDATE AD_Element_Trl SET IsTranslated='Y',Updated=TO_TIMESTAMP('2022-08-10 12:27:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=581263 AND AD_Language='en_US'
;

-- 2022-08-10T10:27:59.160Z
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(581263,'en_US')
;

-- Column: C_Project.Specialist_Consultant
-- 2022-08-10T10:28:43.038Z
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DDL_NoForeignKey,EntityType,FacetFilterSeqNo,FieldLength,FilterOperator,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,584012,581263,0,10,203,'Specialist_Consultant',TO_TIMESTAMP('2022-08-10 12:28:42','YYYY-MM-DD HH24:MI:SS'),100,'N','D',0,255,'E','Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','Y','N','N','N','N','N','Y','N',0,'Fachberater',0,0,TO_TIMESTAMP('2022-08-10 12:28:42','YYYY-MM-DD HH24:MI:SS'),100,0)
;

-- 2022-08-10T10:28:43.040Z
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Column t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y') AND t.AD_Column_ID=584012 AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Column_ID=t.AD_Column_ID)
;

-- 2022-08-10T10:28:43.044Z
/* DDL */  select update_Column_Translation_From_AD_Element(581263)
;

-- 2022-08-10T10:28:45.387Z
/* DDL */ SELECT public.db_alter_table('C_Project','ALTER TABLE public.C_Project ADD COLUMN Specialist_Consultant VARCHAR(255)')
;

-- Field: Work Order Project -> Projekt -> Fachberater
-- Column: C_Project.Specialist_Consultant
-- 2022-08-10T10:31:23.897Z
UPDATE AD_Field SET AD_Column_ID=584012, AD_Name_ID=581263, ColumnDisplayLength=1, Description=NULL, DisplayLength=999, Help=NULL, Name='Fachberater',Updated=TO_TIMESTAMP('2022-08-10 12:31:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=703939
;

-- 2022-08-10T10:31:23.899Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(581263)
;

-- 2022-08-10T10:31:23.910Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=703939
;

-- 2022-08-10T10:31:23.912Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(703939)
;
