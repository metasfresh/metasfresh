...
-- Tab: Geschäftspartner(541526,D) -> PostFinance
-- Table: PostFinance_BPartner_Config
-- 2024-01-18T16:18:53.062Z
INSERT INTO AD_Tab (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Tab_ID,AD_Table_ID,AD_Window_ID,AllowQuickInput,Created,CreatedBy,EntityType,HasTree,ImportFields,IncludedTabNewRecordInputMode,InternalName,IsActive,IsAdvancedTab,IsAutodetectDefaultDateFilter,IsCheckParentsChanged,IsGenericZoomTarget,IsGridModeOnly,IsInfoTab,IsInsertRecord,IsQueryIfNoFilters,IsQueryOnLoad,IsReadOnly,IsRefreshAllOnActivate,IsRefreshViewOnChangeEvents,IsSearchActive,IsSearchCollapsed,IsSingleRow,IsSortTab,IsTranslationTab,MaxQueryRecords,Name,Processing,SeqNo,TabLevel,Updated,UpdatedBy) VALUES (0,582913,0,547357,542387,541526,'Y',TO_TIMESTAMP('2024-01-18 18:18:52.789','YYYY-MM-DD HH24:MI:SS.US'),100,'D','N','N','A','PostFinance_BPartner_Config','Y','N','Y','Y','N','N','N','Y','Y','Y','N','N','N','Y','Y','N','N','N',0,'PostFinance','N',191,1,TO_TIMESTAMP('2024-01-18 18:18:52.789','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2024-01-18T16:18:53.066Z
INSERT INTO AD_Tab_Trl (AD_Language,AD_Tab_ID, CommitWarning,Description,Help,Name,QuickInput_CloseButton_Caption,QuickInput_OpenButton_Caption, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Tab_ID, t.CommitWarning,t.Description,t.Help,t.Name,t.QuickInput_CloseButton_Caption,t.QuickInput_OpenButton_Caption, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Tab t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Tab_ID=547357 AND NOT EXISTS (SELECT 1 FROM AD_Tab_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Tab_ID=t.AD_Tab_ID)
;

-- 2024-01-18T16:18:53.073Z
/* DDL */  select update_tab_translation_from_ad_element(582913)
;

-- 2024-01-18T16:18:53.086Z
/* DDL */ select AD_Element_Link_Create_Missing_Tab(547357)
;

-- Field: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> Mandant
-- Column: PostFinance_BPartner_Config.AD_Client_ID
-- 2024-01-18T16:18:56.823Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,587826,723834,0,547357,TO_TIMESTAMP('2024-01-18 18:18:56.738','YYYY-MM-DD HH24:MI:SS.US'),100,'Mandant für diese Installation.',10,'D','Ein Mandant ist eine Firma oder eine juristische Person. Sie können keine Daten über Mandanten hinweg verwenden. .','Y','N','N','N','N','N','Y','N','Mandant',TO_TIMESTAMP('2024-01-18 18:18:56.738','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2024-01-18T16:18:56.825Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=723834 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2024-01-18T16:18:56.827Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(102)
;

-- 2024-01-18T16:18:56.958Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=723834
;

-- 2024-01-18T16:18:56.959Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(723834)
;

-- Field: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> Organisation
-- Column: PostFinance_BPartner_Config.AD_Org_ID
-- 2024-01-18T16:18:57.062Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,587827,723835,0,547357,TO_TIMESTAMP('2024-01-18 18:18:56.962','YYYY-MM-DD HH24:MI:SS.US'),100,'Organisatorische Einheit des Mandanten',10,'D','Eine Organisation ist ein Bereich ihres Mandanten - z.B. Laden oder Abteilung. Sie können Daten über Organisationen hinweg gemeinsam verwenden.','Y','N','N','N','N','N','N','N','Organisation',TO_TIMESTAMP('2024-01-18 18:18:56.962','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2024-01-18T16:18:57.063Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=723835 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2024-01-18T16:18:57.066Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(113)
;

-- 2024-01-18T16:18:57.189Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=723835
;

-- 2024-01-18T16:18:57.190Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(723835)
;

-- Field: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> Aktiv
-- Column: PostFinance_BPartner_Config.IsActive
-- 2024-01-18T16:18:57.342Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,587830,723836,0,547357,TO_TIMESTAMP('2024-01-18 18:18:57.192','YYYY-MM-DD HH24:MI:SS.US'),100,'Der Eintrag ist im System aktiv',1,'D','Es gibt zwei Möglichkeiten, einen Datensatz nicht mehr verfügbar zu machen: einer ist, ihn zu löschen; der andere, ihn zu deaktivieren. Ein deaktivierter Eintrag ist nicht mehr für eine Auswahl verfügbar, aber verfügbar für die Verwendung in Berichten. Es gibt zwei Gründe, Datensätze zu deaktivieren und nicht zu löschen: (1) Das System braucht den Datensatz für Revisionszwecke. (2) Der Datensatz wird von anderen Datensätzen referenziert. Z.B. können Sie keinen Geschäftspartner löschen, wenn es Rechnungen für diesen Geschäftspartner gibt. Sie deaktivieren den Geschäftspartner und verhindern, dass dieser Eintrag in zukünftigen Vorgängen verwendet wird.','Y','N','N','N','N','N','N','N','Aktiv',TO_TIMESTAMP('2024-01-18 18:18:57.192','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2024-01-18T16:18:57.344Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=723836 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2024-01-18T16:18:57.347Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(348)
;

-- 2024-01-18T16:18:57.483Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=723836
;

-- 2024-01-18T16:18:57.484Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(723836)
;

-- Field: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> PostFinance
-- Column: PostFinance_BPartner_Config.PostFinance_BPartner_Config_ID
-- 2024-01-18T16:18:57.593Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,587833,723837,0,547357,TO_TIMESTAMP('2024-01-18 18:18:57.486','YYYY-MM-DD HH24:MI:SS.US'),100,10,'D','Y','N','N','N','N','N','N','N','PostFinance',TO_TIMESTAMP('2024-01-18 18:18:57.486','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2024-01-18T16:18:57.595Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=723837 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2024-01-18T16:18:57.597Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(582913)
;

-- 2024-01-18T16:18:57.603Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=723837
;

-- 2024-01-18T16:18:57.603Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(723837)
;

-- Field: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> eBill-ID des Kunden
-- Column: PostFinance_BPartner_Config.PostFinance_Receiver_eBillId
-- 2024-01-18T16:18:57.744Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,587834,723838,0,547357,TO_TIMESTAMP('2024-01-18 18:18:57.605','YYYY-MM-DD HH24:MI:SS.US'),100,255,'D','Y','N','N','N','N','N','N','N','eBill-ID des Kunden',TO_TIMESTAMP('2024-01-18 18:18:57.605','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2024-01-18T16:18:57.746Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=723838 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2024-01-18T16:18:57.748Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(582911)
;

-- 2024-01-18T16:18:57.754Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=723838
;

-- 2024-01-18T16:18:57.754Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(723838)
;

-- Field: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> Geschäftspartner
-- Column: PostFinance_BPartner_Config.C_BPartner_ID
-- 2024-01-18T16:18:57.882Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,587835,723839,0,547357,TO_TIMESTAMP('2024-01-18 18:18:57.756','YYYY-MM-DD HH24:MI:SS.US'),100,'Bezeichnet einen Geschäftspartner',22,'D','Ein Geschäftspartner ist jemand, mit dem Sie interagieren. Dies kann Lieferanten, Kunden, Mitarbeiter oder Handelsvertreter umfassen.','Y','N','N','N','N','N','N','N','Geschäftspartner',TO_TIMESTAMP('2024-01-18 18:18:57.756','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2024-01-18T16:18:57.884Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=723839 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2024-01-18T16:18:57.886Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(187)
;

-- 2024-01-18T16:18:57.945Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=723839
;

-- 2024-01-18T16:18:57.946Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(723839)
;

-- Tab: Geschäftspartner(541526,D) -> PostFinance(547357,D)
-- UI Section: main
-- 2024-01-18T16:19:12.751Z
INSERT INTO AD_UI_Section (AD_Client_ID,AD_Org_ID,AD_Tab_ID,AD_UI_Section_ID,Created,CreatedBy,IsActive,SeqNo,Updated,UpdatedBy,Value) VALUES (0,0,547357,545939,TO_TIMESTAMP('2024-01-18 18:19:12.643','YYYY-MM-DD HH24:MI:SS.US'),100,'Y',10,TO_TIMESTAMP('2024-01-18 18:19:12.643','YYYY-MM-DD HH24:MI:SS.US'),100,'main')
;

-- 2024-01-18T16:19:12.753Z
INSERT INTO AD_UI_Section_Trl (AD_Language,AD_UI_Section_ID, Description,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_UI_Section_ID, t.Description,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_UI_Section t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_UI_Section_ID=545939 AND NOT EXISTS (SELECT 1 FROM AD_UI_Section_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_UI_Section_ID=t.AD_UI_Section_ID)
;

-- UI Section: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main
-- UI Column: 10
-- 2024-01-18T16:19:18.155Z
INSERT INTO AD_UI_Column (AD_Client_ID,AD_Org_ID,AD_UI_Column_ID,AD_UI_Section_ID,Created,CreatedBy,IsActive,SeqNo,Updated,UpdatedBy) VALUES (0,0,547241,545939,TO_TIMESTAMP('2024-01-18 18:19:17.949','YYYY-MM-DD HH24:MI:SS.US'),100,'Y',10,TO_TIMESTAMP('2024-01-18 18:19:17.949','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- UI Column: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10
-- UI Element Group: main
-- 2024-01-18T16:19:25.231Z
INSERT INTO AD_UI_ElementGroup (AD_Client_ID,AD_Org_ID,AD_UI_Column_ID,AD_UI_ElementGroup_ID,Created,CreatedBy,IsActive,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,547241,551426,TO_TIMESTAMP('2024-01-18 18:19:25.098','YYYY-MM-DD HH24:MI:SS.US'),100,'Y','main',10,TO_TIMESTAMP('2024-01-18 18:19:25.098','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- UI Element: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10 -> main.eBill-ID des Kunden
-- Column: PostFinance_BPartner_Config.PostFinance_Receiver_eBillId
-- 2024-01-18T16:19:42.269Z
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_Element_ID,AD_UI_ElementGroup_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayed_SideList,IsDisplayedGrid,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNo_SideList,SeqNoGrid,Updated,UpdatedBy) VALUES (0,723838,0,547357,622126,551426,'F',TO_TIMESTAMP('2024-01-18 18:19:42.119','YYYY-MM-DD HH24:MI:SS.US'),100,'Y','N','N','Y','N','N','N',0,'eBill-ID des Kunden',10,0,0,TO_TIMESTAMP('2024-01-18 18:19:42.119','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- UI Element: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10 -> main.Aktiv
-- Column: PostFinance_BPartner_Config.IsActive
-- 2024-01-18T16:19:50.379Z
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_Element_ID,AD_UI_ElementGroup_ID,AD_UI_ElementType,Created,CreatedBy,Description,Help,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayed_SideList,IsDisplayedGrid,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNo_SideList,SeqNoGrid,Updated,UpdatedBy) VALUES (0,723836,0,547357,622127,551426,'F',TO_TIMESTAMP('2024-01-18 18:19:50.243','YYYY-MM-DD HH24:MI:SS.US'),100,'Der Eintrag ist im System aktiv','Es gibt zwei Möglichkeiten, einen Datensatz nicht mehr verfügbar zu machen: einer ist, ihn zu löschen; der andere, ihn zu deaktivieren. Ein deaktivierter Eintrag ist nicht mehr für eine Auswahl verfügbar, aber verfügbar für die Verwendung in Berichten. Es gibt zwei Gründe, Datensätze zu deaktivieren und nicht zu löschen: (1) Das System braucht den Datensatz für Revisionszwecke. (2) Der Datensatz wird von anderen Datensätzen referenziert. Z.B. können Sie keinen Geschäftspartner löschen, wenn es Rechnungen für diesen Geschäftspartner gibt. Sie deaktivieren den Geschäftspartner und verhindern, dass dieser Eintrag in zukünftigen Vorgängen verwendet wird.','Y','N','N','Y','N','N','N',0,'Aktiv',20,0,0,TO_TIMESTAMP('2024-01-18 18:19:50.243','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- UI Element: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10 -> main.Mandant
-- Column: PostFinance_BPartner_Config.AD_Client_ID
-- 2024-01-18T16:20:01.152Z
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_Element_ID,AD_UI_ElementGroup_ID,AD_UI_ElementType,Created,CreatedBy,Description,Help,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayed_SideList,IsDisplayedGrid,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNo_SideList,SeqNoGrid,Updated,UpdatedBy) VALUES (0,723834,0,547357,622128,551426,'F',TO_TIMESTAMP('2024-01-18 18:20:01.037','YYYY-MM-DD HH24:MI:SS.US'),100,'Mandant für diese Installation.','Ein Mandant ist eine Firma oder eine juristische Person. Sie können keine Daten über Mandanten hinweg verwenden. .','Y','N','N','Y','N','N','N',0,'Mandant',30,0,0,TO_TIMESTAMP('2024-01-18 18:20:01.037','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- UI Element: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10 -> main.Organisation
-- Column: PostFinance_BPartner_Config.AD_Org_ID
-- 2024-01-18T16:20:07.650Z
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_Element_ID,AD_UI_ElementGroup_ID,AD_UI_ElementType,Created,CreatedBy,Description,Help,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayed_SideList,IsDisplayedGrid,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNo_SideList,SeqNoGrid,Updated,UpdatedBy) VALUES (0,723835,0,547357,622129,551426,'F',TO_TIMESTAMP('2024-01-18 18:20:07.545','YYYY-MM-DD HH24:MI:SS.US'),100,'Organisatorische Einheit des Mandanten','Eine Organisation ist ein Bereich ihres Mandanten - z.B. Laden oder Abteilung. Sie können Daten über Organisationen hinweg gemeinsam verwenden.','Y','N','N','Y','N','N','N',0,'Organisation',40,0,0,TO_TIMESTAMP('2024-01-18 18:20:07.545','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- UI Element: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10 -> main.eBill-ID des Kunden
-- Column: PostFinance_BPartner_Config.PostFinance_Receiver_eBillId
-- 2024-01-18T16:20:20.635Z
UPDATE AD_UI_Element SET IsDisplayedGrid='Y', SeqNoGrid=10,Updated=TO_TIMESTAMP('2024-01-18 18:20:20.635','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_UI_Element_ID=622126
;

-- UI Element: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10 -> main.Aktiv
-- Column: PostFinance_BPartner_Config.IsActive
-- 2024-01-18T16:20:20.644Z
UPDATE AD_UI_Element SET IsDisplayedGrid='Y', SeqNoGrid=20,Updated=TO_TIMESTAMP('2024-01-18 18:20:20.643','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_UI_Element_ID=622127
;

-- UI Element: Geschäftspartner(541526,D) -> PostFinance(547357,D) -> main -> 10 -> main.Organisation
-- Column: PostFinance_BPartner_Config.AD_Org_ID
-- 2024-01-18T16:20:20.655Z
UPDATE AD_UI_Element SET IsDisplayedGrid='Y', SeqNoGrid=30,Updated=TO_TIMESTAMP('2024-01-18 18:20:20.655','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_UI_Element_ID=622129
;
