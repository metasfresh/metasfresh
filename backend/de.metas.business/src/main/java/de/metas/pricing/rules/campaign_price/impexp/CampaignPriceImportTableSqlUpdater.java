...
public class CampaignPriceImportTableSqlUpdater
{
	...
	private static void dbUpdateCampaignPrice(final ImportRecordsSelection selection, final Properties ctx)
	{
		final String sql = "UPDATE "
				...
				+ " AND (i.C_BPartner_ID=c.C_BPartner_ID  OR i.C_BPartner_ID IS NULL) "
				+ " AND (i.C_BP_Group_ID=c.C_BP_Group_ID OR i.C_BP_Group_ID IS NULL) "
				+ " AND (i.M_PricingSystem_ID=c.M_PricingSystem_ID OR i.M_PricingSystem_ID IS NULL) "
