...
public class InvoiceDocumentLocationAdapterFactory implements DocumentLocationAdapterFactory
{
	...
	public static class InvoiceDocumentLocationAdapter implements IDocumentLocationAdapter
	{
		private final I_C_Invoice delegate;

		private InvoiceDocumentLocationAdapter(@NonNull final I_C_Invoice delegate)
		{
