...
public interface IUOMConversionBL extends ISingletonService
{
	...
	@Deprecated
	default Quantity convertQuantityTo(Quantity quantity, IUOMConversionContext conversionCtx, I_C_UOM uomTo)
	{
		return convertQuantityTo(quantity, (UOMConversionContext)conversionCtx, uomTo);
	}
