...
@Value
public class PaymentReservationCaptureId implements RepoIdAware
{
	@JsonCreator
	...
	{
		return repoId > 0 ? new PaymentReservationCaptureId(repoId) : null;
	}

	public static int toRepoId(final PaymentReservationCaptureId id)
	{
