...
import static org.compiere.model.I_C_BPartner_Block_File.COLUMNNAME_C_BPartner_Block_File_ID;
import static org.compiere.model.I_C_BPartner_Block_File.COLUMNNAME_IsError;
...
public class BPartnerBlockStatusImportProcess extends SimpleImportProcessTemplate<I_I_BPartner_BlockStatus>
{
	...
	protected void updateAndValidateImportRecords()
	{
		...
		if (bPartnerBlockFileId != null && countErrorRecords > 0)
		{
			updateBPartnerBlockFile( bPartnerBlockFileId);
		}
	}
	...
	@Override
	protected ImportRecordResult importRecord(final @NonNull IMutable<Object> stateHolder, final @NonNull I_I_BPartner_BlockStatus importRecord, final boolean isInsertOnly) throws Exception
	{
	...
	private void updateBPartnerBlockFile(@NonNull final BPartnerBlockFileId bPartnerBlockFileId)
	{
		final String sql = "UPDATE " + I_C_BPartner_Block_File.Table_Name
				+ " SET " + COLUMNNAME_IsError + " = 'Y'"
				+ " WHERE " + COLUMNNAME_C_BPartner_Block_File_ID + " = " + bPartnerBlockFileId.getRepoId();
