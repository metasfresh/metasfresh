...
public class MovingAverageInvoiceCostingMethodHandlerTest
{
	...
	{
		final I_C_UOM uom = uomDAO.getBySymbol(uomSymbol)
				.orElseGet(() -> uomDAO.getByX12DE355IfExists(X12DE355.ofCode(uomSymbol)).orElse(null));
		if (uom == null)
		{
			throw new AdempiereException("No UOM found for `" + uomSymbol + "`");
		}
		return uom;
	}
