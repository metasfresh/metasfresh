 ...
 * the ISO 20022 version 2019 that replaces the 2009 versions handled by {@link ESRDataImporterCamt54v02} and
 * {@link ESRDataImporterCamt54v06}.
 *
 * <p>
 * The structure mirrors {@link ESRDataImporterCamt54v06}; what differs is the set of JAXB types generated from the
 * respective XSD, plus the date element, which is {@code DateAndDateTime2Choice} in this version.
 *
 * <p>
 * The XSD file for the xml which this implementation imports is available at
 * <a href="https://www.iso20022.org/documents/messages/camt/schemas/camt.054.001.08.zip">BankToCustomerDebitCreditNotificationV08</a>.<br>
 * Note that
 * <ul>
...
public class ESRDataImporterCamt54v08
{
	 ...
	 * verifyTransactionCurrency for version 8 <code>BankToCustomerDebitCreditNotificationV08</code>
	 */
	...
	public static BankToCustomerDebitCreditNotificationV08 loadXML(@NonNull final MultiVersionStreamReaderDelegate xsr)
	{
		...
		try
		{
			...
			// use a delegate to make sure that the unmarshaller won't refuse camt.054.001.04 and camt.054.001.05
