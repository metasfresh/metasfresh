...
AND EXISTS (SELECT 1
              ...
              WHERE lu_hupiVersion.m_hu_pi_id = @M_LU_HU_PI_ID/-1@
                AND m_hu_pi_item_product.m_hu_pi_item_product_id = tu_hupiip.m_hu_pi_item_product_id)',Updated=TO_TIMESTAMP('2025-07-21 14:51:10.963000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Val_Rule_ID=540738
;
