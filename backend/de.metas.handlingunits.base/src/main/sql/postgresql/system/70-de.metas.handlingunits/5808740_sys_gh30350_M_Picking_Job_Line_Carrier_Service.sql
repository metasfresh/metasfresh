...
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,592845,584113,0,19,542619,'XX','Carrier_Service_ID',TO_TIMESTAMP('2026-06-18 12:11:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','de.metas.handlingunits',0,10,'Y','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N',0,'Lieferweg-Servicekatalog','NP',0,0,TO_TIMESTAMP('2026-06-18 12:11:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
/* DDL */ CREATE TABLE public.M_Picking_Job_Line_Carrier_Service (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, Carrier_Service_ID NUMERIC(10), Created TIMESTAMP WITH TIME ZONE NOT NULL, CreatedBy NUMERIC(10) NOT NULL, IsActive CHAR(1) CHECK (IsActive IN ('Y','N')) NOT NULL, M_Picking_Job_Line_Carrier_Service_ID NUMERIC(10) NOT NULL, M_Picking_Job_Line_ID NUMERIC(10), Updated TIMESTAMP WITH TIME ZONE NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, CONSTRAINT CarrierService_MPickingJobLineCarrierService FOREIGN KEY (Carrier_Service_ID) REFERENCES public.Carrier_Service DEFERRABLE INITIALLY DEFERRED, CONSTRAINT M_Picking_Job_Line_Carrier_Service_Key PRIMARY KEY (M_Picking_Job_Line_Carrier_Service_ID), CONSTRAINT MPickingJobLine_MPickingJobLineCarrierService FOREIGN KEY (M_Picking_Job_Line_ID) REFERENCES public.M_Picking_Job_Line DEFERRABLE INITIALLY DEFERRED)
;
