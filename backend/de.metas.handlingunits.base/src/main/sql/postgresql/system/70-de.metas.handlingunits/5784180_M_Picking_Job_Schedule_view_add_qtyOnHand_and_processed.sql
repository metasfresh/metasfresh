...
WITH base_shipment AS (SELECT s.m_shipmentschedule_id,
...
SELECT b.*,
       ...
       'N' AS isreschedule,
       'Y' AS isassigned
FROM base_shipment b
         JOIN M_Picking_Job_Schedule j
              ON j.m_shipmentschedule_id = b.m_shipmentschedule_id
