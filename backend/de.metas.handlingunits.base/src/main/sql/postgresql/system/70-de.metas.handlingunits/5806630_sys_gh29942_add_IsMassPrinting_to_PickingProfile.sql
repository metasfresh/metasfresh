...
VALUES (0,584952,0,'IsMassPrinting',now(),100,'D','Y','Mass Printing','Mass Printing',now(),100)
;
...
-- Element: IsMassPrinting — de_DE translation (base language)
UPDATE AD_Element_Trl SET Name='Massendruck', PrintName='Massendruck', Description='Wenn aktiviert, kann der Benutzer Massendrucketiketten für selbst verpackte Produkte erstellen.', Help='Wenn aktiviert, kann der Benutzer Massendrucketiketten für selbst verpackte Produkte erstellen.',Updated=now(),UpdatedBy=100 WHERE AD_Element_ID=584952 AND AD_Language='de_DE';
...
-- Element: IsMassPrinting — de_CH translation
UPDATE AD_Element_Trl SET Name='Massendruck', PrintName='Massendruck', Description='Wenn aktiviert, kann der Benutzer Massendrucketiketten für selbst verpackte Produkte erstellen.', Help='Wenn aktiviert, kann der Benutzer Massendrucketiketten für selbst verpackte Produkte erstellen.',Updated=now(),UpdatedBy=100 WHERE AD_Element_ID=584952 AND AD_Language='de_CH';
...
-- Element: IsMassPrinting — en_US translation
UPDATE AD_Element_Trl SET Name='Mass Printing', PrintName='Mass Printing', Description='When enabled, the user can perform mass-printing of shipping labels for self-packed products by scanning one LU.', Help='When enabled, the user can perform mass-printing of shipping labels for self-packed products by scanning one LU.',Updated=now(),UpdatedBy=100 WHERE AD_Element_ID=584952 AND AD_Language='en_US';
...
VALUES (0,592732,584952,0,20,542373,'XX','IsMassPrinting',now(),100,'N','N','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Massendruck',0,0,now(),100,0)
;
...
VALUES (0,592732,780726,0,547258,now(),100,1,'D','Y','N','N','N','N','N','N','N','Massendruck',now(),100)
;
...
VALUES (0,780726,0,547258,652021,551252,'F',now(),100,'Y','N','N','Y','N','N','N',0,'Massendruck',170,0,0,now(),100)
;
