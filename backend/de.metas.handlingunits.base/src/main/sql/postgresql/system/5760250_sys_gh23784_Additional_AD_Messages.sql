...
UPDATE AD_Message_Trl SET MsgText='Manufacturing Order is not completed ! Manufacturing Order ID: {0}',Updated=TO_TIMESTAMP('2025-07-08 09:08:19.565000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Language='en_US' AND AD_Message_ID=545566
;
...
UPDATE AD_Message_Trl SET MsgText='Manufacturing Job already started ! Manufacturing Order ID: {0}',Updated=TO_TIMESTAMP('2025-07-08 09:09:35.722000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Language='en_US' AND AD_Message_ID=545567
;
