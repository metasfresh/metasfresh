...
final class MovementBuilder
{
	...
	public void addMovementLineReceipt(final DDOrderMoveSchedule schedule)
	{
		addMovementLine(schedule, MovementType.ReceiveFromTransit);
	}

	public void addMovementLineShipment(final DDOrderMoveSchedule schedule)
	{
		addMovementLine(schedule, MovementType.ShipToTransit);
	}

	public void addMovementLineDirect(final DDOrderMoveSchedule schedule)
	{
	...
	{
		ddOrderMoveScheduleService.splitFromPickHUIfNeeded(schedule);
			...
			@NonNull final DDOrderLineId fromDDOrderLineId)
	{
		...
		ddOrderService.unassignHUs(fromDDOrderLineId, ImmutableSet.of(huId));
	}
