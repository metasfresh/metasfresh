...
public class PPOrderIssuePlanCreateCommand
{
			...
			final @NonNull PPOrderId ppOrderId)
	{
		...
		final IPPOrderRoutingRepository ppOrderRoutingRepository = Services.get(IPPOrderRoutingRepository.class);
			...
			final boolean createStepsForIncludedTUs)
	{
		...
		final AllocableHUsList availableHUs = getAvailableHusForLine(orderBOMLineId, pickFromLocatorId);
