...
public class DDOrderReplenishmentEventPublisher
{
	...
	public void publishOne(@NonNull final PickingJobScheduleId pickingJobScheduleId)
	{
		...
		final Event event = Event.builder()
				...
				.putProperty(PROPERTY_AD_Client_ID, clientAndOrgId != null ? clientAndOrgId.getClientId().getRepoId() : 0)
				.putProperty(PROPERTY_AD_Org_ID, clientAndOrgId != null ? clientAndOrgId.getOrgId().getRepoId() : 0)
