 ...
 */
public class PickingJobLoaderSupportingServices
{
	...
	public PickingJobLoaderSupportingServices(
	...
	public HUBarcode getHUBarcode(@NonNull final HuId huId)
	{
		return HUBarcode.ofHuId(huId);
	}
}
