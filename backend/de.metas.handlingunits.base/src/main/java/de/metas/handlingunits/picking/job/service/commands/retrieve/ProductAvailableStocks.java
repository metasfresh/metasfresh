...
class ProductAvailableStocks
{
	...
	{
		return CollectionUtils.getOrLoad(map, productId, this::loadByProductId);
	}

	public void warmUpByProductIds(final Set<ProductId> productIds)
	{
		CollectionUtils.getAllOrLoad(map, productIds, this::loadByProductId);
	}

	private Map<ProductId, ProductAvailableStock> loadByProductId(final Set<ProductId> productIds)
	{
