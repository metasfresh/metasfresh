...
public interface IHUCapacityBL extends ISingletonService
{
	Capacity getCapacity(
			@NonNull HUPIItemProductId itemDefProductId,
			@Nullable ProductId productId);

	Capacity getCapacity(
			@NonNull HUPIItemProduct itemDefProduct,
			@Nullable ProductId productId);
	 ...
	 */
	Capacity getCapacity(@NonNull HUPIItemProduct itemDefProduct, @Nullable ProductId productId, @NonNull I_C_UOM uom);
	
	@Deprecated
	Capacity getCapacity(@NonNull I_M_HU_PI_Item_Product itemDefProduct, @Nullable ProductId productId, @NonNull I_C_UOM uom);

	@Deprecated
	Capacity getCapacity(HUPIItemProduct itemDefProduct, I_M_Product product, I_C_UOM uom);
	 ...
	 * zero-capacity. If a record is found, return the result of {@link #getCapacity(HUPIItemProduct, I_M_Product, I_C_UOM)}.
	 *
