...
@Component
public class SalesComputingMethod extends AbstractShipmentComputingMethod
{
	public SalesComputingMethod(
			@NonNull final ModularContractProvider contractProvider,
			@NonNull final ComputingMethodService computingMethodService)
	{
		super(contractProvider, computingMethodService, ComputingMethodType.Sales);
	}
}
