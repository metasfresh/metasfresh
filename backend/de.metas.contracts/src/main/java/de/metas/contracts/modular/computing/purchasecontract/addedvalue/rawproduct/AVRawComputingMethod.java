...
public class AVRawComputingMethod implements IModularContractComputingMethodHandler
{
	private final IProductBL productBL = Services.get(IProductBL.class);
	@NonNull private final ComputingMethodService computingMethodService;
	@Override
	public boolean applies(final @NonNull TableRecordReference tableRecordReference, final @NonNull LogEntryContractType logEntryContractType)
	{
		return false;
	}
