...
public class InterimInvoiceCandidateRepository extends AbstractInvoiceCandidateRepository
{
	...
	{
		final I_C_ILCandHandler handlerRecord = invoiceCandidateHandlerDAO.retrieveForClassOneOnly(Env.getCtx(), FlatrateTerm_Handler.class);
		icRecord.setC_ILCandHandler_ID(handlerRecord.getC_ILCandHandler_ID());
		icRecord.setIsManual(false);
	}
}
