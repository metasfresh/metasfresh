...
@Component
public class AVInterestLog extends AbstractInterestLogHandler
{
	public AVInterestLog(
	...
	{
		super(modularContractService, modCntrInvoicingGroupRepository, computingMethod, interestBaseLogHandler, ComputingMethodType.SalesAV);
	}
}