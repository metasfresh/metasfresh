...
public class ModularContractLogDAO
{
	...
	public ModularContractLogEntry create(@NonNull final LogEntryCreateRequest request)
	{
		return null; // todo
	}

	public ModularContractLogEntry reverse(@NonNull final LogEntryReverseRequest logEntryReverseRequest)
	{
		return null; // todo
	}
