...
@Value
public class SalesInvoiceCandidateDocumentId implements CommissionTriggerDocumentId
{
	public static SalesInvoiceCandidateDocumentId cast(final CommissionTriggerDocumentId commissionTriggerDocInfo)
	{
		return (SalesInvoiceCandidateDocumentId)commissionTriggerDocInfo;
	}
