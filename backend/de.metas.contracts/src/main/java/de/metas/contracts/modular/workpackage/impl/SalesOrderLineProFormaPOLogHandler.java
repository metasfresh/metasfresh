...
{
	private static final AdMessageKey MSG_ON_COMPLETE_DESCRIPTION = AdMessageKey.of("de.metas.contracts.modular.workpackage.impl.SalesOrderLineProFormaPOLogHandler.CompleteLogDescription");
