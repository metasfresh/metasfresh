...
UPDATE AD_Message_Trl SET IsTranslated='Y', MsgText='The harvesting year can not be changed when the order has lines with contract terms.',Updated=TO_TIMESTAMP('2023-10-23 10:54:59.122','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Language='en_US' AND AD_Message_ID=545354
;
