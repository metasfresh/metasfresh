...
INSERT INTO ModCntr_Type (AD_Client_ID,AD_Org_ID,Created,CreatedBy,IsActive,ModCntr_Type_ID,ModularContractHandlerType,Name,Updated,UpdatedBy,Value)
 VALUES (1000000,1000000,TO_TIMESTAMP('2024-05-08 18:37:17.347','YYYY-MM-DD HH24:MI:SS.US'),100,'Y',540008,'InformativeLogs','Informative Logs',TO_TIMESTAMP('2024-05-08 18:37:17.347','YYYY-MM-DD HH24:MI:SS.US'),100,'1000009')
;
