...
-- Value: de.metas.contracts.modular.invgroup.ProductInAnotherGroup
-- 2023-09-07T11:31:19.304306900Z
INSERT INTO AD_Message (AD_Client_ID,AD_Message_ID,AD_Org_ID,Created,CreatedBy,EntityType,IsActive,MsgText,MsgType,Updated,UpdatedBy,Value) VALUES (0,545330,0,TO_TIMESTAMP('2023-09-07 14:31:19.065','YYYY-MM-DD HH24:MI:SS.US'),100,'D','Y','Dieses Produkt ist bereits Teil einer anderen Rechnungsgruppe für den gewählten Zeitraum.','E',TO_TIMESTAMP('2023-09-07 14:31:19.065','YYYY-MM-DD HH24:MI:SS.US'),100,'de.metas.contracts.modular.invgroup.ProductInAnotherGroup')
;

-- 2023-09-07T11:31:19.307967700Z
INSERT INTO AD_Message_Trl (AD_Language,AD_Message_ID, MsgText,MsgTip, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Message_ID, t.MsgText,t.MsgTip, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Message t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Message_ID=545330 AND NOT EXISTS (SELECT 1 FROM AD_Message_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Message_ID=t.AD_Message_ID)
;

-- Value: de.metas.contracts.modular.invgroup.ProductInAnotherGroup
-- 2023-09-07T11:31:32.142261500Z
UPDATE AD_Message_Trl SET MsgText='This product is already part of a different invoicing group for the selected time period.',Updated=TO_TIMESTAMP('2023-09-07 14:31:32.141','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Language='en_US' AND AD_Message_ID=545330
;
