...
/** Generated Model for C_LicenseFeeSettings
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_C_LicenseFeeSettings extends org.compiere.model.PO implements I_C_LicenseFeeSettings, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = 79387114L;

    /** Standard Constructor */
    public X_C_LicenseFeeSettings (final Properties ctx, final int C_LicenseFeeSettings_ID, @Nullable final String trxName)
    {
      super (ctx, C_LicenseFeeSettings_ID, trxName);
    }

    /** Load Constructor */
    public X_C_LicenseFeeSettings (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
