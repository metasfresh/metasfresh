...
import de.metas.contracts.impl.FlatrateTransitionDAO;
...
public class C_Flatrate_ConditionsTest
{
	...
	public void prohibitWrongDeliveryInterval()
	{
		...
		final C_Flatrate_Conditions flatrateConditions = new C_Flatrate_Conditions(new FlatrateTransitionBL(new FlatrateTransitionDAO()), new ModularContractSettingsDAO());
