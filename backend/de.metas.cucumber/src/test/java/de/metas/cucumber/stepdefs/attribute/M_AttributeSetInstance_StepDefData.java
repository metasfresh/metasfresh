...
public class M_AttributeSetInstance_StepDefData extends StepDefData<I_M_AttributeSetInstance>
{
	...
	public Optional<AttributeSetInstanceId> getIdOptional(final StepDefDataIdentifier identifier)
	{
		return getOptional(identifier)
				.map(record -> AttributeSetInstanceId.ofRepoId(record.getM_AttributeSetInstance_ID()));
	}
