...
public class InfrastructureSupport
{
	...
	public void start()
	{
		...
		{
			// the image 5.172.2_380_release is from release-branch 2021-09-15. it is fairly old, 
			...
			//final String fullImageName = "metasfresh/metasfresh-db:5.175.1_22763_master";
