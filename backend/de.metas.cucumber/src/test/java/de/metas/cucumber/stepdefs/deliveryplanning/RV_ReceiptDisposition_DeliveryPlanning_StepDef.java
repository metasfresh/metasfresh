...
public class RV_ReceiptDisposition_DeliveryPlanning_StepDef
{
	 ...
	 * @cucumber.stepdef
	 * @cucumber.columns
	 *   <b>RV_ReceiptDisposition_DeliveryPlanning_ID</b> — (required, identifier-ref) alias to store the loaded row under<br>
	 ...
	 * @cucumber.example
	 * <pre>
	 * Then after not more than 30s, the C_Order identified by order_PO has exactly the following rows in RV_ReceiptDisposition_DeliveryPlanning:
	 *   | RV_ReceiptDisposition_DeliveryPlanning_ID | M_Delivery_Planning_ID | M_ReceiptSchedule_ID | OPT.ETA    |
	 *   | receiptDispositionDeliveryPlanningRow    | deliveryPlanning_PO    | receiptSchedule      | 2023-02-20 |
	 * </pre>
	 */
	@Then("^after not more than (.*)s, the C_Order identified by (.*) has exactly the following rows in RV_ReceiptDisposition_DeliveryPlanning:$")
	public void validate_RV_ReceiptDisposition_DeliveryPlanning(
			...
			@NonNull final DataTable dataTable) throws InterruptedException
	{
		...
		final List<I_RV_ReceiptDisposition_DeliveryPlanning> actualRows = queryRows(order);
		assertThat(actualRows)
				.as("rows of RV_ReceiptDisposition_DeliveryPlanning for C_Order %s", orderIdentifier)
	 ...
	 * @cucumber.example
	 * <pre>
	 * Then RV_ReceiptDisposition_DeliveryPlanning has no row for the C_Order identified by order_SO
	 * </pre>
	 */
	@Then("^RV_ReceiptDisposition_DeliveryPlanning has no row for the C_Order identified by (.*)$")
	public void validate_no_RV_ReceiptDisposition_DeliveryPlanning_row(@NonNull final String orderIdentifier)
	{
		final I_C_Order order = orderTable.get(orderIdentifier);
	...
	private List<I_RV_ReceiptDisposition_DeliveryPlanning> queryRows(@NonNull final I_C_Order order)
	{
		return queryBL.createQueryBuilder(I_RV_ReceiptDisposition_DeliveryPlanning.class)
				.addEqualsFilter(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_C_Order_ID, order.getC_Order_ID())
				.orderBy()
				.addColumn(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_RV_ReceiptDisposition_DeliveryPlanning_ID)
				.endOrderBy()
				.create()
				.list();
	}

	private void validateRow(@NonNull final DataTableRow expected, @NonNull final I_RV_ReceiptDisposition_DeliveryPlanning actual)
	{
		final SoftAssertions softly = new SoftAssertions();

		final StepDefDataIdentifier planningIdentifier = expected.getAsIdentifier(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_Delivery_Planning_ID);
		final I_M_ReceiptSchedule receiptSchedule = expected.getAsIdentifier(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_ReceiptSchedule_ID)
				.lookupNotNullIn(receiptScheduleTable);

		softly.assertThat(actual.getM_ReceiptSchedule_ID())
				.as(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_ReceiptSchedule_ID)
		...
		if (planningIdentifier.isNullPlaceholder())
		{
			...
			softly.assertThat(actual.getM_Delivery_Planning_ID())
					.as("%s of an unplanned row", I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_Delivery_Planning_ID)
					.isZero();
			softly.assertThat(actual.getRV_ReceiptDisposition_DeliveryPlanning_ID())
					.as("%s of an unplanned row", I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_RV_ReceiptDisposition_DeliveryPlanning_ID)
		...
		else
		{
			...
			softly.assertThat(actual.getM_Delivery_Planning_ID())
					.as("%s of a planned row", I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_Delivery_Planning_ID)
					.isEqualTo(deliveryPlanning.getM_Delivery_Planning_ID());
			softly.assertThat(actual.getRV_ReceiptDisposition_DeliveryPlanning_ID())
					.as("%s of a planned row", I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_RV_ReceiptDisposition_DeliveryPlanning_ID)
					.isEqualTo(deliveryPlanning.getM_Delivery_Planning_ID());
		}
		...
		expected.getAsOptionalBigDecimal(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_QtyOrdered)
		...
		expected.getAsOptionalBigDecimal(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_CalendarWeek)
				.ifPresent(calendarWeek -> softly.assertThat(actual.getCalendarWeek())
						.as(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_CalendarWeek)
						.isEqualByComparingTo(calendarWeek));

		expected.getAsOptionalString(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_POReference)
		...
		expected.getAsOptionalBoolean(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_Processed)
				.ifPresent(processed -> softly.assertThat(actual.isProcessed())
						.as(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_Processed)
						.isEqualTo(processed));

		expected.getAsOptionalIdentifier(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_C_BPartner_ID)
				...
				.ifPresent(id -> {
					...
					softly.assertThat(actual.getC_BPartner_ID())
							.as(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_C_BPartner_ID)
							.isEqualTo(bpartner.getC_BPartner_ID());
				});

		expected.getAsOptionalIdentifier(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_Product_ID)
				.filter(StepDefDataIdentifier::isNotNullPlaceholder)
				.ifPresent(id -> {
					final I_M_Product product = id.lookupNotNullIn(productTable);
					softly.assertThat(actual.getM_Product_ID())
							.as(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_Product_ID)
							.isEqualTo(product.getM_Product_ID());
				});

		expected.getAsOptionalIdentifier(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_Warehouse_ID)
				.filter(StepDefDataIdentifier::isNotNullPlaceholder)
				.ifPresent(id -> {
					final I_M_Warehouse warehouse = id.lookupNotNullIn(warehouseTable);
					softly.assertThat(actual.getM_Warehouse_ID())
							.as(I_RV_ReceiptDisposition_DeliveryPlanning.COLUMNNAME_M_Warehouse_ID)
