...
public class C_TaxDeclarationAcct_StepDef
{
			...
			@NonNull final SoftAssertions softly)
	{
		...
		// VATCode column carries a step-def identifier (e.g. `sales19`) — resolve it
		// to the actual C_VAT_Code.VATCode string (a random UUID prefix generated by
		// C_VAT_Code_StepDef.createVATCode).
		final VATCode vatCode = vatCodeTable.get(row.getAsIdentifier("VATCode"));
		final String expectedVatCode = vatCode.getCode();
