...
public class PP_Order_Cost_StepDef
{
	 ...
	 *   <b>PostCalculationAmt</b> — (optional) expected post-calculation amount (bare number), i.e. the cost this row is relieved/valued by after the production post-calc (co-product CP_i = p_i x ΣInboundCost, finished good FG = (1 − Σp) x ΣInboundCost)<br>
