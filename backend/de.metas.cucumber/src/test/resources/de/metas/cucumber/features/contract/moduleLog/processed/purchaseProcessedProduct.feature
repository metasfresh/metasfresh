Feature: Modular contract log from purchase order for processed product
  ...
  No interim invoice created, sold more than received so definitive invoice will be a Credit Memo.
    ...
    And validate created C_Flatrate_Term:
      ...
      | moduleLogContract_1           | moduleLogConditions_06062024_1      | bp_moduleLogPO              | rawProduct              | po_orderLine                       | po_order                       | PCE                   | 1000                  | 10.00           | moduleLogPricingSystem            | ModularContract     | Ru                 | CO            | N           |
      | interimContract_1             | moduleLogConditions_06062024_1      | bp_moduleLogPO              | rawProduct              | po_orderLine                       | po_order                       | PCE                   | 1000                  | 7.50            | moduleLogPricingSystem            | InterimInvoice      | Ru                 | CO            | N           |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | log_1                     | po_orderLine         | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | rawProduct              | rawProduct                    | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | C_OrderLine     | moduleLogContract_1           | modCntr_type_0             | false         | PurchaseOrder                | EUR                        | PCE                   | 10000      | y2022                             | informative_module               | 10.00           | PCE                       | informative_06062024_1       | N              |
      | log_2                     | moduleLogContract_1  | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | rawProduct              | rawProduct                    | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | C_Flatrate_Term | moduleLogContract_1           | modCntr_type_0             | false         | PurchaseModularContract      | EUR                        | PCE                   | 10000      | y2022                             | informative_module               | 10.00           | PCE                       | informative_06062024_1       | N              |
      | log_sv                    | moduleLogContract_1  | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | rawProduct              | rawProduct                    | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | C_Flatrate_Term | moduleLogContract_1           | modCntr_type_5             | false         | PurchaseModularContract      | EUR                        | PCE                   | 7500       | y2022                             | avOnInterim_module               | 7.5             | PCE                       | addValueOnInterim_06062024_1 | Y              |
      | log_ic                    | interimContract_1    | Interim         | bp_moduleLogPO                             | warehouse_06062024_1          | rawProduct              | rawProduct                    | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | C_Flatrate_Term | interimContract_1             | modCntr_type_8             | false         | ContractPrefinancing         | EUR                        | PCE                   | 7500       | y2022                             | interimContract_module           | 7.5             | PCE                       | interimProduct_06062024      | N              |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier | Initial_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty  | TableName   | C_Flatrate_Term_ID.Identifier | ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.C_Currency_ID.ISO_Code | OPT.C_UOM_ID.X12DE355 | OPT.Amount | OPT.Harvesting_Year_ID.Identifier | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 | OPT.ProductName    | OPT.IsBillable |
      | log_1                     | receiptLine_1        | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | rawProduct              | rawProduct                    | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | M_InOutLine | moduleLogContract_1           | modCntr_type_2             | false         | MaterialReceipt              | EUR                        | PCE                   | 0          | y2022                             | receipt_module                   | 0.00            | PCE                       | receipt_06062024_1 | Y              |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | log_1                     | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | addValueOnProcessed_PO_2 | processedProduct              | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | modCntr_type_4             | false         | Production                   | EUR                        | PCE                   | -6000      | y2022                             | avOnProcessedProduct_module_2    | -6.00           | PCE                       | addValueOnProcessedProduct_06062024_2 | Y              |
      | log_2                     | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | addValueOnProcessed_PO   | processedProduct              | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | modCntr_type_4             | false         | Production                   | EUR                        | PCE                   | 8000       | y2022                             | avOnProcessedProduct_module_1    | 8.00            | PCE                       | addValueOnProcessedProduct_06062024_1 | Y              |
      | log_3                     | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | processedProduct         | processedProduct              | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | modCntr_type_1             | false         | Production                   | EUR                        | PCE                   | 20000      | y2022                             | definitive_module                | 20.00           | PCE                       | salesOnProcessedProduct_06062024_1    | Y              |
      | log_4                     | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | processedProduct         | processedProduct              | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | modCntr_type_3             | false         | Production                   | EUR                        | PCE                   | 20000      | y2022                             | salesOnProcessedProduct_module   | 20.00           | PCE                       | salesOnProcessedProduct_06062024_1    | Y              |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier        | Initial_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty  | TableName   | C_Flatrate_Term_ID.Identifier | ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.C_Currency_ID.ISO_Code | OPT.C_UOM_ID.X12DE355 | OPT.Amount | OPT.Harvesting_Year_ID.Identifier | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 | OPT.ProductName                    | OPT.IsBillable |
      | log_inout_1_1             | so_ioline_1          | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | processedProduct               | processedProduct              | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | M_InOutLine | moduleLogContract_1           | modCntr_type_1             | false         | Shipment                     | EUR                        | PCE                   | 20000      | y2022                             | definitive_module                | 20.00           | PCE                       | salesOnProcessedProduct_06062024_1 | Y              |
      | log_inout_1_2             | so_ioline_1          | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | storageCostForProcessedProduct | processedProduct              | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | M_InOutLine | moduleLogContract_1           | modCntr_type_7             | false         | Shipment                     | EUR                        | PCE                   | -1800      | y2022                             | storageCost_module               | -0.06           | PCE                       | storageCost_06062024_1             | Y              |
      | log_inout_2_1             | so_ioline_2          | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | processedProduct               | processedProduct              | bp_moduleLogPO                      | bp_moduleLogPO                  | 50   | M_InOutLine | moduleLogContract_1           | modCntr_type_1             | false         | Shipment                     | EUR                        | PCE                   | 1000       | y2022                             | definitive_module                | 20.00           | PCE                       | salesOnProcessedProduct_06062024_1 | Y              |
      | log_inout_2_2             | so_ioline_2          | ModularContract | bp_moduleLogPO                             | warehouse_06062024_1          | storageCostForProcessedProduct | processedProduct              | bp_moduleLogPO                      | bp_moduleLogPO                  | 50   | M_InOutLine | moduleLogContract_1           | modCntr_type_7             | false         | Shipment                     | EUR                        | PCE                   | -90        | y2022                             | storageCost_module               | -0.06           | PCE                       | storageCost_06062024_1             | Y              |
