...
Feature: Shipping Notifications
  ...
  Background:
    ...
    Given metasfresh contains M_PricingSystems
      ...
      | moduleLogPricingSystem | moduleLogPricingSystem_04102023 | moduleLogPricingSystem_04102023 |
    And metasfresh contains M_PriceLists
      | Identifier     | M_PricingSystem_ID.Identifier | OPT.C_Country.CountryCode | C_Currency.ISO_Code | Name                    | SOTrx | IsTaxIncluded | PricePrecision |
      | moduleLogPL_PO | moduleLogPricingSystem        | DE                        | EUR                 | moduleLogPL_PO_04102023 | false | false         | 2              |
      | moduleLogPL_SO | moduleLogPricingSystem        | DE                        | EUR                 | moduleLogPL_SO_04102023 | true  | false         | 2              |
    And metasfresh contains M_PriceList_Versions
      | Identifier      | M_PriceList_ID.Identifier | Name                     | ValidFrom  |
      | moduleLogPLV_PO | moduleLogPL_PO            | moduleLogPLV_04102023_PO | 2022-02-01 |
      | moduleLogPLV_SO | moduleLogPL_SO            | moduleLogPLV_04102023_SO | 2022-02-01 |

    And metasfresh contains C_BPartners:
      | Identifier     | Name                    | OPT.IsVendor | OPT.IsCustomer | M_PricingSystem_ID.Identifier | OPT.C_PaymentTerm_ID.Value |
      | bp_moduleLogPO | bp_moduleLogPO_04102023 | Y            | N              | moduleLogPricingSystem        | 1000002                    |
      | bp_moduleLogSO | bp_moduleLogSO_04102023 | N            | Y              | moduleLogPricingSystem        | 1000002                    |
    And metasfresh contains C_BPartner_Locations:
      | Identifier              | GLN           | C_BPartner_ID.Identifier | OPT.IsShipToDefault | OPT.IsBillToDefault |
      | bp_moduleLogPO_Location | 0410202312346 | bp_moduleLogPO           | true                | true                |
      | bp_moduleLogSO_Location | 0410202312345 | bp_moduleLogSO           | true                | true                |

    And metasfresh contains M_Warehouse:
      | M_Warehouse_ID.Identifier | Value              | Name               | OPT.C_BPartner_ID.Identifier | OPT.C_BPartner_Location_ID.Identifier |
      | warehouseModularContract  | warehouse_04102023 | warehouse_04102023 | bp_moduleLogPO               | bp_moduleLogPO_Location               |
    And metasfresh contains M_Locator:
      | M_Locator_ID.Identifier | Value            | M_Warehouse_ID.Identifier |
      | locatorModularContract  | locator_04102023 | warehouseModularContract  |
    ...
    And metasfresh contains ModCntr_Types:
      ...
      | modCntr_type_PO            | modCntr_type_PO_04102023        | modCntr_type_PO_04102023        | de.metas.contracts.modular.impl.PurchaseOrderLineModularContractHandler               |
      | modCntr_type_SO_for_PO     | modCntr_type_SO_for_PO_04102023 | modCntr_type_SO_for_PO_04102023 | de.metas.contracts.modular.impl.SOLineForPOModularContractHandler                     |
      | modCntr_type_SO            | modCntr_type_SO_04102023        | modCntr_type_SO_04102023        | de.metas.contracts.modular.impl.SalesOrderLineModularContractHandler                  |
      | modCntr_type_MC_SO         | modCntr_type_MC_SO_04102023     | modCntr_type_MC_SO_04102023     | de.metas.contracts.modular.impl.SalesModularContractHandler                           |
      | modCntr_type_MC_PO         | modCntr_type_MC_PO_04102023     | modCntr_type_MC_PO_04102023     | de.metas.contracts.modular.impl.PurchaseModularContractHandler                        |
      | modCntr_type_MC_SN_SO      | modCntr_type_MC_SN_SO_04102023  | modCntr_type_MC_SN_SO_04102023  | de.metas.contracts.modular.impl.ShippingNotificationForSalesModularContractHandler    |
      | modCntr_type_MC_SN_PO      | modCntr_type_MC_SN_PO_04102023  | modCntr_type_MC_SN_PO_04102023  | de.metas.contracts.modular.impl.ShippingNotificationForPurchaseModularContractHandler |
  ...
  validate recomputation process for a reversed shipping notification
    ...
    Given metasfresh contains M_Products:
      | Identifier           | Name                          |
      | modularContract_prod | modularContract_prod_04102023 |
    ...
    And metasfresh contains ModCntr_Settings:
      ...
      | modCntr_settings_2023          | testSettings_04102023   | modularContract_prod    | harvesting_calendar      | year_2023            | moduleLogPricingSystem            | false       |
      | modCntr_settings_2023_2        | testSettings_04102023_2 | modularContract_prod    | harvesting_calendar      | year_2022            | moduleLogPricingSystem            | true        |
    ...
    And metasfresh contains ModCntr_Modules:
      ...
      | modCntr_module_MC_SN_PO      | 40    | name_40          | modularContract_prod    | Kosten         | modCntr_settings_2023          | modCntr_type_MC_SN_SO      |
      | modCntr_module_SO_1          | 10    | name_04102023_10 | modularContract_prod    | Kosten         | modCntr_settings_2023_2        | modCntr_type_SO            |
      | modCntr_module_MC_1          | 20    | name_04102023_20 | modularContract_prod    | Kosten         | modCntr_settings_2023_2        | modCntr_type_MC_SO         |
      | modCntr_module_MC_SN_SO      | 30    | name_04102023_30 | modularContract_prod    | Kosten         | modCntr_settings_2023_2        | modCntr_type_MC_SN_SO      |
    ...
    And metasfresh contains C_Orders:
      ...
      | po_order   | false   | bp_moduleLogPO           | 2022-03-03  | POO             | poModularContract_04102023 | warehouseModularContract      |
    ...
    And metasfresh contains C_Orders:
      ...
      | so_order   | true    | bp_moduleLogSO           | 2022-03-03  | so_04102023     | harvesting_calendar                     | year_2023                         | warehouseModularContract      |
    And metasfresh contains C_OrderLines:
      | Identifier | C_Order_ID.Identifier | M_Product_ID.Identifier | QtyEntered | OPT.C_Flatrate_Conditions_ID.Identifier |
    ...
    And after not more than 30s, M_Shipping_Notifications are found
      ...
      | shippingNotification_04102023         | so_order              | CO        | bp_moduleLogSO               | bp_moduleLogSO_04102023               | org_1                | locator_04102023        | harvesting_calendar                 | year_2023                     |
    And validate M_Shipping_NotificationLines:
      ...
      | shippingNotificationLine_04102023_1       | shippingNotification_04102023         | s_ol_1                           | modularContract_prod    | 8           |
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_Shipping_NotificationLine | moduleLogContract             | modCntr_type_MC_SN_PO          | false         | ShippingNotification         | year_2023                         | false       | modCntr_module_MC_SN_PO          |
      | poLog_2                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_Shipping_NotificationLine | moduleLogContract_SO          | modCntr_type_MC_SN_SO          | false         | ShippingNotification         | year_2023                         | true        | modCntr_module_MC_SN_SO          |

    And recompute modular logs for record:
      | TableName               | Record_ID.Identifier          |
      | M_Shipping_Notification | shippingNotification_04102023 |
    And after not more than 30s, validate ModCntr_Log_Statuses:
      ...
      | shippingNotificationLine_04102023_1 | M_Shipping_NotificationLine | SP               | 2                   |
    Then after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier                | ContractType    | OPT.ModCntr_InvoicingGroup_ID.Identifier | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName                   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier |
      | soLog_1                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_Shipping_NotificationLine | moduleLogContract             | modCntr_type_MC_SN_PO          | false         | ShippingNotification         | year_2023                         | false       | modCntr_module_MC_SN_PO          |
      | poLog_2                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_Shipping_NotificationLine | moduleLogContract_SO          | modCntr_type_MC_SN_SO          | false         | ShippingNotification         | year_2023                         | true        | modCntr_module_MC_SN_SO          |
    ...
    And after not more than 30s, locate reversal M_Shipping_Notifications
      ...
      | shippingNotification_04102023         | reversal_shippingNotification_04102023 |

    Then after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier                | ContractType    | OPT.ModCntr_InvoicingGroup_ID.Identifier | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName                   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier |
      | soLog_1                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_Shipping_NotificationLine | moduleLogContract             | modCntr_type_MC_SN_PO          | false         | ShippingNotification         | year_2023                         | false       | modCntr_module_MC_SN_PO          |
      | poLog_2                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_Shipping_NotificationLine | moduleLogContract_SO          | modCntr_type_MC_SN_SO          | false         | ShippingNotification         | year_2023                         | true        | modCntr_module_MC_SN_SO          |
      | soLog_3                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | -8  | M_Shipping_NotificationLine | moduleLogContract             | modCntr_type_MC_SN_PO          | false         | ShippingNotification         | year_2023                         | false       | modCntr_module_MC_SN_PO          |
      | poLog_4                   | shippingNotificationLine_04102023_1 | ModularContract | invoicingGroup                           | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | -8  | M_Shipping_NotificationLine | moduleLogContract_SO          | modCntr_type_MC_SN_SO          | false         | ShippingNotification         | year_2023                         | true        | modCntr_module_MC_SN_SO          |
    ...
    And after not more than 30s, validate ModCntr_Log_Statuses:
      | Record_ID.Identifier                | TableName                   | ProcessingStatus | OPT.noOfLogStatuses |
      | shippingNotificationLine_04102023_1 | M_Shipping_NotificationLine | SP               | 4                   |
    Then after not more than 30s, no ModCntr_Logs are found:
      | Record_ID.Identifier                | TableName                   |
      | shippingNotificationLine_04102023_1 | M_Shipping_NotificationLine |
