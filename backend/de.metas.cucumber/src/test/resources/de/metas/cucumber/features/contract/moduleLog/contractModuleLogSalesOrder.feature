Feature: Modular contract log from sales order
  ...
  - validate that for each line a modular contract log is created
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
  ...
  - validate that for each line a modular contract log is created with negated qty
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier  | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 |
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | 10  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | 5   | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | 10  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | 5   | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_3                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | -10 | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_4                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | -5  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
  ...
  - validate that for each line a modular contract log is created with the updated qty
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier  | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 |
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 10  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 5   | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 10  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 5   | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_3                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | -10 | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_4                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | -5  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_3                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | -10 | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_4                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | -5  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_5                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 12  | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
      | soLog_6                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 7   | C_OrderLine | moduleLogContract             | modCntr_type_SO_for_PO         | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       |
