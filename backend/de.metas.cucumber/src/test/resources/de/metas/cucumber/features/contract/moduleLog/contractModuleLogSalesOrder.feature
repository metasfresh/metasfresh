Feature: Modular contract log from sales order
  ...
  - a modular contract log is created for the sales modular contract
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1                   | moduleLogContract    | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogSO                      | bp_moduleLogSO                  | 10  | C_Flatrate_Term | moduleLogContract             | modCntr_type_MC                | false         | SalesModularContract         | year_2023                         | true        | modCntr_module_MC                | 10.00           | PCE                       |
