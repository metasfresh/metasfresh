...
"""
    Then verify that bPartner was created for externalIdentifier
      | externalIdentifier | OPT.Code  | Name      | OPT.CompanyName | OPT.ParentId | OPT.Phone | OPT.Language | OPT.Url | OPT.Group  | OPT.VatId | OPT.M_PricingSystem_ID |
      | ext-ALBERTA-001    | test_code | test_name | test_company    | null         | null      | de           | null    | test-group | null      | 2000837                |
