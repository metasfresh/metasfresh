...
#      | 4      | SUPPLY            |                           | p_2          | 2021-04-16T21:00:00Z | 100  | 0                      | bomLineASI                |
    And after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed | M_AttributeSetInstance_ID |
    ...
    And after not more than 60s, PP_OrderLine_Candidates are found
      | PP_Order_Candidate_ID | M_Product_ID | QtyEntered | C_UOM_ID.X12DE355 | ComponentType | PP_Product_BOMLine_ID | M_AttributeSetInstance_ID |
    ...
    Then after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed | M_AttributeSetInstance_ID |
      | oc_1       | true      | p_1          | bom_1             | ppln_1                 | 540006        | 10         | 0            | 10           | PCE               | 2021-04-16T21:00:00Z | 2021-04-16T21:00:00Z | false    | bomASI                    |
    And after not more than 60s, PP_Orders are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyOrdered | C_UOM_ID.X12DE355 | C_BPartner_ID | DatePromised         | M_AttributeSetInstance_ID |
      | ppo_1      | p_1          | bom_1             | ppln_1                 | 540006        | 10         | 10         | PCE               | endcustomer   | 2021-04-16T21:00:00Z | bomASI                    |
    And after not more than 60s, PP_Order_BomLines are found
      | PP_Order_ID | M_Product_ID | QtyRequiered | C_UOM_ID.X12DE355 | ComponentType | M_AttributeSetInstance_ID |
...
#      | c_l_2      | SUPPLY            |                           | p_4          | 2021-06-16T21:00:00Z | 100  | 0                      | bomLineASI                |
    ...
    And after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed | M_AttributeSetInstance_ID |
      | oc_2       | true      | p_3          | bom_2             | ppln_2                 | 540006        | 10         | 0            | 10           | PCE               | 2021-06-16T21:00:00Z | 2021-06-16T21:00:00Z | false    | bomASI                    |
    And after not more than 60s, PP_Orders are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyOrdered | C_UOM_ID.X12DE355 | C_BPartner_ID | DatePromised         | M_AttributeSetInstance_ID |
      | ppo_3      | p_3          | bom_2             | ppln_2                 | 540006        | 10         | 10         | PCE               | endcustomer   | 2021-06-16T21:00:00Z | bomASI                    |
    And after not more than 60s, PP_Order_BomLines are found
      | PP_Order_BOMLine_ID | PP_Order_ID | M_Product_ID | QtyRequiered | IsQtyPercentage | C_UOM_ID.X12DE355 | ComponentType | M_AttributeSetInstance_ID |
...
#      | c_l_2      | SUPPLY            |                           | p_4          | 2021-06-16T21:00:00Z | 100 | -20                    | bomLineASI                |
    ...
    Then after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed | M_AttributeSetInstance_ID |
      | oc_2       | true      | p_3          | bom_2             | ppln_2                 | 540006        | 22         | 0            | 22           | PCE               | 2021-06-16T21:00:00Z | 2021-06-16T21:00:00Z | false    | bomASI                    |
    And after not more than 60s, PP_Orders are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyOrdered | C_UOM_ID.X12DE355 | C_BPartner_ID | DatePromised         | M_AttributeSetInstance_ID |
      | ppo_3_1    | p_3          | bom_2             | ppln_2                 | 540006        | 12         | 12         | PCE               | endcustomer   | 2021-06-16T21:00:00Z | bomASI                    |
    And after not more than 60s, PP_Order_BomLines are found
      | PP_Order_BOMLine_ID | PP_Order_ID | M_Product_ID | QtyRequiered | IsQtyPercentage | C_UOM_ID.X12DE355 | ComponentType | M_AttributeSetInstance_ID |
...
#      | c_l_2      | SUPPLY            |                           | p_22         | 2021-04-12T21:00:00Z | 100  | 0                      |
    ...
    Then after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed |
      | oc_11      | true      | p_11         | bom_11            | ppln_11                | 540006        | 10         | 0            | 10           | PCE               | 2021-04-12T21:00:00Z | 2021-04-12T21:00:00Z | false    |
    And after not more than 60s, PP_Orders are found
      ...
      | ppo_11     | p_11         | bom_11            | ppln_11                | 540006        | 10         | 10         | PCE               | endcustomer   | 2021-04-12T21:00:00Z |
    And after not more than 60s, PP_Order_BomLines are found
      | PP_Order_ID | M_Product_ID | QtyRequiered | IsQtyPercentage | C_UOM_ID.X12DE355 | ComponentType |
      | ppo_11      | p_22         | 100          | false           | PCE               | CO            |
    And after not more than 60s, PP_OrderCandidate_PP_Order are found
      | PP_Order_Candidate_ID | PP_Order_ID | QtyEntered | C_UOM_ID.X12DE355 |
      | oc_11                 | ppo_11      | 10         | PCE               |
    And after not more than 60s, MD_Candidates are found
...
#      | c_l_2      | SUPPLY            |                           | p_222        | 2021-04-12T21:00:00Z | 100 | 100                    | bomLineASI                |
    ...
    Then after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed | M_AttributeSetInstance_ID |
      | oc_111     | true      | p_111        | bom_111           | ppln_111               | 540006        | 10         | 0            | 10           | PCE               | 2021-04-11T21:00:00Z | 2021-04-11T21:00:00Z | false    | bomASI                    |
    And after not more than 60s, PP_Orders are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyOrdered | C_UOM_ID.X12DE355 | C_BPartner_ID | DatePromised         | M_AttributeSetInstance_ID |
      | ppo_111    | p_111        | bom_111           | ppln_111               | 540006        | 10         | 10         | PCE               | endcustomer   | 2021-04-11T21:00:00Z | bomASI                    |
    And after not more than 60s, PP_Order_BomLines are found
      | PP_Order_ID | M_Product_ID | QtyRequiered | IsQtyPercentage | C_UOM_ID.X12DE355 | ComponentType |
      | ppo_111     | p_222        | 100          | false           | PCE               | CO            |
    And after not more than 60s, PP_OrderCandidate_PP_Order are found
      | PP_Order_Candidate_ID | PP_Order_ID | QtyEntered | C_UOM_ID.X12DE355 |
...
#      | c_l_2      | SUPPLY            |                           | p_22         | 2021-04-12T21:00:00Z | 100 | 100                    |
    ...
    Then after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed |
      | oc_11      | true      | p_11         | bom_11            | ppln_11                | 540006        | 10         | 0            | 10           | PCE               | 2021-04-15T21:00:00Z | 2021-04-15T21:00:00Z | false    |
    And after not more than 60s, PP_Orders are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyOrdered | C_UOM_ID.X12DE355 | C_BPartner_ID | DatePromised         |
      | ppo_11     | p_11         | bom_11            | ppln_11                | 540006        | 10         | 10         | PCE               | endcustomer   | 2021-04-15T21:00:00Z |
    And after not more than 60s, PP_Order_BomLines are found
      | PP_Order_ID | M_Product_ID | QtyRequiered | IsQtyPercentage | C_UOM_ID.X12DE355 | ComponentType |
      | ppo_11      | p_22         | 100          | false           | PCE               | CO            |
    And after not more than 60s, PP_OrderCandidate_PP_Order are found
...
#      | c_l_2      | SUPPLY            |                           | p_22         | 2021-04-12T21:00:00Z | 100 | 100                    |
      ...
      | c_l_3      | DEMAND            | PRODUCTION                | p_22         | 2021-04-15T21:00:00Z | 100 | -100                   |
      | c_l_1      | DEMAND            | PRODUCTION                | p_22         | 2021-04-15T21:00:00Z | 0   | 0                      |
...
#      | c_l_2_s    | SUPPLY            |                           | p_comp_2     | 2021-04-16T21:00:00Z | 150  | 0                      |
    ...
    And after not more than 60s, PP_OrderLine_Candidates are found
      | PP_Order_Candidate_ID | Identifier | M_Product_ID | QtyEntered | C_UOM_ID.X12DE355 | ComponentType | PP_Product_BOMLine_ID |
...
#      | c_l_3_s    | SUPPLY            |                           | p_comp_3     | 2021-04-16T21:00:00Z | 300 | 0                      |
    ...
    Then after not more than 60s, PP_Order_Candidates are found
      | Identifier | Processed | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | C_UOM_ID.X12DE355 | DatePromised         | DateStartSchedule    | IsClosed |
      | oc_1       | true      | p_1          | bom_2             | ppln_1                 | 540006        | 10         | 0            | 10           | PCE               | 2021-04-16T21:00:00Z | 2021-04-16T21:00:00Z | false    |
    And after not more than 60s, PP_Orders are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyOrdered | C_UOM_ID.X12DE355 | C_BPartner_ID | DatePromised         |
      | ppo_1      | p_1          | bom_2             | ppln_1                 | 540006        | 10         | 10         | PCE               | endcustomer   | 2021-04-16T21:00:00Z |
    And after not more than 60s, PP_Order_BomLines are found
      | PP_Order_ID | PP_Order_BOMLine_ID | M_Product_ID | QtyRequiered | IsQtyPercentage | C_UOM_ID.X12DE355 | ComponentType |
