Feature: EDI_DesadvPack and EDI_DesadvPack_Item, when the orderline has a TU-UOM like TU or COLI
  ...
  - M_HU_PI_Item_Product_ID = created in the test
    ...
    And metasfresh contains C_OrderLines:
      | Identifier | C_Order_ID.Identifier | M_Product_ID.Identifier | QtyEntered | OPT.M_HU_PI_Item_Product_ID.Identifier | OPT.C_UOM_ID.X12DE355 |
      | ol_1       | o_1                   | p_1                     | 4          | huAuditProductTU                       | COLI                  |
    ...
    And validate the created shipment lines
      ...
      | shipmentLine_1            | s_1                   | p_1                     | 40          | true      | ol_1                          |
    ...
    And after not more than 30s, the EDI_Desadv_Pack_Item has only the following records:
      ...
      | pi_1                               | p_1                           | 40              | 40        | 40              | 10                  | 4         | s_1                       | shipmentLine_1                | 2021-04-20         | lotNumber     | huPackagingCode_2                       | bPartnerProductGTIN         |
  ...
  """
    ...
    And metasfresh contains C_OrderLines:
      | Identifier | C_Order_ID.Identifier | M_Product_ID.Identifier | QtyEntered | OPT.M_HU_PI_Item_Product_ID.Identifier | OPT.M_AttributeSetInstance_ID.Identifier | OPT.C_UOM_ID.X12DE355 |
      | ol_1       | o_1                   | p_1                     | 10         | huAuditProductTU_2                     | orderLineASI                             | COLI                  |
