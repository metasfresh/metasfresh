...
Feature: After a quantity of a product is issued/received for the manufacturing order, an entry is created in the module contract log
  ...
  Scenario: There is an entry created in the module contract log when a quantity for the manufacturing order is issued and receipt
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | log_1                     | ppOrder_manufacturing | ModularContract | warehouse                     | componentProduct        | bp_moduleLogMO                  | -10 | PP_Order  | moduleLogContract_1           | modCntr_type_1                 | false         | Production                   | PCE                   | year                              | bp_moduleLogMO                             | modCntr_module_1                 | null            | null                      |
      | log_2                     | ppOrder_manufacturing | ModularContract | warehouse                     | manufacturingProduct    | bp_moduleLogMO                  | 10  | PP_Order  | moduleLogContract_1           | modCntr_type_1                 | false         | Production                   | PCE                   | year                              | bp_moduleLogMO                             | modCntr_module_1                 | null            | null                      |
