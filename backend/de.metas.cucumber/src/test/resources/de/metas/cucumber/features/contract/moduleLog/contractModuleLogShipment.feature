Feature: Modular contract log from shipment
  ...
  - validate that for each shipment line a modular contract log is created
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1_S0303_100         | soLine_1_S0303_100   | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0303_100 | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine | moduleLogContract_S0303_100   | modCntr_type_SO_S0303          | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO_S0303_100      | 10.00           | PCE                       |
      | soLog_2_S0303_100         | soLine_2_S0303_100   | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0303_100 | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine | moduleLogContract_S0303_100   | modCntr_type_SO_S0303          | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO_S0303_100      | 10.00           | PCE                       |
  ...
  - validate `ReactivateNotAllowed` error is thrown
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier        | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 |
      | soLog_1_S0303_200         | soLine_1_S0303_200   | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0303_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine | moduleLogContract_S0303_200   | modCntr_type_SO_S0303          | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO_S0303_200      | 10.00           | PCE                       |
      | soLog_2_S0303_200         | soLine_2_S0303_200   | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0303_200 | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine | moduleLogContract_S0303_200   | modCntr_type_SO_S0303          | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO_S0303_200      | 10.00           | PCE                       |
  ...
  - validate that for each shipment line a modular contract log is created with negated qty
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier        | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 |
      | soLog_1_S0303_300         | soLine_1_S0303_300   | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0303_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine | moduleLogContract_S0303_300   | modCntr_type_SO_S0303          | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO_S0303_300      | 10.00           | PCE                       |
      | soLog_2_S0303_300         | soLine_2_S0303_300   | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0303_300 | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine | moduleLogContract_S0303_300   | modCntr_type_SO_S0303          | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO_S0303_300      | 10.00           | PCE                       |
