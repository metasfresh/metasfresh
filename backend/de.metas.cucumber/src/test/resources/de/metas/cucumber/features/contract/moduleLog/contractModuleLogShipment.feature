Feature: Modular contract log from shipment
  ...
  - validate that for each shipment line a modular contract log is created
    ...
    Then ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier        | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx |
      | shipLog_1_S0303_100       | s_l_1_S0303_100      | ModularContract | bp_moduleLogSO                             | warehouseModularContract      | modularContract_prod_S0303_100 | bp_moduleLogSO                      | bp_moduleLogPO                  | 8   | M_InOutLine | moduleLogContract_S0303_100   | modCntr_type_SHIP_S0303        | false         | Shipment                     | year_2023                         | false       |
      | shipLog_2_S0303_100       | s_l_2_S0303_100      | ModularContract | bp_moduleLogSO                             | warehouseModularContract      | modularContract_prod_S0303_100 | bp_moduleLogSO                      | bp_moduleLogPO                  | 3   | M_InOutLine | moduleLogContract_S0303_100   | modCntr_type_SHIP_S0303        | false         | Shipment                     | year_2023                         | false       |
  ...
  - validate that for each shipment line a modular contract log is created with negated qty
    ...
    Then ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier        | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx |
      | shipLog_1_S0303_300       | s_l_1_S0303_300      | ModularContract | bp_moduleLogSO                             | warehouseModularContract      | modularContract_prod_S0303_300 | bp_moduleLogSO                      | bp_moduleLogPO                  | 8   | M_InOutLine | moduleLogContract_S0303_300   | modCntr_type_SHIP_S0303        | false         | Shipment                     | year_2023                         | false       |
      | shipLog_2_S0303_300       | s_l_2_S0303_300      | ModularContract | bp_moduleLogSO                             | warehouseModularContract      | modularContract_prod_S0303_300 | bp_moduleLogSO                      | bp_moduleLogPO                  | 3   | M_InOutLine | moduleLogContract_S0303_300   | modCntr_type_SHIP_S0303        | false         | Shipment                     | year_2023                         | false       |
