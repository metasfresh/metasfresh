@from:cucumber
@allure.label.epic:E0225
@allure.label.feature:F01000
...
@allure.label.feature:F01000
  ...
  Scenario: Happy flow
    ...
    Then expect inventory valuation report
      ...
      | 2024-03-22 | P1           | wh             | 180 | 10.5263        | 1894.73          | 1894.74               |
      | 2024-03-27 | P1           | wh             | 100 | 10.5264        | 1052.64          | 1052.64               |
      | 2024-04-01 | P1           | wh             | 0   | 0.0000         | 0.00             | 0.01                  |
