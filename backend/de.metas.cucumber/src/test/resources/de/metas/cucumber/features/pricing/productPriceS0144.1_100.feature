...
#  - Product category `Standard` is set on the testing product `product_S0144.1_100`
  ...
  Scenario: Validate that Age attribute set on productCategory.ASI has no default value on order line if configured so (M_AttributeValue.IsNullFieldValue=N)
    ...
    And metasfresh contains M_Products:
      ...
      | product_S0144.1_100 | product_S0144.1_100 | standard_category                    |
    And metasfresh contains M_ProductPrices
      ...
      | pp_S0144.1_100 | plv_SO_02062022                   | product_S0144.1_100     | 100      | PCE               | Normal                        | false                    | 10        |

    And metasfresh contains C_BPartners:
      | Identifier           | Name             | OPT.IsCustomer | M_PricingSystem_ID.Identifier |
      | bpartner_S0144.1_100 | BPartner02062022 | Y              | ps_02062022                   |

    And metasfresh contains C_Orders:
      | Identifier        | IsSOTrx | C_BPartner_ID.Identifier | DateOrdered | OPT.POReference |
      | order_S0144.1_100 | true    | bpartner_S0144.1_100     | 2022-06-01  | po_S0144.1_100  |
    And metasfresh contains C_OrderLines:
      | Identifier     | C_Order_ID.Identifier | M_Product_ID.Identifier | QtyEntered |
      | ol_S0144.1_100 | order_S0144.1_100     | product_S0144.1_100     | 1          |
    ...
    And validate C_OrderLine:
      ...
      | ol_S0144.1_100            | order_S0144.1_100     | 2022-06-01      | product_S0144.1_100     | 1          | 0            | 0           | 100   | 0        | EUR          | false     | attr_age:null                                |
