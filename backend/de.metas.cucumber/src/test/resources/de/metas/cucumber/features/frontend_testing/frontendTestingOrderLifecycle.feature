...
Feature: Frontend Testing API - Order Lifecycle
  ...
  @from:cucumber
  Scenario: Create sales order and verify it completes
    ...
    When metasfresh contains C_Orders:
      ...
      | order_ft_1 | true    | bp_ft_1       | bp_ft_1_loc            | ps_ft_1            | 2022-05-17  |
    And metasfresh contains C_OrderLines:
      | Identifier  | C_Order_ID | M_Product_ID | QtyEntered |
      | ol_ft_1     | order_ft_1 | prod_ft_1    | 10         |
    Then the order identified by order_ft_1 is completed
