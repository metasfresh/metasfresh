...
Feature: Interim contract and interim invoice for bpartner
  ...
  - validate interim invoice reverse log is created on interim invoice reverse
    ...
    And after not more than 60s, ModCntr_Logs are found:
      ...
      | log_9                     | akonto_il_1          | null            | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | 100  | C_InvoiceLine   | moduleLogContract_2           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 200        | year_2022                         | invoiceCand_1                         | modCntr_module_9                 | 2.00            | PCE                       |
      | log_10                    | akonto_il_2          | null            | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 50   | C_InvoiceLine   | moduleLogContract_4           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 100        | year_2022                         | invoiceCand_2                         | modCntr_module_10                | 2.00            | PCE                       |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType | OPT.ModCntr_InvoicingGroup_ID.Identifier | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName     | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.C_Currency_ID.ISO_Code | OPT.C_UOM_ID.X12DE355 | OPT.Amount | OPT.Harvesting_Year_ID.Identifier | OPT.C_Invoice_Candidate_ID.Identifier | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 |
      | log_9                     | akonto_il_1          | Interim      | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | 100 | C_InvoiceLine | moduleLogContract_2           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 200        | year_2022                         | invoiceCand_1                         | modCntr_module_9                 | 2.00            | PCE                       |
      | log_10                    | akonto_il_2          | Interim      | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 50  | C_InvoiceLine | moduleLogContract_4           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 100        | year_2022                         | invoiceCand_2                         | modCntr_module_10                | 2.00            | PCE                       |
    ...
    And after not more than 60s, ModCntr_Logs are found:
      ...
      | log_7                     | mr_line_2            | ModularContract | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 50   | M_InOutLine     | moduleLogContract_3           | modCntr_type_3                 | false         | MaterialReceipt              |                            | PCE                   |            | year_2022                         |                                       | modCntr_module_7                 | null            | null                      |
      | log_8                     | mr_line_2            | Interim         | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 50   | M_InOutLine     | moduleLogContract_4           | modCntr_type_4                 | true          | MaterialReceipt              |                            | PCE                   |            | year_2022                         | invoiceCand_2                         | modCntr_module_8                 | null            | null                      |
      | log_9                     | akonto_il_1          | Interim         | null                                     | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | 100  | C_InvoiceLine   | moduleLogContract_2           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 200        | year_2022                         | invoiceCand_1                         | modCntr_module_9                 | 2.00            | PCE                       |
      | log_10                    | akonto_il_2          | Interim         | null                                     | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 50   | C_InvoiceLine   | moduleLogContract_4           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 100        | year_2022                         | invoiceCand_2                         | modCntr_module_10                | 2.00            | PCE                       |
      | log_11                    | akonto_il_1          | Interim         | null                                     | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | -100 | C_InvoiceLine   | moduleLogContract_2           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | -200       | year_2022                         | invoiceCand_1                         | modCntr_module_9                 | 2.00            | PCE                       |
