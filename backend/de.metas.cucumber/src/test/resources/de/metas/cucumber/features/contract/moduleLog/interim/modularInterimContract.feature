...
Feature: Interim contract and interim invoice for bpartner
  ...
  - validate interim invoice reverse log is created on interim invoice reverse
    ...
    And after not more than 60s, ModCntr_Logs are found:
      ...
      | log_9                     | akonto_il_1          | Interim         | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | 100  | C_InvoiceLine   | moduleLogContract_2           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 200        | year_2022                         | invoiceCand_1                         | modCntr_module_9                 | 2.00            | PCE                       |
      | log_10                    | akonto_il_2          | Interim         | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 50   | C_InvoiceLine   | moduleLogContract_4           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | 100        | year_2022                         | invoiceCand_2                         | modCntr_module_10                | 2.00            | PCE                       |
      | log_11                    | akonto_il_1          | Interim         | invoicingGroup                           | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | -100 | C_InvoiceLine   | moduleLogContract_2           | modCntr_type_5                 | false         | InterimInvoice               | EUR                        | PCE                   | -200       | year_2022                         | invoiceCand_1                         | modCntr_module_9                 | 2.00            | PCE                       |
