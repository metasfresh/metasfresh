...
Feature: Interim contract and interim invoice for bpartner
  ...
  - validate interim invoice reverse log is created on interim invoice reverse
    ...
    And validate created C_Flatrate_Term:
      ...
      | moduleLogContract_1           | moduleLogConditions_PO_1            | bp_interimPO                | module_log_product_PO_1 | po_orderLine_1                     | po_order_1                     | PCE                   | 1000                  | 2.00            | interimPS                         | ModularContract     | Ru                 | CO            |
      | moduleLogContract_2           | moduleLogConditions_interim_1       | bp_interimPO                | module_log_product_PO_1 | po_orderLine_1                     | po_order_1                     | PCE                   | 1000                  | 2.00            | interimPS                         | InterimInvoice      | Ru                 | CO            |
      | moduleLogContract_3           | moduleLogConditions_PO_2            | bp_interimPO                | module_log_product_PO_2 | po_orderLine_2                     | po_order_1                     | PCE                   | 500                   | 2.00            | interimPS                         | ModularContract     | Ru                 | CO            |
      | moduleLogContract_4           | moduleLogConditions_interim_2       | bp_interimPO                | module_log_product_PO_2 | po_orderLine_2                     | po_order_1                     | PCE                   | 500                   | 2.00            | interimPS                         | InterimInvoice      | Ru                 | CO            |
  ...
  - validate error on create interim contract create, if overlapping with interim contract for same modular contract
    ...
    And validate created C_Flatrate_Term:
      | C_Flatrate_Term_ID.Identifier | C_Flatrate_Conditions_ID.Identifier | Bill_BPartner_ID.Identifier | M_Product_ID.Identifier | OPT.C_OrderLine_Term_ID.Identifier | OPT.C_Order_Term_ID.Identifier | OPT.C_UOM_ID.X12DE355 | OPT.PlannedQtyPerUnit | OPT.PriceActual | OPT.M_PricingSystem_ID.Identifier | OPT.Type_Conditions | OPT.ContractStatus | OPT.DocStatus |
      | moduleLogContract_1           | moduleLogConditions_PO_1            | bp_interimPO                | module_log_product_PO_1 | po_orderLine_1                     | po_order_1                     | PCE                   | 1000                  | 2.00            | interimPS                         | ModularContract     | Ru                 | CO            |
      | moduleLogContract_2           | moduleLogConditions_PO_2            | bp_interimPO                | module_log_product_PO_2 | po_orderLine_2                     | po_order_1                     | PCE                   | 500                   | 2.00            | interimPS                         | ModularContract     | Ru                 | CO            |
    ...
    And validate created C_Flatrate_Term:
      | C_Flatrate_Term_ID.Identifier | C_Flatrate_Conditions_ID.Identifier | Bill_BPartner_ID.Identifier | M_Product_ID.Identifier | OPT.C_OrderLine_Term_ID.Identifier | OPT.C_Order_Term_ID.Identifier | OPT.C_UOM_ID.X12DE355 | OPT.PlannedQtyPerUnit | OPT.PriceActual | OPT.M_PricingSystem_ID.Identifier | OPT.Type_Conditions | OPT.ContractStatus | OPT.DocStatus |
      | moduleLogContract_3           | moduleLogConditions_interim_1       | bp_interimPO                | module_log_product_PO_1 | po_orderLine_1                     | po_order_1                     | PCE                   | 1000                  | 2.00            | interimPS                         | InterimInvoice      | Ru                 | CO            |
      | moduleLogContract_4           | moduleLogConditions_interim_2       | bp_interimPO                | module_log_product_PO_2 | po_orderLine_2                     | po_order_1                     | PCE                   | 500                   | 2.00            | interimPS                         | InterimInvoice      | Ru                 | CO            |
