...
Feature: Interim contract for bpartner
  ...
  - after receipt validate interim and modular receiptLine Log created
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | log_3                     | po_orderLine_2       | ModularContract | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 500  | C_OrderLine     | moduleLogContract_3           | modCntr_type_1                 | false         | PurchaseOrder                | EUR                        | PCE                   | 1000       | year_2022                         | modCntr_module_5                 | 2.00            | PCE                       |
      | log_4                     | moduleLogContract_4  | Interim         | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 500  | C_Flatrate_Term | moduleLogContract_3           | modCntr_type_2                 | false         | ContractPrefinancing         | EUR                        | PCE                   | 1000       | year_2022                         | modCntr_module_6                 | 2.00            | PCE                       |
      | log_5                     | shipmentLine_1       | ModularContract | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | 100  | M_InOutLine     | moduleLogContract_1           | modCntr_type_3                 | false         | MaterialReceipt              |                            | PCE                   |            | year_2022                         | modCntr_module_3                 | null            | null                      |
      | log_6                     | shipmentLine_1       | Interim         | bp_interimPO                               | warehouseStd                  | module_log_product_PO_1 | bp_interimPO                        | bp_interimPO                    | 100  | M_InOutLine     | moduleLogContract_2           | modCntr_type_4                 | false         | MaterialReceipt              |                            | PCE                   |            | year_2022                         | modCntr_module_4                 | null            | null                      |
      | log_7                     | shipmentLine_2       | ModularContract | bp_interimPO                               | warehouseStd                  | module_log_product_PO_2 | bp_interimPO                        | bp_interimPO                    | 50   | M_InOutLine     | moduleLogContract_3           | modCntr_type_3                 | false         | MaterialReceipt              |                            | PCE                   |            | year_2022                         | modCntr_module_7                 | null            | null                      |
