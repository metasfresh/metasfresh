...
Feature:bom create using metasfresh api
    ...
    """
 {
    ...
    And verify that bomLine was created for bom
      | PP_Product_BOM_ID.Identifier | M_Product_ID.Identifier | Qty | UomCode | IsQtyPercentage | Scrap | Line |
      | bom_1                        | component_1_Id          | 5.0 | KGM     | true            | 20.15 | 1    |
    ...
    """
 {
    ...
    And verify that bomLine was created for bom
      | PP_Product_BOM_ID.Identifier | M_Product_ID.Identifier | Qty  | UomCode | IsQtyPercentage | Scrap | Line |
      | bom_2                        | component_2_Id          | 20.0 | KGM     | true            | 7.5   | 1    |