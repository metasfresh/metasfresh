...
"""
    ...
    And validate created invoices
      | C_Invoice_ID.Identifier | C_BPartner_ID.Identifier | C_BPartner_Location_ID.Identifier | OPT.POReference | paymentTerm   | processed | docStatus | OPT.C_Currency.ISO_Code | OPT.DateInvoiced | OPT.DateAcct | OPT.DateOrdered | OPT.C_DocType_ID.Identifier | OPT.C_DocTypeTarget_ID.Identifier |
      | invoice_1               | endCustomer_1            | endCustomerLocation_1             | poReference     | 30 Tage netto | true      | CO        | EUR                     | 2022-01-19       | 2022-01-18   | 2022-01-17      | docType                     | docType                           |

    And validate created invoice lines
      | C_InvoiceLine_ID.Identifier | C_Invoice_ID.Identifier | M_Product_ID.Identifier | qtyinvoiced | processed | OPT.PriceEntered | OPT.PriceActual | OPT.LineNetAmt | OPT.C_Tax_ID.Identifier | OPT.Line | OPT.TaxAmtInfo |
      | invoiceLine_1               | invoice_1               | product_1               | 10          | true      | 10               | 10              | 400            | tax_1                   | 10       | 28             |

    And C_Invoice_Acct is found:
      | C_Invoice_Acct_ID.Identifier | OPT.C_AcctSchema_ID.Identifier | OPT.C_Invoice_ID.Identifier | OPT.C_InvoiceLine_ID.Identifier |
      | invoiceAcct_1                | acctSchema_1                   | invoice_1                   | invoiceLine_1                   |
...
"""
    ...
    And validate created invoice lines
      | C_InvoiceLine_ID.Identifier | C_Invoice_ID.Identifier | M_Product_ID.Identifier | qtyinvoiced | processed | OPT.PriceEntered | OPT.PriceActual | OPT.LineNetAmt | OPT.C_Tax_ID.Identifier | OPT.Line | OPT.TaxAmtInfo |
      | invoiceLine_1               | invoice_1               | product_1               | 10          | true      | 10               | 10              | 400            | tax_1                   | 10       | 76             |

    And C_Invoice_Acct is found:
      | C_Invoice_Acct_ID.Identifier | OPT.C_AcctSchema_ID.Identifier | OPT.C_Invoice_ID.Identifier | OPT.C_InvoiceLine_ID.Identifier | OPT.AccountName |
      | invoiceAcct_1                | acctSchema_1                   | invoice_1                   | invoiceLine_1                   | P_Revenue_Acct  |
...
"""
    ...
    And validate created invoices
      | C_Invoice_ID.Identifier | C_BPartner_ID.Identifier | C_BPartner_Location_ID.Identifier | OPT.POReference | paymentTerm   | processed | docStatus | OPT.C_Currency.ISO_Code | OPT.DateInvoiced | OPT.DateAcct | OPT.DateOrdered | OPT.C_DocType_ID.Identifier | OPT.C_DocTypeTarget_ID.Identifier |
      | invoice_1               | endCustomer_1            | endCustomerLocation_1             | poReference     | 30 Tage netto | true      | CO        | EUR                     | 2022-01-24       | 2022-01-23   | 2022-01-22      | docType                     | docType                           |

    And validate created invoice lines
      | C_InvoiceLine_ID.Identifier | C_Invoice_ID.Identifier | M_Product_ID.Identifier | qtyinvoiced | processed | OPT.PriceEntered | OPT.PriceActual | OPT.LineNetAmt | OPT.C_Tax_ID.Identifier | OPT.Line | OPT.TaxAmtInfo |
      | invoiceLine_1               | invoice_1               | product_1               | 10          | true      | 2                | 2               | 20             | tax_1                   | 10       | 1.4            |
