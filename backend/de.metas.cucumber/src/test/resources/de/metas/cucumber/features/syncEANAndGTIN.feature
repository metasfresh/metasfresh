...
Feature: M_Product.SyncEANAndGTIN sysconfig controls GTIN/UPC/EAN_CU sync
  ...
  @from:cucumber
  @Id:S0612_070
  Scenario: TC-07 M_Product - Sync OFF - EAN13_ProductCode still clears GTIN and UPC
    Given set sys config boolean value false for sys config M_Product.SyncEANAndGTIN
    And metasfresh contains M_Products:
      | Identifier | Name     |
      | p_tc07     | TC07Prod |
    ...
    When update M_Product:
      | M_Product_ID.Identifier | EAN13_ProductCode |
      | p_tc07                  | 1234567890123     |
    Then M_Product is verified:
      | M_Product_ID.Identifier | GTIN | UPC  | EAN13_ProductCode |
      | p_tc07                  | null | null | 1234567890123     |
  ...
  Scenario: TC-08 M_Product - Sync ON - EAN13_ProductCode clears GTIN and UPC
    ...
    When update M_Product:
      | M_Product_ID.Identifier | EAN13_ProductCode |
      | p_tc08                  | 1234567890123     |
    Then M_Product is verified:
      | M_Product_ID.Identifier | GTIN | UPC  | EAN13_ProductCode |
      | p_tc08                  | null | null | 1234567890123     |
  ...
  Scenario: TC-09 C_BPartner_Product - Sync OFF - GTIN does NOT auto-fill CU-EAN or CU-UPC
    ...
    And metasfresh contains C_BPartners:
      | Identifier | Name   | IsVendor | IsCustomer |
      | bp_tc09    | BP_TC09| Y        | Y          |
    And metasfresh contains C_BPartner_Product
      | C_BPartner_Product_ID.Identifier | C_BPartner_ID.Identifier | M_Product_ID.Identifier |
      | bpp_tc09                         | bp_tc09                  | p_tc09                  |
    When update C_BPartner_Product:
      | C_BPartner_Product_ID.Identifier | GTIN          |
  ...
  Scenario: TC-10 C_BPartner_Product - Sync OFF - CU-EAN does NOT auto-fill GTIN or CU-UPC
    ...
    When update C_BPartner_Product:
      | C_BPartner_Product_ID.Identifier | EAN_CU        |
  ...
  @from:cucumber
  @Id:S0612_110
  Scenario: TC-11 C_BPartner_Product - Sync OFF - EAN13_ProductCode still clears all fields
    Given set sys config boolean value false for sys config M_Product.SyncEANAndGTIN
    And metasfresh contains M_Products:
      | Identifier | Name     |
      | p_tc11     | TC11Prod |
    ...
    And update C_BPartner_Product:
      | C_BPartner_Product_ID.Identifier | UPC           |
      | bpp_tc11                         | 4012345678903 |
    When update C_BPartner_Product:
      | C_BPartner_Product_ID.Identifier | EAN13_ProductCode |
      | bpp_tc11                         | 1234567890123     |
    Then C_BPartner_Product is verified:
      | C_BPartner_Product_ID.Identifier | GTIN | EAN_CU | UPC  | EAN13_ProductCode |
      | bpp_tc11                         | null | null   | null | 1234567890123     |
