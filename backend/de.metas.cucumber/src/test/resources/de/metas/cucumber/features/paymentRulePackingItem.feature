@from:cucumber
Feature: Validate that PaymentRule is correctly set on C_Order and C_InvoiceCandidate
  ...
  @from:cucumber
  Scenario: Payment rule 'Cash' correctly propagates to Invoice Candidate for packing items
