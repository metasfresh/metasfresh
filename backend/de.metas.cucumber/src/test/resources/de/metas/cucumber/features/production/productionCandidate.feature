...
Feature: Production dispo scenarios
  ...
  Scenario: Reactivate and reduce QTY for order with negative ATP. Ensure correct qty is used on new PP_Order_Candidate.
    When metasfresh contains M_PricingSystems
      | Identifier |
      | ps_1       |
    ...
    And metasfresh contains C_Orders:
      ...
      | o_1        | true    | customer      | 2024-09-20  | 2024-09-22T21:00:00Z | warehouseStd   |
    ...
    And after not more than 60s, the MD_Candidate table has only the following records
      ...
      | 01/d_1_1   | DEMAND            | SHIPMENT                  | p_1          | 2024-09-22T21:00:00Z | 200 | -200 | warehouseStd   |
    ...
    And metasfresh contains C_Orders:
      | Identifier | IsSOTrx | C_BPartner_ID | DateOrdered | PreparationDate      | M_Warehouse_ID |
      | o_2        | true    | customer      | 2024-09-20  | 2024-09-22T21:00:00Z | warehouseStd   |
    And metasfresh contains C_OrderLines:
      | Identifier | C_Order_ID | M_Product_ID | QtyEntered |
      | ol_2       | o_2        | p_1          | 50         |
    ...
    And after not more than 60s, PP_Order_Candidates are found
      ...
      | oc_1       | p_1          | bom_1             | ppln_1                 | 540006        | 250 PCE    | 250 PCE      | 0 PCE        | 2024-09-22T21:00:00Z | 2024-09-22T21:00:00Z | false        | false         |
    ...
    And after not more than 60s, the MD_Candidate table has only the following records
      ...
      | 01/d_1_1   | DEMAND            | SHIPMENT                  | p_1          | 2024-09-22T21:00:00Z | 200  | -200  | warehouseStd   |                       |
      | 02/d_1_2   | DEMAND            | SHIPMENT                  | p_1          | 2024-09-22T21:00:00Z | 50   | -250  | warehouseStd   |                       |
      | 03/s_1_1   | SUPPLY            | PRODUCTION                | p_1          | 2024-09-22T21:00:00Z | 250  | 0     | warehouseStd   | oc_1                  |
      | 04/d_2_1   | DEMAND            | PRODUCTION                | p_2          | 2024-09-22T21:00:00Z | 2500 | -2500 | warehouseStd   | oc_1                  |

    And the order identified by o_2 is reactivated

    Then after not more than 60s, PP_Order_Candidates are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | DatePromised         | DateStartSchedule    | OPT.IsClosed | OPT.Processed |
      | oc_1       | p_1          | bom_1             | ppln_1                 | 540006        | 200 PCE    | 200 PCE      | 0 PCE        | 2024-09-22T21:00:00Z | 2024-09-22T21:00:00Z | false        | false         |

    And after not more than 60s, the MD_Candidate table has only the following records
      | Identifier | MD_Candidate_Type | MD_Candidate_BusinessCase | M_Product_ID | DateProjected        | Qty  | ATP   | M_Warehouse_ID | PP_Order_Candidate_ID |
      | 01/d_1_1   | DEMAND            | SHIPMENT                  | p_1          | 2024-09-22T21:00:00Z | 200  | -200  | warehouseStd   |                       |
      | 02/d_1_2   | DEMAND            | SHIPMENT                  | p_1          | 2024-09-22T21:00:00Z | 0    | -200  | warehouseStd   |                       |
      | 03/s_1_1   | SUPPLY            | PRODUCTION                | p_1          | 2024-09-22T21:00:00Z | 200  | 0     | warehouseStd   | oc_1                  |
      | 04/d_2_1   | DEMAND            | PRODUCTION                | p_2          | 2024-09-22T21:00:00Z | 2000 | -2000 | warehouseStd   | oc_1                  |
    ...
    And after not more than 60s, PP_Order_Candidates are found
      | Identifier | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID | QtyEntered | QtyToProcess | QtyProcessed | DatePromised         | DateStartSchedule    | OPT.IsClosed | OPT.Processed |
      | oc_1       | p_1          | bom_1             | ppln_1                 | 540006        | 200 PCE    | 200 PCE      | 0 PCE        | 2024-09-22T21:00:00Z | 2024-09-22T21:00:00Z | false        | false         |
      | oc_2       | p_1          | bom_1             | ppln_1                 | 540006        | 30 PCE     | 30 PCE       | 0 PCE        | 2024-09-22T21:00:00Z | 2024-09-22T21:00:00Z | false        | false         |

    And after not more than 60s, the MD_Candidate table has only the following records
      | Identifier | MD_Candidate_Type | MD_Candidate_BusinessCase | M_Product_ID | DateProjected        | Qty  | ATP   | M_Warehouse_ID | PP_Order_Candidate_ID |
      | 01/d_1_1   | DEMAND            | SHIPMENT                  | p_1          | 2024-09-22T21:00:00Z | 200  | -200  | warehouseStd   |                       |
      | 02/d_1_2   | DEMAND            | SHIPMENT                  | p_1          | 2024-09-22T21:00:00Z | 30   | -230  | warehouseStd   |                       |
      | 03/s_1_1   | SUPPLY            | PRODUCTION                | p_1          | 2024-09-22T21:00:00Z | 200  | -30   | warehouseStd   | oc_1                  |
      | 04/d_2_1   | DEMAND            | PRODUCTION                | p_2          | 2024-09-22T21:00:00Z | 2000 | -2000 | warehouseStd   | oc_1                  |
      | 05/s_1_2   | SUPPLY            | PRODUCTION                | p_1          | 2024-09-22T21:00:00Z | 30   | 0     | warehouseStd   | oc_2                  |
      | 06/d_2_2   | DEMAND            | PRODUCTION                | p_2          | 2024-09-22T21:00:00Z | 300  | -2300 | warehouseStd   | oc_2                  |