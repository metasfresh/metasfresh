...
Feature: Trade margin commission contract
  ...
  Scenario: Margin commission combined having one sales rep and one customer
    ...
    And metasfresh contains M_ProductPrices
      ...
      | salesRep_cp_po_price      | salesRep_po_plv                   | commission_product      | 1.0      | Normal                        |
      | customer_product_so_price | customer_so_plv                   | transaction_product     | 25.0     | Normal                        |
      | salesRep_product_so_price | salesRep_so_plv                   | transaction_product     | 15.0     | Normal                        |
