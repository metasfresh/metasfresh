Feature: Modular contract log for sales invoice
  ...
  Background:
    ...
    And load AD_JavaClass:
      ...
      | class_4                    | type_1                          | de.metas.contracts.modular.impl.SalesInvoiceLineModularContractHandler  |

    And metasfresh contains ModCntr_Types:
      | ModCntr_Type_ID.Identifier | Name                | Value               | AD_JavaClass_ID.Identifier |
      | modCntr_type_PO            | modCntr_type_PO     | modCntr_type_PO     | class_1                    |
      | modCntr_type_SO            | modCntr_type_SO     | modCntr_type_SO     | class_2                    |
      | modCntr_type_SHIP          | modCntr_type_SHIP   | modCntr_type_SHIP   | class_3                    |
      | modCntr_type_INV_SO        | modCntr_type_INV_SO | modCntr_type_INV_SO | class_4                    |
