Feature: Modular contract log for sales invoice
  ...
  - validate that for each invoice line a modular contract log is created
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       | 80         |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       | 30         |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       | 80         |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       | 30         |
      | shipLog_1                 | shipLine_1           | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | M_InOutLine | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       | null                             | null            | null                      |            |
      | shipLog_2                 | shipLine_2           | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | M_InOutLine | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       | null                             | null            | null                      |            |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.DateTrx | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName     | C_Flatrate_Term_ID.Identifier | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 | OPT.Amount |
      | soLog_1                   | soLine_1             | ModularContract |             | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine   | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       | 80         |
      | soLog_2                   | soLine_2             | ModularContract |             | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine   | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       | modCntr_module_SO                | 10.00           | PCE                       | 30         |
      | shipLog_1                 | shipLine_1           | ModularContract |             | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | M_InOutLine   | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       | null                             | null            | null                      |            |
      | shipLog_2                 | shipLine_2           | ModularContract |             | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | M_InOutLine   | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       | null                             | null            | null                      |            |
      | ilLog_1                   | il_1                 | ModularContract | 2023-09-25  | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | 80         |
      | ilLog_2                   | il_2                 | ModularContract | 2023-09-25  | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | 30         |
  ...
  - reverse the invoice and validate that logs with negated qty are created
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | shipLog_1                 | shipLine_1           | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | M_InOutLine   | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       | null                             | null            | null                      |            |
      | shipLog_2                 | shipLine_2           | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | M_InOutLine   | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       | null                             | null            | null                      |            |
      | ilLog_1                   | il_1                 | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | 80         |
      | ilLog_2                   | il_2                 | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | 30         |
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | ilLog_1                   | il_1                 | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | 80         |
      | ilLog_2                   | il_2                 | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | 30         |
      | ilLog_3                   | il_1                 | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | -8  | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | -80        |
      | ilLog_4                   | il_2                 | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | -3  | C_InvoiceLine | moduleLogContract             | modCntr_type_INV_SO            | false         | SalesInvoice                 | year_2023                         | false       | modCntr_module_INV_SO            | 10.00           | PCE                       | -30        |
