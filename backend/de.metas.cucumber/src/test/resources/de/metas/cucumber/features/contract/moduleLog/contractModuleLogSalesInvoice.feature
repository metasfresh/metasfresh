Feature: Modular contract log for sales invoice
  ...
  - validate that for each invoice line a modular contract log is created
    ...
    And ModCntr_Logs are found:
      ...
      | soLog_1                   | soLine_1             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | C_OrderLine | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       |
      | soLog_2                   | soLine_2             | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | C_OrderLine | moduleLogContract             | modCntr_type_SO                | false         | SalesOrder                   | year_2023                         | false       |
      | shipLog_1                 | shipLine_1           | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 8   | M_InOutLine | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       |
      | shipLog_2                 | shipLine_2           | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod    | bp_moduleLogPO                      | bp_moduleLogPO                  | 3   | M_InOutLine | moduleLogContract             | modCntr_type_SHIP              | false         | Shipment                     | year_2023                         | false       |
  ...
  - generate invoice and validate no ModCntr_Logs for invoice lines
    ...
    Then no ModCntr_Logs are found:
