...
@F32000
  @topic:orderCandidate
  Scenario: PIIP ValidFrom date-awareness: when dateRequired is absent, dateOrdered is used; future packing instruction must not be selected
    Given set sys config boolean value true for sys config de.metas.ordercandidate.api.OLCandOrderFactory.UseQtyUOMOnManualPrice
    And metasfresh contains M_Products:
      | Identifier | Name                    | IsStocked |
      | p_S0469_30 | noPriceProduct_S0469_30 | true      |

    And metasfresh contains M_HU_PI:
      | M_HU_PI_ID.Identifier       | Name            |
      | huPackingTU_S0469_30        | huPackingTU     |
      | huPackingVirtualPI_S0469_30 | No Packing Item |
    And metasfresh contains M_HU_PI_Version:
      | M_HU_PI_Version_ID.Identifier | M_HU_PI_ID.Identifier       | Name             | HU_UnitType | IsCurrent |
      | packingVersionTU_S0469_30     | huPackingTU_S0469_30        | packingVersionTU | TU          | Y         |
      | packingVersionCU_S0469_30     | huPackingVirtualPI_S0469_30 | No Packing Item  | V           | Y         |
    And metasfresh contains M_HU_PI_Item:
      | M_HU_PI_Item_ID.Identifier | M_HU_PI_Version_ID.Identifier | Qty | ItemType |
      | huPiItemTU_S0469_30        | packingVersionTU_S0469_30     | 0   | MI       |
    And metasfresh contains M_HU_PI_Item_Product:
      | M_HU_PI_Item_Product_ID.Identifier | M_HU_PI_Item_ID.Identifier | M_Product_ID.Identifier | Qty | ValidFrom  | GTIN         |
      | huItemProduct_S0469_30_OLD         | huPiItemTU_S0469_30        | p_S0469_30              | 10  | 2020-01-01 | 223456789127 |
      | huItemProduct_S0469_30_FUTURE      | huPiItemTU_S0469_30        | p_S0469_30              | 6   | 2099-01-01 | 223456789127 |

    And load C_BPartner:
      | C_BPartner_ID.Identifier | OPT.C_BPartner_ID |
      | bpartner_1_S0469_30      | 2156425           |
    And load C_BPartner_Location:
      | C_BPartner_Location_ID.Identifier | C_BPartner_Location_ID | C_BPartner_ID.Identifier |
      | bpartnerLocation_1_S0469_30       | 2205175                | bpartner_1_S0469_30      |
...
{
    "orgCode": "001",
    "externalLineId": "externalLineId_S0469_30",
    "externalHeaderId": "externalHeaderId_S0469_30",
    "externalSystemCode": "Shopware6",
    "dataSource": "int-Shopware",
    "dataDest": "DEST.de.metas.invoicecandidate",
    "bpartner": {
        "bpartnerIdentifier": "2156425",
        "bpartnerLocationIdentifier": "2205175",
        "contactIdentifier": null
    ...
    "dateCandidate": "2021-04-15",
    "orderDocType": "SalesOrder",
    "productIdentifier": "gtin-223456789127",
    "qty": 10,
    "uomCode": "PCE",
    "poReference": "po_ref_S0469_30",
    "line": 1,
    "isManualPrice": true,
    "currencyCode": "EUR",
    "price": 10,
