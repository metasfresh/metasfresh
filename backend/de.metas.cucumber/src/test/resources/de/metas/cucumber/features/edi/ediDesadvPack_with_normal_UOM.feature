...
# ###############################################################################################################################################
  ...
  - Weight = 0.25 KGM
    ...
    Then after not more than 120s, EDI_Desadv_Pack records are found:
      | EDI_Desadv_Pack_ID | IsManual_IPA_SSCC18 | M_HU_ID              | M_HU_PackagingCode_ID        | GTIN_PackingMaterial   | SeqNo |
      | p_1_11212023_3     | true                | createdLU_11212023_3 | huPackagingCode_1_11212023_3 | bPartnerProductGTIN_LU | 1     |
      | p_1_11212023_4     | true                |                      |                              |                        | 2     |
...
# ###############################################################################################################################################
  ...
  """
    ...
    Then after not more than 30s, EDI_Desadv_Pack records are found:
      | EDI_Desadv_Pack_ID.Identifier | IsManual_IPA_SSCC18 | M_HU_ID             | M_HU_PackagingCode_ID       | GTIN_PackingMaterial   | SeqNo |
      | p_1_S0316_040                 | true                | null                | huPackagingCode_1_S0316_040 | gtinPiItemProduct      | 1     |
      | p_2_S0316_040                 | true                | createdLU_S0316_040 | huPackagingCode_1_S0316_040 | bPartnerProductGTIN_LU | 2     |
  ...
  - QtyPickList = 20
    ...
    And validate the created shipment lines
      ...
      | shipmentLine_2_S0457_010  | s_2_S0457_010         | p_2_S0457_010           | 10          | true      | ol_2_S0457_010                |

# This part whill work when i did the implementation  
#    Then after not more than 30s, EDI_Desadv_Pack records are found:
#      | EDI_Desadv_Pack_ID | IsManual_IPA_SSCC18 | M_HU_ID             | M_HU_PackagingCode_ID       | GTIN_PackingMaterial   | SeqNo |
...
#      | pi_2_S0457_010                     | p_1_S0457_010                 | 20              | 10              | 20              | 10                  | 2         | s_1_S0457_010             | shipmentLine_2_S0457_010      | 2021-04-20         | luLotNumber   | huPackagingCode_2_S0457_010             | bPartnerProductGTIN_TU      |
#
