...
Feature: invoice generation and invoice candidates aggregation
  ...
  Scenario: sales orders with multiple salesRep_IDs, one invoice with SalesRep_ID = NULL
    ...
    And metasfresh contains C_Orders:
      ...
      | o_1        | true    | endcustomer_1            | 2021-04-17  | po_ref_mock     | 1000012              | 1000010    |
      | o_2        | true    | endcustomer_1            | 2021-04-17  | po_ref_mock     | 1000012              | 1000010    |
  ...
  @from:cucumber
  Scenario: sales orders with same salesRep_ID, invoice had that SalesRep_ID
    Given metasfresh has date and time 2021-04-16T13:30:13+01:00[Europe/Berlin]
    And metasfresh contains M_Products:
      | Identifier | Name            |
      | p_1        | salesProduct_70 |
    ...
    And metasfresh contains C_Orders:
      ...
      | o_4        | true    | endcustomer_1            | 2021-04-17  | po_ref_mock     | 1000012              | 1000010    |
    And metasfresh contains C_OrderLines:
      | Identifier | C_Order_ID.Identifier | M_Product_ID.Identifier | QtyEntered |
      | ol_3       | o_3                   | p_1                     | 10         |
      | ol_4       | o_4                   | p_1                     | 10         |
