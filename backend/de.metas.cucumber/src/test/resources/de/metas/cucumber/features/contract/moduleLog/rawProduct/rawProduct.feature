Feature: Modular contract log from purchase order for raw product
  ...
  - Storage cost
    ...
    And metasfresh contains ModCntr_InvoicingGroup:
      ...
      | invGroup                             | invoicingGroup_06032024_1 | 2021-04-14 | 2022-02-25 | y2022                         | 40            | EUR                 |
    ...
    And metasfresh contains C_Orders:
      ...
      | po_order   | false   | bp_moduleLogPO           | 2022-03-03  | POO             | poModuleLogContract_ref_06292023_2 | warehouse_06032024_1          | y2022                             |
    ...
    And create material receipt
      ...
      | processedTopHU     | receiptSchedule_PO              | inOut_06032024_1      |
