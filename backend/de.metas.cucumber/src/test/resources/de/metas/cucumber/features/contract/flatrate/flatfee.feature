...
Feature: Flatfee contract with Flatfee-Type "Reported-Qty"
  ...
  Scenario: Flatfee contract with reported quantities
    ...
    And metasfresh contains C_UOMs:
      | Identifier          | X12DE355 | Name         | UOMSymbol | StdPrecision | CostingPrecision | OPT.UOMType |
      | flatfee_uom_S0433_1 | MEAL     | Meal_S0433_1 | M         | 2            | 2                | HC          |
  ...
  """
    ...
    And metasfresh contains C_BPartners:
      ...
      | customer_1_S0433_1 | customer_location_1_S0433_1           | customer_1_S0433_1 | ps_1_S0433_1                  | Y            | Y              | Y              | 1000009              |
    And metasfresh contains C_BPartner_Departments:
      | Identifier           | C_BPartner_ID.Identifier | Value | Name         |
      | department_1_S0433_1 | customer_1_S0433_1       | 1     | Department 1 |
      | department_2_S0433_1 | customer_1_S0433_1       | 2     | Department 2 |
    ...
    When metasfresh contains C_Flatrate_Terms:
      ...
      | flatFeeContract_1_S0433_1 | flatFeeConditions_1_S0433_1         | customer_1_S0433_1          | 2022-05-01 | 2023-04-31 | DR            | false         |
    And the C_Flatrate_Term identified by flatFeeContract_1_S0433_1 is completed

#    Then the C_Flatrate_Term identified by flatFeeContract_1_S0433_1 has C_Flatrate_DataEntries:
#    continue here!

    When metasfresh contains C_Orders:
      | Identifier  | IsSOTrx | C_BPartner_ID.Identifier | DateOrdered |
      | o_1_S0433_1 | true    | customer_1_S0433_1       | 2022-06-01  |
