...
Feature: Create or update using prices API
  ...
  Scenario: Create price list version from external ref
    Given metasfresh contains M_PricingSystems
      ...
      | ps_1       | pricing_system_name_15112022_3 | pricing_system_value_15112022_3 | pricing_system_description_15112022_3 | true     |
    And metasfresh contains M_PriceLists
      | Identifier | M_PricingSystem_ID.Identifier | OPT.C_Country.CountryCode | C_Currency.ISO_Code | Name                       | OPT.Description | SOTrx | IsTaxIncluded | PricePrecision | OPT.IsActive |
      | pl_1       | ps_1                          | DE                        | CHF                 | price_list_name_15112022_3 | null            | true  | false         | 2              | true         |
  ...
  Scenario: Update price list version
    Given metasfresh contains M_PricingSystems
      | Identifier | Name                           | Value                           | OPT.Description                       | IsActive |
      | ps_2       | pricing_system_name_15112022_4 | pricing_system_value_15112022_4 | pricing_system_description_15112022_4 | true     |
    And metasfresh contains M_PriceLists
      | Identifier | M_PricingSystem_ID.Identifier | OPT.C_Country.CountryCode | C_Currency.ISO_Code | Name                       | OPT.Description | SOTrx | IsTaxIncluded | PricePrecision | OPT.IsActive |
      | pl_1       | ps_2                          | DE                        | CHF                 | price_list_name_15112022_4 | null            | true  | false         | 2              | true         |
    When the user adds price list version data
      | Identifier  | OrgCode | M_PriceList_ID.Identifier | OPT.Description            | ValidFrom            | OPT.IsActive |
