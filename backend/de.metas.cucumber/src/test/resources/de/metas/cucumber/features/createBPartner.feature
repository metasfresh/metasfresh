Feature: create or update BPartner
  As a user
  ...
  Scenario: create BPartner request
    ...
    When the metasfresh REST-API endpoint path 'api/bpartner' receives a 'PUT' request with the payload from context and responds with '201' status code
