...
#      | C_DocType_Invoicing_Pool_ID.Identifier | Name            | Positive_Amt_C_DocType_ID.Identifier | Negative_Amt_C_DocType_ID.Identifier | IsSOTrx |
#      | ip_1                                   | test_12012023_1 | dt_si                                | dt_cm                                | true    |
#
...
#    And metasfresh contains C_DocType_Invoicing_Pool:
#      | C_DocType_Invoicing_Pool_ID.Identifier | Name            | Positive_Amt_C_DocType_ID.Identifier | Negative_Amt_C_DocType_ID.Identifier | IsSOTrx |
#      | ip_1                                   | test_12012023_2 | dt_si                                | dt_cm                                | true    |
#
#    And update C_DocType:
#      | C_DocType_ID.Identifier | OPT.C_DocType_Invoicing_Pool_ID.Identifier |
#      | dt_si                   | ip_1                                       |
...
#
  ...
  @from:cucumber
  @Id:S0242_200
  Scenario: 2 invoice candidates (both sales); same invoiceDocTypeId, invoicing pool setup active, credit memo < invoice => one invoice with 2 lines, DocType=SalesInvoice
    Given metasfresh contains M_Products:
      | Identifier | Value                 | Name                  |
      | product_SO | product_SO_12012023_2 | product_SO_12012023_2 |
    And metasfresh contains M_PricingSystems
    ...
    And validate created invoices
      | Invoice.Identifier | C_BPartner_ID.Identifier | C_BPartner_Location_ID.Identifier | poReference       | paymentTerm   | processed | docStatus | OPT.GrandTotal | OPT.C_DocType_ID.Identifier |
      | invoice_1          | customer_SO              | customerLocation_SO               | po_ref_12012023_2 | 30 Tage netto | true      | CO        | 4.76           | dt_cr                       |
