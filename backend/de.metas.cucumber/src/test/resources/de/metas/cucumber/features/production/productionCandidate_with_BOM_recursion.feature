...
Feature: Production dispo scenarios with BOMs whose components have their own BOMs in turn
  ...
  @Id:S0460_20
  @from:cucumber
  Scenario: Like S0460_10, but now PP_Product_Planning.IsCreatePlan=true and we exprect PP_Orders to be created and completed right away
    ...
    And metasfresh contains PP_Product_Plannings
      | Identifier        | M_Product_ID.Identifier | OPT.PP_Product_BOMVersions_ID.Identifier | OPT.IsCreatePlan | OPT.IsDocComplete | OPT.S_Resource_ID.Identifier | OPT.SeqNo |
      | ppln_1_1_S0460_10 | product_1_1_S0460_10    | bomVersions_1_S0460_10                   | true             | true              | resource_S0460               | 10        |
      | ppln_2_1_S0460_10 | product_2_1_S0460_10    | bomVersions_2_S0460_10                   | true             | true              | resource_S0460               | 10        |
