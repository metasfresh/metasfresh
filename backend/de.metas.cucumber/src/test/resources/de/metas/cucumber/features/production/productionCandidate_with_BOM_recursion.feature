...
##################################################
  ...
  Scenario: There is a BOM with two components. One of those components' product is the main-product of its own BOM. We expect manufacturing candidates to be created for all involved BOMs' main-products, then the sales order is re-opened and the ordered quantity is decreased, resulting in an update of the manufacturing candidates to reflect the decreased demand.
    ...
    Given metasfresh contains M_Products:
      | Identifier  | M_Product_Category_ID   | C_UOM_ID.X12DE355 |
      | product_1_1 | standard_category_S0460 | PCE               |
      | product_2_1 | standard_category_S0460 | PCE               |
      | product_2_2 | standard_category_S0460 | PCE               |
      | product_3_1 | standard_category_S0460 | PCE               |
    And metasfresh contains C_UOM_Conversions
      | M_Product_ID.Identifier | FROM_C_UOM_ID.X12DE355 | TO_C_UOM_ID.X12DE355 | MultiplyRate |
      | product_1_1             | PCE                    | KGM                  | 4            |
      | product_2_1             | PCE                    | KGM                  | 6            |
    ...
    And metasfresh contains M_ProductPrices
      | Identifier    | M_PriceList_Version_ID | M_Product_ID | PriceStd | C_UOM_ID | C_TaxCategory_ID |
      | pp_1_S0460_50 | plv_1_S0460_50         | product_1_1  | 10.0     | PCE      | Normal           |
    ...
    And metasfresh contains PP_Product_BOM
      | Identifier     | M_Product_ID.Identifier | ValidFrom  | PP_Product_BOMVersions_ID.Identifier |
      | bom_1_S0460_50 | product_1_1             | 2024-09-01 | bomVersions_1_S0460_50               |
      | bom_2_S0460_50 | product_2_1             | 2024-09-01 | bomVersions_2_S0460_50               |
    And metasfresh contains PP_Product_BOMLines
      | Identifier        | PP_Product_BOM_ID.Identifier | M_Product_ID.Identifier | ValidFrom  | QtyBatch | OPT.IsQtyPercentage | C_UOM_ID.X12DE355 |
      | boml_2_1_S0460_50 | bom_1_S0460_50               | product_2_1             | 2024-09-01 | 140      | true                | KGM               |
      | boml_2_2_S0460_50 | bom_1_S0460_50               | product_2_2             | 2024-09-01 | 2        | false               | PCE               |
      | boml_3_1_S0460_50 | bom_2_S0460_50               | product_3_1             | 2024-09-01 | 3        | false               | PCE               |
    ...
    And metasfresh contains PP_Product_Plannings
      | Identifier        | M_Product_ID.Identifier | OPT.PP_Product_BOMVersions_ID.Identifier | OPT.IsCreatePlan | OPT.IsDocComplete | OPT.S_Resource_ID.Identifier | OPT.SeqNo |
      | ppln_1_1_S0460_50 | product_1_1             | bomVersions_1_S0460_50                   | false            | true              | resource_S0460               | 20        |
      | ppln_2_1_S0460_50 | product_2_1             | bomVersions_2_S0460_50                   | false            | true              | resource_S0460               | 10        |
    ...
    And metasfresh contains C_OrderLines:
      | Identifier    | C_Order_ID   | M_Product_ID | QtyEntered |
      | ol_1_S0460_50 | o_1_S0460_50 | product_1_1  | 11         |
    ...
    And after not more than 60s, PP_Order_Candidates are found
      | Identifier    | M_Product_ID | PP_Product_BOM_ID | PP_Product_Planning_ID | S_Resource_ID  | QtyEntered | QtyToProcess | QtyProcessed | DatePromised         | DateStartSchedule    | OPT.IsClosed | OPT.Processed |
      | oc_1_S0460_50 | product_1_1  | bom_1_S0460_50    | ppln_1_1_S0460_50      | resource_S0460 | 11 PCE     | 11 PCE       | 0 PCE        | 2024-09-22T21:00:00Z | 2024-09-22T21:00:00Z | false        | false         |
      | oc_2_S0460_50 | product_2_1  | bom_2_S0460_50    | ppln_2_1_S0460_50      | resource_S0460 | 11 PCE     | 11 PCE       | 0 PCE        | 2024-09-22T21:00:00Z | 2024-09-22T21:00:00Z | false        | false         |
    ...
    And after not more than 60s, PP_OrderLine_Candidates are found
      ...
      | oc_1_1_S0460_50 | oc_1_S0460_50         | product_2_1  | 61.6 KGM   | CO            | boml_2_1_S0460_50     |
      | oc_1_2_S0460_50 | oc_1_S0460_50         | product_2_2  | 22 PCE     | CO            | boml_2_2_S0460_50     |
      | oc_2_1_S0460_50 | oc_2_S0460_50         | product_3_1  | 33 PCE     | CO            | boml_3_1_S0460_50     |
    ...
    And after not more than 60s, PP_OrderLine_Candidates are found
      | PP_Order_Candidate_ID | M_Product_ID | QtyEntered | ComponentType | PP_Product_BOMLine_ID |
      | oc_1_1_S0460_50       | product_2_1  | 39.2 KGM   | CO            | boml_2_1_S0460_50     |
      | oc_1_2_S0460_50       | product_2_2  | 14 PCE     | CO            | boml_2_2_S0460_50     |
      | oc_2_S0460_50         | product_3_1  | 21 PCE     | CO            | boml_3_1_S0460_50     |
