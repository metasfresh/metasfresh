Feature: Modular contract log from shipment
  ...
  -> modular contract log is created for each shipment line
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      ...
      | shipLog_1_S0321           | s_l_1_S0321          | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0321| bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_InOutLine | moduleLogContract_SO_S0321    | modCntr_type_SO_SHIP_S0321     | false         | Shipment                     | year_2023                         | true        | modCntr_module_SO_SHIP_S0321     | null            | null                      |
  ...
  -> a modular contract log should be added for each suitable shipment line, with the negated qty
    ...
    Then after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier       | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier  | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 |
      | shipLog_1_S0321_200       | s_l_1_S0321_200      | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0321_200| bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_InOutLine | moduleLogContract_SO_S0321_200 | modCntr_type_SO_SHIP_S0321     | false         | Shipment                     | year_2023                         | true        | modCntr_module_SO_SHIP_S0321_200 | null            | null                      |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier        | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier  | OPT.ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.Harvesting_Year_ID.Identifier | OPT.IsSOTrx |
      | shipLog_1_S0321_200       | s_l_1_S0321_200      | ModularContract | bp_moduleLogPO                             | warehouseModularContract      | modularContract_prod_S0321_200 | bp_moduleLogSO                      | bp_moduleLogSO                  | 8   | M_InOutLine | moduleLogContract_SO_S0321_200 | modCntr_type_SO_SHIP_S0321     | false         | Shipment                     | year_2023                         | true        |
