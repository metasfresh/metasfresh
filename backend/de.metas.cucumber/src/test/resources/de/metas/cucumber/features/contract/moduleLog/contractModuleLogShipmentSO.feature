Feature: Modular contract log from shipment
  ...
  Background:
    ...
    And load AD_JavaClass:
      ...
      | class_6                    | type_1                          | de.metas.contracts.modular.impl.ShipmentLineForPOModularContractHandler |
      | class_7                    | type_1                          | de.metas.contracts.modular.impl.ShipmentLineForSOModularContractHandler |

    And metasfresh contains ModCntr_Types:
      | ModCntr_Type_ID.Identifier   | Name                         | Value                        | AD_JavaClass_ID.Identifier |
      | modCntr_type_PO_S0321        | modCntr_type_PO_S0321        | modCntr_type_PO_S0321        | class_1                    |
      | modCntr_type_SO_for_PO_S0321 | modCntr_type_SO_for_PO_S0321 | modCntr_type_SO_for_PO_S0321 | class_2                    |
      | modCntr_type_SO_S0321        | modCntr_type_SO_S0321        | modCntr_type_SO_S0321        | class_3                    |
      | modCntr_type_MC_SO_S0321     | modCntr_type_MC_SO_S0321     | modCntr_type_MC_SO_S0321     | class_4                    |
      | modCntr_type_MC_PO_S0321     | modCntr_type_MC_PO_S0321     | modCntr_type_MC_PO_S0321     | class_5                    |
      | modCntr_type_PO_SHIP_S0321   | modCntr_type_PO_SHIP_S0303   | modCntr_type_PO_SHIP_S0303   | class_6                    |
      | modCntr_type_SO_SHIP_S0321   | modCntr_type_SO_SHIP_S0303   | modCntr_type_SO_SHIP_S0303   | class_7                    |
