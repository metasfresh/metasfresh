...
## F00355: Shipper
  ...
  Scenario: nShift Delivery Order Creation and Request Content Validation
    ...
    And validate the captured nShift advisor request:
      ...
      | metasfresh AG     | DE                | nShift Customer     | nShift Logistics Dept. | street         | Floor 2                       | 1               | 12345       | city         | CH                  | Attention Test    | nShift Customer Contact | +41791234567         | contact@nshift-test.example | 10        | 100        | 10              | 12345678      | 21              |
