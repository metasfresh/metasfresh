...
Feature: create purchase simulation
  ...
  Scenario: create purchase simulation, delete order line and validate there is no purchase candidate for deleted line
    ...
    And metasfresh contains M_PriceList_Versions
      ...
      | plv_1      | pl_1                      | priceListVersion_1 | 2022-07-01 |
      | plv_2      | pl_2                      | priceListVersion_2 | 2022-07-01 |
    ...
    And metasfresh contains M_DiscountSchema
      ...
      | discountSchema_1               | DiscountSchemaName | Q              | P            | 2022-07-01 |
    ...
    And metasfresh contains C_Orders:
      ...
      | o_1        | true    | customer_1               | 2022-07-04  | 2022-07-04T00:00:00Z |
    ...
    Then after not more than 30s, the MD_Candidate table has only the following records
      ...
      | c_1        | DEMAND            | SHIPMENT                      | p_1                     | 2022-07-04T00:00:00Z | -100 | -100                   | true          |
      | c_2        | SUPPLY            | PURCHASE                      | p_1                     | 2022-07-04T00:00:00Z | 100  | 0                      | true          |
    And delete C_OrderLine identified by ol_1
    And validate no C_PurchaseCandidate found for orderLine ol_1
