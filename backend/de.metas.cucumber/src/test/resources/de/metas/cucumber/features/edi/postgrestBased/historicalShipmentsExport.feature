...
Feature: Shipments export via postgREST
  ...
  Scenario: create a shipment and export it to JSON via UpdatedGE and InputDataSource
    ...
    And metasfresh contains C_Orders:
      ...
      | o_1        | true    | customer1     | 2025-04-17  | 2025-04-18Z  | dataSource_S0474_011  | externalId_S0474_011 |
    And metasfresh contains C_OrderLines:
      | Identifier | C_Order_ID.Identifier | M_Product_ID      | QtyEntered | ExternalId               |
      | ol_1       | o_1                   | product_S0475_010 | 100        | externalLineId_S0474_011 |
...
[
  {
    ...
    "DocStatus": "CO",
    "ExternalId": "externalId_S0474_011",
    ...
    "Lines": [
      {
        "UOM": "Stk",
        "LineNo": 10,
        "ExternalId": "externalLineId_S0474_011",
