...
Feature: Delivery planning processes interaction
  ...
  Scenario: Create additional delivery plannings
    ...
    And validate M_Delivery_Planning:
      ...
      | deliveryPlanningAdd_1  | 5          | 5            | Outgoing           | 3                     | 3                        | 0             | 0                       | orderAdd   | orderLineAdd   | customer      | product      | customerLocation       | shipper_DHL  | 2023-02-25 | deliveryInstructionAdd     |
      | deliveryPlanningAdd_2  | 5          | 5            | Outgoing           | 1                     | 1                        | 0             | 0                       | orderAdd   | orderLineAdd   | customer      | product      | customerLocation       | shipper_DHL  | 2023-02-25 | null                       |
      | deliveryPlanningAdd_3  | 5          | 5            | Outgoing           | 1                     | 1                        | 0             | 0                       | orderAdd   | orderLineAdd   | customer      | product      | customerLocation       | shipper_DHL  | 2023-02-25 | null                       |
