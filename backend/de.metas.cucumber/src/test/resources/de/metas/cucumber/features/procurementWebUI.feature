...
@allure.label.feature:F00640
  Scenario: metasfresh provides bpartner data to the procurement-WebUI
    ...
    And metasfresh contains AD_Users:
      | Identifier | OPT.C_BPartner_ID.Identifier | Name         | OPT.EMail     | OPT.Password | OPT.AD_Language | OPT.IsMFProcurementUser | OPT.ProcurementPassword |
