Feature: Modular contract log from sales order for processed product
  ...
  - Storage cost
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | log_av                    | moduleLogContract_1  | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | rawProduct              | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | C_Flatrate_Term | moduleLogContract_1           | avInterim_type             | false         | PurchaseModularContract      | EUR                        | PCE                   | 7500       | y2022                             | PO_avOnInterim_module            | 7.5             | PCE                       | addValueOnInterim_03102024_1 | Y              | N           |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty  | TableName   | C_Flatrate_Term_ID.Identifier | ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.C_Currency_ID.ISO_Code | OPT.C_UOM_ID.X12DE355 | OPT.Amount | OPT.Harvesting_Year_ID.Identifier | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 | OPT.ProductName    | OPT.IsBillable | OPT.IsSOTrx |
      | log_receipt_1             | receiptLine_1        | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | rawProduct              | bp_moduleLogPO                      | bp_moduleLogPO                  | 1000 | M_InOutLine | moduleLogContract_1           | receipt_type               | false         | MaterialReceipt              | EUR                        | PCE                   | 0          | y2022                             | PO_receipt_module                | 0.00            | PCE                       | receipt_03102024_1 | Y              | N           |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | pp_log_1                  | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | addValueOnProcessed_PO_2 | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | avOnPP_type                | false         | Production                   | EUR                        | PCE                   | -6000      | y2022                             | PO_avOnProcessedProduct_module_2  | -6.00           | PCE                       | addValueOnProcessedProduct_03102024_2 | Y              | N           |
      | pp_log_2                  | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | addValueOnProcessed_PO   | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | avOnPP_type                | false         | Production                   | EUR                        | PCE                   | 8000       | y2022                             | PO_avOnProcessedProduct_module_1  | 8.00            | PCE                       | addValueOnProcessedProduct_03102024_1 | Y              | N           |
      | pp_log_3                  | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | processedProduct         | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | def_inv_type               | false         | Production                   | EUR                        | PCE                   | 20000      | y2022                             | PO_definitive_module              | 20.00           | PCE                       | salesOnProcessedProduct_03102024_1    | Y              | N           |
      | pp_log_4                  | ppo_1                | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | processedProduct         | bp_moduleLogPO                  | 1000 | PP_Order  | moduleLogContract_1           | PO_sales_type              | false         | Production                   | EUR                        | PCE                   | 20000      | y2022                             | PO_salesOnProcessedProduct_module | 20.00           | PCE                       | salesOnProcessedProduct_03102024_1    | Y              | N           |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier   | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty  | TableName       | C_Flatrate_Term_ID.Identifier | ModCntr_Type_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.C_Currency_ID.ISO_Code | OPT.C_UOM_ID.X12DE355 | OPT.Amount | OPT.Harvesting_Year_ID.Identifier | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 | OPT.ProductName        | OPT.IsBillable | OPT.IsSOTrx |
      | log_soLine_1              | soLine_1               | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | processedProduct        | bp_moduleLogSO                      | bp_moduleLogSO                  | 1000 | C_OrderLine     | moduleLogContract_SO_1        | sales_info_logs_type       | false         | SalesOrder                   | EUR                        | PCE                   | 20000      | y2022                             | SO_informative_module            | 20.00           | PCE                       | informative_03102024_1 | N              | Y           |
      | log_salesModContract_1    | moduleLogContract_SO_1 | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | processedProduct        | bp_moduleLogSO                      | bp_moduleLogSO                  | 1000 | C_Flatrate_Term | moduleLogContract_SO_1        | sales_info_logs_type       | false         | SalesModularContract         | EUR                        | PCE                   | 20000      | y2022                             | SO_informative_module            | 20.00           | PCE                       | informative_03102024_1 | N              | Y           |
    ...
    And after not more than 30s, ModCntr_Logs are found:
      | ModCntr_Log_ID.Identifier | Record_ID.Identifier | ContractType    | OPT.CollectionPoint_BPartner_ID.Identifier | OPT.M_Warehouse_ID.Identifier | M_Product_ID.Identifier        | OPT.Producer_BPartner_ID.Identifier | OPT.Bill_BPartner_ID.Identifier | Qty | TableName   | C_Flatrate_Term_ID.Identifier | ModCntr_Type_ID.Identifier | ModCntr_BaseModule_ID.Identifier | OPT.Processed | OPT.ModCntr_Log_DocumentType | OPT.C_Currency_ID.ISO_Code | OPT.C_UOM_ID.X12DE355 | OPT.Amount      | OPT.Harvesting_Year_ID.Identifier | OPT.ModCntr_Module_ID.Identifier | OPT.PriceActual | OPT.Price_UOM_ID.X12DE355 | OPT.StorageDays | OPT.InterestDays | OPT.ProductName                    | OPT.IsBillable | OPT.IsSOTrx |
      ...
      | log_inout_1_2             | so_ioline_1          | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | storageCostForProcessedProduct | bp_moduleLogPO                      | bp_moduleLogPO                  | 750 | M_InOutLine | moduleLogContract_1           | storageCost_type           |                                  | false         | Shipment                     | EUR                        | PCE                   | -4185           | y2022                             | PO_storageCost_module            | -0.06           | PCE                       | 93              |                  | storageCost_03102024_1             | Y              | N           |
      ...
      | log_inout_1_4             | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | storageCostForProcessedProduct | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesStorageCost_type      |                                  | false         | Shipment                     | EUR                        | PCE                   | 3000            | y2022                             | SO_storageCost_module            | 0.1             | PCE                       | 40              |                  | salesStorageCost_03102024_1        | Y              | Y           |
      ...
      | log_inout_1_8             | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_sales_module                  | false         | Shipment                     | EUR                        | PCE                   | 72.916666666667 | y2022                             | SO_interest_module               | 15000           | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_1_9             | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_HL_module                     | false         | Shipment                     | EUR                        | PCE                   | 0.911458333333  | y2022                             | SO_interest_module               | 187.5           | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_1_10            | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_protein_module                | false         | Shipment                     | EUR                        | PCE                   | -0.364583333333 | y2022                             | SO_interest_module               | -75             | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      ...
      | log_inout_2_2             | so_ioline_2          | ModularContract | bp_moduleLogPO                             | warehouse_03102024_1          | storageCostForProcessedProduct | bp_moduleLogPO                      | bp_moduleLogPO                  | 250 | M_InOutLine | moduleLogContract_1           | storageCost_type           |                                  | false         | Shipment                     | EUR                        | PCE                   | -1395           | y2022                             | PO_storageCost_module            | -0.06           | PCE                       | 93              |                  | storageCost_03102024_1             | Y              | N           |
      ...
      | log_inout_2_4             | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | storageCostForProcessedProduct | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesStorageCost_type      |                                  | false         | Shipment                     | EUR                        | PCE                   | 1000            | y2022                             | SO_storageCost_module            | 0.1             | PCE                       | 40              |                  | salesStorageCost_03102024_1        | Y              | Y           |
      ...
      | log_inout_2_8             | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_sales_module                  | false         | Shipment                     | EUR                        | PCE                   | 24.305555555556 | y2022                             | SO_interest_module               | 5000            | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_2_9             | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_HL_module                     | false         | Shipment                     | EUR                        | PCE                   | 0.303819444444  | y2022                             | SO_interest_module               | 62.5            | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_2_10            | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_protein_module                | false         | Shipment                     | EUR                        | PCE                   | 0.243055555556  | y2022                             | SO_interest_module               | 50              | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_2_11            | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_salesAV_module                | false         | Shipment                     | EUR                        | PCE                   | 0.243055555556  | y2022                             | SO_interest_module               | 50              | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
