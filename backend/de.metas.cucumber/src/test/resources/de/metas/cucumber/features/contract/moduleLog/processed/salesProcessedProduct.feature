Feature: Modular contract log from sales order for processed product
  ...
  - Storage cost
    ...
    And after not more than 30s, ModCntr_Logs are found:
      ...
      | log_inout_1_8             | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_sales_module                  | false         | Shipment                     | EUR                        | PCE                   | 72.91666667   | y2022                             | SO_interest_module               | 15000           | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_1_9             | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_HL_module                     | false         | Shipment                     | EUR                        | PCE                   | 0.9114583333  | y2022                             | SO_interest_module               | 187.5           | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_1_10            | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_protein_module                | false         | Shipment                     | EUR                        | PCE                   | -0.3645833333 | y2022                             | SO_interest_module               | -75             | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_1_11            | so_ioline_1          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 750 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_salesAV_module                | false         | Shipment                     | EUR                        | PCE                   | 0.7291666667  | y2022                             | SO_interest_module               | 150             | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      ...
      | log_inout_2_8             | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_sales_module                  | false         | Shipment                     | EUR                        | PCE                   | 24.30555556   | y2022                             | SO_interest_module               | 5000            | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_2_9             | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_HL_module                     | false         | Shipment                     | EUR                        | PCE                   | 0.3038194444  | y2022                             | SO_interest_module               | 62.5            | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_2_10            | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_protein_module                | false         | Shipment                     | EUR                        | PCE                   | 0.2430555556  | y2022                             | SO_interest_module               | 50              | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
      | log_inout_2_11            | so_ioline_2          | ModularContract | bp_moduleLogSO                             | warehouse_03102024_1          | salesInterest                  | bp_moduleLogSO                      | bp_moduleLogSO                  | 250 | M_InOutLine | moduleLogContract_SO_1        | salesInterest_type         | SO_salesAV_module                | false         | Shipment                     | EUR                        | PCE                   | 0.2430555556  | y2022                             | SO_interest_module               | 50              | PCE                       |                 | 35               | salesInterest_03102024_1           | Y              | Y           |
    ...
    And validate C_Invoice_Candidate:
      ...
      | candidate_salesInterest           | 0            | 1              | 1                | I               | 74.98           | 0                   | 74.98              | Y             |

    And after not more than 60s, C_Invoice are found:
      | C_Invoice_Candidate_ID.Identifier | C_Invoice_ID.Identifier | OPT.TotalLines |
      | candidate_sales                   | final_SO_Inv            | 24494.98       |
    ...
    And validate created invoices
      ...
      | final_SO_Inv            | bp_moduleLogSO           | bp_moduleLogSO_Location           | 1000002     | true      | CO        | 29149,03       | finalSO                     |
    ...
    And after not more than 30s, ModCntr_Logs are marked as invoiced:
      ...
      | log_sv                    | candidate_subValueOnInterim            |
