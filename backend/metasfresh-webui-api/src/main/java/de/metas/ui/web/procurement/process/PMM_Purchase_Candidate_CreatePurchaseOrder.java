...

{
	...
	{
		final SqlViewRowsWhereClause sqlWhereClause = getView().getSqlWhereClause(DocumentIdsSelection.ALL, SqlOptions.usingTableName(I_PMM_PurchaseCandidate.Table_Name));
