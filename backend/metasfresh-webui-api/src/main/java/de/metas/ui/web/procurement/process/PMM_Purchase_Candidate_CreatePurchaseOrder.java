...

{
	...
	protected String doIt() throws Exception
	{
		...
		final ICompositeQueryFilter<I_PMM_PurchaseCandidate> pmmPurchaseCandidateICompositeQueryFilter = queryBL.createCompositeQueryFilter(I_PMM_PurchaseCandidate.class)
		...
		recordsEnqueued = PMM_GenerateOrders.prepareEnqueuing()
				.filter(pmmPurchaseCandidateICompositeQueryFilter)
				.enqueue();
		return MSG_OK;
	}
