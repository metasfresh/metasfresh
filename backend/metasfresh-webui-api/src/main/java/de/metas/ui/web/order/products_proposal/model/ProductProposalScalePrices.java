...
@EqualsAndHashCode
@ToString
public class ProductProposalScalePrices
{

	private final Optional <Map<BigDecimal, BigDecimal>> scalePrices;	
	
	@NonNull
	private final Amount amount;
	private final boolean applyOnlyIfLessThanStandardPrice;

	public Amount applyOn(@NonNull final Amount standardPrice, @NonNull final BigDecimal qty)
	{
