package de.metas.vertical.pharma.msv3.protocol.util.v2;
...
public class MiscJAXBConvertersV2
{
	private final ObjectFactory jaxbObjectFactory;

	public MiscJAXBConvertersV2(@NonNull final ObjectFactory jaxbObjectFactory)
	{
