...
-- 2021-07-15T07:31:26.705Z
-- URL zum Konzept
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,575062,650315,0,543016,TO_TIMESTAMP('2021-07-15 10:31:26','YYYY-MM-DD HH24:MI:SS'),100,10,'EE01','Y','N','N','N','N','N','N','N','Dienstleistungsaufwand',TO_TIMESTAMP('2021-07-15 10:31:26','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2021-07-15T07:31:26.744Z
-- URL zum Konzept
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y') AND t.AD_Field_ID=650315 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2021-07-15T07:31:26.783Z
-- URL zum Konzept
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(579498) 
;

-- 2021-07-15T07:31:26.830Z
-- URL zum Konzept
DELETE FROM AD_Element_Link WHERE AD_Field_ID=650315
;

-- 2021-07-15T07:31:26.867Z
-- URL zum Konzept
/* DDL */ select AD_Element_Link_Create_Missing_Field(650315)
;

-- 2021-07-15T07:33:16.019Z
-- URL zum Konzept
UPDATE AD_Field SET DisplayLogic='@DocBaseType/X@=MRO', IsDisplayed='Y',Updated=TO_TIMESTAMP('2021-07-15 10:33:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=650315
;

-- 2021-07-15T07:34:11.056Z
-- URL zum Konzept
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,650315,0,543016,546201,587084,'F',TO_TIMESTAMP('2021-07-15 10:34:10','YYYY-MM-DD HH24:MI:SS'),100,'Y','N','Y','N','N','Dienstleistungsaufwand',20,0,0,TO_TIMESTAMP('2021-07-15 10:34:10','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 2021-07-15T07:34:32.240Z
-- URL zum Konzept
UPDATE AD_UI_Element SET SeqNo=20,Updated=TO_TIMESTAMP('2021-07-15 10:34:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_UI_Element_ID=587079
;

-- 2021-07-15T07:34:37.416Z
-- URL zum Konzept
UPDATE AD_UI_Element SET SeqNo=10,Updated=TO_TIMESTAMP('2021-07-15 10:34:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_UI_Element_ID=587084
;
