-- nShift: add M_Shipper_Mapping_Config rows for IncotermsValue, ExternalSystemValue, IsPreAdviceRequired
-- These enable passing Incoterms, external system value and pre-advice flag as custom references
-- in the nShift advise request for the default nShift shipper (M_Shipper_ID=540019).
--
