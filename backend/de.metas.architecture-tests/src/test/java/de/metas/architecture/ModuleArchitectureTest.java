 ...
 * {@link MetasfreshArchRules#checkAllModuleRules(JavaClasses)}; this class only imports a module's classes and
 * calls it. Adding a new rule changes only {@code MetasfreshArchRules}, never this class. Covering another
 * module = import its classes and add one more {@code @Test} that calls {@code checkAllModuleRules}.
 * <p>
...
public class ModuleArchitectureTest
{
	...
	{
		MetasfreshArchRules.checkAllModuleRules(businessClasses);
	}
}
