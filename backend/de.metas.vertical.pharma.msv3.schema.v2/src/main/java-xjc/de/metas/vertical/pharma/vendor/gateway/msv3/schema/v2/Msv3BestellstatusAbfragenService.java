 ...
 * 
 */
@WebServiceClient(name = "Msv3BestellstatusAbfragenService", targetNamespace = "urn:msv3:v2", wsdlLocation = "file:/C:/work/new_dawn_uat_java21/metasfresh/backend/de.metas.vertical.pharma.msv3.schema.v2/src/main/resources/de/metas/vertical/pharma/vendor/gateway/msv3/schema/v2/Msv3BestellstatusAbfragenService.wsdl")
    ...
    extends Service
{
    ...
    private static final QName MSV3BESTELLSTATUSABFRAGENSERVICE_QNAME = new QName("urn:msv3:v2", "Msv3BestellstatusAbfragenService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/work/new_dawn_uat_java21/metasfresh/backend/de.metas.vertical.pharma.msv3.schema.v2/src/main/resources/de/metas/vertical/pharma/vendor/gateway/msv3/schema/v2/Msv3BestellstatusAbfragenService.wsdl");
    ...
    public Msv3BestellstatusAbfragen getMsv3BestellstatusAbfragenPort() {
        return super.getPort(new QName("urn:msv3:v2", "Msv3BestellstatusAbfragenPort"), Msv3BestellstatusAbfragen.class);
    }
    ...
    public Msv3BestellstatusAbfragen getMsv3BestellstatusAbfragenPort(WebServiceFeature... features) {
        return super.getPort(new QName("urn:msv3:v2", "Msv3BestellstatusAbfragenPort"), Msv3BestellstatusAbfragen.class, features);
    }
