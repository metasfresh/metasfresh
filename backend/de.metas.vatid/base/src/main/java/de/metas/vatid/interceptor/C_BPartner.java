...
public class C_BPartner
{
	 ...
	 * <em>method</em> was invoked — not that it <em>validated</em> anything: the SysConfig above can make it
	 * a no-op, and inter-class interceptor ordering is not guaranteed, so another interceptor's
