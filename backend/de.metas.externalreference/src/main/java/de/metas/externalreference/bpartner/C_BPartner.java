...
public class C_BPartner
{
	...
	public void deleteLinkedExternalReferences(@NonNull final I_C_BPartner record)
	{
		...
		externalReferenceRepository.deleteByRecordIdAndType(record.getC_BPartner_ID(), BPartnerValueExternalReferenceType.BPARTNER_VALUE);
	}
	...
	public void updateLinkedExternalReferencesOrgId(@NonNull final I_C_BPartner record)
	{
		...
		externalReferenceRepository.updateOrgIdByRecordIdAndType(record.getC_BPartner_ID(), BPartnerValueExternalReferenceType.BPARTNER_VALUE, OrgId.ofRepoId(record.getAD_Org_ID()));
