 ...
 *         &lt;element name="ValidationState" type="{http://dhl.de/webservices/businesscustomershipping/3.0}ValidationState" maxOccurs="30" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ValidateShipmentResponse")
public class ValidateShipmentResponse {
    ...
    @XmlElement(name = "ValidationState")
    protected List<ValidationState> validationState;
    ...
    /**
     * Gets the value of the validationState property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the validationState property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getValidationState().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ValidationState> getValidationState() {
        if (validationState == null) {
            validationState = new ArrayList<ValidationState>();
        }
