 ...
 *         &lt;element name="DeletionState" type="{http://dhl.de/webservices/businesscustomershipping/3.0}DeletionState" maxOccurs="30" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "DeleteShipmentOrderResponse")
public class DeleteShipmentOrderResponse {
    ...
    protected List<DeletionState> deletionState;
     ...
     * This is why there is not a <CODE>set</CODE> method for the deletionState property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDeletionState().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DeletionState> getDeletionState() {
        if (deletionState == null) {
            deletionState = new ArrayList<DeletionState>();
        }
