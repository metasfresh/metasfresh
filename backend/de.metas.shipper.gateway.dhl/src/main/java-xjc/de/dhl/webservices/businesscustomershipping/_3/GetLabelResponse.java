 ...
 *         &lt;element name="LabelData" type="{http://dhl.de/webservices/businesscustomershipping/3.0}LabelData" maxOccurs="30" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetLabelResponse {
    ...
    protected List<LabelData> labelData;
     ...
     * This is why there is not a <CODE>set</CODE> method for the labelData property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLabelData().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<LabelData> getLabelData() {
        if (labelData == null) {
            labelData = new ArrayList<LabelData>();
        }
