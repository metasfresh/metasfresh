...
@XmlRootElement(name = "DoManifestRequest")
public class DoManifestRequest {
     ...
     * 							from ShipmentNumberType->shipmentNumber Gets the value of the shipmentNumber property.
     * 
     * <p>
