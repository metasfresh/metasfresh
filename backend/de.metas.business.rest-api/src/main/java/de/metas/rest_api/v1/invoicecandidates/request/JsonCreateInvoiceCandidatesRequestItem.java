...
package de.metas.rest_api.v1.invoicecandidates.request;
...
public class JsonCreateInvoiceCandidatesRequestItem
{
	...
	@ApiModelProperty(value = "Specifies the value of the payment term that will propagate to the created order", required = true)
	String paymentTerm;
