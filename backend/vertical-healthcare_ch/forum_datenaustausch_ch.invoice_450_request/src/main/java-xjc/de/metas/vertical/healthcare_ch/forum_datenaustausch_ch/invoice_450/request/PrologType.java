...
@XmlType(name = "prologType", namespace = "http://www.forum-datenaustausch.ch/invoice", propOrder = {
    "_package",
    "generator"
})
public class PrologType {

    @XmlElement(name = "package", namespace = "http://www.forum-datenaustausch.ch/invoice")
