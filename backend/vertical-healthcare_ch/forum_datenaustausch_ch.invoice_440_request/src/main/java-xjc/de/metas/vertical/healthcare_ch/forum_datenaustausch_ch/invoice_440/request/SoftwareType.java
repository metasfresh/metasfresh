...
@XmlType(name = "softwareType", namespace = "http://www.forum-datenaustausch.ch/invoice", propOrder = {
    "dependsOn"
})
public class SoftwareType {

    @XmlElement(name = "depends_on", namespace = "http://www.forum-datenaustausch.ch/invoice")
