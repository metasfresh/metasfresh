...
package de.metas.postfinance.document.results.model;
...
public record XmlProcessProtocol(
	...
	@JacksonXmlProperty(localName = "ReasonCode") String reasonCode,

	@JacksonXmlProperty(localName = "ReasonText") String reasonText
	)
{
