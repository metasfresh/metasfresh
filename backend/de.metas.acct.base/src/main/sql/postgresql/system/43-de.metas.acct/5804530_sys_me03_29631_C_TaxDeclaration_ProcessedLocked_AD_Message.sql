...
-- Value: TaxDeclaration_ProcessedLocked
-- 2026-05-26T00:00:00Z
UPDATE AD_Message_Trl SET MsgText='Tax Declaration is locked (Processed=Y). Only IsCorrectionNeeded and CorrectionNeededReason can be modified.',Updated=TIMESTAMP '2026-05-26 00:00:00',UpdatedBy=100 WHERE AD_Language='en_US' AND AD_Message_ID=545718
;
