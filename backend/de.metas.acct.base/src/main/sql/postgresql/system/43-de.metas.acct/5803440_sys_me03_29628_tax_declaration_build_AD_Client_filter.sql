...
-- Tax Declaration: tighten Fact_Acct snapshot filter to the header's AD_Client_ID,
-- pre-load C_Currency_ID from the AcctSchema (replaces the awkward CROSS JOIN in
-- Phase 3a), and document AD_Org_ID as an explicit open question (not filtered).
