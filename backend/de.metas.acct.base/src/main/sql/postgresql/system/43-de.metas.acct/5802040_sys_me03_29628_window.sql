...
VALUES (0, 0, 542146 /*From ID Server - pre-fetched*/, 2862 /*C_TaxDeclaration_ID*/, NOW(), 100, 'de.metas.acct',
    'Y', 'N', 'N', 'N', 'Tax Declaration', NOW(), 100, 'M');
...
VALUES (0, 0, 549256 /*From ID Server - pre-fetched*/, 818, 542146,
    ...
    NOW(), 100, 'de.metas.acct', 'N', 'Y', 'N',
    'N', 'N', 'Y', 'N', 'N',
    'Tax Declaration', NULL, 10, 0, NOW(), 100);
...
VALUES (0, 0, 549258 /*From ID Server - pre-fetched*/, 820, 542146,
    ...
    NOW(), 100, 'de.metas.acct', 'N', 'Y', 'N',
    'N', 'Y', 'N', 'N', 'N',
    'Accounting Facts', NULL, 30, 1, NOW(), 100,
...
VALUES (0, 0, 547771 /*From ID Server*/, 549256,
    NOW(), 100, 'Y', 'main', 10, NOW(), 100, 'main');
...
VALUES (0, 0, 555313 /*From ID Server*/, 549485,
    NOW(), 100, 'Y', 'default', 10, 'primary', NOW(), 100);
...
VALUES (0, 0, 542323 /*From ID Server*/, 542146, 'W', 'de.metas.acct',
    'Y', 'N', 'N', 'N', 'Tax Declaration', NOW(), 100, NOW(), 100,
