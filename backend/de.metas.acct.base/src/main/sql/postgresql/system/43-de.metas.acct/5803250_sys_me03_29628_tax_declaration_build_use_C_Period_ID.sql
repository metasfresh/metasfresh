...
BEGIN
    ...
    -- Period drives the date range (StartDate..EndDate); DateFrom/DateTo
    ...
    RAISE NOTICE 'tax_declaration_build: Building declaration ID=% (C_Period_ID=%, DateFrom=%, DateTo=%, C_AcctSchema_ID=%)',
        p_C_TaxDeclaration_ID, v_C_Period_ID, v_DateFrom, v_DateTo, v_C_AcctSchema_ID;
