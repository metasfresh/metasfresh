...
$$
    BEGIN
        ...
        VALUES ('N', 'E', 1000000, 1000000, 1000000, 543201, TO_TIMESTAMP('2024-09-10 11:42:59.315', 'YYYY-MM-DD HH24:MI:SS.US'), 100,
        ...
        INSERT INTO C_ElementValue_Trl (AD_Language, C_ElementValue_ID, Description, Name, IsTranslated, AD_Client_ID, AD_Org_ID, Created, Createdby, Updated, UpdatedBy, IsActive)
        ...
        WHERE l.IsActive = 'Y'
          ...
          AND t.C_ElementValue_ID = 543201
          AND NOT EXISTS (SELECT 1 FROM C_ElementValue_Trl tt WHERE tt.AD_Language = l.AD_Language AND tt.C_ElementValue_ID = t.C_ElementValue_ID);
        ...
        WHERE t.AD_Client_ID = 1000000
          AND t.IsActive = 'Y'
          AND t.AD_Tree_ID = 1000020
          AND NOT EXISTS (SELECT *
                          FROM AD_TreeNode e
                          WHERE e.AD_Tree_ID = t.AD_Tree_ID
                            AND Node_ID = 543201);
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE NOTICE 'Failed creating Cash Rounding account: %', SQLERRM;
    END
$$
;
