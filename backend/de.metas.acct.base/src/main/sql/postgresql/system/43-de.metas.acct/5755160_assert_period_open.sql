SELECT db_drop_functions('de_metas_acct.assert_period_open')
;
...
BEGIN
    ...
    RAISE DEBUG 'assert_period_open: OK, period open for DateAcct=%, C_Period_ID=%, DocBaseType=%', p_DateAcct, v_C_Period_ID, p_DocBaseType;
END;
$BODY$
    LANGUAGE plpgsql
    STABLE
