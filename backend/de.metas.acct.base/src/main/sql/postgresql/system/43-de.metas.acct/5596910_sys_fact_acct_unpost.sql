DROP FUNCTION IF EXISTS "de_metas_acct".fact_acct_unpost(
...
CREATE OR REPLACE FUNCTION "de_metas_acct".fact_acct_unpost(
    p_tablename       character varying,
    p_Record_ID       numeric,
    p_Force           char(1) = 'N',
...
BEGIN
    ...
    IF (p_CheckPeriodOpen = 'Y') THEN
        PERFORM "de_metas_acct".assert_period_open_by_record(
