...
( --
    SELECT ev.value || '_' || ev.name                                                 AS AccountValueAndName,
           ...
           -- Document Info
           (CASE WHEN fa.c_currency_id = fa2.c_currency_id THEN fa2.amtsourcecr END)  AS amtsourcedr, -- FIXME: find out if the reversal of debit and credit is a typo or a weird design
