...
-- Tax Declaration: filter Fact_Acct by C_Period_ID
...
BEGIN
    ...
    -- Fact_Acct entries are matched by C_Period_ID directly (Mark's explicit
    -- request) — no derived DateFrom/DateTo BETWEEN range.
    -- =========================================================
