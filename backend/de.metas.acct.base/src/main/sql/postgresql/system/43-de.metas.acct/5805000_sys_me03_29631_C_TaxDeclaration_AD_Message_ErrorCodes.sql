...
UPDATE AD_Message SET ErrorCode='TAXDECLARATION_PROCESSED_LOCKED',         Updated=TO_TIMESTAMP('2026-05-26 00:00:00','YYYY-MM-DD HH24:MI:SS'), UpdatedBy=100 WHERE Value='TaxDeclaration_ProcessedLocked'                    AND ErrorCode IS NULL;
