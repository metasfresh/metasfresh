...
VALUES
    ('3', 0, 0, 585615 /*From ID Server*/,
     ...
     NOW(), 100, 'de.metas.acct',
     'Y', 'N', 'N', 'N',
     'N', 'N', 'Y', 'Y',
     0, 'Build Tax Declaration', 'N', 'Y',
     'Java', NOW(), 100, 'C_TaxDeclaration_Build')
;

-- Translation rows for AD_Process
...
-- INSERT AD_Message for the already-processed guard
INSERT INTO AD_Message
    (AD_Client_ID, AD_Message_ID, AD_Org_ID, Created, CreatedBy,
     EntityType, IsActive, MsgText, MsgType, Updated, UpdatedBy, Value)
VALUES
    (0, 545682 /*From ID Server*/, 0, NOW(), 100,
     'de.metas.acct', 'Y',
     'Tax Declaration is already processed and cannot be rebuilt.',
     'E', NOW(), 100,
...
-- Translation rows for AD_Message
