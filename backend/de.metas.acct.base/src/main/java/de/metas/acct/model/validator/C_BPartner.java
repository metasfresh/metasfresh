...
public class C_BPartner
{
	...
	@ModelChange(timings = { ModelValidator.TYPE_BEFORE_NEW, ModelValidator.TYPE_BEFORE_CHANGE }, ifColumnsChanged = I_C_BPartner.COLUMNNAME_Value)
	public void beforeSave(final I_C_BPartner bpartner)
	{
		...
		final AcctSchema as = acctSchemaDAO.getByCliendAndOrg(clientId, orgId);
