...
public class C_Campaign
{
	...
	{
		validCombinationService.scheduleUpdateDescriptionAfterCommit(ValidCombinationQuery.ofElementTypeAndValue(AcctSchemaElementType.Campaign, record.getC_Campaign_ID()));
	}
}
