...
public interface IGLJournalLineBL extends ISingletonService
{
	...
	void checkMandatoryDimensions(I_GL_JournalLine glJournalLine);

	@NonNull
	GLJournalLineSide extractSide(@NonNull I_GL_JournalLine glJournalLine, @NonNull PostingSign postingSign);

	@NonNull
	Account extractAccount(@NonNull I_GL_JournalLine glJournalLine, @NonNull PostingSign postingSign);

	@Nullable
	ProductId extractProductId(@NonNull I_GL_JournalLine glJournalLine, @NonNull PostingSign postingSign);

	@Nullable
	LocatorId extractLocatorId(@NonNull I_GL_JournalLine glJournalLine, @NonNull PostingSign postingSign);

	@Nullable
	OrderId extractSalesOrderId(@NonNull I_GL_JournalLine glJournalLine, @NonNull PostingSign postingSign);
}
