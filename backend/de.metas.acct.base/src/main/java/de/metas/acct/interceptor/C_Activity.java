...
public class C_Activity
{
	...
	{
		validCombinationService.scheduleUpdateDescriptionAfterCommit(ValidCombinationQuery.ofElementTypeAndValue(AcctSchemaElementType.Activity, record.getC_Activity_ID()));
	}
}
