...
public interface IReferenceNoDAO extends ISingletonService
{
	...
	/**
	 * Creates and saves an {@link I_C_ReferenceNo_Doc} record to link the given <code>referenceNo</code> with the PO specified by the given <code>tableId</code> and <code>recordId</code>. If such a
	 ...
	 * @return
	 */
	I_C_ReferenceNo_Doc getCreateReferenceNoDoc(I_C_ReferenceNo referenceNo, int tableId, int recordId);
