...
public class PlainReferenceNoDAO extends AbstractReferenceNoDAO
{
	...
	@Override
	public I_C_ReferenceNo_Doc getCreateReferenceNoDoc(I_C_ReferenceNo referenceNo, int tableId, int recordId)
	{
		throw new UnsupportedOperationException();
	}
	...
	public List<I_C_ReferenceNo> retrieveReferenceNos(final Object model, final I_C_ReferenceNo_Type type)
	{
		...
		final Set<I_C_ReferenceNo> refNos = new HashSet<I_C_ReferenceNo>();
		...
		return new ArrayList<I_C_ReferenceNo>(refNos);
	}
