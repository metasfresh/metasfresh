...
class GODraftDeliveryOrderCreator
{
	...
	public @NotNull DeliveryOrder createDraftDeliveryOrder(@NonNull final CreateDraftDeliveryOrderRequest request)
	{
		...
		final @NonNull BPartnerLocationId deliverToBPartnerLocationId = deliveryOrderKey.getDeliverToBPartnerLocationId();
		final @NonNull BPartnerId deliverToBPartnerId = deliverToBPartnerLocationId.getBpartnerId();
