...
public class X_MD_Candidate extends org.compiere.model.PO implements I_MD_Candidate, org.compiere.model.I_Persistent
{
	...
	private static final long serialVersionUID = -2111591291L;
	...
	{
		set_ValueNoCheck (COLUMNNAME_MD_Candidate_Type, MD_Candidate_Type);
	}
	...
	@Override
	public void setReplenish_IsHighPriority (final boolean Replenish_IsHighPriority)
	{
		set_Value (COLUMNNAME_Replenish_IsHighPriority, Replenish_IsHighPriority);
	}

	@Override
	public boolean isReplenish_IsHighPriority()
	{
		return get_ValueAsBoolean(COLUMNNAME_Replenish_IsHighPriority);
	}
