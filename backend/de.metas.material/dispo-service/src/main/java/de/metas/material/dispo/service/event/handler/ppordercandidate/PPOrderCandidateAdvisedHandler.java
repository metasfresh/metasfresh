		...
		implements MaterialEventHandler<PPOrderCandidateAdvisedEvent>
{
	...
	public void handleEvent(@NonNull final PPOrderCandidateAdvisedEvent event)
	{
		...
		materialEventService.enqueueEventBeforeNextCommit(ppOrderRequestEvent); // want to avoid the situation that some response comes back before the data here was even committed to DB
	}
