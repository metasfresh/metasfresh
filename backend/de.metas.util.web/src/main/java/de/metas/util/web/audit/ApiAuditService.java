...
public class ApiAuditService
{
			...
			@NonNull final ContentCachingResponseWrapper response)
	{
		try
		{
			...
			final UserAndRoleId userAndRoleId = UserAndRoleId.createFromCurrentEnv(); // when creating the audit in another thread, we still want the user and role that was authenticated
