		...
		implements IDocumentDeliveryLocationAdapter, RecordBasedLocationAdapter<DropShipOverrideLocationAdapter>
{
	...
	private int dropShipUserId = -1;

	DropShipOverrideLocationAdapter(@NonNull final I_C_OLCand delegate)
	{
	...
	{
		return delegate.getDropShip_BPartner_Override_ID();
	}

	@Override
	public void setDropShip_BPartner_ID(final int DropShip_BPartner_ID)
	{
		delegate.setDropShip_BPartner_Override_ID(DropShip_BPartner_ID);
	}

	@Override
	public int getDropShip_Location_ID()
	{
		return delegate.getDropShip_Location_Override_ID();
	}

	@Override
	public void setDropShip_Location_ID(final int DropShip_Location_ID)
	{
		delegate.setDropShip_Location_Override_ID(DropShip_Location_ID);
	}

	@Override
	public int getDropShip_Location_Value_ID()
	{
		return delegate.getDropShip_Location_Override_Value_ID();
	}

	@Override
	public void setDropShip_Location_Value_ID(final int DropShip_Location_Value_ID)
	{
		delegate.setDropShip_Location_Override_Value_ID(DropShip_Location_Value_ID);
	}
