...
@EqualsAndHashCode
@ToString
public class POBasedESModelToIndex implements ESModelToIndex
{
	public static POBasedESModelToIndex ofObject(@NonNull final Object object)
	{
		return object instanceof POBasedESModelToIndex
				? (POBasedESModelToIndex)object
				: new POBasedESModelToIndex(object);
	}

	public static ESModelToIndex ofPO(@NonNull final PO po)
	{
		return new POBasedESModelToIndex(po);
	}

	@NonNull Object object;

	private POBasedESModelToIndex(@NonNull final Object object)
	{
		this.object = object;
	}
