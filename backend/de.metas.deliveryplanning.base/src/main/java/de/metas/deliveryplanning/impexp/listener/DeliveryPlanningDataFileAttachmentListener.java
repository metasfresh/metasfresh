...
public class DeliveryPlanningDataFileAttachmentListener implements AttachmentListener
{
	...
	{
		final AttachmentEntryDataResource data = attachmentEntryService.retrieveDataResource(attachmentEntry.getId());

		final DataImportResult dataImportResult = dataImportService.importDataFromResource(DataImportRequest.builder()
				.data(data)
