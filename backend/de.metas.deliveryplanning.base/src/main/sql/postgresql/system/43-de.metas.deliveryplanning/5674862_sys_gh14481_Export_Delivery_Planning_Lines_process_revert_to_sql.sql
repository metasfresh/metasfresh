...
UPDATE AD_Process SET SQLStatement='SELECT div.documentno,
    ...
    LEFT JOIN c_country fromC ON m_delivery_planning.c_origincountry_id = fromC.c_country_id WHERE @SELECTION_WHERECLAUSE/false@',Updated=TO_TIMESTAMP('2023-02-06 15:54:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_ID=585207
;
