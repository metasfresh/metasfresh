...
-- 1,000,000,000 + M_ReceiptSchedule_ID (see RV_ReceiptLogistics.sql), that fallback buried every
...
SET SortNo   = 1,
    ...
    UpdatedBy = 100
WHERE AD_Field_ID = 784930 -- ETA field on the RV_ReceiptLogistics tab (549491)
;
