...
-- which on this window yields RV_ReceiptDisposition_DeliveryPlanning, while every WEBUI_M_ReceiptSchedule_* action asks for
...
VALUES
 (585662 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_SelectHUsToReverse','Korrektur',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_SelectHUsToReverse','Java','N',
 ...
 (585663 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_CreateEmptiesReturnsToVendor','Leergut Ausgabe',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_CreateEmptiesReturnsToVendor','Java','N',
  'N','N','N','N',0,'N','N','Y','N','Y','N','json','Y','','N','N','"','Y','N'),
 (585664 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_CreateEmptiesReturnsFromCustomer','Leergut Rücknahme',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_CreateEmptiesReturnsFromCustomer','Java','N',
  'N','N','N','N',0,'N','N','Y','N','Y','N','json','Y','','N','N','"','Y','N'),
 (585665 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_AttachPhoto','Foto',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_AttachPhoto','Java','Y',
  'N','N','N','N',0,'N','N','Y','N','Y','N','json','Y','','N','N','"','Y','N'),
 (585666 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_RunMaterialReceiptJasper','Drucken Produktanlieferung',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_RunMaterialReceiptJasper','Java','N',
  'N','N','N','N',0,'N','N','Y','N','Y','N','json','Y','','N','N','"','Y','N')
;
...
-- ---------------------------------------------------------------------------------------------------
-- AD_Table_Process -- what makes the five actions appear on AD_Table 542644 (RV_ReceiptDisposition_DeliveryPlanning).
