...
-- record via IView#getTableRecordReferenceOrNull, which for this window yields RV_ReceiptDisposition_DeliveryPlanning. Every
...
VALUES
 (585658 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveHUs_UsingDefaults','HUs annehmen Voreinst.',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveHUs_UsingDefaults','Java','N',
 ...
 (585659 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveHUs_UsingConfig','HUs annehmen',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveHUs_UsingConfig','Java','N',
  'N','N','N','N',0,'N','N','Y','N','Y','N','json','Y','','N','N','"','Y','N'),
 (585660 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveCUs','CUs annehmen',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveCUs','Java','N',
  'N','N','N','N',0,'N','N','Y','N','Y','N','json','Y','','N','N','"','Y','N'),
 (585661 /*From ID Server*/,0,0,'Y',TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2026-09-04 09:00:00','YYYY-MM-DD HH24:MI:SS'),100,
  'WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveCUs_WithParam','CUs annehmen mit Menge',3,'D','N','N',
  'de.metas.ui.web.receiptdisposition_deliveryplanning.process.WEBUI_RV_ReceiptDisposition_DeliveryPlanning_ReceiveCUs_WithParam','Java','N',
  'N','N','N','N',0,'N','N','Y','N','Y','N','json','Y','','N','N','"','Y','N')
;
...
-- ---------------------------------------------------------------------------------------------------
-- AD_Table_Process -- what makes the four actions appear on AD_Table 542644 (RV_ReceiptDisposition_DeliveryPlanning).
-- ---------------------------------------------------------------------------------------------------
