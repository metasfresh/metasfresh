...
{
	/**
	 * Decides for the given olCand whether the HU item capacity from our own master data (<code>false</code>) shall be used, or the one that was imported into the given <code>olCand</code> (
	 * <code>true</code>).
	 *
