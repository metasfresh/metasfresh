...
public class X_EDI_Desadv extends org.compiere.model.PO implements I_EDI_Desadv, org.compiere.model.I_Persistent
{
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_FulfillmentPercent, BigDecimal.ZERO);
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_FulfillmentPercentMin, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_SumDeliveredInStockingUOM, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_SumOrderedInStockingUOM, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
