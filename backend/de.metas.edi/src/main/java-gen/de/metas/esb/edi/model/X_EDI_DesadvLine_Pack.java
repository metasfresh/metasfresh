...
public class X_EDI_DesadvLine_Pack extends org.compiere.model.PO implements I_EDI_DesadvLine_Pack, org.compiere.model.I_Persistent
{
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_MovementQty, BigDecimal.ZERO);
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyCU, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyCUsPerLU, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
