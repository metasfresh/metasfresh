...
public class X_EDI_DesadvLine extends org.compiere.model.PO implements I_EDI_DesadvLine, org.compiere.model.I_Persistent
{
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_PriceActual, BigDecimal.ZERO);
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyDeliveredInInvoiceUOM, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyDeliveredInStockingUOM, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyDeliveredInUOM, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyEntered, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyItemCapacity, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
	...
	{
		BigDecimal bd = get_ValueAsBigDecimal(COLUMNNAME_QtyOrdered, BigDecimal.ZERO);
		return bd != null ? bd : BigDecimal.ZERO;
	}
