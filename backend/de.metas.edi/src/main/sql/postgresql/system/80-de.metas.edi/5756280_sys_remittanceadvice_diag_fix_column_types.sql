...
SELECT 'invoice-to-payment'::text                                                                                          AS allocation_type,
       ...
       ral.paymentdiscountamt                                                                                              AS al_discountamt_exp,
       al.discountamt = ral.paymentdiscountamt                                                                             AS al_discountamt_ok,
...
SELECT * FROM information_schema.columns WHERE data_type ILIKE 'unknown';