...
--
-- Affects three views:
--   1. M_InOut_Export_EDI_DESADV_JSON_V  — TechnicalRecipientGLN (EdiDesadvRecipientGLN)
--   2. edi_cctop_000_v                   — EdiInvoicRecipientGLN
--   3. EDI_Cctop_INVOIC_v               — ReceiverGLN (EdiInvoicRecipientGLN with rl.GLN fallback)
