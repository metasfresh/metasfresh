         ...
         LEFT JOIN (SELECT c_invoice_id,
                    ...
                    FROM edi_cctop_119_v cctop119
                             LEFT JOIN (SELECT bpartner_value,
                                        ...
                                        GROUP BY bpartner_value, ad_client_id, ad_org_id) attr_v ON attr_v.bpartner_value = cctop119.value AND attr_v.ad_client_id = cctop119.ad_client_id AND attr_v.ad_org_id = cctop119.ad_org_id
