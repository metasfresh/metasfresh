...
-- Field: Lieferung -> Lieferung -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:04:20.712Z
UPDATE AD_Field SET AD_Reference_ID=17, AD_Reference_Value_ID=540381, FilterOperator='E', IsFilterField='Y', IsShowFilterInline='N', SelectionColumnSeqNo=10.000000000000,Updated=TO_TIMESTAMP('2024-09-25 12:04:20.712000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;
...
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:05:20.824Z
UPDATE AD_Field SET SelectionColumnSeqNo=NULL,Updated=TO_TIMESTAMP('2024-09-25 12:05:20.823000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;
...
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:05:58.039Z
UPDATE AD_Field SET IsShowFilterInline='Y',Updated=TO_TIMESTAMP('2024-09-25 12:05:58.038000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;
...
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:07:20.553Z
UPDATE AD_Field SET IsShowFilterInline='N',Updated=TO_TIMESTAMP('2024-09-25 12:07:20.552000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;
...
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:07:52.962Z
UPDATE AD_Field SET SelectionColumnSeqNo=10.000000000000,Updated=TO_TIMESTAMP('2024-09-25 12:07:52.962000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;

-- Column: M_InOut.EDI_ExportStatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:08:51.449Z
UPDATE AD_Column SET FilterOperator='E', IsSelectionColumn='Y',Updated=TO_TIMESTAMP('2024-09-25 12:08:51.449000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Column_ID=549871
;
...
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:11:21.481Z
UPDATE AD_Field SET SelectionColumnSeqNo=60.000000000000,Updated=TO_TIMESTAMP('2024-09-25 12:11:21.480000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;
...
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:11:55.004Z
UPDATE AD_Field SET SelectionColumnSeqNo=100.000000000000,Updated=TO_TIMESTAMP('2024-09-25 12:11:55.004000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;
...
-- Field: Lieferung(169,D) -> Lieferung(257,D) -> EDI-Sendestatus
-- Column: M_InOut.EDI_ExportStatus
-- 2024-09-25T12:12:44.990Z
UPDATE AD_Field SET SelectionColumnSeqNo=140.000000000000,Updated=TO_TIMESTAMP('2024-09-25 12:12:44.989000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Field_ID=553214
;
