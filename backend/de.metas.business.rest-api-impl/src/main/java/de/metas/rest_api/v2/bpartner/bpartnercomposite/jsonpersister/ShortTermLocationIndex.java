...
public class ShortTermLocationIndex
{
	...
	/**
	 * locations that were not (yet) retrieved via {@link #extractAndMarkUsed(ExternalIdentifier)}.
	 */
	...
	public BPartnerLocation extractAndMarkUsed(@NonNull final MetasfreshId metasfreshId)
	{
		final BPartnerLocationId bpartnerLocationId = BPartnerLocationId.ofRepoId(bpartnerId, metasfreshId.getValue());
		final BPartnerLocation result = id2Location.get(bpartnerLocationId);
	...
	public BPartnerLocation extractAndMarkUsed(@NonNull final ExternalIdentifier locationIdentifier)
	{
	...
	private BPartnerLocation extract0(@NonNull final ExternalIdentifier locationIdentifier)
	{
	...
	public BPartnerLocation newLocation(@NonNull final ExternalIdentifier locationIdentifier)
	{
