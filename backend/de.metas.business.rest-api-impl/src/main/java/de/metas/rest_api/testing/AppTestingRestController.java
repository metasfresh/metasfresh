...
package de.metas.rest_api.testing;
...
@RequestMapping(value = {
		MetasfreshRestAPIConstants.ENDPOINT_API_DEPRECATED + "/test",
		MetasfreshRestAPIConstants.ENDPOINT_API_V1 + "/test",
		MetasfreshRestAPIConstants.ENDPOINT_API_V2 + "/tests" })
