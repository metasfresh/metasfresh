...
public class DeprecatedProductsRestController extends ProductsRestController
{
	public DeprecatedProductsRestController(
			...
			final @NonNull ExternalIdentifierProductLookupService productLookupService)
	{
		super(productsServicesFacade, albertaProductService, externalSystemService, productRestService, productLookupService);
	}
}
