...
import de.metas.common.shipping.v2.receiptcandidate.JsonResponseReceiptCandidate;
import de.metas.common.shipping.v2.receiptcandidate.JsonResponseReceiptCandidate.JsonResponseReceiptCandidateBuilder;
import de.metas.common.shipping.v2.receiptcandidate.JsonResponseReceiptCandidates;
import de.metas.common.shipping.v2.receiptcandidate.JsonResponseReceiptCandidates.JsonResponseReceiptCandidatesBuilder;
import de.metas.common.shipping.v2.receiptcandidate.JsonVendor;
import de.metas.common.shipping.v2.receiptcandidate.JsonVendor.JsonVendorBuilder;
...
class ReceiptCandidateAPIService
{
			...
			@NonNull final Map<AttributeSetInstanceId, ImmutableAttributeSet> attributesForASIs)
	{
		...
		return RestApiUtilsV2.extractJsonAttributeSetInstance(attributeSet, receiptSchedule.getOrgId());
	}
