...
import de.metas.rest_api.bpartner.impl.v1.ContactRestController;
...
import static de.metas.rest_api.bpartner.impl.v2.BPartnerRecordsUtil.AD_USER_VALUE;
...
import static de.metas.rest_api.bpartner.impl.v2.BPartnerRecordsUtil.resetTimeSource;
import static de.metas.rest_api.bpartner.impl.v2.BPartnerRecordsUtil.setupTimeSource;
...
{
	private de.metas.rest_api.bpartner.impl.v1.ContactRestController contactRestController;
	...
	void init()
	{
		...
		final JsonServiceFactory jsonServiceFactory = new JsonServiceFactory(
				new de.metas.rest_api.bpartner.impl.v1.JsonRequestConsolidateService(),
		...
		contactRestController = new ContactRestController(
				new de.metas.rest_api.bpartner.impl.v1.BPartnerEndpointService(jsonServiceFactory),
				jsonServiceFactory,
