...
import static de.metas.rest_api.bpartner.impl.v2.BPartnerRecordsUtil.C_BPARTNER_VALUE;
...
class JsonRetrieverServiceTest
{
	...
	void init()
	{
		...
		final de.metas.rest_api.bpartner.impl.v2.bpartnercomposite.JsonServiceFactory jsonServiceFactory = new JsonServiceFactory(
