...
class BpartnerRestControllerTest
{
	...
	void init()
	{
		...
		bpartnerCompositeRepository = new BPartnerCompositeRepository(partnerBL, new BPartnerBL(new UserRepository()), new MockLogEntriesRepository(), new UserRoleRepository());
