...
@EqualsAndHashCode
public abstract class AbstractPurchaseInvoiceAsPaymentDocumentWrapper implements IPaymentDocument
{
	protected final PayableDocument purchaseInvoicePayableDoc;

	public AbstractPurchaseInvoiceAsPaymentDocumentWrapper(@NonNull final PayableDocument purchasePayableDoc)
	{
	...
	{
		return getClass().getSimpleName() + "[" + purchaseInvoicePayableDoc + "]";
	}
	...
	public boolean canPay(@NonNull final PayableDocument payable)
	{
		...
		if (payable.getType() != PayableDocument.PayableDocumentType.Invoice)
		{
			return false;
		}
