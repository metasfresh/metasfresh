...
-- 2023-09-12T09:46:46.400095400Z
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DDL_NoForeignKey,Description,EntityType,FacetFilterSeqNo,FieldLength,Help,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,587460,558,0,19,542365,'C_Order_ID',TO_TIMESTAMP('2023-09-12 12:46:46.173','YYYY-MM-DD HH24:MI:SS.US'),100,'N','Auftrag','de.metas.shippingnotification',0,10,'The Order is a control document.  The  Order is complete when the quantity ordered is the same as the quantity shipped and invoiced.  When you cloase an order, unshipped (backordered) quantities are cancelled.','Y','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Auftrag',0,0,TO_TIMESTAMP('2023-09-12 12:46:46.173','YYYY-MM-DD HH24:MI:SS.US'),100,0)
;

-- 2023-09-12T09:46:46.413066300Z
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Column t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Column_ID=587460 AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Column_ID=t.AD_Column_ID)
;

-- 2023-09-12T09:46:46.441914300Z
/* DDL */  select update_Column_Translation_From_AD_Element(558) 
;

-- Column: M_Shipping_Notification.C_Order_ID
-- 2023-09-12T09:46:51.374772300Z
UPDATE AD_Column SET IsMandatory='N',Updated=TO_TIMESTAMP('2023-09-12 12:46:51.374','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Column_ID=587460
;

-- 2023-09-12T09:46:53.055609200Z
/* DDL */ SELECT public.db_alter_table('M_Shipping_Notification','ALTER TABLE public.M_Shipping_Notification ADD COLUMN C_Order_ID NUMERIC(10)')
;

-- 2023-09-12T09:46:53.068453900Z
...
-- Column: M_Shipping_NotificationLine.C_Order_ID
-- 2023-09-13T06:01:11.005899400Z
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DDL_NoForeignKey,Description,EntityType,FacetFilterSeqNo,FieldLength,Help,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,587469,558,0,19,542366,'C_Order_ID',TO_TIMESTAMP('2023-09-13 09:01:10.772','YYYY-MM-DD HH24:MI:SS.US'),100,'N','Auftrag','de.metas.shippingnotification',0,10,'The Order is a control document.  The  Order is complete when the quantity ordered is the same as the quantity shipped and invoiced.  When you cloase an order, unshipped (backordered) quantities are cancelled.','Y','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Auftrag',0,0,TO_TIMESTAMP('2023-09-13 09:01:10.772','YYYY-MM-DD HH24:MI:SS.US'),100,0)
;

-- 2023-09-13T06:01:11.013169900Z
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Column t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Column_ID=587469 AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Column_ID=t.AD_Column_ID)
;

-- 2023-09-13T06:01:11.022638200Z
/* DDL */  select update_Column_Translation_From_AD_Element(558) 
;

-- Column: M_Shipping_NotificationLine.C_Order_ID
-- 2023-09-13T06:01:14.791474800Z
UPDATE AD_Column SET IsMandatory='N',Updated=TO_TIMESTAMP('2023-09-13 09:01:14.791','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Column_ID=587469
;

-- 2023-09-13T06:01:17.342788500Z
/* DDL */ SELECT public.db_alter_table('M_Shipping_NotificationLine','ALTER TABLE public.M_Shipping_NotificationLine ADD COLUMN C_Order_ID NUMERIC(10)')
;

-- 2023-09-13T06:01:17.356490900Z
ALTER TABLE M_Shipping_NotificationLine ADD CONSTRAINT COrder_MShippingNotificationLine FOREIGN KEY (C_Order_ID) REFERENCES public.C_Order DEFERRABLE INITIALLY DEFERRED
;

-- 2023-09-13T06:04:22.263803Z
INSERT INTO t_alter_column values('m_shipping_notificationline','C_Order_ID','NUMERIC(10)',null,null)
;

-- Column: M_Shipping_NotificationLine.C_Order_ID
-- 2023-09-13T06:04:31.679519300Z
UPDATE AD_Column SET IsMandatory='Y',Updated=TO_TIMESTAMP('2023-09-13 09:04:31.679','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Column_ID=587469
;

-- 2023-09-13T06:04:32.969119Z
INSERT INTO t_alter_column values('m_shipping_notificationline','C_Order_ID','NUMERIC(10)',null,null)
;

-- 2023-09-13T06:04:32.973308200Z
...
-- Column: C_Order.PhysicalClearanceDate
-- 2023-09-14T06:00:46.688469300Z
