--
-- Backup
create table backup.AD_TreeNodeMM_BKP_BeforeImportWebUI_5462980 as select * from AD_TreeNodeMM;
create table backup.AD_Menu_BKP_BeforeImportWebUI_5462980 as select * from AD_Menu;
create table backup.AD_Menu_Trk_BKP_BeforeImportWebUI_5462980 as select * from AD_Menu_Trl;
...
where
	...
	and (t.AD_Window_ID is null or exists(select 1 from AD_Window z where z.AD_Window_ID=t.AD_Window_ID))
;
--
