...
--
-- Placement mirrors the field it replaces: on both tabs IsSOTrx sits first in the right-column
-- "flags" element group (540096 -> group 553415, 546732 -> group 555562); the direction element
-- is placed directly after it (SeqNo 12), so removing the IsSOTrx element later leaves no hole.
...
;
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,783020,0,540096,553415,653669 /*From ID Server*/,'F',TO_TIMESTAMP('2026-08-26 12:02:00','YYYY-MM-DD HH24:MI:SS'),100,'Y','N','N','Y','Y','N','N',0,'Richtung',12,65,0,TO_TIMESTAMP('2026-08-26 12:02:00','YYYY-MM-DD HH24:MI:SS'),100)
;
