...
UPDATE AD_Val_Rule SET Code=' EXISTS(SELECT 1
        ...
        AND NOT EXISTS(SELECT 1
                       ...
                       WHERE luVersion1.hu_unittype = ''LU''
                         ...
                         AND qtyenteredtu % tuItemOnLUVersion1.qty != 0)
    )',Updated=TO_TIMESTAMP('2025-04-29 10:43:59.251000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Val_Rule_ID=540724
;
