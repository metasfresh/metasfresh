...
FROM (SELECT
          ...
          (SELECT cast_to_numeric_or_null(z.Setup_Place_No)
           FROM C_BPartner_Location z
           WHERE z.C_BPartner_Location_ID = (CASE WHEN o.IsUseHandOver_Location = 'Y' THEN COALESCE(o.HandOver_Location_ID, o.C_BPartner_Location_ID) ELSE o.C_BPartner_Location_ID END)) AS Setup_Place_No,
          dt.DocSubType,
          s.DateOrdered,
