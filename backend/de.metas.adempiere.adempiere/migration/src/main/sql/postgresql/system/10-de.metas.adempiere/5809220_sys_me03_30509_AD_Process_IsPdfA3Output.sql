...
-- ============================================================
ALTER TABLE AD_Process ADD COLUMN IF NOT EXISTS IsPdfA3Output CHAR(1) DEFAULT 'N';
UPDATE AD_Process SET IsPdfA3Output = 'N' WHERE IsPdfA3Output IS NULL;
ALTER TABLE AD_Process ALTER COLUMN IsPdfA3Output SET NOT NULL;
