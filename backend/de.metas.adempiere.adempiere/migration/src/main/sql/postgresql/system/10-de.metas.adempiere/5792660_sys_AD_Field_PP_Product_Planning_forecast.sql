...
-- AD_Field: Forecast_ComparisonPeriod (AD_Column_ID=592199)
...
VALUES (0,592199,774856,0,542102,TO_TIMESTAMP('2026-03-07 10:00','YYYY-MM-DD HH24:MI'),100,1,'D','Y','Y','Y','N','N','N','N','N','Vergleichszeitraum Prognose',30,30,TO_TIMESTAMP('2026-03-07 10:00','YYYY-MM-DD HH24:MI'),100);
...
UPDATE AD_Field_Trl SET Name='Forecast Comparison Period', IsTranslated='Y', Updated=TO_TIMESTAMP('2026-03-07 10:00','YYYY-MM-DD HH24:MI'), UpdatedBy=100 WHERE AD_Field_ID=774856 AND AD_Language='en_US';
