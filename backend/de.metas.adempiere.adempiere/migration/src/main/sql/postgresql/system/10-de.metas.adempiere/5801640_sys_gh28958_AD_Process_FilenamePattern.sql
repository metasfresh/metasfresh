...
UPDATE AD_Element_Trl SET Name='Dateinamensmuster', PrintName='Dateinamensmuster',
  ...
  IsTranslated='Y', Updated=TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC', UpdatedBy=100
...
VALUES (0,592505 /*From ID Server*/,584851,0,10,284,'XX','FilenamePattern',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','D',0,255,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N',0,'Filename Pattern','NP',0,0,TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
VALUES (0,592505,779177 /*From ID Server*/,0,245,TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,60,'D','Y','Y','N','N','N','N','N','N','Filename Pattern',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
VALUES (0,779177,0,245,541398,651161 /*From ID Server*/,'F',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','N','N','Filename Pattern',50,0,0,TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
SET FilenamePattern='{orgname}-{processname}-{pinstanceid}',
    Updated=TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',
    UpdatedBy=100
