...
-- Column: C_Payment.Proforma_Invoice_ID
-- 2026-04-14T06:38:22.522Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,592361,777074,0,330,TO_TIMESTAMP('2026-04-14 06:38:22.350000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,10,'D','Y','N','N','N','N','N','N','N','Proforma Rechnung',TO_TIMESTAMP('2026-04-14 06:38:22.350000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;

-- 2026-04-14T06:38:22.529Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=777074 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2026-04-14T06:38:22.534Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(584758)
;

-- 2026-04-14T06:38:22.545Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=777074
;

-- 2026-04-14T06:38:22.554Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(777074)
;

-- UI Element: Zahlung(195,D) -> Zahlung(330,D) -> main -> 10 -> order invoice.Proforma Rechnung
-- Column: C_Payment.Proforma_Invoice_ID
-- 2026-04-14T06:39:51.272Z
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,777074,0,330,540955,649814,'F',TO_TIMESTAMP('2026-04-14 06:39:51.139000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','N','Y','N','N','N',0,'Proforma Rechnung',25,0,0,TO_TIMESTAMP('2026-04-14 06:39:51.139000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
