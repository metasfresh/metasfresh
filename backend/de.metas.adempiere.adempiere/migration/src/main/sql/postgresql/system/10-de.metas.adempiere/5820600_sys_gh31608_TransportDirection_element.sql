...
VALUES (0, 585383 /*From ID Server*/, 0, 'TransportDirection', TO_TIMESTAMP('2026-08-27 09:00:00','YYYY-MM-DD HH24:MI:SS'), 100, 'D', 'Y', 'Richtung', 'Richtung', TO_TIMESTAMP('2026-08-27 09:00:00','YYYY-MM-DD HH24:MI:SS'), 100)
;
...
-- 3) en_US override: "Direction" (matches 540579)
UPDATE AD_Element_Trl SET Name='Direction', PrintName='Direction', IsTranslated='Y', Updated=TO_TIMESTAMP('2026-08-27 09:00:12','YYYY-MM-DD HH24:MI:SS'), UpdatedBy=100 WHERE AD_Element_ID=585383 AND AD_Language='en_US'
;
/* DDL */ select update_TRL_Tables_On_AD_Element_TRL_Update(585383,'en_US')
;

-- 4) de_DE: text already matches base ('Richtung'); flip IsTranslated='Y'
...
-- 5) de_CH: text already matches base ('Richtung'); flip IsTranslated='Y'
