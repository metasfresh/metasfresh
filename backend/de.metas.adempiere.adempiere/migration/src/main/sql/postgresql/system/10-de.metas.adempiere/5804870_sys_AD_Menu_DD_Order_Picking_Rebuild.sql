...
VALUES (0, 0, 'Y', TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100, TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100,
...
VALUES ('de_DE', 0, 0, 'Y', TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100, TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100,
        584873 /*From ID Server*/,
...
INSERT INTO AD_Element_Trl (AD_Language, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
                            AD_Element_ID, Name, PrintName, Description, Help, IsTranslated)
VALUES ('de_CH', 0, 0, 'Y', TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100, TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100,
        584873 /*From ID Server*/,
        'Picking DD_Orders neu aufbauen', 'Picking DD_Orders neu aufbauen', NULL, NULL, 'N');
...
INSERT INTO AD_Element_Trl (AD_Language, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
                            AD_Element_ID, Name, PrintName, Description, Help, IsTranslated)
VALUES ('en_US', 0, 0, 'Y', TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100, TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100,
        584873 /*From ID Server*/,
...
SELECT 0, 0, 'Y', TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100, TO_TIMESTAMP('2026-05-27 14:00', 'YYYY-MM-DD HH24:MI'), 100,
