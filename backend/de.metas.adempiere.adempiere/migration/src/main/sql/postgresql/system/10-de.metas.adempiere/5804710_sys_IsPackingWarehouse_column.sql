...
-- =============================================================================
ALTER TABLE M_Warehouse ADD COLUMN IF NOT EXISTS IsPackingWarehouse CHAR(1) DEFAULT 'N';
UPDATE M_Warehouse SET IsPackingWarehouse = 'N' WHERE IsPackingWarehouse IS NULL;
ALTER TABLE M_Warehouse ALTER COLUMN IsPackingWarehouse SET NOT NULL;
