/*
delete from ad_field where ad_column_id=588186;
delete from ad_column where ad_column_id=588186;
alter table AD_Task_Access drop column AD_Task_Access_ID;
...
$$
    ...
    BEGIN
        ...
        WHERE t.tablename = 'AD_Task_Access'
          AND c.columnname = 'AD_Task_Access_ID';

        IF (v_count > 0) THEN
            RAISE NOTICE 'Column AD_Task_Access.AD_Task_Access_ID already exists. Do nothing';
            RETURN;
        END IF;
        ...
        WHERE l.IsActive = 'Y'
          ...
          AND t.AD_Column_ID = 588186
          AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language = l.AD_Language AND tt.AD_Column_ID = t.AD_Column_ID);

        -- 2024-04-15T07:17:51.775Z
        /* DDL */
        PERFORM update_Column_Translation_From_AD_Element(543338);
        ...
        ALTER TABLE AD_Task_Access
            ADD COLUMN AD_Task_Access_ID numeric(10, 0) NOT NULL DEFAULT NEXTVAL('ad_task_access_seq');
        ...
        VALUES (0, 588186, 728047, 0, 313, TO_TIMESTAMP('2024-04-15 07:17:52.265000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100, 10, 'D', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'AD_Task_Access', TO_TIMESTAMP('2024-04-15 07:17:52.265000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100);
        ...
        WHERE l.IsActive = 'Y'
          AND (l.IsSystemLanguage = 'Y' OR l.IsBaseLanguage = 'Y')
          AND t.AD_Field_ID = 728047
          AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language = l.AD_Language AND tt.AD_Field_ID = t.AD_Field_ID);

        -- 2024-04-15T07:17:52.389Z
        /* DDL */
        PERFORM update_FieldTranslation_From_AD_Name_Element(543338);

        -- 2024-04-15T07:17:52.391Z
        DELETE FROM AD_Element_Link WHERE AD_Field_ID = 728047;

        -- 2024-04-15T07:17:52.392Z
        /* DDL */ PERFORM AD_Element_Link_Create_Missing_Field(728047);

        -- Field: Aufgabe(114,D) -> Berechtigung(310,D) -> AD_Task_Access
        -- Column: AD_Task_Access.AD_Task_Access_ID
        -- 2024-04-15T07:17:52.521Z
        INSERT INTO AD_Field (AD_Client_ID, AD_Column_ID, AD_Field_ID, AD_Org_ID, AD_Tab_ID, Created, CreatedBy, DisplayLength, EntityType, IsActive, IsDisplayed, IsDisplayedGrid, IsEncrypted, IsFieldOnly, IsHeading, IsReadOnly, IsSameLine, Name, Updated, UpdatedBy)
        VALUES (0, 588186, 728048, 0, 310, TO_TIMESTAMP('2024-04-15 07:17:52.406000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100, 10, 'D', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'AD_Task_Access', TO_TIMESTAMP('2024-04-15 07:17:52.406000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100);
        ...
        /* DDL */ PERFORM AD_Element_Link_Create_Missing_Field(728048);
