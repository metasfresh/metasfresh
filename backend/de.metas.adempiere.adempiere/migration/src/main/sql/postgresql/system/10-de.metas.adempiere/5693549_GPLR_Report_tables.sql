-- Fixes failure of: 5693550_GPLR_Report_tables_2.sql
-- PORT-FORWARD (NEW_DAWN WINS): the new_dawn_uat base RECORDS filename
-- 5692690_GPLR_Report_tables.sql in AD_MigrationScript but has NO GPLR_Report
-- objects (table/AD metadata all absent), so the migration tool would SKIP a
-- 5692690-named copy and the dependent GPLR_Report_tables_2..7 scripts fail on the
-- missing table. Re-numbered to an unrecorded forced-ordering sub-slot (< 5693550)
-- so the GPLR feature is actually created before its dependents. Copied from
-- origin/master 5692690_GPLR_Report_tables.sql; AD_Sequence StartNewYear column
-- stripped (absent in this base).
...
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNo,Updated,UpdatedBy) VALUES (0,0,556279,TO_TIMESTAMP('2023-06-27 13:34:18','YYYY-MM-DD HH24:MI:SS'),100,1000000,50000,'Table GPLR_Report_Shipment',1,'Y','N','Y','Y','GPLR_Report_Shipment',1000000,TO_TIMESTAMP('2023-06-27 13:34:18','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNo,Updated,UpdatedBy) VALUES (0,0,556280,TO_TIMESTAMP('2023-06-27 14:34:56','YYYY-MM-DD HH24:MI:SS'),100,1000000,50000,'Table GPLR_Report_PurchaseOrder',1,'Y','N','Y','Y','GPLR_Report_PurchaseOrder',1000000,TO_TIMESTAMP('2023-06-27 14:34:56','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNo,Updated,UpdatedBy) VALUES (0,0,556282,TO_TIMESTAMP('2023-06-27 16:43:52','YYYY-MM-DD HH24:MI:SS'),100,1000000,50000,'Table GPLR_Report_Line',1,'Y','N','Y','Y','GPLR_Report_Line',1000000,TO_TIMESTAMP('2023-06-27 16:43:52','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- PORT-FORWARD (NEW_DAWN WINS): shared AD_Element 582509 (Amount_LC / "Amount (LC)")
-- already exists in the new_dawn_uat base (duplicate key on ad_element_pkey). Its create
-- (AD_Element INSERT + AD_Element_Trl seed) is stripped; the base element is authoritative.
-- The GPLR AD_Column inserts referencing 582509 (586978, 586994) are kept below.
...
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNo,Updated,UpdatedBy) VALUES (0,0,556283,TO_TIMESTAMP('2023-06-27 22:45:02','YYYY-MM-DD HH24:MI:SS'),100,1000000,50000,'Table GPLR_Report_Charge',1,'Y','N','Y','Y','GPLR_Report_Charge',1000000,TO_TIMESTAMP('2023-06-27 22:45:02','YYYY-MM-DD HH24:MI:SS'),100)
;
