...
-- 2026-08-17 09:01:00
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,585308 /*From ID Server*/,0,'IsCaptureCatchWeightAtReceipt',TO_TIMESTAMP('2026-08-17 09:01:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'D','Y','Fanggewicht beim Wareneingang erfassen','Fanggewicht beim Wareneingang erfassen',TO_TIMESTAMP('2026-08-17 09:01:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
UPDATE AD_Element_Trl SET Name='Fanggewicht beim Wareneingang erfassen', Description='Fanggewicht eines Fanggewicht-Produkts beim Produktions-Wareneingang erfassen.', Help='Wenn gesetzt (Standard), wird bei einem Fanggewicht-Produkt das Fanggewicht beim Produktions-Wareneingang abgefragt. Deaktivieren, damit beim Wareneingang kein Fanggewicht erfasst wird – es wird nur die nominale Menge eingegeben – und das Gewicht später erfasst wird (z. B. bei der Kommissionierung). Gilt nur für die Zeile des Hauptfertigprodukts; Kuppel- und Nebenprodukte (z. B. in ein Gebinde mit unbegrenzter Kapazität, bei dem das Fanggewicht die Menge ist) behalten die Fanggewicht-Erfassung immer.', IsTranslated='Y', Updated=TO_TIMESTAMP('2026-08-17 09:01:13.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC', UpdatedBy=100 WHERE AD_Element_ID=585308 AND AD_Language='de_DE'
;
...
-- 2026-08-17 09:02:30
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593325 /*From ID Server*/,585308,0,20,542397,'XX','IsCaptureCatchWeightAtReceipt',TO_TIMESTAMP('2026-08-17 09:02:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','Y','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Fanggewicht beim Wareneingang erfassen','NP',0,0,TO_TIMESTAMP('2026-08-17 09:02:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- 2026-08-17 09:03:30
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593329 /*From ID Server*/,585308,0,17,319,542263,'XX','IsCaptureCatchWeightAtReceipt',TO_TIMESTAMP('2026-08-17 09:03:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N',0,'Fanggewicht beim Wareneingang erfassen','NP',0,0,TO_TIMESTAMP('2026-08-17 09:03:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- Field: MobileUI Manufacturing Configuration(541788,D) -> MobileUI Manufacturing Configuration(547483,D) -> Fanggewicht beim Wareneingang erfassen (782319)
-- Column: MobileUI_MFG_Config.IsCaptureCatchWeightAtReceipt
-- 2026-08-17 09:06:30
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593325,782319 /*From ID Server*/,0,547483,TO_TIMESTAMP('2026-08-17 09:06:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fanggewicht beim Wareneingang erfassen',TO_TIMESTAMP('2026-08-17 09:06:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- Field: Nutzer(108,D) -> Mobile UI Nutzerprofil - Produktion(546679,D) -> Fanggewicht beim Wareneingang erfassen (782323)
-- Column: MobileUI_UserProfile_MFG.IsCaptureCatchWeightAtReceipt
-- 2026-08-17 09:07:30
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593329,782323 /*From ID Server*/,0,546679,TO_TIMESTAMP('2026-08-17 09:07:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fanggewicht beim Wareneingang erfassen',TO_TIMESTAMP('2026-08-17 09:07:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- UI Element: MobileUI Manufacturing Configuration -> config group -> 90 -> Fanggewicht beim Wareneingang erfassen (653172)
-- Column: MobileUI_MFG_Config.IsCaptureCatchWeightAtReceipt
-- 2026-08-17 09:09:30
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,782319,0,547483,551690,653172 /*From ID Server*/,'F',TO_TIMESTAMP('2026-08-17 09:09:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','Y','N','Fanggewicht beim Wareneingang erfassen',90,90,0,TO_TIMESTAMP('2026-08-17 09:09:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- UI Element: Nutzer -> Mobile UI Nutzerprofil - Produktion -> primary group -> 90 -> Fanggewicht beim Wareneingang erfassen (653176)
-- Column: MobileUI_UserProfile_MFG.IsCaptureCatchWeightAtReceipt
-- 2026-08-17 09:10:30
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,782323,0,546679,550042,653176 /*From ID Server*/,'F',TO_TIMESTAMP('2026-08-17 09:10:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','Y','N','Fanggewicht beim Wareneingang erfassen',90,90,0,TO_TIMESTAMP('2026-08-17 09:10:30.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
