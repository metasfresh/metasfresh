...
-- ============================================================================
-- AD_Element: IsAllowFinishedGoodsReceiveToLU (585305)
-- ============================================================================

-- 2026-08-17 09:00:00
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,585305 /*From ID Server*/,0,'IsAllowFinishedGoodsReceiveToLU',TO_TIMESTAMP('2026-08-17 09:00:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'D','Y','Fertigprodukt: Entnahme auf LU erlauben','Fertigprodukt: Entnahme auf LU erlauben',TO_TIMESTAMP('2026-08-17 09:00:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
UPDATE AD_Element_Trl SET Name='Finished goods: allow receiving to LU', PrintName='Finished goods: allow receiving to LU', Description='Offer load-unit (pallet/LU) targets for the finished-goods production receipt.', Help='When set, the mobile manufacturing receipt offers LU (pallet) Gebinde as receiving targets for the main finished product. Unset to hide LU targets. Applies to the main finished-good line only — co- and by-products are not affected.', IsTranslated='Y', Updated=TO_TIMESTAMP('2026-08-17 09:00:12.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC', UpdatedBy=100 WHERE AD_Element_ID=585305 AND AD_Language='en_US'
;

-- 2026-08-17 09:00:13 (de_DE override — set description/help + flip IsTranslated)
UPDATE AD_Element_Trl SET Name='Fertigprodukt: Entnahme auf LU erlauben', Description='Ladeeinheit (Palette/LU) als Ziel-Gebinde für das Hauptfertigprodukt bei der Produktionsentnahme anbieten.', Help='Wenn gesetzt, bietet die mobile Produktionsentnahme Ladeeinheiten (Paletten/LU) als Ziel-Gebinde für das Hauptfertigprodukt an. Deaktivieren, um LU-Ziele auszublenden. Gilt nur für die Zeile des Hauptfertigprodukts – Kuppel- und Nebenprodukte sind nicht betroffen.', IsTranslated='Y', Updated=TO_TIMESTAMP('2026-08-17 09:00:13.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC', UpdatedBy=100 WHERE AD_Element_ID=585305 AND AD_Language='de_DE'
;
...
-- ============================================================================
-- AD_Element: IsAllowFinishedGoodsReceiveToTU (585306)
-- ============================================================================

-- 2026-08-17 09:00:20
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,585306 /*From ID Server*/,0,'IsAllowFinishedGoodsReceiveToTU',TO_TIMESTAMP('2026-08-17 09:00:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'D','Y','Fertigprodukt: Entnahme auf TU erlauben','Fertigprodukt: Entnahme auf TU erlauben',TO_TIMESTAMP('2026-08-17 09:00:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- ============================================================================
-- AD_Element: IsSkipFinishedGoodsReceiveTargetStep (585307)
-- ============================================================================

-- 2026-08-17 09:00:40
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,585307 /*From ID Server*/,0,'IsSkipFinishedGoodsReceiveTargetStep',TO_TIMESTAMP('2026-08-17 09:00:40.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'D','Y','Fertigprodukt: Gebinde-Auswahl überspringen','Fertigprodukt: Gebinde-Auswahl überspringen',TO_TIMESTAMP('2026-08-17 09:00:40.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
UPDATE AD_Element_Trl SET Name='Finished goods: skip receiving-target step', PrintName='Finished goods: skip receiving-target step', Description='Skip the new-Gebinde / scan-existing screen for the finished good and go straight to the packing instruction.', Help='When set, the mobile manufacturing receipt skips the intermediate target-choice screen (new Gebinde vs. scan an existing one) for the main finished product and goes directly to the packing-instruction (Packvorschrift) list. Use when finished goods are always received onto a new pallet. Applies to the main finished-good line only.', IsTranslated='Y', Updated=TO_TIMESTAMP('2026-08-17 09:00:52.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC', UpdatedBy=100 WHERE AD_Element_ID=585307 AND AD_Language='en_US'
;

-- 2026-08-17 09:00:53 (de_DE override)
UPDATE AD_Element_Trl SET Name='Fertigprodukt: Gebinde-Auswahl überspringen', Description='Bildschirm „Neues Gebinde / bestehendes scannen“ für das Hauptfertigprodukt überspringen und direkt zur Packvorschrift springen.', Help='Wenn gesetzt, überspringt die mobile Produktionsentnahme für das Hauptfertigprodukt den Zwischenschritt zur Gebinde-Auswahl (neues Gebinde vs. bestehendes scannen) und geht direkt zur Packvorschrift-Liste. Verwenden, wenn Fertigprodukte immer auf eine neue Palette eingelagert werden. Gilt nur für die Zeile des Hauptfertigprodukts.', IsTranslated='Y', Updated=TO_TIMESTAMP('2026-08-17 09:00:53.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC', UpdatedBy=100 WHERE AD_Element_ID=585307 AND AD_Language='de_DE'
;
...
-- Column: MobileUI_MFG_Config.IsAllowFinishedGoodsReceiveToLU (593322) — DefaultValue='Y'
-- 2026-08-17 09:02:00
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593322 /*From ID Server*/,585305,0,20,542397,'XX','IsAllowFinishedGoodsReceiveToLU',TO_TIMESTAMP('2026-08-17 09:02:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','Y','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Fertigprodukt: Entnahme auf LU erlauben','NP',0,0,TO_TIMESTAMP('2026-08-17 09:02:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- Column: MobileUI_MFG_Config.IsAllowFinishedGoodsReceiveToTU (593323) — DefaultValue='Y'
-- 2026-08-17 09:02:10
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593323 /*From ID Server*/,585306,0,20,542397,'XX','IsAllowFinishedGoodsReceiveToTU',TO_TIMESTAMP('2026-08-17 09:02:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','Y','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Fertigprodukt: Entnahme auf TU erlauben','NP',0,0,TO_TIMESTAMP('2026-08-17 09:02:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- Column: MobileUI_MFG_Config.IsSkipFinishedGoodsReceiveTargetStep (593324) — DefaultValue='N'
-- 2026-08-17 09:02:20
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593324 /*From ID Server*/,585307,0,20,542397,'XX','IsSkipFinishedGoodsReceiveTargetStep',TO_TIMESTAMP('2026-08-17 09:02:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','N','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Fertigprodukt: Gebinde-Auswahl überspringen','NP',0,0,TO_TIMESTAMP('2026-08-17 09:02:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- Column: MobileUI_UserProfile_MFG.IsAllowFinishedGoodsReceiveToLU (593326)
-- 2026-08-17 09:03:00
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593326 /*From ID Server*/,585305,0,17,319,542263,'XX','IsAllowFinishedGoodsReceiveToLU',TO_TIMESTAMP('2026-08-17 09:03:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N',0,'Fertigprodukt: Entnahme auf LU erlauben','NP',0,0,TO_TIMESTAMP('2026-08-17 09:03:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- Column: MobileUI_UserProfile_MFG.IsAllowFinishedGoodsReceiveToTU (593327)
-- 2026-08-17 09:03:10
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593327 /*From ID Server*/,585306,0,17,319,542263,'XX','IsAllowFinishedGoodsReceiveToTU',TO_TIMESTAMP('2026-08-17 09:03:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N',0,'Fertigprodukt: Entnahme auf TU erlauben','NP',0,0,TO_TIMESTAMP('2026-08-17 09:03:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- Column: MobileUI_UserProfile_MFG.IsSkipFinishedGoodsReceiveTargetStep (593328)
-- 2026-08-17 09:03:20
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,CloningStrategy,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,PersonalDataCategory,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,593328 /*From ID Server*/,585307,0,17,319,542263,'XX','IsSkipFinishedGoodsReceiveTargetStep',TO_TIMESTAMP('2026-08-17 09:03:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N',0,'Fertigprodukt: Gebinde-Auswahl überspringen','NP',0,0,TO_TIMESTAMP('2026-08-17 09:03:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
-- 2026-08-17 09:05:00
/* DDL */ SELECT public.db_alter_table('MobileUI_MFG_Config','ALTER TABLE public.MobileUI_MFG_Config ADD COLUMN IsAllowFinishedGoodsReceiveToLU CHAR(1) DEFAULT ''Y'' CHECK (IsAllowFinishedGoodsReceiveToLU IN (''Y'',''N'')) NOT NULL')
;

-- 2026-08-17 09:05:01
/* DDL */ SELECT public.db_alter_table('MobileUI_MFG_Config','ALTER TABLE public.MobileUI_MFG_Config ADD COLUMN IsAllowFinishedGoodsReceiveToTU CHAR(1) DEFAULT ''Y'' CHECK (IsAllowFinishedGoodsReceiveToTU IN (''Y'',''N'')) NOT NULL')
;

-- 2026-08-17 09:05:02
/* DDL */ SELECT public.db_alter_table('MobileUI_MFG_Config','ALTER TABLE public.MobileUI_MFG_Config ADD COLUMN IsSkipFinishedGoodsReceiveTargetStep CHAR(1) DEFAULT ''N'' CHECK (IsSkipFinishedGoodsReceiveTargetStep IN (''Y'',''N'')) NOT NULL')
;
...
-- 2026-08-17 09:05:04
/* DDL */ SELECT public.db_alter_table('MobileUI_UserProfile_MFG','ALTER TABLE public.MobileUI_UserProfile_MFG ADD COLUMN IsAllowFinishedGoodsReceiveToLU CHAR(1) CHECK (IsAllowFinishedGoodsReceiveToLU IN (''Y'',''N''))')
;

-- 2026-08-17 09:05:05
/* DDL */ SELECT public.db_alter_table('MobileUI_UserProfile_MFG','ALTER TABLE public.MobileUI_UserProfile_MFG ADD COLUMN IsAllowFinishedGoodsReceiveToTU CHAR(1) CHECK (IsAllowFinishedGoodsReceiveToTU IN (''Y'',''N''))')
;

-- 2026-08-17 09:05:06
/* DDL */ SELECT public.db_alter_table('MobileUI_UserProfile_MFG','ALTER TABLE public.MobileUI_UserProfile_MFG ADD COLUMN IsSkipFinishedGoodsReceiveTargetStep CHAR(1) CHECK (IsSkipFinishedGoodsReceiveTargetStep IN (''Y'',''N''))')
;
...
-- Field: MobileUI Manufacturing Configuration(541788,D) -> MobileUI Manufacturing Configuration(547483,D) -> Fertigprodukt: Entnahme auf LU erlauben (782316)
-- Column: MobileUI_MFG_Config.IsAllowFinishedGoodsReceiveToLU
-- 2026-08-17 09:06:00
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593322,782316 /*From ID Server*/,0,547483,TO_TIMESTAMP('2026-08-17 09:06:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fertigprodukt: Entnahme auf LU erlauben',TO_TIMESTAMP('2026-08-17 09:06:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- Field: MobileUI Manufacturing Configuration(541788,D) -> MobileUI Manufacturing Configuration(547483,D) -> Fertigprodukt: Entnahme auf TU erlauben (782317)
-- Column: MobileUI_MFG_Config.IsAllowFinishedGoodsReceiveToTU
-- 2026-08-17 09:06:10
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593323,782317 /*From ID Server*/,0,547483,TO_TIMESTAMP('2026-08-17 09:06:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fertigprodukt: Entnahme auf TU erlauben',TO_TIMESTAMP('2026-08-17 09:06:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- Field: MobileUI Manufacturing Configuration(541788,D) -> MobileUI Manufacturing Configuration(547483,D) -> Fertigprodukt: Gebinde-Auswahl überspringen (782318)
-- Column: MobileUI_MFG_Config.IsSkipFinishedGoodsReceiveTargetStep
-- 2026-08-17 09:06:20
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593324,782318 /*From ID Server*/,0,547483,TO_TIMESTAMP('2026-08-17 09:06:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fertigprodukt: Gebinde-Auswahl überspringen',TO_TIMESTAMP('2026-08-17 09:06:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- Field: Nutzer(108,D) -> Mobile UI Nutzerprofil - Produktion(546679,D) -> Fertigprodukt: Entnahme auf LU erlauben (782320)
-- Column: MobileUI_UserProfile_MFG.IsAllowFinishedGoodsReceiveToLU
-- 2026-08-17 09:07:00
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593326,782320 /*From ID Server*/,0,546679,TO_TIMESTAMP('2026-08-17 09:07:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fertigprodukt: Entnahme auf LU erlauben',TO_TIMESTAMP('2026-08-17 09:07:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- Field: Nutzer(108,D) -> Mobile UI Nutzerprofil - Produktion(546679,D) -> Fertigprodukt: Entnahme auf TU erlauben (782321)
-- Column: MobileUI_UserProfile_MFG.IsAllowFinishedGoodsReceiveToTU
-- 2026-08-17 09:07:10
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593327,782321 /*From ID Server*/,0,546679,TO_TIMESTAMP('2026-08-17 09:07:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fertigprodukt: Entnahme auf TU erlauben',TO_TIMESTAMP('2026-08-17 09:07:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- Field: Nutzer(108,D) -> Mobile UI Nutzerprofil - Produktion(546679,D) -> Fertigprodukt: Gebinde-Auswahl überspringen (782322)
-- Column: MobileUI_UserProfile_MFG.IsSkipFinishedGoodsReceiveTargetStep
-- 2026-08-17 09:07:20
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,593328,782322 /*From ID Server*/,0,546679,TO_TIMESTAMP('2026-08-17 09:07:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','N','N','N','N','N','N','N','Fertigprodukt: Gebinde-Auswahl überspringen',TO_TIMESTAMP('2026-08-17 09:07:20.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
-- UI Element: MobileUI Manufacturing Configuration -> config group -> 60 -> Fertigprodukt: Entnahme auf LU erlauben (653169)
-- Column: MobileUI_MFG_Config.IsAllowFinishedGoodsReceiveToLU
-- 2026-08-17 09:09:00
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,782316,0,547483,551690,653169 /*From ID Server*/,'F',TO_TIMESTAMP('2026-08-17 09:09:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','Y','N','Fertigprodukt: Entnahme auf LU erlauben',60,60,0,TO_TIMESTAMP('2026-08-17 09:09:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;

-- UI Element: MobileUI Manufacturing Configuration -> config group -> 70 -> Fertigprodukt: Entnahme auf TU erlauben (653170)
-- Column: MobileUI_MFG_Config.IsAllowFinishedGoodsReceiveToTU
-- 2026-08-17 09:09:10
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,782317,0,547483,551690,653170 /*From ID Server*/,'F',TO_TIMESTAMP('2026-08-17 09:09:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','Y','N','Fertigprodukt: Entnahme auf TU erlauben',70,70,0,TO_TIMESTAMP('2026-08-17 09:09:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;

-- UI Element: MobileUI Manufacturing Configuration -> config group -> 80 -> Fertigprodukt: Gebinde-Auswahl überspringen (653171)
-- Column: MobileUI_MFG_Config.IsSkipFinishedGoodsReceiveTargetStep
-- 2026-08-17 09:09:20
...
-- UI Element: Nutzer -> Mobile UI Nutzerprofil - Produktion -> primary group -> 60 -> Fertigprodukt: Entnahme auf LU erlauben (653173)
-- Column: MobileUI_UserProfile_MFG.IsAllowFinishedGoodsReceiveToLU
-- 2026-08-17 09:10:00
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,782320,0,546679,550042,653173 /*From ID Server*/,'F',TO_TIMESTAMP('2026-08-17 09:10:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','Y','N','Fertigprodukt: Entnahme auf LU erlauben',60,60,0,TO_TIMESTAMP('2026-08-17 09:10:00.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;

-- UI Element: Nutzer -> Mobile UI Nutzerprofil - Produktion -> primary group -> 70 -> Fertigprodukt: Entnahme auf TU erlauben (653174)
-- Column: MobileUI_UserProfile_MFG.IsAllowFinishedGoodsReceiveToTU
-- 2026-08-17 09:10:10
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,IsActive,IsAdvancedField,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,782321,0,546679,550042,653174 /*From ID Server*/,'F',TO_TIMESTAMP('2026-08-17 09:10:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','Y','N','Fertigprodukt: Entnahme auf TU erlauben',70,70,0,TO_TIMESTAMP('2026-08-17 09:10:10.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;

-- UI Element: Nutzer -> Mobile UI Nutzerprofil - Produktion -> primary group -> 80 -> Fertigprodukt: Gebinde-Auswahl überspringen (653175)
-- Column: MobileUI_UserProfile_MFG.IsSkipFinishedGoodsReceiveTargetStep
-- 2026-08-17 09:10:20
