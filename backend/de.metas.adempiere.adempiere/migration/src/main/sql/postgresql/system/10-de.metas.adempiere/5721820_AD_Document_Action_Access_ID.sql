/*
delete from ad_field where ad_column_id=588187;
delete from ad_column where ad_column_id=588187;
alter table AD_Document_Action_Access drop column AD_Document_Action_Access_ID;
...
$$
    ...
    BEGIN
        ...
        WHERE t.tablename = 'AD_Document_Action_Access'
          AND c.columnname = 'AD_Document_Action_Access_ID';

        IF (v_count > 0) THEN
            RAISE NOTICE 'Column AD_Document_Action_Access.AD_Document_Action_Access_ID already exists. Do nothing';
            RETURN;
        END IF;
        ...
        VALUES (0, 588187, 543335, 0, 13, 53012, 'AD_Document_Action_Access_ID', TO_TIMESTAMP('2024-04-15 07:18:20.718000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100, 'D', 10, 'Y', 'Y', 'N', 'N', 'N', 'Y', 'Y', 'N', 'N', 'N', 'N', 'Document Action Access',
                TO_TIMESTAMP('2024-04-15 07:18:20.718000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100, 1);
        ...
        WHERE l.IsActive = 'Y'
          ...
          AND t.AD_Column_ID = 588187
          AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language = l.AD_Language AND tt.AD_Column_ID = t.AD_Column_ID);

        -- 2024-04-15T07:18:20.999Z
        /* DDL */
        PERFORM update_Column_Translation_From_AD_Element(543335);
        ...
        ALTER TABLE AD_Document_Action_Access
            ADD COLUMN AD_Document_Action_Access_ID numeric(10, 0) NOT NULL DEFAULT NEXTVAL('ad_document_action_access_seq');
