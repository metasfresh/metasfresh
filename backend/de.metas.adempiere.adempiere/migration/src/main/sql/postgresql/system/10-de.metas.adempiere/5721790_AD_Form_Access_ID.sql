/*
delete from ad_field where ad_column_id=588184;
delete from ad_column where ad_column_id=588184;
alter table AD_Form_Access drop column AD_Form_Access_ID;
...
$$
    ...
    BEGIN
        ...
        WHERE t.tablename = 'AD_Form_Access'
          AND c.columnname = 'AD_Form_Access_ID';

        IF (v_count > 0) THEN
            RAISE NOTICE 'Column AD_Form_Access.AD_Form_Access_ID already exists. Do nothing';
            RETURN;
        END IF;
        ...
        WHERE l.IsActive = 'Y'
          ...
          AND t.AD_Column_ID = 588184
          AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language = l.AD_Language AND tt.AD_Column_ID = t.AD_Column_ID);

        -- 2024-04-15T07:16:47.353Z
        /* DDL */
        PERFORM update_Column_Translation_From_AD_Element(543336);
        ...
        ALTER TABLE AD_Form_Access
            ADD COLUMN AD_Form_Access_ID numeric(10, 0) NOT NULL DEFAULT NEXTVAL('ad_form_access_seq');
        ...
        VALUES (0, 588184, 728042, 0, 306, TO_TIMESTAMP('2024-04-15 07:16:47.676000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100, 10, 'D', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'AD_Form_Access', TO_TIMESTAMP('2024-04-15 07:16:47.676000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100);
        ...
        WHERE l.IsActive = 'Y'
          AND (l.IsSystemLanguage = 'Y' OR l.IsBaseLanguage = 'Y')
          AND t.AD_Field_ID = 728042
          AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language = l.AD_Language AND tt.AD_Field_ID = t.AD_Field_ID);

        -- 2024-04-15T07:16:47.815Z
        /* DDL */
        PERFORM update_FieldTranslation_From_AD_Name_Element(543336);

        -- 2024-04-15T07:16:47.820Z
        DELETE FROM AD_Element_Link WHERE AD_Field_ID = 728042;

        -- 2024-04-15T07:16:47.822Z
        /* DDL */ PERFORM AD_Element_Link_Create_Missing_Field(728042);

        -- Field: Fenster (nicht dynamisch)(187,D) -> Berechtigung(309,D) -> AD_Form_Access
        -- Column: AD_Form_Access.AD_Form_Access_ID
        -- 2024-04-15T07:16:47.959Z
        INSERT INTO AD_Field (AD_Client_ID, AD_Column_ID, AD_Field_ID, AD_Org_ID, AD_Tab_ID, Created, CreatedBy, DisplayLength, EntityType, IsActive, IsDisplayed, IsDisplayedGrid, IsEncrypted, IsFieldOnly, IsHeading, IsReadOnly, IsSameLine, Name, Updated, UpdatedBy)
        VALUES (0, 588184, 728043, 0, 309, TO_TIMESTAMP('2024-04-15 07:16:47.844000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100, 10, 'D', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'AD_Form_Access', TO_TIMESTAMP('2024-04-15 07:16:47.844000', 'YYYY-MM-DD HH24:MI:SS.US')::timestamp WITHOUT TIME ZONE AT TIME ZONE 'UTC', 100);
        ...
        -- 2024-04-15T07:16:47.967Z
        /* DDL */ PERFORM AD_Element_Link_Create_Missing_Field(728043);
