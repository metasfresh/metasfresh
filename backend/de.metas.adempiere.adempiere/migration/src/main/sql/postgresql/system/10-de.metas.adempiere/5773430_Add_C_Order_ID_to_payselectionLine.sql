...
-- on some DBs this field already exists - since 2015 - without a migration script
UPDATE ad_element_link SET AD_Field_ID=754992 where AD_Field_ID=(select ad_field_id from ad_field where ad_tab_id=353 and ad_column_id=552758); 
UPDATE AD_Field_Trl SET AD_Field_ID=754992 where AD_Field_ID=(select ad_field_id from ad_field where ad_tab_id=353 and ad_column_id=552758); 
UPDATE AD_Field SET AD_Field_ID=754992 where ad_tab_id=353 and ad_column_id=552758;
