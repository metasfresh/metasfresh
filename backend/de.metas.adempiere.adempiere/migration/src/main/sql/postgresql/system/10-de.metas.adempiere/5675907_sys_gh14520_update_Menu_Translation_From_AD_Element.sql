...
BEGIN
    ...
    WHERE (p_AD_Element_ID IS NULL OR e_trl.AD_Element_ID = p_AD_Element_ID)
      ...
      AND EXISTS(
            SELECT 1 FROM ad_menu m WHERE m.ad_element_id = e_trl.ad_element_id AND m.ad_menu_id = m_trl.ad_menu_id)
      AND m_trl.updated <> e_trl.updated;
