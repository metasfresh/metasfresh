...
CREATE OR REPLACE FUNCTION update_Process_Para_Translation_From_AD_Element(p_AD_Element_ID numeric = NULL,
...
COMMENT ON FUNCTION update_Process_Para_Translation_From_AD_Element(numeric, character varying) IS
