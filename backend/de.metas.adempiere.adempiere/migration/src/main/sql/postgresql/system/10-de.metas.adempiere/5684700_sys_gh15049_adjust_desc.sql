...
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(582207,'fr_CH') 
;
...
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(582207,'nl_NL') 
;

-- Element: InvoiceAdditionalText
-- 2023-04-11T06:28:24.258Z
UPDATE AD_Element_Trl SET Description='',Updated=TO_TIMESTAMP('2023-04-11 08:28:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=582034 AND AD_Language='de_CH'
;

-- 2023-04-11T06:28:24.260Z
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(582034,'de_CH') 
;

-- Element: InvoiceAdditionalText
-- 2023-04-11T06:28:33.707Z
UPDATE AD_Element_Trl SET Description='',Updated=TO_TIMESTAMP('2023-04-11 08:28:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=582034 AND AD_Language='de_DE'
;

-- 2023-04-11T06:28:33.708Z
UPDATE AD_Element SET Description='' WHERE AD_Element_ID=582034
;

-- 2023-04-11T06:28:38.175Z
/* DDL */  select update_ad_element_on_ad_element_trl_update(582034,'de_DE') 
;

-- 2023-04-11T06:28:38.177Z
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(582034,'de_DE') 
;

-- Element: InvoiceAdditionalText
-- 2023-04-11T06:28:45.492Z
UPDATE AD_Element_Trl SET Description='',Updated=TO_TIMESTAMP('2023-04-11 08:28:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=582034 AND AD_Language='en_US'
;

-- 2023-04-11T06:28:45.494Z
/* DDL */  select update_TRL_Tables_On_AD_Element_TRL_Update(582034,'en_US') 
;
