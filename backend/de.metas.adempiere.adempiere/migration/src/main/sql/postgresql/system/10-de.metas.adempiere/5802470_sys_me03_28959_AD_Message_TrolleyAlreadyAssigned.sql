...
VALUES (0,545685 /*From ID Server*/,0,TO_TIMESTAMP('2026-05-15 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','Dieser Wagen ist bereits einem anderen Nutzer zugewiesen. Bitte den Nutzer um Freigabe.','E',TO_TIMESTAMP('2026-05-15 10:00:00','YYYY-MM-DD HH24:MI:SS'),100,'WFRestAPI_TrolleyAlreadyAssigned')
;

-- 2026-05-15T10:00:01.000Z
UPDATE AD_Message SET ErrorCode='TrolleyAlreadyAssigned', Updated=TO_TIMESTAMP('2026-05-15 10:00:01','YYYY-MM-DD HH24:MI:SS'), UpdatedBy=100 WHERE AD_Message_ID=545685 /*From ID Server*/
;
...
-- 2026-05-15T10:00:03.000Z
UPDATE AD_Message_Trl SET MsgText='This trolley is already assigned to another user. Please ask them to release it first.',IsTranslated='Y',Updated=TO_TIMESTAMP('2026-05-15 10:00:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Language='en_US' AND AD_Message_ID=545685 /*From ID Server*/
;

-- Mark de_DE and de_CH as actively translated (same text as base; flips IsTranslated to Y).
-- 2026-05-15T10:00:04.000Z
UPDATE AD_Message_Trl SET IsTranslated='Y',Updated=TO_TIMESTAMP('2026-05-15 10:00:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Language='de_DE' AND AD_Message_ID=545685 /*From ID Server*/
;

-- 2026-05-15T10:00:05.000Z
UPDATE AD_Message_Trl SET IsTranslated='Y',Updated=TO_TIMESTAMP('2026-05-15 10:00:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Language='de_CH' AND AD_Message_ID=545685 /*From ID Server*/
;
