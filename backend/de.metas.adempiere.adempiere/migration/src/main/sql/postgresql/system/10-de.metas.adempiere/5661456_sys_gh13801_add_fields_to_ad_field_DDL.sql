...
-- 2022-10-22T05:58:54.114Z
/* DDL */ SELECT public.db_alter_table('AD_Field','ALTER TABLE public.AD_Field ADD COLUMN IsAlwaysUpdateable CHAR(1) DEFAULT ''N'' CHECK (IsAlwaysUpdateable IN (''Y'',''N''))')
;


-- 2022-10-22T06:00:04.449Z
INSERT INTO t_alter_column values('ad_field','IsAlwaysUpdateable','CHAR(1)',null,null)
;
