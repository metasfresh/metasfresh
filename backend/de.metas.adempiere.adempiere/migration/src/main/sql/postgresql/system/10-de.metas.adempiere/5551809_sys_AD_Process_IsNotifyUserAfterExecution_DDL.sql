...
/* DDL */ PERFORM public.db_alter_table('AD_Process','ALTER TABLE public.AD_Process ADD COLUMN IsNotifyUserAfterExecution CHAR(1) DEFAULT ''N'' CHECK (IsNotifyUserAfterExecution IN (''Y'',''N'')) NOT NULL')
;
