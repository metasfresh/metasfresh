...
-- guard keeps this forward-compatible with the wider scanner-config framework (me03 #29246) that
-- may introduce the same setting in the core line.
--
...
-- instance (and setting useCamera=N) is deployment configuration and lives in the dt204 customer
-- repo via set_sysconfig_value(...), NOT here. See me03 #30363.
