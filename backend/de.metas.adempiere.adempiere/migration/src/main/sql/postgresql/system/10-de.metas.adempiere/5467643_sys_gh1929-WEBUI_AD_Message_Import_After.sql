--
-- Backup
create table backup.AD_Message_BKP_BeforeImport_5467640 as select * from AD_Message;
create table backup.AD_Message_Trl_BKP_BeforeImport_5467640 as select * from AD_Message_Trl;
