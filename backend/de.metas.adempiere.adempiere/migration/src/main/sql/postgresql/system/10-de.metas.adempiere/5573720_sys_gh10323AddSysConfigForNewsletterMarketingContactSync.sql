...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_SysConfig SET Description='This sys config specifies whether a use should be added or removed from a marketing campaign when setting the ''isNewsletter'' flag to Y or N.',Updated=TO_TIMESTAMP('2020-12-02 13:19:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_SysConfig_ID=541347
;
