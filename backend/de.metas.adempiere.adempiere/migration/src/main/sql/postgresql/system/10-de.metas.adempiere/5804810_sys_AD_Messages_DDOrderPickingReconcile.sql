...
UPDATE AD_Message_Trl SET MsgText='No source warehouse found in distribution network {0} for product {1} (packing warehouse).',IsTranslated='Y',Updated=TO_TIMESTAMP('2026-05-27 01:00:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Language='en_US' AND AD_Message_ID=545726 /*From ID Server*/
;
