...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy, Value, MsgType, MsgText, ErrorCode)
VALUES (545702 /*From ID Server*/, 0, 0, 'Y', TIMESTAMP '2026-05-21 00:00:00', 100, TIMESTAMP '2026-05-21 00:00:00', 100, 'TaxDeclaration_PeriodOverlap', 'E', 'Eine andere abgeschlossene Steuererklärung deckt diesen Zeitraum für das gleiche Buchungsschema bereits ab.', 'TAXDECLARATION_PERIOD_OVERLAP');
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy, Value, MsgType, MsgText, ErrorCode)
VALUES (545703 /*From ID Server*/, 0, 0, 'Y', TIMESTAMP '2026-05-21 00:00:00', 100, TIMESTAMP '2026-05-21 00:00:00', 100, 'TaxDeclaration_PeriodUniqueness', 'E', 'Pro Buchungsschema und Periode ist nur eine abgeschlossene Steuererklärung zulässig.', 'TAXDECLARATION_PERIOD_UNIQUENESS');
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy, Value, MsgType, MsgText, ErrorCode)
VALUES (545704 /*From ID Server*/, 0, 0, 'Y', TIMESTAMP '2026-05-21 00:00:00', 100, TIMESTAMP '2026-05-21 00:00:00', 100, 'TaxDeclaration_NoLinesYet', 'E', 'Eine Steuererklärung ohne Zeilen kann nicht abgeschlossen werden. Zuerst „Zeilen erstellen" ausführen.', 'TAXDECLARATION_NO_LINES_YET');
