...
VALUES (0,584852 /*From ID Server*/,0,'IsPrintDDOrderOnComplete',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,'D','Y','Print DD_Order on Complete','Print DD_Order on Complete',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
UPDATE AD_Element_Trl SET Name='Print DD_Order on Complete', PrintName='Print DD_Order on Complete',
...
VALUES (0,592506 /*From ID Server*/,584852,0,20,542462,'XX','IsPrintDDOrderOnComplete',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','Y','D',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Print DD_Order on Complete','NP',0,0,TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
...
VALUES (0,592506,779178 /*From ID Server*/,0,547735,TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,1,'D','Y','Y','N','N','N','N','N','N','Print DD_Order on Complete',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
...
VALUES (0,779178,0,547735,553846,651162 /*From ID Server*/,'F',TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100,'Y','N','Y','N','N','Print DD_Order on Complete',30,0,0,TO_TIMESTAMP('2026-05-11 14:00:00','YYYY-MM-DD HH24:MI:SS')::timestamp without time zone AT TIME ZONE 'UTC',100)
;
