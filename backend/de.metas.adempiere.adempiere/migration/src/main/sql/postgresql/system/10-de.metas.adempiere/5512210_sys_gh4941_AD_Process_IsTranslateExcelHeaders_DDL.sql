...
DO $$
    BEGIN
        ...
        /* DDL */ PERFORM public.db_alter_table('AD_Process','ALTER TABLE public.AD_Process ADD COLUMN IsTranslateExcelHeaders CHAR(1) DEFAULT ''Y'' CHECK (IsTranslateExcelHeaders IN (''Y'',''N'')) NOT NULL')
        ;
