...
/* DDL */ SELECT public.db_alter_table('M_Product','ALTER TABLE public.M_Product ADD COLUMN Grade VARCHAR(250)')
;



-- 2022-11-16T18:33:18.582Z
/* DDL */ CREATE TABLE public.M_Delivery_Planning (ActualDeliveredQty NUMERIC, ActualDeliveryDate TIMESTAMP WITHOUT TIME ZONE, ActualLoadingDate TIMESTAMP WITHOUT TIME ZONE, ActualLoadQty NUMERIC, AD_Client_ID NUMERIC(10) NOT NULL, 
AD_Org_ID NUMERIC(10) NOT NULL, Batch VARCHAR(250), C_BPartner_ID NUMERIC(10), C_BPartner_Location_ID NUMERIC(10), C_Incoterms_ID NUMERIC(10), C_Order_ID NUMERIC(10), Created TIMESTAMP WITH TIME ZONE NOT NULL, CreatedBy NUMERIC(10) NOT NULL, 
Forwarder VARCHAR(1000), IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, IsB2B CHAR(1) DEFAULT 'N' CHECK (IsB2B IN ('Y','N')) NOT NULL, M_Delivery_Planning_ID NUMERIC(10) NOT NULL, M_Delivery_Planning_Type VARCHAR(250),
 MeansOfTransportation VARCHAR(250), M_Product_ID NUMERIC(10), M_ReceiptSchedule_ID NUMERIC(10), M_SectionCode_ID NUMERIC(10), M_ShipmentSchedule_ID NUMERIC(10), M_ShipperTransportation_ID NUMERIC(10), M_Warehouse_ID NUMERIC(10), 
 OrderStatus VARCHAR(250), OriginCountry VARCHAR(250), PlannedDeliveryDate TIMESTAMP WITHOUT TIME ZONE, PlannedLoadingDate TIMESTAMP WITHOUT TIME ZONE, QtyOrdered NUMERIC, QtyTotalOpen NUMERIC, ReleaseNo VARCHAR(250),
 TransportDetails VARCHAR(5000), Updated TIMESTAMP WITH TIME ZONE NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, WayBillNo VARCHAR(15),
