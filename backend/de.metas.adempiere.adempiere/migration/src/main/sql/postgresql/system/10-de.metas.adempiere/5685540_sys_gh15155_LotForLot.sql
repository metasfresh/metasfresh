...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,582267,0,TO_TIMESTAMP('2023-04-27 09:24:16.12','YYYY-MM-DD HH24:MI:SS.US'),100,'Gibt an ob bei der Berechnung der Anzahl Lot for Lot verwendet wurde, welches in den Produkt Plandaten konfiguriert wird. Gibt leer an, wenn nicht eindeutig bestimmbar oder nicht via Produkt Plandaten erstellt.','U','Y','Lot for Lot','Lot for Lot',TO_TIMESTAMP('2023-04-27 09:24:16.12','YYYY-MM-DD HH24:MI:SS.US'),100)
;
...
UPDATE AD_Element_Trl SET Description='Indicates whether Lot for Lot was used in the calculation of the number, which is configured in the product planning. Indicates none, if not clearly determinable or not created via product planning.', IsTranslated='Y',Updated=TO_TIMESTAMP('2023-04-27 09:25:49.27','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Element_ID=582267 AND AD_Language='en_US'
;
...
UPDATE AD_Field SET AD_Name_ID=582267, Description='Gibt an ob bei der Berechnung der Anzahl Lot for Lot verwendet wurde, welches in den Produkt Plandaten konfiguriert wird. Gibt leer an, wenn nicht eindeutig bestimmbar oder nicht via Produkt Plandaten erstellt.', Help=NULL, Name='Lot for Lot',Updated=TO_TIMESTAMP('2023-04-27 09:27:47.563','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Field_ID=715028
;
...
UPDATE AD_UI_Element SET Description='Gibt an ob bei der Berechnung der Anzahl Lot for Lot verwendet wurde, welches in den Produkt Plandaten konfiguriert wird. Gibt leer an, wenn nicht eindeutig bestimmbar oder nicht via Produkt Plandaten erstellt.',Updated=TO_TIMESTAMP('2023-04-27 09:31:48.417','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_UI_Element_ID=617259
;

-- Column: PP_Order_Candidate.IsLotForLot
-- 2023-05-17T12:08:26.208Z
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,Description,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,586659,582256,0,17,540528,541913,'IsLotForLot',TO_TIMESTAMP('2023-05-17 14:08:26.028','YYYY-MM-DD HH24:MI:SS.US'),100,'N','','Erzwingt, dass die Menge gleich der bestellten Menge ist.','EE01',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','Y','N',0,'Lot for Lot',0,0,TO_TIMESTAMP('2023-05-17 14:08:26.028','YYYY-MM-DD HH24:MI:SS.US'),100,0)
;

-- 2023-05-17T12:08:26.210Z
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Column t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y') AND t.AD_Column_ID=586659 AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Column_ID=t.AD_Column_ID)
;

-- 2023-05-17T12:08:26.238Z
/* DDL */  select update_Column_Translation_From_AD_Element(582256)
;

-- 2023-05-17T12:09:04.302Z
/* DDL */ SELECT public.db_alter_table('PP_Order_Candidate','ALTER TABLE public.PP_Order_Candidate ADD COLUMN IsLotForLot CHAR(1)')
;

-- Field: Produktionsdisposition -> Produktionsdisposition -> Lot for Lot
-- Column: PP_Order_Candidate.IsLotForLot
-- 2023-05-17T12:16:14.616Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Name_ID,AD_Org_ID,AD_Tab_ID,ColumnDisplayLength,Created,CreatedBy,Description,DisplayLength,EntityType,IncludedTabHeight,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SeqNoGrid,SortNo,SpanX,SpanY,Updated,UpdatedBy) VALUES (0,586659,715333,582267,0,544794,0,TO_TIMESTAMP('2023-05-17 14:16:14.492','YYYY-MM-DD HH24:MI:SS.US'),100,'Erzwingt, dass die Menge gleich der bestellten Menge ist.',0,'EE04',0,'Y','N','N','N','N','N','Y','N','Lot for Lot',0,10,0,1,1,TO_TIMESTAMP('2023-05-17 14:16:14.492','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- 2023-05-17T12:16:14.619Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y') AND t.AD_Field_ID=715333 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2023-05-17T12:16:14.622Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(582256)
;

-- 2023-05-17T12:16:14.634Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=715333
;

-- 2023-05-17T12:16:14.637Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(715333)
;

-- UI Element: Produktionsdisposition -> Produktionsdisposition.Lot for Lot
-- Column: PP_Order_Candidate.IsLotForLot
-- 2023-05-17T12:18:05.122Z
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,Description,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,715333,0,544794,547107,617432,'F',TO_TIMESTAMP('2023-05-17 14:18:05.009','YYYY-MM-DD HH24:MI:SS.US'),100,'Erzwingt, dass die Menge gleich der bestellten Menge ist.','Y','N','N','Y','N','N','N',0,'Lot for Lot',30,0,0,TO_TIMESTAMP('2023-05-17 14:18:05.009','YYYY-MM-DD HH24:MI:SS.US'),100)
;

-- Field: Produktionsdisposition -> Produktionsdisposition -> Lot for Lot
-- Column: PP_Order_Candidate.IsLotForLot
-- 2023-05-17T12:18:48.277Z
UPDATE AD_Field SET AD_Name_ID=582267, Description='Gibt an ob bei der Berechnung der Anzahl Lot for Lot verwendet wurde, welches in den Produkt Plandaten konfiguriert wird. Gibt leer an, wenn nicht eindeutig bestimmbar oder nicht via Produkt Plandaten erstellt.', Help=NULL, Name='Lot for Lot',Updated=TO_TIMESTAMP('2023-05-17 14:18:48.277','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Field_ID=715333
;

-- 2023-05-17T12:18:48.280Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(582267)
;

-- 2023-05-17T12:18:48.282Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=715333
;

-- 2023-05-17T12:18:48.283Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(715333)
;
