...
from m_productprice mpp
         ...
         left join M_DiscountSchema_Calculated_Surcharge_Price dsc ON dsc.isActive = ''Y'' AND (dsc.c_region_id = plv.c_region_id OR dsc.c_region_id ISNULL) -- new window/table and $1 = Target_PriceList_Version_ID
