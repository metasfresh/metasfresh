...
FROM (SELECT target_plv.m_pricelist_version_id                                                                       AS target_pricelist_version_id,
             m_discountschemaline_transformprices(dsl => dsl,
                                                  ...
                                                  p_applydiscountschema => source_pp.isseasonfixedprice = 'N'::bpchar AND source_pp.isactive = 'Y'::bpchar,
                                                  p_donotchangezeroprices => ds.donotchangezeroprices = 'Y'::bpchar) AS prices,
