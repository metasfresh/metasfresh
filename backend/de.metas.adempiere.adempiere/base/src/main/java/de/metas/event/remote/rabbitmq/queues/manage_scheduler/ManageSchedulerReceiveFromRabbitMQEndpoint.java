...
@Component
@EnableRabbit
public class ManageSchedulerReceiveFromRabbitMQEndpoint extends RabbitMQReceiveFromEndpointTemplate
{
	public ManageSchedulerReceiveFromRabbitMQEndpoint(
	...
	@RabbitListener(queues = { ManageSchedulerQueueConfiguration.QUEUE_NAME_SPEL })
	public void onEvent(
