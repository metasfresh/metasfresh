...
@Component
@EnableRabbit
public class CacheInvalidationReceiveFromRabbitMQEndpoint extends RabbitMQReceiveFromEndpointTemplate
{
	public CacheInvalidationReceiveFromRabbitMQEndpoint(
	...
	@RabbitListener(queues = { CacheInvalidationQueueConfiguration.QUEUE_NAME_SPEL })
	public void onEvent(
