...
public class AcctSchemaDAO implements IAcctSchemaDAO
{
	...
	private final SpringContextHolder.Lazy<PeriodRepo> periodRepo = SpringContextHolder.lazyBean(PeriodRepo.class);
	...
	public @Nullable AcctSchemaId getAcctSchemaIdByClientAndOrgOrNull(@NonNull final ClientId clientId, @NonNull final OrgId orgId)
	{
	...
	{
		final PeriodId periodId = acctSchemaRecord.getC_Period_ID() > 0 ? periodRepo.get().getPeriodId(acctSchemaRecord.getC_Period_ID()) : null;
