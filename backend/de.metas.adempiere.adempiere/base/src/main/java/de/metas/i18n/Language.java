...
public final class Language implements Serializable
{
	...
	private static final CopyOnWriteArrayList<Language> s_languages = new CopyOnWriteArrayList<>(new Language[] {
			...
			new Language("\uFE94\uFEF4\uFE91\uFEAE\uFECC\uFEDF\uFE8D (AR)",
					AD_Language_ar_TN, Locale.of("ar", "TN"), Boolean.TRUE, "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("\u0411\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 (BG)",
					AD_Language_bg_BG, Locale.of("bg", "BG"), Boolean.FALSE, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Catal\u00e0",
					AD_Language_ca_ES, Locale.of("ca", "ES"), null, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			...
			new Language("Deutsch (Schweiz)",
					AD_Language_de_CH, Locale.of("de", "CH"), Boolean.FALSE, "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("Dansk",
					AD_Language_da_DK, Locale.of("da", "DK"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("English (AU)",
					AD_Language_en_AU, Locale.of("en", "AU"), null, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("English (UK)",
					AD_Language_en_GB, Locale.UK, null, null,
					MediaSize.ISO.A4),
			new Language("Espa\u00f1ol",
					AD_Language_es_ES, Locale.of("es", "ES"), Boolean.FALSE, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Espa\u00f1ol (MX)",
					AD_Language_es_MX, Locale.of("es", "MX"), Boolean.TRUE, "dd/MM/yyyy",
					MediaSize.NA.LETTER),
			new Language("Espa\u00f1ol (CO)",
					AD_Language_es_CO, Locale.of("es", "ES"), Boolean.FALSE, "dd/MM/yyyy",
					MediaSize.NA.LETTER),
			...
			new Language("Espa\u00f1ol (DO)",
					AD_Language_es_DO, Locale.of("es", "DO"), Boolean.TRUE, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("\u0395\u03bb\u03bb\u03b7\u03bd\u03b9\u03ba\u03ac (GR)",
					AD_Language_el_GR, Locale.of("el", "GR"), Boolean.FALSE, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Farsi",
					AD_Language_fa_IR, Locale.of("fa", "IR"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Finnish",
					AD_Language_fi_FI, Locale.of("fi", "FI"), Boolean.TRUE, "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("Fran\u00e7ais",
					AD_Language_fr_FR, Locale.FRANCE, null, null, 		// dd.MM.yy
					MediaSize.ISO.A4),
			new Language("Fran\u00e7ais (CA)",
					AD_Language_fr_CA, Locale.of("fr", "CA"), Boolean.TRUE, "MM/dd/yyyy", 	// MM/dd/yy
					MediaSize.NA.LETTER),
			new Language("Hrvatski",
					AD_Language_hr_HR, Locale.of("hr", "HR"), null, "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("Indonesia Bahasa",
					AD_Language_in_ID, Locale.of("in", "ID"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
			...
			new Language("Malaysian",
					AD_Language_ms_MY, Locale.of("ms", "MY"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Magyar (HU)",
					AD_Language_hu_HU, Locale.of("hu", "HU"), Boolean.FALSE, "yyyy.MM.dd",
					MediaSize.ISO.A4),
			new Language("Nederlands",
					AD_Language_nl_NL, Locale.of("nl", "NL"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Norsk",
					AD_Language_no_NO, Locale.of("no", "NO"), Boolean.FALSE, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Polski",
					AD_Language_pl_PL, Locale.of("pl", "PL"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Portuguese (BR)",
					AD_Language_pt_BR, Locale.of("pt", "BR"), Boolean.FALSE, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Rom\u00e2n\u0103",
					AD_Language_ro_RO, Locale.of("ro", "RO"), Boolean.FALSE, "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("\u0420\u0443\u0441\u0441\u043a\u0438\u0439 (Russian)",
					AD_Language_ru_RU, Locale.of("ru", "RU"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
			new Language("Slovenski",
					AD_Language_sl_SI, Locale.of("sl", "SI"), null, "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("\u0421\u0440\u043F\u0441\u043A\u0438 (RS)",
					AD_Language_sr_RS, Locale.of("sr", "RS"), null, "dd.MM.yyyy",
					MediaSize.ISO.A4),
			new Language("Svenska",
					AD_Language_sv_SE, Locale.of("sv", "SE"), Boolean.FALSE, "yyyy-MM-dd",
					MediaSize.ISO.A4),
			new Language("\u0e44\u0e17\u0e22 (TH)",
					AD_Language_th_TH, Locale.of("th", "TH"), Boolean.FALSE, "dd/MM/yyyy",
					MediaSize.ISO.A4),
			new Language("Vi\u1EC7t Nam",
					AD_Language_vi_VN, Locale.of("vi", "VN"), Boolean.FALSE, "dd-MM-yyyy",
					MediaSize.ISO.A4),
