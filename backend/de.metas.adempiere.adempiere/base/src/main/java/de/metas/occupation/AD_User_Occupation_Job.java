...
import org.compiere.model.I_AD_User_Occupation_Job;
...
public class AD_User_Occupation_Job
{
	...
	public void onDeleteUserOccupationJob(final I_AD_User_Occupation_Job userOccupationJob) {
		userOccupationRepository.deleteUserSpecializationByUserJob(userOccupationJob.getCRM_Occupation_ID(), userOccupationJob.getAD_User_ID());
	}
}
