...
@Component
@EnableRabbit
public class AsyncBatchReceiveFromRabbitMQEndpoint extends RabbitMQReceiveFromEndpointTemplate
{
	public AsyncBatchReceiveFromRabbitMQEndpoint(
	...
	@RabbitListener(queues = { AsyncBatchQueueConfiguration.QUEUE_NAME_SPEL })
	public void onEvent(
