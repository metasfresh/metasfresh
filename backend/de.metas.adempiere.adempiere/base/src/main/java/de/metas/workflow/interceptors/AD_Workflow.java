...
import de.metas.workflow.service.impl.AD_WorkflowPOCopyRecordSupport;
...
public class AD_Workflow
{
	...
	public void init()
	{
		...
		CopyRecordFactory.registerCopyRecordSupport(I_AD_Workflow.Table_Name, AD_WorkflowPOCopyRecordSupport.class);
	}
