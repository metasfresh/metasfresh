...
public class ADReferenceService
{
	...
	public ADRefList getRefListById(@NonNull ReferenceId adReferenceId)
	{
	...
	public Collection<ADRefListItem> retrieveListItems(int adReferenceId)
	{
	...
	@Deprecated
	public String retrieveListNameTrl(final Properties ctx, int adReferenceId, String value)
	{
	...
	@Nullable
	public ADRefListItem retrieveListItemOrNull(final ReferenceId adReferenceId, final String value)
	{
		return getRefListById(adReferenceId).getItemByValue(value).orElse(null);
	}

	@Nullable
	public ADRefListItem retrieveListItemOrNull(int adReferenceId, String value)
	{
	...
	public ITranslatableString retrieveListNameTranslatableString(int adReferenceId, String value)
	{
