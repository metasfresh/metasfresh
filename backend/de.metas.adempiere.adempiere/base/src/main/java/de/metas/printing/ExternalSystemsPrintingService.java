...
@Service
public class ExternalSystemsPrintingService
{
	private final List<IPrintingHandler> handlerList;

	public ExternalSystemsPrintingService(final List<IPrintingHandler> handlerList)
	{
	...
	public void print(PrintRequest request)
	{
		...
		{
			iPrintingHandler.print(request);
		}
	}
}
