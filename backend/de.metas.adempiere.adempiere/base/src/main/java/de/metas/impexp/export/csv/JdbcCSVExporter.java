...
/**
 * DataConsumer that consumes a jdbc-{@link ResultSet} towards a csv file.
 */
@ToString(exclude = { "m_ctx", "m_resultSet", "m_columnHeaders" }) // exclude some fields, not sure if this is the best choice
public class JdbcCSVExporter
		implements DataConsumer<ResultSet>
{
	private static final Logger logger = LogManager.getLogger(JdbcCSVExporter.class);
