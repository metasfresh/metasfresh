 ...
 * @author tsa
 */
public class DBArchiveStorage implements IArchiveStorage
{
	private static final Logger logger = LogManager.getLogger(DBArchiveStorage.class);

	private final ArchiveStorageConfigId storageConfigId;

	public DBArchiveStorage(final ArchiveStorageConfig config)
	{
