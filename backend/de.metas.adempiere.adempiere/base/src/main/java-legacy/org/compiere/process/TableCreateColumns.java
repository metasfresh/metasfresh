...
public class TableCreateColumns extends JavaProcess
{
	...
	private void addTableColumn(ResultSet rs, MTable table) throws Exception
	{
		...
		while (rs.next())
		{
			...
			log.info("Checking column {}.{}...", tableName, columnName);
			...
			//
			log.info("{} - DataType={} {}, Nullable={}, Size={}, Digits={}", columnName, dataType, typeName, nullable, size, digits);
			//
			...
			//	Done
			column.setDynAttribute("DisableValidateOnSave", true);
			if (column.save())
			{
