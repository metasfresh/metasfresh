...
{
	@Nullable
	public static Object fromObject(@NonNull final Object valueObj, final int displayType)
	{
		switch (displayType)
		{
	...
	@Nullable
	public static LocalTime fromObjectToLocalTime(final Object valueObj)
	{
		return fromObjectTo(valueObj,
							LocalTime.class,
