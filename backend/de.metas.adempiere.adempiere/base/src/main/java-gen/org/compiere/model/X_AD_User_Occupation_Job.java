...
/** Generated Model for AD_User_Occupation_Job
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_AD_User_Occupation_Job extends org.compiere.model.PO implements I_AD_User_Occupation_Job, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = -804898259L;

    /** Standard Constructor */
    public X_AD_User_Occupation_Job (final Properties ctx, final int AD_User_Occupation_Job_ID, @Nullable final String trxName)
    {
      super (ctx, AD_User_Occupation_Job_ID, trxName);
    }

    /** Load Constructor */
    public X_AD_User_Occupation_Job (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
