...
public class X_GL_JournalLine extends org.compiere.model.PO implements I_GL_JournalLine, org.compiere.model.I_Persistent 
{
	...
	/** 
	 * CR_AccountConceptualName AD_Reference_ID=541939
	 * Reference name: GL_JournalLine_AccountConceptualName
	 */
	public static final int CR_ACCOUNTCONCEPTUALNAME_AD_Reference_ID=541939;
	/** P_Asset_Acct = P_Asset_Acct */
	public static final String CR_ACCOUNTCONCEPTUALNAME_P_Asset_Acct = "P_Asset_Acct";
	@Override
	public void setCR_AccountConceptualName (final @Nullable java.lang.String CR_AccountConceptualName)
	{
		set_Value (COLUMNNAME_CR_AccountConceptualName, CR_AccountConceptualName);
	}

	@Override
	public java.lang.String getCR_AccountConceptualName() 
	{
		return get_ValueAsString(COLUMNNAME_CR_AccountConceptualName);
	}
	...
	/** 
	 * DR_AccountConceptualName AD_Reference_ID=541939
	 * Reference name: GL_JournalLine_AccountConceptualName
	 */
	public static final int DR_ACCOUNTCONCEPTUALNAME_AD_Reference_ID=541939;
	/** P_Asset_Acct = P_Asset_Acct */
	public static final String DR_ACCOUNTCONCEPTUALNAME_P_Asset_Acct = "P_Asset_Acct";
	@Override
	public void setDR_AccountConceptualName (final @Nullable java.lang.String DR_AccountConceptualName)
	{
		set_Value (COLUMNNAME_DR_AccountConceptualName, DR_AccountConceptualName);
	}

	@Override
	public java.lang.String getDR_AccountConceptualName() 
	{
		return get_ValueAsString(COLUMNNAME_DR_AccountConceptualName);
	}
