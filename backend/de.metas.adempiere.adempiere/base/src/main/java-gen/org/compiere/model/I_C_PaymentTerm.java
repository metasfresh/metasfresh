...
//	int Table_ID = org.compiere.model.MTable.getTable_ID(Table_Name);
	...
	/**
	 * Set Payment Term Group.
	 * Defines a grouping key that allows different partner payment terms with varying names to be consolidated under a common condition for reporting and analysis.
	 *
	 * <br>Type: String
	 * <br>Mandatory: false
	 * <br>Virtual Column: false
	 */
	void setGroupCode (@Nullable java.lang.String GroupCode);

	/**
	 * Get Payment Term Group.
	 * Defines a grouping key that allows different partner payment terms with varying names to be consolidated under a common condition for reporting and analysis.
	 *
	 * <br>Type: String
	 * <br>Mandatory: false
	 * <br>Virtual Column: false
	 */
	@Nullable java.lang.String getGroupCode();

	ModelColumn<I_C_PaymentTerm, Object> COLUMN_GroupCode = new ModelColumn<>(I_C_PaymentTerm.class, "GroupCode", null);
	String COLUMNNAME_GroupCode = "GroupCode";
	...
	ModelColumn<I_C_PaymentTerm, Object> COLUMN_IsComplex = new ModelColumn<>(I_C_PaymentTerm.class, "IsComplex", null);
	String COLUMNNAME_IsComplex = "IsComplex";
