...
/** Generated Model for QM_Analysis_Report
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_QM_Analysis_Report extends org.compiere.model.PO implements I_QM_Analysis_Report, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = -366515740L;

    /** Standard Constructor */
    public X_QM_Analysis_Report (final Properties ctx, final int QM_Analysis_Report_ID, @Nullable final String trxName)
    {
      super (ctx, QM_Analysis_Report_ID, trxName);
    }

    /** Load Constructor */
    public X_QM_Analysis_Report (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
