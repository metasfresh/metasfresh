...
/** Generated Model for AD_User_Occupation_AdditionalSpecialization
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_AD_User_Occupation_AdditionalSpecialization extends org.compiere.model.PO implements I_AD_User_Occupation_AdditionalSpecialization, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = -499859448L;

    /** Standard Constructor */
    public X_AD_User_Occupation_AdditionalSpecialization (final Properties ctx, final int AD_User_Occupation_AdditionalSpecialization_ID, @Nullable final String trxName)
    {
      super (ctx, AD_User_Occupation_AdditionalSpecialization_ID, trxName);
    }

    /** Load Constructor */
    public X_AD_User_Occupation_AdditionalSpecialization (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
