...
public class X_M_InOut_Cost extends PO implements I_M_InOut_Cost, I_Persistent
{
	...
	{
		return get_ValueAsPO(COLUMNNAME_C_Order_ID, I_C_Order.class);
	}

	@Override
	public void setC_Order(final I_C_Order C_Order)
	{
		set_ValueFromPO(COLUMNNAME_C_Order_ID, I_C_Order.class, C_Order);
	}
	...
	{
		return get_ValueAsPO(COLUMNNAME_M_InOutLine_ID, I_M_InOutLine.class);
	}

	@Override
	public void setM_InOutLine(final I_M_InOutLine M_InOutLine)
	{
		set_ValueFromPO(COLUMNNAME_M_InOutLine_ID, I_M_InOutLine.class, M_InOutLine);
	}
