...
/** Generated Model for C_Prepayment_Settings
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_C_Prepayment_Settings extends org.compiere.model.PO implements I_C_Prepayment_Settings, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = 1488694862L;

    /** Standard Constructor */
    public X_C_Prepayment_Settings (final Properties ctx, final int C_Prepayment_Settings_ID, @Nullable final String trxName)
    {
      super (ctx, C_Prepayment_Settings_ID, trxName);
    }

    /** Load Constructor */
    public X_C_Prepayment_Settings (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
	...
	@Override
	public void setC_Prepayment_Settings_ID (final int C_Prepayment_Settings_ID)
	{
		if (C_Prepayment_Settings_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_Prepayment_Settings_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_Prepayment_Settings_ID, C_Prepayment_Settings_ID);
	}

	@Override
	public int getC_Prepayment_Settings_ID() 
	{
		return get_ValueAsInt(COLUMNNAME_C_Prepayment_Settings_ID);
	}
