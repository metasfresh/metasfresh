...
//	int Table_ID = org.compiere.model.MTable.getTable_ID(Table_Name);
	...
	void setC_Order(I_C_Order C_Order);

	ModelColumn<I_M_InOut_Cost, I_C_Order> COLUMN_C_Order_ID = new ModelColumn<>(I_M_InOut_Cost.class, "C_Order_ID", I_C_Order.class);
	...
	void setC_OrderLine(I_C_OrderLine C_OrderLine);

	ModelColumn<I_M_InOut_Cost, I_C_OrderLine> COLUMN_C_OrderLine_ID = new ModelColumn<>(I_M_InOut_Cost.class, "C_OrderLine_ID", I_C_OrderLine.class);
	...
	void setM_CostElement(I_M_CostElement M_CostElement);

	ModelColumn<I_M_InOut_Cost, I_M_CostElement> COLUMN_M_CostElement_ID = new ModelColumn<>(I_M_InOut_Cost.class, "M_CostElement_ID", I_M_CostElement.class);
	...
	void setM_InOut(I_M_InOut M_InOut);

	ModelColumn<I_M_InOut_Cost, I_M_InOut> COLUMN_M_InOut_ID = new ModelColumn<>(I_M_InOut_Cost.class, "M_InOut_ID", I_M_InOut.class);
	...
	void setM_InOutLine(I_M_InOutLine M_InOutLine);

	ModelColumn<I_M_InOut_Cost, I_M_InOutLine> COLUMN_M_InOutLine_ID = new ModelColumn<>(I_M_InOut_Cost.class, "M_InOutLine_ID", I_M_InOutLine.class);
	...
	@Nullable I_M_InOut_Cost getReversal();

	void setReversal(@Nullable I_M_InOut_Cost Reversal);

	ModelColumn<I_M_InOut_Cost, I_M_InOut_Cost> COLUMN_Reversal_ID = new ModelColumn<>(I_M_InOut_Cost.class, "Reversal_ID", I_M_InOut_Cost.class);
