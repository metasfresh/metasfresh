...
/** Generated Model for C_CostClassification_Category_Trl
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_C_CostClassification_Category_Trl extends org.compiere.model.PO implements I_C_CostClassification_Category_Trl, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = 1483295664L;

    /** Standard Constructor */
    public X_C_CostClassification_Category_Trl (final Properties ctx, final int C_CostClassification_Category_Trl_ID, @Nullable final String trxName)
    {
      super (ctx, C_CostClassification_Category_Trl_ID, trxName);
    }

    /** Load Constructor */
    public X_C_CostClassification_Category_Trl (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
