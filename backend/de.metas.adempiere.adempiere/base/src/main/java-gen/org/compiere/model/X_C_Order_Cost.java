...
public class X_C_Order_Cost extends PO implements I_C_Order_Cost, I_Persistent
{
	...
	@Override
	public I_C_Cost_Type getC_Cost_Type()
	{
		return get_ValueAsPO(COLUMNNAME_C_Cost_Type_ID, I_C_Cost_Type.class);
	}

	@Override
	public void setC_Cost_Type(final I_C_Cost_Type C_Cost_Type)
	{
		set_ValueFromPO(COLUMNNAME_C_Cost_Type_ID, I_C_Cost_Type.class, C_Cost_Type);
	}
	...
	@Override
	public void setCostCalculationMethod (final String CostCalculationMethod)
	{
		set_Value (COLUMNNAME_CostCalculationMethod, CostCalculationMethod);
	}

	@Override
	public String getCostCalculationMethod()
	{
