...
public class X_M_Product_Acct extends org.compiere.model.PO implements I_M_Product_Acct, org.compiere.model.I_Persistent 
{
	...
	private static final long serialVersionUID = -277952803L;

    /** Standard Constructor */
    public X_M_Product_Acct (final Properties ctx, final int M_Product_Acct_ID, @Nullable final String trxName)
    {
      super (ctx, M_Product_Acct_ID, trxName);
    }

    /** Load Constructor */
    public X_M_Product_Acct (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
	...
	@Override
	public void setM_Product_Acct_ID (final int M_Product_Acct_ID)
	{
		if (M_Product_Acct_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_M_Product_Acct_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_M_Product_Acct_ID, M_Product_Acct_ID);
	}

	@Override
	public int getM_Product_Acct_ID() 
	{
		return get_ValueAsInt(COLUMNNAME_M_Product_Acct_ID);
	}
