...
public class X_Fact_Acct extends org.compiere.model.PO implements I_Fact_Acct, org.compiere.model.I_Persistent 
{
	...
	private static final long serialVersionUID = 316342362L;
    ...
    /** Load Constructor */
    public X_Fact_Acct (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
	...
	public void setLine_ID (final int Line_ID)
	{
		if (Line_ID < 1) 
			...
			set_ValueNoCheck (COLUMNNAME_Line_ID, Line_ID);
	}
	...
	public void setSubLine_ID (final int SubLine_ID)
	{
		if (SubLine_ID < 1) 
			...
			set_ValueNoCheck (COLUMNNAME_SubLine_ID, SubLine_ID);
	}
