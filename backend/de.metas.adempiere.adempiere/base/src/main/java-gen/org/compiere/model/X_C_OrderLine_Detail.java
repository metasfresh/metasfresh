...
/** Generated Model for C_OrderLine_Detail
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_C_OrderLine_Detail extends org.compiere.model.PO implements I_C_OrderLine_Detail, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = -1497953031L;

    /** Standard Constructor */
    public X_C_OrderLine_Detail (final Properties ctx, final int C_OrderLine_Detail_ID, @Nullable final String trxName)
    {
      super (ctx, C_OrderLine_Detail_ID, trxName);
    }

    /** Load Constructor */
    public X_C_OrderLine_Detail (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
