...
/** Generated Model for C_CostClassification
 *  @author metasfresh (generated) 
 */
@SuppressWarnings("unused")
public class X_C_CostClassification extends org.compiere.model.PO implements I_C_CostClassification, org.compiere.model.I_Persistent 
{

	private static final long serialVersionUID = -1060884627L;

    /** Standard Constructor */
    public X_C_CostClassification (final Properties ctx, final int C_CostClassification_ID, @Nullable final String trxName)
    {
      super (ctx, C_CostClassification_ID, trxName);
    }

    /** Load Constructor */
    public X_C_CostClassification (final Properties ctx, final ResultSet rs, @Nullable final String trxName)
    {
