...
public class CacheInterceptor_WithTrx_Test
{
	...
	public void testCachedMethodWithTrx()
	{
...

		{
			...
			Assertions.assertSame(value1, obj.cachedMethodWithTrx(param1, trx1.getTrxName()));
		}

		{
			obj.cachedValueToReturn = value2;
			Assertions.assertSame(value2, obj.cachedMethodWithTrx(param1, trx2.getTrxName()));
		}
		...
		Assertions.assertSame(value3, obj.cachedMethodWithTrx(param1, trx1.getTrxName()));
	}
	...
	public void testCachedMethodWithTrx_UsingThreadInherited()
	{
		...
		Assertions.assertSame(value1, obj.cachedMethodWithTrx(param1, ITrx.TRXNAME_ThreadInherited));
	}
	...
	public void testCachedMethodWithTrx_WhenTrxNotFound()
	{
		...
		obj.cachedValueToReturn = "value1";
		Assertions.assertSame("value1", obj.cachedMethodWithTrx(1, "MissingTrxName"));
		
		// Make sure it's not cached
		obj.cachedValueToReturn = "value1New";
		Assertions.assertSame("value1New", obj.cachedMethodWithTrx(1, "MissingTrxName"));
	}
