...
class ExplainedOptionalTest
{
	...
	class resolve
	{
		...
		void whenPresent()
		{
			final String result = ExplainedOptional.of(12345)
					.resolve(
							(value) -> "present: " + value,
							(explanation) -> "explanation: " + explanation);

			Assertions.assertThat(result).isEqualTo("present: 12345");
		}

		@Test
		void whenAbsent()
		{
			final String result = ExplainedOptional.emptyBecause("some missing reason")
					.resolve(
							(value) -> "present: " + value,
