...
{
	@NonNull private final InvoiceLineADRModelAttributeSetInstanceListener invoiceLineListener;
	private static final List<String> sourceColumnNames = Collections.singletonList(I_C_Invoice.COLUMNNAME_C_BPartner_ID);
