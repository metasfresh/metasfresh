...
UPDATE AD_Reference_Trl SET Name='Order Board Status', IsTranslated='Y',Updated=TO_TIMESTAMP('2026-06-28 11:26:15.000000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Reference_ID=542115 AND AD_Language='en_US'
;
