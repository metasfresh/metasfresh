DROP FUNCTION IF EXISTS KPI_Top_Products_Inventory_Function (IN CurrentDate date, IN ComparisonDate date) ;


CREATE OR REPLACE FUNCTION KPI_Top_Products_Inventory_Function (IN CurrentDate date, IN ComparisonDate date) 
RETURNS TABLE 
(
