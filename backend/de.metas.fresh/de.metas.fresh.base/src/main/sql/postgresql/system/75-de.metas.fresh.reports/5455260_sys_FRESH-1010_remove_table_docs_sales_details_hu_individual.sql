...
COMMENT ON FUNCTION de_metas_endcustomer_fresh_reports.Docs_Sales_InOut_Details_HU_Individual (numeric, Character Varying (6) ) IS 'This function is used in report_details_hu.jasper subreport from individual_inout jasper. It is an alternate version of de_metas_endcustomer_fresh_reports.Docs_Sales_InOut_Details_HU (numeric, Character Varying (6)) function, the difference is that the order of the HUs are taken via C_BP_DocLine_Sort table';