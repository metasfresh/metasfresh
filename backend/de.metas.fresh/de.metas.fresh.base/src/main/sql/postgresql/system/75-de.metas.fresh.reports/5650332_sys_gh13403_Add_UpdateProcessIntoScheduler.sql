...
INSERT INTO AD_Process (AccessLevel, AD_Client_ID, AD_Org_ID, AD_Process_ID, AllowProcessReRun, Classname, CopyFromProcess, Created, CreatedBy, Description, EntityType, Help, IsActive, IsApplySecuritySettings, IsBetaFunctionality, IsDirectPrint, IsFormatExcelFile, IsNotifyUserAfterExecution, IsOneInstanceOnly, IsReport, IsTranslateExcelHeaders, IsUseBPartnerLanguage, LockWaitTimeout, Name,
                        PostgrestResponseFormat, RefreshAllAfterExecution, ShowHelp, SQLStatement, Type, Updated, UpdatedBy, Value)
VALUES ('3', 0, 0, 585087, 'Y', 'de.metas.process.ExecuteUpdateSQL', 'N', TO_TIMESTAMP('2022-06-08 10:06:38', 'YYYY-MM-DD HH24:MI:SS'), 100, 'Aktualisiert Statisktik nach Mengen Gesamt ', 'D', '', 'Y', 'N', 'N', 'N', 'Y', 'N', 'N', 'N', 'Y', 'Y', 0, 'Update fresh statistics kg week report', 'json', 'Y', 'Y', 'Select report.update_fresh_statistics_kg();', 'SQL',
        TO_TIMESTAMP('2022-06-08 10:06:38', 'YYYY-MM-DD HH24:MI:SS'), 100, 'update_fresh_statistics_kg')
;
...
VALUES (0, 0, 585087, 0, 550099, TO_TIMESTAMP('2022-06-08 10:07:54', 'YYYY-MM-DD HH24:MI:SS'), 100, '00 00 * * *', 'Runs at 00:00 every night to update the table fresh_statistics_kg_MV.', 'de.metas.swat', 0, 'D', 'Y', 'N', 7, 'N', 'update_fresh_statistics_kg', 'N', 'P', 'C', 'NEW', 100, TO_TIMESTAMP('2022-06-08 10:07:54', 'YYYY-MM-DD HH24:MI:SS'), 100)
