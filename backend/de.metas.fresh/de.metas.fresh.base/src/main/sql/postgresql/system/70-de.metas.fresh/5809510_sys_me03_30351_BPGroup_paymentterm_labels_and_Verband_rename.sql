-- me03 #30351 — BP-Group window: disambiguate the two payment-term field labels + rename "Verband".
-- Core window 192 (all customers); the dt204 override window 541917 is handled by the coupled
-- customer script 5809520 (which only sets AD_Name_ID on its own fields — the Verband rename
-- below propagates to every field referencing element 583888, on both windows, via one call).
--
-- AFFECTED RECORDS
-- =====================================================================
...
--    references it on BOTH windows (core 192 field 752676 + dt204 541917 field 753514).
-- ============================================================================
