-- gh#28336: Create dedicated Intrastat view that supports both Export (issotrx='Y') and Import (issotrx='N').
-- M_InOut_V is left unchanged (export-only) to avoid breaking customer repos that depend on it.
