DROP FUNCTION IF EXISTS de_metas_endcustomer_fresh_reports.docs_purchase_invoice_description(IN record_id   numeric,
                                                                                             IN ad_language Character Varying(6))
;

CREATE OR REPLACE FUNCTION de_metas_endcustomer_fresh_reports.docs_purchase_invoice_description(c_invoice_id numeric,
...
ALTER FUNCTION de_metas_endcustomer_fresh_reports.docs_purchase_invoice_description(numeric, varchar) OWNER TO metasfresh
;
