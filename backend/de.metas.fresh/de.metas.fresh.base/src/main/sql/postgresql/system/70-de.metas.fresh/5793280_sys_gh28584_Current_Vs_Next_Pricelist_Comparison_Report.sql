     ...
     result AS
         (
             SELECT t.*,
                    ...
                    plv.namePLV1,
                    plv.namePLV2,
                    (SELECT bpl.c_bpartner_location_id FROM c_bpartner_location bpl WHERE bpl.c_bpartner_id = plv.c_bpartner_id AND bpl.isactive='Y' ORDER BY bpl.isbilltodefault DESC LIMIT 1) c_bpartner_location_id,
