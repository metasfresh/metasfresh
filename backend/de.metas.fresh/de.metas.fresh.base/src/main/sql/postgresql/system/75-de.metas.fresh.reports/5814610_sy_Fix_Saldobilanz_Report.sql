...
(
    ...
    parentname1       character varying(200),
    parentvalue1      character varying(200),
    parentname2       character varying(200),
    parentvalue2      character varying(200),
    parentname3       character varying(200),
    parentvalue3      character varying(200),
    parentname4       character varying(200),
    parentvalue4      character varying(200),
    parentname5       character varying(200),
    parentvalue5      character varying(200),
    parentname6       character varying(200),
    parentvalue6      character varying(200),
    parentname7       character varying(200),
    parentvalue7      character varying(200),
    parentname8       character varying(200),
    parentvalue8      character varying(200),
    parentname9       character varying(200),
    parentvalue9      character varying(200),
    name              character varying(200),
    namevalue         character varying(200),
    AccountType       char(1),
