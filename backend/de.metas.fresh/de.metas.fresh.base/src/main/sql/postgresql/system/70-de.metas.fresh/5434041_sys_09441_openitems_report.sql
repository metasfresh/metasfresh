...
CREATE FUNCTION de_metas_endcustomer_fresh_reports.OpenItems_Report(IN Reference_Date date DEFAULT now())
...
FROM
	(
		SELECT
			...
			invoiceOpenToDate ( i.C_Invoice_ID, COALESCE ( ips.C_InvoicePaySchedule_ID, 0::numeric ), $1 ) AS OpenAmt,
