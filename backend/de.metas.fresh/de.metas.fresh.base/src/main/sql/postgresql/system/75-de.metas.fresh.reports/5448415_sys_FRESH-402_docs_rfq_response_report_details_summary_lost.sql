--DROP FUNCTION IF EXISTS de_metas_endcustomer_fresh_reports.docs_rfq_response_report_details_summary_lost(in numeric,in character varying);

CREATE OR REPLACE FUNCTION de_metas_endcustomer_fresh_reports.docs_rfq_response_report_details_summary_lost(IN record_id numeric,IN ad_language character varying)
...
INNER JOIN R_MailText mt ON t.rfq_lost_mailtext_id = mt.R_MailText_ID
