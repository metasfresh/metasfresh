...
FROM (
    SELECT
        ...
        COALESCE((CASE
            ...
            WHEN uomConvert(iol.M_Product_ID, iol.C_UOM_ID, (SELECT C_UOM_ID FROM kgm_uom), iol.qtyentered) IS NOT NULL
                THEN uomConvert(iol.M_Product_ID, iol.C_UOM_ID, (SELECT C_UOM_ID FROM kgm_uom), iol.qtyentered)
            ELSE iol.qtyentered
