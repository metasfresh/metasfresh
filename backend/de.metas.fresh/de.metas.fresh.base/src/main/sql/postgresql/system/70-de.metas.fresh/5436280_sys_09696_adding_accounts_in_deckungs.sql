...
UPDATE report.Margin_Conf_Acct SET Name = 'Total Nettoerlös' WHERE Margin_Conf_ID = 1000000 AND value = '3';
UPDATE report.Margin_Conf_Acct SET Name = 'Total Materialaufwand Produktion' WHERE Margin_Conf_ID = 1000000 AND value = '4';
UPDATE report.Margin_Conf_Acct SET Name = 'Aufwand Früchte Standard' WHERE Margin_Conf_ID = 1000000 AND value = '4002';

UPDATE report.Margin_Conf_Acct SET Name = null WHERE Margin_Conf_ID = 1000001 AND value = '3';
UPDATE report.Margin_Conf_Acct SET Name = null WHERE Margin_Conf_ID = 1000001 AND value = '4';
UPDATE report.Margin_Conf_Acct SET Name = 'Total Personalaufwand Produktion' WHERE Margin_Conf_ID = 1000001 AND value = '5';
UPDATE report.Margin_Conf_Acct SET Name = 'Lohnaufwand Produktion' WHERE Margin_Conf_ID = 1000001 AND value = '500';
UPDATE report.Margin_Conf_Acct SET Name = 'Sozialversicherungsaufwand Produktion' WHERE Margin_Conf_ID = 1000001 AND value = '570';
...
UPDATE report.Margin_Conf_Acct SET lvl2_SeqNo = 100, lvl3_SeqNo = 625  WHERE Margin_Conf_ID = 1000003 AND value = '3408';
UPDATE report.Margin_Conf_Acct SET lvl2_SeqNo = 50, lvl3_SeqNo = 265  WHERE Margin_Conf_ID = 1000003 AND value = '3407';
UPDATE report.Margin_Conf_Acct SET Parent_Account_ID = 1000039, lvl2_SeqNo = 50, lvl3_SeqNo = 225 WHERE Margin_Conf_ID = 1000003 AND value = '3403';
