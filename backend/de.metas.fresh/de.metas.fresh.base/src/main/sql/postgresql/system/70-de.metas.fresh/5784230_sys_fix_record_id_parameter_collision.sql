...
-- Generated for: gray_knight_hotfix branch
...
-- Function: Docs_Purchase_Invoice_Details
DROP FUNCTION IF EXISTS de_metas_endcustomer_fresh_reports.Docs_Purchase_Invoice_Details;
DROP FUNCTION IF EXISTS de_metas_endcustomer_fresh_reports.Docs_Purchase_Invoice_Details;
...
-- Function: Docs_Sales_Dunning_Report_description
DROP FUNCTION IF EXISTS de_metas_endcustomer_fresh_reports.Docs_Sales_Dunning_Report_description;
DROP FUNCTION IF EXISTS de_metas_endcustomer_fresh_reports.Docs_Sales_Dunning_Report_description;
