-- Source DDL: backend/de.metas.fresh/de.metas.fresh.base/src/main/sql/postgresql/ddl/functions/Docs_Sales_Dunning_QR_Code.sql
...
select ('SPC' || E'\n' || --QRType
        ...
        'S' || E'\n' || -- CR - AddressType = Structured (mandatory from 2026-11-14)
        ...
        (case
             ...
             else btrim(coalesce(u.FirstName, '') || ' ' || coalesce(u.LastName, '')) end)
            || E'\n' || --UD – Name
