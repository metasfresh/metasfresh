...
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,AllowProcessReRun,Classname,CopyFromProcess,Created,CreatedBy,Description,EntityType,Help,IsActive,IsApplySecuritySettings,IsBetaFunctionality,IsDirectPrint,IsFormatExcelFile,IsNotifyUserAfterExecution,IsOneInstanceOnly,IsReport,IsTranslateExcelHeaders,IsUpdateExportDate,IsUseBPartnerLanguage,LockWaitTimeout,Name,PostgrestResponseFormat,RefreshAllAfterExecution,ShowHelp,SQLStatement,Type,Updated,UpdatedBy,Value) VALUES ('3',0,0,585066,'Y','de.metas.process.ExecuteUpdateSQL','N',TO_TIMESTAMP('2022-06-08 10:06:38','YYYY-MM-DD HH24:MI:SS'),100,'Aktualisiert Statisktik nach Mengen Gesamt Woche ','D','','Y','N','N','N','Y','N','N','N','Y','N','Y',0,'Update fresh statistics kg week report','json','Y','Y','Select report.update_fresh_statistics_kg_week();','SQL',TO_TIMESTAMP('2022-06-08 10:06:38','YYYY-MM-DD HH24:MI:SS'),100,'update_fresh_statistics_kg_week')
;
