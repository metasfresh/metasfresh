...
-- Node name: `webUI`
-- 2026-05-15T08:48:04Z
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=0, Updated=now(), UpdatedBy=100 WHERE  Node_ID=1000007 AND AD_Tree_ID=10
;

-- Node name: `Open Balance (@PREFIX@de/metas/reports/openitems_factbased/report.jasper)`
-- 2026-05-15T08:48:04.004Z
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=1, Updated=now(), UpdatedBy=100 WHERE  Node_ID=542324 AND AD_Tree_ID=10
;

-- Node name: `Application Dictionary`
-- 2026-05-15T08:48:04.011Z
...
-- Node name: `Open Balance (@PREFIX@de/metas/reports/openitems_factbased/report.jasper)`
-- 2026-05-15T08:48:33.608Z
UPDATE AD_TreeNodeMM SET Parent_ID=1000064, SeqNo=24, Updated=now(), UpdatedBy=100 WHERE  Node_ID=542324 AND AD_Tree_ID=10
;

-- Node name: `Cost Center Movements (@PREFIX@de/metas/reports/movements/report.jasper)`
-- 2026-05-15T08:48:33.609Z
UPDATE AD_TreeNodeMM SET Parent_ID=1000064, SeqNo=25, Updated=now(), UpdatedBy=100 WHERE  Node_ID=540959 AND AD_Tree_ID=10
;

-- Node name: `Deposit in transit (de.metas.impexp.spreadsheet.process.ExportToSpreadsheetProcess)`
-- 2026-05-15T08:48:33.610Z
UPDATE AD_TreeNodeMM SET Parent_ID=1000064, SeqNo=26, Updated=now(), UpdatedBy=100 WHERE  Node_ID=542036 AND AD_Tree_ID=10
;

-- Node name: `Payment selection (de.metas.impexp.spreadsheet.process.ExportToSpreadsheetProcess)`
-- 2026-05-15T08:48:33.610Z
UPDATE AD_TreeNodeMM SET Parent_ID=1000064, SeqNo=27, Updated=now(), UpdatedBy=100 WHERE  Node_ID=542038 AND AD_Tree_ID=10
;

-- Node name: `Goods received not yet invoiced (de.metas.impexp.spreadsheet.process.ExportToSpreadsheetProcess)`
-- 2026-05-15T08:48:33.611Z
UPDATE AD_TreeNodeMM SET Parent_ID=1000064, SeqNo=28, Updated=now(), UpdatedBy=100 WHERE  Node_ID=542040 AND AD_Tree_ID=10
;

-- Node name: `Bellandvision “Grüner Punkt” (de.metas.impexp.spreadsheet.process.ExportToSpreadsheetProcess)`
-- 2026-05-15T08:48:33.612Z
