-- Overview tab (581171): replace the two text fields ProductValue (781407) and ProductName (781408)
...
VALUES (781321/*From ID Server*/, 0, 0, 'Y',
    ...
    TO_TIMESTAMP('2026-07-02 23:00:00', 'YYYY-MM-DD HH24:MI:SS'), 100,
    'Artikel', 581171, 592941/*M_Product_ID in M_Picking_OrderBoard_Overview_v*/, 'Y', 10, 'Y', 10,
    'N', 'N', 'N', 'N', 'D')
;
...
UPDATE AD_Tab SET AD_Column_ID=592960,Updated=TO_TIMESTAMP('2026-07-03 05:16:39.145000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Tab_ID=581037
;

-- Tab: Auftrags-Board(581036,D) -> In Kommissionierung
-- Table: M_Picking_OrderBoard_v
-- 2026-07-03T05:17:14.136Z
UPDATE AD_Tab SET AD_Column_ID=592960,Updated=TO_TIMESTAMP('2026-07-03 05:17:14.136000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Tab_ID=581038
;

-- Tab: Auftrags-Board(581036,D) -> Packen
-- Table: M_Picking_OrderBoard_v
-- 2026-07-03T05:17:23.418Z
UPDATE AD_Tab SET AD_Column_ID=592960,Updated=TO_TIMESTAMP('2026-07-03 05:17:23.418000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',UpdatedBy=100 WHERE AD_Tab_ID=581039
;
