...
FROM
	...
	LEFT JOIN C_DunningLevel_Trl dlt 	ON dd.C_Dunninglevel_ID = dlt.C_DunningLevel_ID AND dlt.ad_Language = $2
	...
	LEFT JOIN C_PaymentTerm_Trl pt		ON dl.C_PaymentTerm_ID = pt.C_PaymentTerm_ID AND pt.ad_Language = $2
WHERE
