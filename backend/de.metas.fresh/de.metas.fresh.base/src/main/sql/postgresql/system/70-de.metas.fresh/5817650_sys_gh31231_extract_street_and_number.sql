-- Source DDL: backend/de.metas.fresh/de.metas.fresh.base/src/main/sql/postgresql/ddl/functions/extract_street_and_number.sql
...
BEGIN
    ...
    ELSE
        ...
        v_extracted_number := '';  -- return empty string (not NULL)
    END IF;
