...
SELECT o.description                         AS description,
       ...
       CASE
           WHEN report.IsHiddenReportElement(o.C_DocTypeTarget_ID, 'Delivery_To_Address') = 'N' THEN
               REPLACE(
       ...
       CASE
           WHEN report.IsHiddenReportElement(o.C_DocTypeTarget_ID, 'Bill_To_Address') = 'N' THEN
               REPLACE(
