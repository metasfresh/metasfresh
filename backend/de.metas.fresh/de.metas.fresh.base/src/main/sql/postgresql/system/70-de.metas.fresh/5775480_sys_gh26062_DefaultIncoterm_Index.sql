...
UPDATE C_Incoterms SET IsDefault='N', Updated=NEW.Updated, UpdatedBy=NEW.UpdatedBy WHERE 1=1  AND AD_Org_ID=NEW.AD_Org_ID AND IsDefault=NEW.IsDefault AND C_Incoterms_ID<>NEW.C_Incoterms_ID AND IsDefault='Y';
 ELSE
