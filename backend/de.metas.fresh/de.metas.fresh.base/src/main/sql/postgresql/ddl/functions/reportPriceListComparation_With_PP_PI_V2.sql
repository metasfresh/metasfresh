DROP FUNCTION IF EXISTS report.reportPriceListComparation_With_PP_PI_V2(
...
CREATE FUNCTION report.reportPriceListComparation_With_PP_PI_V2(c_bpartner_id            numeric,
