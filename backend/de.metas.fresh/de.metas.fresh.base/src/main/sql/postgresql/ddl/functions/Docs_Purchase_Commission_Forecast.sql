...
WHERE (c.C_BPartner_SalesRep_ID = p_BPartner_SalesRep_ID OR p_BPartner_SalesRep_ID IS NULL)
  AND (p_CommissionDate_From IS NULL OR c.CommissionDate >= p_CommissionDate_From)
  AND (p_CommissionDate_To IS NULL OR c.CommissionDate <= p_CommissionDate_To)
