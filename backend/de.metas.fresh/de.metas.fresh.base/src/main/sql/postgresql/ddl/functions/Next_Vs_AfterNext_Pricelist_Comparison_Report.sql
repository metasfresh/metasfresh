DROP FUNCTION IF EXISTS report.Next_Vs_AfterNext_Pricelist_Comparison_Report(p_C_BPartner_ID              numeric,
...
CREATE OR REPLACE FUNCTION report.Next_Vs_AfterNext_Pricelist_Comparison_Report(p_C_BPartner_ID              numeric = NULL,
...
SELECT *
FROM report.Next_Vs_AfterNext_Pricelist_Comparison_Report()
;

- Specific Bpartner

SELECT *
FROM report.Next_Vs_AfterNext_Pricelist_Comparison_Report(2156515)
;
 */
