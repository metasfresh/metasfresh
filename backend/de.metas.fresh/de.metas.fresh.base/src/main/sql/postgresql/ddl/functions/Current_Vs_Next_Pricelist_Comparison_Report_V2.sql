DROP FUNCTION IF EXISTS report.Current_Vs_Next_Pricelist_Comparison_Report_V2(p_C_BPartner_ID              numeric,
...
CREATE FUNCTION report.Current_Vs_Next_Pricelist_Comparison_Report_V2(p_c_bpartner_id              numeric DEFAULT NULL::numeric,
         ...
         (SELECT t.*
          FROM ((SELECT --
                ...
                (SELECT --
                 ...
                 ORDER BY TRUE,
                          plv.validfrom ASC,
                          plv.m_pricelist_version_id ASC)) t
     ...
     result AS
         (SELECT t.*,
          ...
          FROM currentAndPreviousPLV plv
                   INNER JOIN LATERAL report.fresh_PriceList_Details_Report_V2(
                  plv.c_bpartner_id,
                  plv.PLV1_ID,
                  plv.PLV2_ID,
                  p_AD_Language,
