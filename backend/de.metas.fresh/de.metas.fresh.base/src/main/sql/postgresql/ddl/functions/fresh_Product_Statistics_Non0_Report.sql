...
COMMENT ON FUNCTION report.fresh_product_statistics_report(numeric, character varying, numeric, numeric, numeric, numeric, numeric, numeric, numeric,character varying) IS 'Making this function volatile is currently our only known way to avoid
