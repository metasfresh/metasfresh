    ...
    -- Get shipment details
         LEFT OUTER JOIN (SELECT DISTINCT x.C_InvoiceLine_ID,
                          ...
                          FROM (SELECT DISTINCT iliol.C_InvoiceLine_ID,
                                ...
                                GROUP BY C_InvoiceLine_ID, io.poreference, bpl.C_BPartner_Location_ID, t.name) x

                          GROUP BY x.C_InvoiceLine_ID, x.shipLocation, x.tour) io ON il.C_InvoiceLine_ID = io.C_InvoiceLine_ID
