...
DROP VIEW IF EXISTS "de.metas.fresh".OrderBy_ProductGroup;
CREATE OR REPLACE VIEW "de.metas.fresh".OrderBy_ProductGroup AS
SELECT 
	p.M_Product_ID, 
...
;
COMMENT ON VIEW "de.metas.fresh".OrderBy_ProductGroup IS 'see task 08924'
;
