...
DROP FUNCTION IF EXISTS de_metas_fresh_kpi.KPI_Sales_Order_Status_Overview_Function (IN DateFrom date, IN DateTo date) ;
CREATE OR REPLACE FUNCTION de_metas_fresh_kpi.KPI_Sales_Order_Status_Overview_Function (IN DateFrom date, IN DateTo date) 
RETURNS TABLE 
(
	Confirmed numeric,
	Allocated numeric,
