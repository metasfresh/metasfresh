DROP FUNCTION IF EXISTS report.Current_Vs_Next_Pricelist_Comparison_Report_With_PP_PI_V2(p_C_BPartner_ID              numeric,
...
CREATE FUNCTION report.Current_Vs_Next_Pricelist_Comparison_Report_With_PP_PI_V2(p_c_bpartner_id              numeric DEFAULT NULL::numeric,
     ...
     result AS
         (SELECT t.*,
          ...
          FROM currentAndPreviousPLV plv
                   INNER JOIN LATERAL report.fresh_PriceList_Details_Report_With_PP_PI_V2(
                  plv.c_bpartner_id,
                  plv.PLV1_ID,
                  plv.PLV2_ID,
                  p_AD_Language,
