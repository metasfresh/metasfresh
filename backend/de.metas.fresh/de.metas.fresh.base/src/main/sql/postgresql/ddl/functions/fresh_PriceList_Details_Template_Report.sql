DROP FUNCTION IF EXISTS report.fresh_pricelist_details_template_report(NUMERIC,
                                                                       NUMERIC,
                                                                       CHARACTER VARYING,
                                                                       NUMERIC,
                                                                       TEXT
...
CREATE OR REPLACE FUNCTION report.fresh_pricelist_details_template_report(IN p_c_bpartner_id              numeric,
...
COMMENT ON FUNCTION report.fresh_pricelist_details_template_report(NUMERIC, NUMERIC, CHARACTER VARYING, NUMERIC, text, NUMERIC, NUMERIC) IS
