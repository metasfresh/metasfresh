...
CREATE OR REPLACE FUNCTION de_metas_endcustomer_fresh_reports.Direct_Costing_Raw_Data_Remainings_Activity_10_50 (Year Date, AD_Org_ID numeric(10,0) ) RETURNS TABLE
	...
	Balance_10 numeric, Balance_20 numeric, Balance_30 numeric, Balance_40 numeric, Balance_50 numeric, Balance_90 numeric, Balance_Other numeric, Balance numeric, 
	Budget_10 numeric, Budget_20 numeric, Budget_30 numeric, Budget_40 numeric, Budget_50 numeric, Budget_90 numeric, Budget numeric, 
