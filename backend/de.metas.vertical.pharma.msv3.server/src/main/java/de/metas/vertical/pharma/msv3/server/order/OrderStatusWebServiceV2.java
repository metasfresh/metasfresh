...
import de.metas.vertical.pharma.msv3.protocol.order.v2.OrderStatusJAXBConvertersV2;
...
public class OrderStatusWebServiceV2
{
			...
			@NonNull final OrderService orderService)
	{
		this.impl = OrderStatusWebServiceImpl.builder()
				...
				.jaxbConverters(OrderStatusJAXBConvertersV2.instance)
				.build();
	}

	@PayloadRoot(localPart = "bestellstatusAbfragen", namespace = MSV3ServerConstants.SOAP_NAMESPACE_V2)
