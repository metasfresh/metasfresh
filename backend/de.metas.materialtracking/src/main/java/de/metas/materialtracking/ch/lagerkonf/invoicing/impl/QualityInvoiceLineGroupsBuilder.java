...
public class QualityInvoiceLineGroupsBuilder implements IQualityInvoiceLineGroupsBuilder
{
	...
	private void createQualityInvoiceLineGroups_RegularOrdersSimplified()
	{
		...
		detailBefore.setQty(marketableGoodsAvgProducedQtyPerTU);
		...
		invoiceableLine.setQty(marketableGoods.getQtyProjected());
		...
		invoiceableLine.setC_UOM(marketableGoodsUOM);
		...
		final QualityInvoiceLine invoicableDetailLineOverride = createDetailForSingleRegularOrder(marketableGoodsUOM, huInfo, invoiceableLine.getQty(), labelToUse);
