...
public class QualityInvoiceLineGroupsBuilderProvider implements IQualityInvoiceLineGroupsBuilderProvider
{
	@Override
	public IQualityInvoiceLineGroupsBuilder provideBuilderFor(final IMaterialTrackingDocuments materialTrackingDocuments)
	{
		return new QualityInvoiceLineGroupsBuilder(materialTrackingDocuments);
	}
}
