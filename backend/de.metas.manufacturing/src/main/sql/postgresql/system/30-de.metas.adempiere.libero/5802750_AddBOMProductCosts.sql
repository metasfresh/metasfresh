...
-- Column: PP_Product_BOM.Cost
-- 2026-05-18T18:55:53.468Z
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,CloningStrategy,ColumnName,ColumnSQL,Created,CreatedBy,DDL_NoForeignKey,Description,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,592552,2319,0,37,53018,'XX','Cost','(computeProductBOMCost(     (PP_Product_BOM.M_Product_ID),     now()::date,     (select ci.C_AcctSchema1_ID from AD_ClientInfo ci where PP_Product_BOM.AD_Client_ID = ci.AD_Client_ID),     (select M_CostElement_ID from M_CostElement where IsActive=''Y'' and CostElementType=''M'' and exists (select 1 from C_AcctSchema cas where cas.CostingMethod = M_CostElement.CostingMethod     and cas.C_AcctSchema_ID=(select ci.C_AcctSchema1_ID from AD_ClientInfo ci where PP_Product_BOM.AD_Client_ID = ci.AD_Client_ID))),     (PP_Product_BOM.AD_Client_ID),     (PP_Product_BOM.AD_Org_ID)     ))',TO_TIMESTAMP('2026-05-18 18:55:52.223000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'N','Kosteninformation','EE01',0,22,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N',0,'Kosten',0,0,TO_TIMESTAMP('2026-05-18 18:55:52.223000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;


-- 2026-05-18T18:55:53.490Z
INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Column t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Column_ID=592552 AND NOT EXISTS (SELECT 1 FROM AD_Column_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Column_ID=t.AD_Column_ID)
;

-- 2026-05-18T18:55:53.523Z
/* DDL */  select update_Column_Translation_From_AD_Element(2319)
;

-- Field: Stücklistenkonfiguration Version(53006,EE01) -> Stücklistenartikel(53028,EE01) -> Kosten
-- Column: PP_Product_BOM.Cost
-- 2026-05-18T18:56:40.200Z
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsDisplayed,IsDisplayedGrid,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,592552,780246,0,53028,TO_TIMESTAMP('2026-05-18 18:56:40.058000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Kosteninformation',22,'EE01','Y','N','N','N','N','N','N','N','Kosten',TO_TIMESTAMP('2026-05-18 18:56:40.058000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;

-- 2026-05-18T18:56:40.208Z
INSERT INTO AD_Field_Trl (AD_Language,AD_Field_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy,IsActive) SELECT l.AD_Language, t.AD_Field_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy,'Y' FROM AD_Language l, AD_Field t WHERE l.IsActive='Y'AND (l.IsSystemLanguage='Y' OR l.IsBaseLanguage='Y') AND t.AD_Field_ID=780246 AND NOT EXISTS (SELECT 1 FROM AD_Field_Trl tt WHERE tt.AD_Language=l.AD_Language AND tt.AD_Field_ID=t.AD_Field_ID)
;

-- 2026-05-18T18:56:40.215Z
/* DDL */  select update_FieldTranslation_From_AD_Name_Element(2319)
;

-- 2026-05-18T18:56:40.236Z
DELETE FROM AD_Element_Link WHERE AD_Field_ID=780246
;

-- 2026-05-18T18:56:40.245Z
/* DDL */ select AD_Element_Link_Create_Missing_Field(780246)
;

-- UI Element: Stücklistenkonfiguration Version(53006,EE01) -> Stücklistenartikel(53028,EE01) -> main -> 20 -> Cost.Kosten
-- Column: PP_Product_BOM.Cost
-- 2026-05-18T18:57:03.366Z
INSERT INTO AD_UI_Element (AD_Client_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,AD_UI_ElementGroup_ID,AD_UI_Element_ID,AD_UI_ElementType,Created,CreatedBy,Description,IsActive,IsAdvancedField,IsAllowFiltering,IsDisplayed,IsDisplayedGrid,IsDisplayed_SideList,IsMultiLine,MultiLine_LinesCount,Name,SeqNo,SeqNoGrid,SeqNo_SideList,Updated,UpdatedBy) VALUES (0,780246,0,53028,555368,651687,'F',TO_TIMESTAMP('2026-05-18 18:57:03.227000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,'Kosteninformation','Y','N','N','Y','N','N','N',0,'Kosten',30,0,0,TO_TIMESTAMP('2026-05-18 18:57:03.227000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100)
;

-- Column: PP_Product_BOM.Cost
-- Column SQL (old): (computeProductBOMCost(     (PP_Product_BOM.M_Product_ID),     now()::date,     (select ci.C_AcctSchema1_ID from AD_ClientInfo ci where PP_Product_BOM.AD_Client_ID = ci.AD_Client_ID),     (select M_CostElement_ID from M_CostElement where IsActive='Y' and CostElementType='M' and exists (select 1 from C_AcctSchema cas where cas.CostingMethod = M_CostElement.CostingMethod     and cas.C_AcctSchema_ID=(select ci.C_AcctSchema1_ID from AD_ClientInfo ci where PP_Product_BOM.AD_Client_ID = ci.AD_Client_ID))),     (PP_Product_BOM.AD_Client_ID),     (PP_Product_BOM.AD_Org_ID)     ))
