...
public class PP_OrderCandidate_PP_Order
{
	...
	private void propagateQtyProcessed(@NonNull final I_PP_OrderCandidate_PP_Order ppOrderAllocation)
	{
		...
		// This cannot be collected and ran AFTER_COMMIT to prevent duplication of the MD_Candidates generated by both PP_Order_Candidate and PP_Order.
		// In this version, the PPOrderCandidateCreatedEvent will already have a PP_Order_Candidate.QtyToProcess = 0, so it will not generate a SupplyRequiredEvent.
		// If collected and ran AFTER_COMMIT, both the PPOrderCandidateCreatedEvent and the PPOrderCreatedEvent will generate SupplyRequiredEvents, which will lead to duplicate MD_Candidates.
