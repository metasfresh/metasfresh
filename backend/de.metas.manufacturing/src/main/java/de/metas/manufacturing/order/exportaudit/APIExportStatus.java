...
{
	DontExport(X_PP_Order.EXPORTSTATUS_DONT_EXPORT), //
	Pending(X_PP_Order.EXPORTSTATUS_PENDING), //
	Exported(X_PP_Order.EXPORTSTATUS_EXPORTED), //
	ExportError(X_PP_Order.EXPORTSTATUS_EXPORT_ERROR), //
	ExportedAndForwarded(X_PP_Order.EXPORTSTATUS_EXPORTED_AND_FORWARDED), //
	ExportedAndError(X_PP_Order.EXPORTSTATUS_EXPORTED_FORWARD_ERROR) //
	;
