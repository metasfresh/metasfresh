...
public class C_Queue_WorkPackage
{
	...
	{
		final AsyncBatchMilestoneService asyncBatchMilestoneService = SpringContextHolder.instance.getBean(AsyncBatchMilestoneService.class);
		...
		{
			asyncBatchMilestoneService.processAsyncBatchMilestone(asyncBatchId, milestones, trxName);
		}
	}
}
