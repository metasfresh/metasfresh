...
public final class Async_Constants
{
	...
	/**
	 * metasfresh posts {@link WorkpackageProcessedEvent}s to this topic when a workpackage that has a correlation-id set was processed. Also see {@link WorkpackagesProcessedWaiter}.
	 */
