...
/* package */class WorkPackageBlockBuilder implements IWorkPackageBlockBuilder
{
	...
	{
		final QueuePackageProcessorId queuePackageProcessorId = QueuePackageProcessorId.ofRepoId(_queuePackageProcessorId);

		final WorkPackageBuilder workpackageBuilder = new WorkPackageBuilder(_ctx, _workPackageQueue, queuePackageProcessorId, this);
