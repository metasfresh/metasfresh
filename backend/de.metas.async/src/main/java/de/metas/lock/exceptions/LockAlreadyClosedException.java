 ...
 *
 */
public class LockAlreadyClosedException extends LockException
{
	/**
	 * 
	 */
	...
	public static void throwIfClosed(final ILock lock)
	{
		if (lock.isClosed())
		{
			throw new LockAlreadyClosedException(lock);
		}
	}

	public LockAlreadyClosedException(final ILock lock)
	{
		super("Lock already closed: " + lock);
	}
}
