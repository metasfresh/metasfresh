...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Element_Trl SET IsTranslated='Y', Name='Asyncronous WorkPackage Queue', PrintName='Asyncronous WorkPackage Queue',Updated=TO_TIMESTAMP('2020-06-25 15:44:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=541904 AND AD_Language='en_US'
;
