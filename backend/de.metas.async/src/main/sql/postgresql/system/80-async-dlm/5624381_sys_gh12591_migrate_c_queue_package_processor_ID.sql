...
from c_queue_block block
    inner join c_queue_packageprocessor packageProcessor on packageProcessor.c_queue_packageprocessor_id = block.c_queue_packageprocessor_id
...
SET c_queue_packageprocessor_id=(SELECT b.c_queue_packageprocessor_id
                                 FROM dlm.c_queue_block_archived b
                                          inner join c_queue_packageprocessor packageProcessor on packageProcessor.c_queue_packageprocessor_id = b.c_queue_packageprocessor_id
