...
public class TestService implements ITestService
{
	...
	{
		addTestPojoOneWayReturnsVoid(testPojo);
		return Response.ok().build();
	}

	@Override
	public Response addTestPojoOneWay(final TestPojo testPojo)
	{
		addTestPojoOneWayReturnsVoid(testPojo);
		return Response.ok().build();
	}
	...
	@Override
	public void addTestPojoOneWayReturnsVoid(final TestPojo testPojo)
	{
		addTestPojoReturnsVoid(testPojo);
	}

	@Override
	public void addTestPojoReturnsVoid(TestPojo testPojo)
	{
