...
public interface DunningExportClient
{
	public boolean canExport(@NonNull final DunningToExport invoice);

	public List<DunningExportResult> export(@NonNull final DunningToExport invoice);
}
