...
public class JsonWFDistributionStep extends JsonWFStep
{
	@JsonProperty("id")
	@NonNull String id;
	@JsonProperty("pickFromHU")
	@NonNull JsonWFPickFromHU pickFromHU;

	@Builder
	@JsonCreator
	public JsonWFDistributionStep(
			@JsonProperty("id") @NonNull final String id,
			@JsonProperty("pickFromHU") @NonNull final JsonWFPickFromHU pickFromHU
	)
	{
		this.id = id;
