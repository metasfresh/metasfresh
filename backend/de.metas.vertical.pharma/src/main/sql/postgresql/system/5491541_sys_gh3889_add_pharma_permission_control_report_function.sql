...
(
	...
	param_manufacturer character(1),param_wholesale character(1),param_agent character(1), 
	param_pharmacie character(1), param_veterinary character(1)
)
AS 
$$
SELECT 
	...
	$2 AS param_manufacturer, $3 AS param_wholesale, $4 AS param_agent, $5 AS param_pharmacie, $6 AS param_veterinary
...
WHERE 
	...
	AND (CASE WHEN $2 IS NULL THEN TRUE ELSE IsPharmaManufacturerPermission = $2 END)
	AND (CASE WHEN $3 IS NULL THEN TRUE ELSE IsPharmaWholesalePermission = $3 END)
	AND (CASE WHEN $4 IS NULL THEN TRUE ELSE IsPharmaAgentPermission = $4 END)
	AND (CASE WHEN $5 IS NULL THEN TRUE ELSE IsPharmaciePermission = $5 END)
	AND (CASE WHEN $6 IS NULL THEN TRUE ELSE IsVeterinaryPharmacyPermission = $6 END)
