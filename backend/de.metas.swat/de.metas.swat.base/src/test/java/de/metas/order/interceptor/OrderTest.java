...
public class OrderTest
{
	...
	public void init()
	{
		...
		Services.get(IModelInterceptorRegistry.class).addModelInterceptor(new C_Order(bpartnerBL, orderLineDetailRepository, partnerSupplierApprovalService, documentLocationBL));
	}
