...
{
	@NonNull private final InOutLineCountryModelAttributeSetInstanceListener inoutLineListener;
	
	private static final List<String> sourceColumnNames = Collections.singletonList(I_M_InOut.COLUMNNAME_C_BPartner_Location_ID);
