...
public class OrderLineCountryModelAttributeSetInstanceListener implements IModelAttributeSetInstanceListener
{
	...
	public void modelChanged(final Object model)
	{
		new CountryAwareAttributeUpdater()
				.setCountryAwareFactory(OrderLineCountryAware.factory)
