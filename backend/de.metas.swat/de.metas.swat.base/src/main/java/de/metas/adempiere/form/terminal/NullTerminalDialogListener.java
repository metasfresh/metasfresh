...
public final class NullTerminalDialogListener implements ITerminalDialogListener
{
	public static final NullTerminalDialogListener instance = new NullTerminalDialogListener();

	private NullTerminalDialogListener()
	{
		super();
	}
