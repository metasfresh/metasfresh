...
public class C_Payment_UnmarkForRefund extends JavaProcess implements IProcessPrecondition
{
	...
	public ProcessPreconditionsResolution checkPreconditionsApplicable(final @NonNull IProcessPreconditionsContext context)
	{
		...
		final boolean hasScheduledForRefund = paymentBL.hasScheduledForRefund(selectedPaymentsFilter);

		if (!hasScheduledForRefund)
		{
			return ProcessPreconditionsResolution.rejectWithInternalReason("No payment schedules for refund were selected");
		}
	...
	protected String doIt() throws Exception
	{
		...
		paymentBL.unmarkForRefund(selectedPaymentsFilter);
