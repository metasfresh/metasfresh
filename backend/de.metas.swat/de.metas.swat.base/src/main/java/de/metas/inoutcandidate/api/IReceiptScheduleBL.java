...
public interface IReceiptScheduleBL extends ISingletonService
{
	...
	int updateDatePromisedOverridePOReferenceAndConfirmedBySupplier(@NonNull PInstanceId pinstanceId, @Nullable LocalDateTime datePromisedOverride, @Nullable String poReference, @Nullable Boolean isConfirmedBySupplier);
