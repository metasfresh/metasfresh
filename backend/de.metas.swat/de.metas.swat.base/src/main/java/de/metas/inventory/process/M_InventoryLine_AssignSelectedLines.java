...
public class M_InventoryLine_AssignSelectedLines extends JavaProcess
{
	...
	private BigDecimal numberOfCounters;

	@Override
	protected String doIt() throws Exception
	{
		final List<I_M_InventoryLine> inventoryLines = getSelectedInventoryLines();

		inventoryBL.assignToInventoryCounters(inventoryLines, numberOfCounters.intValue());
