...
public class LettersValidator implements ModelValidator
{
	...
	static
	{
		...
		s_mapDocBaseTypeToTableName.put(X_C_DocType.DOCBASETYPE_MaintenanceOrder, I_PP_Order.Table_Name);
		s_mapDocBaseTypeToTableName.put(X_C_DocType.DOCBASETYPE_ManufacturingOrder, I_PP_Order.Table_Name);
		s_mapDocBaseTypeToTableName.put(X_C_DocType.DOCBASETYPE_QualityOrder, I_PP_Order.Table_Name);
		s_mapDocBaseTypeToTableName.put(X_C_DocType.DOCBASETYPE_ServiceRepairOrder, I_PP_Order.Table_Name);
