...
public class IncomingDeliveryPlanningWorkingProcessor extends WorkpackageProcessorAdapter
{
	...
	private static final WorkpackagesOnCommitSchedulerTemplate<I_M_ReceiptSchedule> SCHEDULER = new WorkpackagesOnCommitSchedulerTemplate<I_M_ReceiptSchedule>(IncomingDeliveryPlanningWorkingProcessor.class)
	{
		...
		{
			return model != null && model.getM_ReceiptSchedule_ID() > 0;
		}

		@Override
		protected Properties extractCtxFromItem(final I_M_ReceiptSchedule item)
		{
			return Env.getCtx();
		}

		@Override
		protected String extractTrxNameFromItem(final I_M_ReceiptSchedule item)
		{
			return ITrx.TRXNAME_ThreadInherited;
		}

		@Override
		protected Object extractModelToEnqueueFromItem(final Collector collector, final I_M_ReceiptSchedule item)
		{
			return TableRecordReference.of(I_M_ReceiptSchedule.Table_Name, item.getM_ReceiptSchedule_ID());
		}
	};
