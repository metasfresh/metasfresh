...
/** Generated Model for M_ShipmentSchedule_ExportAudit_Line
...
public class X_M_ShipmentSchedule_ExportAudit_Line extends org.compiere.model.PO implements I_M_ShipmentSchedule_ExportAudit_Line, org.compiere.model.I_Persistent 
{
	...
	private static final long serialVersionUID = 1033456689L;
    ...
    {
      super (ctx, M_ShipmentSchedule_ExportAudit_Line_ID, trxName);
    }

    /** Load Constructor */
    public X_M_ShipmentSchedule_ExportAudit_Line (Properties ctx, ResultSet rs, String trxName)
    {
	 ...
	 * Reference name: M_ShipmentSchedule_ExportStatus
	 */
	...
	@Override
	public void setM_ShipmentSchedule_ExportAudit_Line_ID (int M_ShipmentSchedule_ExportAudit_Line_ID)
	{
		if (M_ShipmentSchedule_ExportAudit_Line_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_M_ShipmentSchedule_ExportAudit_Line_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_M_ShipmentSchedule_ExportAudit_Line_ID, Integer.valueOf(M_ShipmentSchedule_ExportAudit_Line_ID));
	}

	@Override
	public int getM_ShipmentSchedule_ExportAudit_Line_ID() 
	{
		return get_ValueAsInt(COLUMNNAME_M_ShipmentSchedule_ExportAudit_Line_ID);
	}
