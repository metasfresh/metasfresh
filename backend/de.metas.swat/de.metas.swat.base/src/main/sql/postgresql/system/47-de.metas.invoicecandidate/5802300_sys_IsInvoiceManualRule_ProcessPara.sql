...
-- InvoiceRule Manual —Add AD_Element for the new 'IsInvoiceManualRule' process parameter
...
-- InvoiceRule Manual —Seed AD_Element_Trl rows for all system languages and the base language
...
-- InvoiceRule Manual —English (en_US) translation for the new element
...
-- InvoiceRule Manual —Add the new 'IsInvoiceManualRule' boolean parameter to process C_Invoice_Candidate_EnqueueSelectionForInvoicing (AD_Process_ID=540304).
...
-- InvoiceRule Manual —Seed AD_Process_Para_Trl rows for all system languages and the base language
...
-- InvoiceRule Manual —English (en_US) translation for the process parameter
