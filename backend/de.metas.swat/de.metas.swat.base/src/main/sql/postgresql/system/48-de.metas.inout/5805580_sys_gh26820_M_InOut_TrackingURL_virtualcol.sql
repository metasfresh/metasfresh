...
INSERT INTO AD_Column (
  ...
  IsTranslated,IsUpdateable,IsUseDocSequence,Name,SeqNo,Updated,UpdatedBy,Version
) VALUES (
  0,592668,2127,0,10,(SELECT AD_Table_ID FROM AD_Table WHERE TableName='M_InOut'),
  'N','TrackingURL',
  ...
  'N','N','N','N','N','N',
  'Y','N','N','N','N','N',
  'N','N','N','Tracking URL',0,now(),100,0
);
