...
-- Element: IsShippingNotificationRequired
...
UPDATE AD_Element_Trl SET IsTranslated='Y', Name='Shipping Notification required', PrintName='Shipping Notification required',Updated=TO_TIMESTAMP('2024-10-02 15:13:48.254','YYYY-MM-DD HH24:MI:SS.US'),UpdatedBy=100 WHERE AD_Element_ID=583295 AND AD_Language='en_US'
;
...
-- Column: M_ShipmentSchedule.IsShippingNotificationRequired
-- 2024-10-02T13:23:05.576Z
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DDL_NoForeignKey,DefaultValue,EntityType,FacetFilterSeqNo,FieldLength,IsActive,IsAdvancedText,IsAllowLogging,IsAlwaysUpdateable,IsAutoApplyValidationRule,IsAutocomplete,IsCalculated,IsDimension,IsDLMPartitionBoundary,IsEncrypted,IsExcludeFromZoomTargets,IsFacetFilter,IsForceIncludeInGeneratedModel,IsGenericZoomKeyColumn,IsGenericZoomOrigin,IsIdentifier,IsKey,IsLazyLoading,IsMandatory,IsParent,IsRestAPICustomColumn,IsSelectionColumn,IsShowFilterIncrementButtons,IsShowFilterInline,IsStaleable,IsSyncDatabase,IsTranslated,IsUpdateable,IsUseDocSequence,MaxFacetsToFetch,Name,SelectionColumnSeqNo,SeqNo,Updated,UpdatedBy,Version) VALUES (0,589178,583295,0,20,500221,'IsShippingNotificationRequired',TO_TIMESTAMP('2024-10-02 15:23:05.369','YYYY-MM-DD HH24:MI:SS.US'),100,'N','N','de.metas.inoutcandidate',0,1,'Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','Y','N',0,'Lieferavis erforderlich',0,0,TO_TIMESTAMP('2024-10-02 15:23:05.369','YYYY-MM-DD HH24:MI:SS.US'),100,0)
;
...
/* DDL */ SELECT public.db_alter_table('M_ShipmentSchedule','ALTER TABLE public.M_ShipmentSchedule ADD COLUMN IsShippingNotificationRequired CHAR(1) DEFAULT ''N'' CHECK (IsShippingNotificationRequired IN (''Y'',''N'')) NOT NULL')
;
