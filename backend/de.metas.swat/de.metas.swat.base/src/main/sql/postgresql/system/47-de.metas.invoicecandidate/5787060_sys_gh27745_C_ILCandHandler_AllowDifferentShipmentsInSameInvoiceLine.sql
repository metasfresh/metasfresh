...
Wenn deaktiviert, wird der Rechnungskandidat je Lieferung immer auf separate Rechnungszeilen aufgeteilt.','Y','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','Y','N','N','N','N','N','N','N','N','N','Y','N',0,'Versch. Lieferungen in selber Rechn.-Pos.',0,0,'No for backwards-compatibility',TO_TIMESTAMP('2026-02-05 15:16:10.960000','YYYY-MM-DD HH24:MI:SS.US')::timestamp without time zone AT TIME ZONE 'UTC',100,0)
;
