...
public class PlainDunningConfigurator implements IDunningConfigurator
{
	...
	public int configureRequestCount = 0;

	@Override
	public IDunningConfig configure(IDunningEditableConfig config)
	{
		this.configureRequestCount++;
		return returnNull ? null : config;
	}
}
