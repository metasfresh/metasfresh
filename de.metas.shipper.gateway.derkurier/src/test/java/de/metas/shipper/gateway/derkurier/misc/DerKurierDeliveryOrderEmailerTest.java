...
public class DerKurierDeliveryOrderEmailerTest
{
	...
	public void testAttachAndEmail()
	{
		...
		DerKurierDeliveryOrderEmailer deliveryOrderEmailAttachment = new DerKurierDeliveryOrderEmailer();
		
		deliveryOrderEmailAttachment.emailAttachment(derKurierShipperConfig, firstEntry);
