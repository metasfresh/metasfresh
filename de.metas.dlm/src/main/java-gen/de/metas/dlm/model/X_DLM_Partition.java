...
public class X_DLM_Partition extends org.compiere.model.PO implements I_DLM_Partition, org.compiere.model.I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 1346855804L;

    /** Standard Constructor */
    public X_DLM_Partition (Properties ctx, int DLM_Partition_ID, String trxName)
    {
...
// N
    ...
    /** Load Constructor */
    public X_DLM_Partition (Properties ctx, ResultSet rs, String trxName)
    {
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Current_DLM_Level);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Nächte Prüfung der DLM-Levels.
		@param DateNextInspection Nächte Prüfung der DLM-Levels	  */
	@Override
	...
	/** Get Nächte Prüfung der DLM-Levels.
		@return Nächte Prüfung der DLM-Levels	  */
	@Override
	...
	{
		Object oo = get_Value(COLUMNNAME_IsPartitionComplete);
		if (oo != null) 
		{
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Target_DLM_Level);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
