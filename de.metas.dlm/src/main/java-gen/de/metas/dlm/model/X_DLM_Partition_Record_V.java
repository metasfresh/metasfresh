...
public class X_DLM_Partition_Record_V extends org.compiere.model.PO implements I_DLM_Partition_Record_V, org.compiere.model.I_Persistent 
{
    ...
    public X_DLM_Partition_Record_V (Properties ctx, int DLM_Partition_Record_V_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_DLM_Partition_Record_V (Properties ctx, ResultSet rs, String trxName)
    {
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DLM_Partition_Record_V_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
