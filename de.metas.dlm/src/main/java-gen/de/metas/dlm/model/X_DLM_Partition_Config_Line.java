...
public class X_DLM_Partition_Config_Line extends org.compiere.model.PO implements I_DLM_Partition_Config_Line, org.compiere.model.I_Persistent 
{
    ...
    public X_DLM_Partition_Config_Line (Properties ctx, int DLM_Partition_Config_Line_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_DLM_Partition_Config_Line (Properties ctx, ResultSet rs, String trxName)
    {
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DLM_Partition_Config_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DLM_Partition_Config_Line_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_DLM_Referencing_Table_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsDLM);
		if (oo != null) 
		{
