...
public class X_DLM_Partition_Config extends org.compiere.model.PO implements I_DLM_Partition_Config, org.compiere.model.I_Persistent 
{
    ...
    public X_DLM_Partition_Config (Properties ctx, int DLM_Partition_Config_ID, String trxName)
    {
...
// N
    ...
    /** Load Constructor */
    public X_DLM_Partition_Config (Properties ctx, ResultSet rs, String trxName)
    {
