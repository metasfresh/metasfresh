...
/** Generated Model for P_AdvCommissionDocs
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_P_AdvCommissionDocs extends PO implements I_P_AdvCommissionDocs, I_Persistent 
{
    ...
    public X_P_AdvCommissionDocs (Properties ctx, int P_AdvCommissionDocs_ID, String trxName)
    {
      super (ctx, P_AdvCommissionDocs_ID, trxName);
      /** if (P_AdvCommissionDocs_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_P_AdvCommissionDocs (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_P_AdvCommissionDocs[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_Rank, Integer.valueOf(Rank));
	}
