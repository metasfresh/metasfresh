...
/** Generated Model for C_AdvComRankCollection
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_C_AdvComRankCollection extends PO implements I_C_AdvComRankCollection, I_Persistent 
{
    ...
    public X_C_AdvComRankCollection (Properties ctx, int C_AdvComRankCollection_ID, String trxName)
    {
      super (ctx, C_AdvComRankCollection_ID, trxName);
      /** if (C_AdvComRankCollection_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_C_AdvComRankCollection (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_AdvComRankCollection[")
