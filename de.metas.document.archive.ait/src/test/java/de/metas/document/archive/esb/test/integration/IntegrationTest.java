...
{
	public final String RESTHTTP_ServerURL = "http://localhost:8181";
	private static final String JMS_ServerURL = "tcp://localhost:61616";
	...
	public static void initStatic() throws Exception
	{
		...
		// org.apache.camel.RuntimeCamelException: org.apache.cxf.interceptor.Fault: Could not add cxf jetty handler for url http://localhost:8181/ to Jetty server, as the path / is still in use.
		setupCamelRouter();
	}
