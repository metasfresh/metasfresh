...
public class TrlToolbarbutton extends Toolbarbutton implements ITranslatableLabel
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5630423170810176342L;

	private final TranslatableLabelSupport trl;

	public TrlToolbarbutton()
	{
		super();
