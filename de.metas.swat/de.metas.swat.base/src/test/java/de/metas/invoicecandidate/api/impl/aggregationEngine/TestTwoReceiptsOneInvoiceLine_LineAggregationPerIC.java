...
public class TestTwoReceiptsOneInvoiceLine_LineAggregationPerIC extends AbstractTwoInOutsTests
{
		...
		// Setup C_Aggregation(s)
		{
			...
			lineAggregation_StandardFields = new C_Aggregation_Builder()
				...
				.newItem()
					...
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_M_Product_ID)
					.end()
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_C_Charge_ID)
					.end()
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_PriceActual)
					.end()
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
				...
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_C_UOM_ID)
					.end()
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_IsPrinted)
					.end()
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_Line)
					.end()
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_C_Tax_ID)
					.end()
				.build();
			//@formatter:on
			...
			lineAggregation_PerInvoiceCandidate = new C_Aggregation_Builder()
				...
				.newItem()
					.setType(X_C_AggregationItem.TYPE_Column)
					.setAD_Column(I_C_Invoice_Candidate.COLUMN_C_Invoice_Candidate_ID)
	...
	@Override
	protected boolean config_IsAllowConsolidateInvoice()
	{
		return true;
	}
