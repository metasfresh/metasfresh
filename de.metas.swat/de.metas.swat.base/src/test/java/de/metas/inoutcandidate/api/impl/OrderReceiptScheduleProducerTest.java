...
public class OrderReceiptScheduleProducerTest extends ReceiptScheduleTestBase
{
	...
	public void createReceiptSchedulesTestNullPrev()
	{
		...
		List<I_M_ReceiptSchedule> rcs = orderReceiptScheduleProducer.createOrUpdateReceiptSchedules(order, Collections.<I_M_ReceiptSchedule> emptyList());
	...
	public void createReceiptSchedulesTestOnePrev()
	{
		...
		List<I_M_ReceiptSchedule> rcs = orderReceiptScheduleProducer.createOrUpdateReceiptSchedules(order, receiptSchedules);
		Assert.assertEquals(1, rcs.size());
	}
	...
	public void dataInOrderValidateTest()
	{
		...
		final List<I_M_ReceiptSchedule> rcs = orderReceiptScheduleProducer.createOrUpdateReceiptSchedules(order, Collections.<I_M_ReceiptSchedule> emptyList());
		Assert.assertEquals(1, rcs.size());
