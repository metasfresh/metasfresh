...
/** Generated Model for RV_C_InvoiceLine_Overview
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_RV_C_InvoiceLine_Overview extends PO implements I_RV_C_InvoiceLine_Overview, I_Persistent 
{
    ...
    public X_RV_C_InvoiceLine_Overview (Properties ctx, int RV_C_InvoiceLine_Overview_ID, String trxName)
    {
      super (ctx, RV_C_InvoiceLine_Overview_ID, trxName);
      /** if (RV_C_InvoiceLine_Overview_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_RV_C_InvoiceLine_Overview (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_RV_C_InvoiceLine_Overview[")
