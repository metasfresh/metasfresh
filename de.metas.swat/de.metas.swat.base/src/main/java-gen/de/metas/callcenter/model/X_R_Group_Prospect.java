...
/** Generated Model for R_Group_Prospect
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_R_Group_Prospect extends PO implements I_R_Group_Prospect, I_Persistent 
{
    ...
    public X_R_Group_Prospect (Properties ctx, int R_Group_Prospect_ID, String trxName)
    {
      super (ctx, R_Group_Prospect_ID, trxName);
      /** if (R_Group_Prospect_ID == 0)
        {
			setAD_User_ID (0);
// -1
			setC_BPartner_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_R_Group_Prospect (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_R_Group_Prospect[")
