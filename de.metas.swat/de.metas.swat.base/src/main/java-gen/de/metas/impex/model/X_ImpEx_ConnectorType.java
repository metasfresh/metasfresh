...
/** Generated Model for ImpEx_ConnectorType
 *  @author Adempiere (generated) 
 *  @version Release 3.5.4a - $Id$ */
public class X_ImpEx_ConnectorType extends PO implements I_ImpEx_ConnectorType, I_Persistent 
{
    ...
    public X_ImpEx_ConnectorType (Properties ctx, int ImpEx_ConnectorType_ID, String trxName)
    {
      super (ctx, ImpEx_ConnectorType_ID, trxName);
      /** if (ImpEx_ConnectorType_ID == 0)
        {
			setClassname (null);
			setDirection (null);
    ...
    /** Load Constructor */
    public X_ImpEx_ConnectorType (Properties ctx, ResultSet rs, String trxName)
    {
