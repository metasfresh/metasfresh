 ...
 * @author Jorg Janke
 */
public class RichTextEditorExperimental extends CDialog {
	 ...
	 *            text
	 */
	public RichTextEditorExperimental(Frame owner, String title, String htmlText,
			boolean editable) {
		super(owner,
	 ...
	 *            text
	 */
	public RichTextEditorExperimental(Dialog owner, String title, String htmlText,
			boolean editable) {
		super(owner,
				title == null ? Msg.getMsg(Env.getCtx(), "Editor") : title,
				true);
