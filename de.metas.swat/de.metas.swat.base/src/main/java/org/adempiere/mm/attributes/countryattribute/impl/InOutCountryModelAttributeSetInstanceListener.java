...
public class InOutCountryModelAttributeSetInstanceListener implements IModelAttributeSetInstanceListener
{
	private final IModelAttributeSetInstanceListener inoutLineListener = new InOutLineCountryModelAttributeSetInstanceListener();
