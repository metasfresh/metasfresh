...
public class M_AttributeInstance
{
	...
	/**
	 * In case {@link I_M_AttributeInstance#COLUMNNAME_Value} column changed and we deal with an List attribute, search and set coresponding {@link I_M_AttributeValue}
	 *
	 * @param ai
	 */
