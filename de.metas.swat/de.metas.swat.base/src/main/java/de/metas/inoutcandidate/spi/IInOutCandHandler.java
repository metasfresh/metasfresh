 ...
 * 
 * Interface methods should only be called by the {@link IInOutCandHandlerBL} implementation.
 * 
 * @author ts
 * 
 */
public interface IInOutCandHandler
{
	 ...
	 * <li>Implementors should check for <code>I_M_IolCandHandler_Log</code> to make sure that they don't repeatedly
	 * return records are then vetoed by some {@link IInOutCandHandlerListener}</li>
	 * </ul>
	 * 
	 * @param ctx
	 * @param trxName
	 ...
	 * <li>the framework will look up and set the shipment schedules'
	 * {@link I_M_ShipmentSchedule#COLUMNNAME_M_IolCandHandler_ID} with the correct value for this handler.
