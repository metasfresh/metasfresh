 ...
 * between the first and second allocation run.<br>
 * Its task is to set the status of the candidates from the first run.
 * 
 */
public interface IShipmentSchedulesAfterFirstPassUpdater
{
	 ...
	 */
	int doUpdateAfterFirstPass(Properties ctx, IShipmentSchedulesDuringUpdate candidates, String trxName);
}
