...
public class C_BPartner
{
	...
	public void onInvoiceRuleChange(final I_C_BPartner bPartner) throws Exception
	{
		...
		invoiceCandDAO.invalidateCandsForBPartnerInvoiceRule(bPartner);
	}
	...
	@ModelChange(timings = { ModelValidator.TYPE_AFTER_CHANGE }
			, ifColumnsChanged = {
					I_C_BPartner.COLUMNNAME_PO_Invoice_Aggregation_ID
					, I_C_BPartner.COLUMNNAME_PO_InvoiceLine_Aggregation_ID
					, I_C_BPartner.COLUMNNAME_SO_Invoice_Aggregation_ID
					, I_C_BPartner.COLUMNNAME_SO_InvoiceLine_Aggregation_ID })
