...
DROP VIEW If EXISTS rv_r_group_prospect;

ALTER TABLE R_Group_Prospect RENAME COLUMN lockedby TO lockedby_OLD;
ALTER TABLE R_Group_Prospect ADD COLUMN lockedby  NUMERIC(10);
UPDATE R_Group_Prospect SET lockedby=lockedby_OLD::NUMERIC(10);
COMMIT;
ALTER TABLE R_Group_Prospect DROP COLUMN lockedby_OLD;
