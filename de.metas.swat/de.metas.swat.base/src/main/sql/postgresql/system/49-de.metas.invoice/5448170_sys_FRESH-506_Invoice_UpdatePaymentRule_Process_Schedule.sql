...
-- 12.07.2016 16:20
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET DisplayLogic='@Type@=''SQL'' | @JasperReport@!''''',Updated=TO_TIMESTAMP('2016-07-12 16:20:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=543154
;

-- 12.07.2016 16:26
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET DisplayLogic='@Type@=''Update-SQL'' | @JasperReport@!''''',Updated=TO_TIMESTAMP('2016-07-12 16:26:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=543154
;
...
-- 12.07.2016 16:30
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Field SET DisplayLogic='@Type@=''SQL'' | @JasperReport@!''''',Updated=TO_TIMESTAMP('2016-07-12 16:30:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=543154
;
...
-- 12.07.2016 17:04
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Scheduler SET EntityType='de.metas.i',Updated=TO_TIMESTAMP('2016-07-12 17:04:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Scheduler_ID=550037
;
...
-- 12.07.2016 17:14
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Scheduler SET EntityType='de.metas.i',Updated=TO_TIMESTAMP('2016-07-12 17:14:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Scheduler_ID=550038
;
