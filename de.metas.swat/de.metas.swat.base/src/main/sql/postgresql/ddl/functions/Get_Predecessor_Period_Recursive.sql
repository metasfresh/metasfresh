...
CREATE OR REPLACE FUNCTION report.Get_Predecessor_Period_recursive( p_C_Period_ID numeric, p_Steps int ) RETURNS numeric AS
$BODY$
/**
...
BEGIN
	...
	END IF;
	SELECT report.Get_Predecessor_Period( p_C_Period_ID ) INTO v_C_Period_ID;
	RETURN report.Get_Predecessor_Period_recursive( v_C_Period_ID, p_steps-1 );
END;
$BODY$
