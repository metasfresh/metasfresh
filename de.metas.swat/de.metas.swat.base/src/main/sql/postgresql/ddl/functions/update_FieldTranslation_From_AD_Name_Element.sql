-- Function: public.update_fieldtranslation_from_ad_name_element(numeric)

-- DROP FUNCTION public.update_fieldtranslation_from_ad_name_element(numeric);

CREATE OR REPLACE FUNCTION public.update_fieldtranslation_from_ad_name_element(ad_element_id numeric)
  RETURNS void AS
$BODY$
