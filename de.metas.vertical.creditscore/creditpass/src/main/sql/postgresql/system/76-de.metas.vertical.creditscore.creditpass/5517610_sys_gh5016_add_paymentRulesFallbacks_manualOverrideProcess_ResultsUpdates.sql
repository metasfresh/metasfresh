...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,AllowProcessReRun,Classname,CopyFromProcess,Created,CreatedBy,EntityType,IsActive,IsApplySecuritySettings,IsBetaFunctionality,IsDirectPrint,IsOneInstanceOnly,IsReport,IsServerProcess,IsTranslateExcelHeaders,IsUseBPartnerLanguage,LockWaitTimeout,Name,RefreshAllAfterExecution,ShowHelp,Type,Updated,UpdatedBy,Value) VALUES ('3',0,0,541088,'Y','de.metas.vertical.creditscore.creditpass.process.CS_Transaction_Result_ManualOverride','N',TO_TIMESTAMP('2019-03-29 16:35:08','YYYY-MM-DD HH24:MI:SS'),100,'de.metas.vertical.creditscore.creditpass','Y','N','N','N','N','N','N','Y','Y',0,'CreditPass Antwort überschreiben','N','N','Java',TO_TIMESTAMP('2019-03-29 16:35:08','YYYY-MM-DD HH24:MI:SS'),100,'10000001')
;
