 ...
 * @task 08839
 */
public class XlsToMapListConverter
{
	...
	public static class Builder
	{
		...
		public XlsToMapListConverter build()
		{
			return new XlsToMapListConverter(this);
		}
		...
		/**
		 * Sets if a cell value which is a null string (i.e. {@link XlsToMapListConverter#NULLStringMarker}) shall be considered as <code>null</code>.
		 *
