...
public class H000 implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5070976328144146272L;
	...
	public void setSenderQual(final String senderQual)
	{
	...
	public void setReceiverQual(final String receiverQual)
	{
	...
	public void setMsgSubType(final String msgSubType)
	{
	...
	public void setSyntaxID(final String syntaxID)
	{
	...
	public void setApplicationRef(final String applicationRef)
	{
		this.applicationRef = applicationRef;
	}

	public String getCommsAgreement()
	{
		return commsAgreement;
	}

	public void setCommsAgreement(final String commsAgreement)
	{
	...
	public List<H100> getH100Lines()
	{
		return h100Lines;
	}

	public void setH100Lines(final List<H100> h100Lines)
	{
		this.h100Lines = h100Lines;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (h100Lines == null ? 0 : h100Lines.hashCode());
	...
	public boolean equals(final Object obj) // NOPMD by al
	{
		...
		if (h100Lines == null)
		{
			if (other.h100Lines != null)
			{
				return false;
			}
		}
		else if (!h100Lines.equals(other.h100Lines))
		{
			return false;
		}
		if (messageDate == null)
	...
	{
		return "H000 [record=" + record + ", sender=" + sender + ", senderQual=" + senderQual + ", receiver=" + receiver + ", receiverQual=" + receiverQual + ", reference=" + reference
				+ ", msgFormat=" + msgFormat + ", msgType=" + msgType + ", msgSubType=" + msgSubType + ", msgCount=" + msgCount + ", syntaxID=" + syntaxID + ", syntaxVersion=" + syntaxVersion
				+ ", messageDate=" + messageDate + ", applicationRef=" + applicationRef + ", commsAgreement=" + commsAgreement + ", testFlag=" + testFlag
				+ ", h100Lines=" + h100Lines + "]";
	}
}
