...
package de.metas.edi.esb.invoicexport.metasfresh;
...
public class MetasfreshXMLInvoicRoute extends AbstractEDIRoute
{
	public static final String ROUTE_ID = "MF-Invoic-To-metasfresh-XML-Invoic";
	...
	private static final String OUTPUT_INVOIC_LOCAL = "{{edi.file.invoic.metasfresh-xml}}";

	private static final String OUTPUT_INVOIC_REMOTE = "edi.file.invoic.metasfresh-xml.remote";
