...
You can always get the latest docker-compose.yml at <code>${mvnResolveRepoBaseURL}/service/rest/v1/search/assets/download?sort=version&repository=${mvnRepoName}&maven.groupId=${dockerComposeGroupId}&maven.artifactId=${dockerComposeArtifactId}&maven.classifier=${dockerComposeClassifier}&maven.extension=yml</code>
