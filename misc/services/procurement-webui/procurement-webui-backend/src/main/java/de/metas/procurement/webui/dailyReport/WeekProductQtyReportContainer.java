...
public class WeekProductQtyReportContainer
{
	private final BPartner bpartner;
	private final DateRange week;

	public WeekProductQtyReportContainer(@NonNull final BPartner bpartner, @NonNull final DateRange week)
	{
		this.bpartner = bpartner;
		this.week = week;
	}

	public void addDailyQtyReport(final ProductQtyReport bean)
	{
	// 	final LocalDate day = bean.getDay();
