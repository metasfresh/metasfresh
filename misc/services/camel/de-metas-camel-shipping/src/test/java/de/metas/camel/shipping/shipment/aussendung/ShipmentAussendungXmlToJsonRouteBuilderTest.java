...
public class ShipmentAussendungXmlToJsonRouteBuilderTest extends CamelTestSupport
{
	...
	private static final String CREATE_SHIPMENT_VALID_XML_RESOURCE_PATH = "/de/metas/camel/shipping/shipment/aussendung/Siro_aussendungen.xml";
	private static final String CREATE_SHIPMENT_EMPTY_XML_RESOURCE_PATH = "/de/metas/camel/shipping/shipment/aussendung/Siro_aussendungen_empty.xml";
	private static final String CREATE_SHIPMENT_RESPONSE_JSON_RESOURCE_PATH = "/de/metas/camel/shipping/shipment/aussendung/JsonCreateShipmentResponse.json";
	private static final String CREATE_SHIPMENT_REQUEST_JSON_RESOURCE_PATH = "/de/metas/camel/shipping/shipment/aussendung/JsonCreateShipmentRequest.json";
	private static final String CORRECT_INVENTORY_JSON_REQUEST_RESOURCE_PATH = "/de/metas/camel/shipping/shipment/aussendung/inventory/JsonInventory.json";
	...
	@Disabled // testing only makes sense when we changed the ShipmentAussendungXmlToJsonRouteBuilder's job
	@Test
	void validFile_test() throws Exception
	{
		...
		assertThat(importInventoryLinesEndpoint.called).isEqualTo(1);
	...
	{
		AdviceWithRouteBuilder.adviceWith(context, ShipmentAussendungXmlToJsonRouteBuilder.MF_SHIPMENT_FILEMAKER_XML_TO_JSON,
				advice -> {
		...
		AdviceWithRouteBuilder.adviceWith(context, ShipmentAussendungXmlToJsonRouteBuilder.MF_GENERATE_SHIPMENTS,
				advice -> {
		...
		AdviceWithRouteBuilder.adviceWith(context, ShipmentAussendungXmlToJsonRouteBuilder.MF_SHIPMENT_INVENTORY_CORRECTION,
				advice -> {
