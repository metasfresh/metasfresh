...
class MetasfreshInHouseV2InvoicRouteTest extends CamelTestSupport
{
	...
	{
		return new MetasfreshInHouseV2InvoicRoute();
	}
	...
	protected Properties useOverridePropertiesWithPropertiesComponent()
	{
		...
		try
		{
			properties.load(MetasfreshInHouseV2InvoicRouteTest.class.getClassLoader().getResourceAsStream("application.properties"));
			properties.setProperty(MetasfreshInHouseV2InvoicRoute.OUTPUT_INVOIC_LOCAL_NEW_VERSION, "mock:fileOutputEndpoint");
	...
	void empty_invoic() throws Exception
	{
		...
		template.sendBodyAndHeader(
				MetasfreshInHouseV2InvoicRoute.EP_EDI_METASFRESH_XML_INVOIC_CONSUMER /*endpoint-URI*/,
	...
	{
		// given
		final var inputStr = MetasfreshInHouseV2InvoicRouteTest.class.getResourceAsStream("/de/metas/edi/esb/invoicexport/metasfreshinhousev2/INVOIC.xml");
		...
		XmlAssert.assertThat(invoicOutput)
				.and(new File("./src/test/resources/de/metas/edi/esb/invoicexport/metasfreshinhousev2/INVOIC_expected_output.xml"))
