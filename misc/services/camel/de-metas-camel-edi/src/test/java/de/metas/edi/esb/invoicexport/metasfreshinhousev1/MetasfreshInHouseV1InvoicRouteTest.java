...
class MetasfreshInHouseV1InvoicRouteTest extends CamelTestSupport
{
	...
	{
		return new MetasfreshInHouseV1InvoicRoute();
	}
	...
	protected Properties useOverridePropertiesWithPropertiesComponent()
	{
		...
		try
		{
			properties.load(MetasfreshInHouseV1InvoicRouteTest.class.getClassLoader().getResourceAsStream("application.properties"));
			properties.setProperty(MetasfreshInHouseV1InvoicRoute.OUTPUT_INVOIC_LOCAL, "mock:fileOutputEndpoint");
	...
	void empty_invoic() throws Exception
	{
		...
		template.sendBodyAndHeader(
				MetasfreshInHouseV1InvoicRoute.EP_EDI_METASFRESH_XML_INVOIC_CONSUMER /*endpoint-URI*/,
		...
		assertThat(invoicBody).isEqualToIgnoringWhitespace(
				"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
						+ "<EDI_cctop_invoic_v AD_Client_Value=\"ADClientValueAttr\" Version=\"*\">\n"
	...
	{
		// given
		final var inputStr = MetasfreshInHouseV1InvoicRouteTest.class.getResourceAsStream("/de/metas/edi/esb/invoicexport/metasfreshinhousev1/INVOIC.xml");
		...
		assertThat(invoicOutput).isNotBlank();
		XmlAssert.assertThat(invoicOutput).and(new File("./src/test/resources/de/metas/edi/esb/invoicexport/metasfreshinhousev1/INVOIC_expected_output.xml"))
