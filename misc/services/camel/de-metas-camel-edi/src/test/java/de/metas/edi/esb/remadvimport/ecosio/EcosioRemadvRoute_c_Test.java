...
class EcosioRemadvRoute_c_Test extends CamelTestSupport
{
	...
	private static final String CREATE_REMADV_VALID_XML_RESOURCE_PATH = "/de/metas/edi/esb/remadvimport/ecosio/c_10_EcosioRemadvTestFile_Invoice_CreditMemo_VendorInvoice.xml";
	private static final String CREATE_REMADV_REQUEST_JSON_RESOURCE_PATH = "/de/metas/edi/esb/remadvimport/ecosio/c_20_JsonCreateREMADVRequest.json";
	private static final String CREATE_REMADV_RESPONSE_JSON_RESOURCE_PATH = "/de/metas/edi/esb/remadvimport/ecosio/c_30_JsonCreateREMADVResponse.json";
	...
	protected Properties useOverridePropertiesWithPropertiesComponent()
	{
		...
		try
		{
			properties.load(EcosioRemadvRoute_c_Test.class.getClassLoader().getResourceAsStream("application.properties"));
			return properties;
		}
