...
import de.metas.edi.esb.jaxb.metasfreshinhousev1.EDIExpDesadvType;
...
class MetasfreshInHouseV1DesadvRouteTest extends CamelTestSupport
{
	...
	{
		return new MetasfreshInHouseV1DesadvRoute();
	}
	...
	protected Properties useOverridePropertiesWithPropertiesComponent()
	{
		...
		try
		{
			properties.load(MetasfreshInHouseV1DesadvRouteTest.class.getClassLoader().getResourceAsStream("application.properties"));
			properties.setProperty(MetasfreshInHouseV1DesadvRoute.OUTPUT_DESADV_LOCAL, "mock:fileOutputEndpoint");
	...
	void empty_desadv() throws Exception
	{
		...
		template.sendBodyAndHeader(
				MetasfreshInHouseV1DesadvRoute.EP_EDI_METASFRESH_XML_DESADV_CONSUMER /*endpoint-URI*/,
		...
		assertThat(desadvBody).isEqualToIgnoringWhitespace(
				"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
						+ "<EDI_Exp_Desadv AD_Client_Value=\"ADClientValueAttr\" Version=\"*\">\n"
	...
	void nonEmpty_desadv() throws Exception
	{
		testAndValidateResult(
				"/de/metas/edi/esb/desadvexport/metasfreshinhousev1/DESADV_1023358_1611220554035.xml",
				"./src/test/resources/de/metas/edi/esb/desadvexport/metasfreshinhousev1/DESADV_1023358_1611220554035_expected_output.xml");
	}
	...
	{
		testAndValidateResult(
				"/de/metas/edi/esb/desadvexport/metasfreshinhousev1/DESADV_noPacks.xml",
				"./src/test/resources/de/metas/edi/esb/desadvexport/metasfreshinhousev1/DESADV_noPacks_expected_output.xml");
	}
	...
	{
		testAndValidateResult(
				"/de/metas/edi/esb/desadvexport/metasfreshinhousev1/DESADV_with_and_without_packs.xml",
				"./src/test/resources/de/metas/edi/esb/desadvexport/metasfreshinhousev1/DESADV_with_and_without_packs_expected_output.xml");
	}
	...
	{
		// given
		final var inputStr = MetasfreshInHouseV1DesadvRouteTest.class.getResourceAsStream(inputStrPath);
