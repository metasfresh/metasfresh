...
class MetasfreshInHouseV2DesadvRouteTest extends CamelTestSupport
{
	...
	{
		return new MetasfreshInHouseV2DesadvRoute();
	}
	...
	void empty_desadv() throws Exception
	{
		...
		template.sendBodyAndHeader(
				MetasfreshInHouseV2DesadvRoute.EP_EDI_METASFRESH_XML_DESADV_CONSUMER /*endpoint-URI*/,
	...
	void nonEmpty_desadv() throws Exception
	{
		testAndValidateResult(
				"/de/metas/edi/esb/desadvexport/metasfreshinhousev2/DESADV_1023358_1611220554035.xml",
				"./src/test/resources/de/metas/edi/esb/desadvexport/metasfreshinhousev2/DESADV_1023358_1611220554035_expected_output.xml");
	}
	...
	{
		testAndValidateResult(
				"/de/metas/edi/esb/desadvexport/metasfreshinhousev2/DESADV_noPacks.xml",
				"./src/test/resources/de/metas/edi/esb/desadvexport/metasfreshinhousev2/DESADV_noPacks_expected_output.xml");
	}
	...
	{
		testAndValidateResult(
				"/de/metas/edi/esb/desadvexport/metasfreshinhousev2/DESADV_with_and_without_packs.xml",
				"./src/test/resources/de/metas/edi/esb/desadvexport/metasfreshinhousev2/DESADV_with_and_without_packs_expected_output.xml");
	}
	...
	{
		// given
		final var inputStr = MetasfreshInHouseV2DesadvRouteTest.class.getResourceAsStream(inputStrPath);
