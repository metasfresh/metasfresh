...
/**
 * <p>Java class for PPACK1 complex type</p>.
 * 
...
public class PPACK1 {
     ...
     * This is why there is not a <CODE>set</CODE> method for the pmesu1 property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the pmesu1 property.
     */
    public List<PMESU1> getPMESU1() {
        if (pmesu1 == null) {
            pmesu1 = new ArrayList<>();
        }
        return this.pmesu1;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the phand1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the phand1 property.
     */
    public List<PHAND1> getPHAND1() {
        if (phand1 == null) {
            phand1 = new ArrayList<>();
        }
        return this.phand1;
    }
