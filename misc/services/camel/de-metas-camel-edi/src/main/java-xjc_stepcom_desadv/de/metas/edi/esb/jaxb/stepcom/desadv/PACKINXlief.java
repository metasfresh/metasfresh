...
/**
 * <p>Java class for PACKIN_Xlief complex type</p>.
 * 
...
public class PACKINXlief {
     ...
     * This is why there is not a <CODE>set</CODE> method for the ppack1 property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the ppack1 property.
     */
    public List<PPACK1> getPPACK1() {
        if (ppack1 == null) {
            ppack1 = new ArrayList<>();
        }
        return this.ppack1;
    }
