...
/**
 * <p>Java class for HEADER_Xlief complex type</p>.
 * 
...
public class HEADERXlief {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hdate1 property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hdate1 property.
     */
    public List<HDATE1> getHDATE1() {
        if (hdate1 == null) {
            hdate1 = new ArrayList<>();
        }
        return this.hdate1;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hrefe1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the hrefe1 property.
     */
    public List<HREFE1> getHREFE1() {
        if (hrefe1 == null) {
            hrefe1 = new ArrayList<>();
        }
        return this.hrefe1;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hadre1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the hadre1 property.
     */
    public List<HADRE1> getHADRE1() {
        if (hadre1 == null) {
            hadre1 = new ArrayList<>();
        }
        return this.hadre1;
    }
