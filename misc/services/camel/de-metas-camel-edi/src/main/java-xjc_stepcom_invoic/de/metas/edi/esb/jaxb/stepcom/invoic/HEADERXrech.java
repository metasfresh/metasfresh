...
/**
 * <p>Java class for HEADER_Xrech complex type</p>.
 * 
...
public class HEADERXrech {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the haddi1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the haddi1 property.
     */
    public List<HADDI1> getHADDI1() {
        if (haddi1 == null) {
            haddi1 = new ArrayList<>();
        }
        return this.haddi1;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the htext1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the htext1 property.
     */
    public List<HTEXT1> getHTEXT1() {
        if (htext1 == null) {
            htext1 = new ArrayList<>();
        }
        return this.htext1;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hcurr1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the hcurr1 property.
     */
    public List<HCURR1> getHCURR1() {
        if (hcurr1 == null) {
            hcurr1 = new ArrayList<>();
        }
        return this.hcurr1;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hpayt1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the hpayt1 property.
     */
    public List<HPAYT1> getHPAYT1() {
        if (hpayt1 == null) {
            hpayt1 = new ArrayList<>();
        }
        return this.hpayt1;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the halch1 property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the halch1 property.
     */
    public List<HALCH1> getHALCH1() {
        if (halch1 == null) {
            halch1 = new ArrayList<>();
        }
        return this.halch1;
    }
