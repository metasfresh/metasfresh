 ...
 *         &lt;element name="EDI_Exp_DesadvLine" type="{}EDI_Exp_DesadvLineType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class EDIExpDesadvType {
    ...
    @XmlElement(name = "EDI_Exp_DesadvLine")
    protected List<EDIExpDesadvLineType> ediExpDesadvLine;
    ...
    /**
     * Gets the value of the ediExpDesadvLine property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ediExpDesadvLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEDIExpDesadvLine().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EDIExpDesadvLineType> getEDIExpDesadvLine() {
        if (ediExpDesadvLine == null) {
            ediExpDesadvLine = new ArrayList<EDIExpDesadvLineType>();
        }
        return this.ediExpDesadvLine;
    }
