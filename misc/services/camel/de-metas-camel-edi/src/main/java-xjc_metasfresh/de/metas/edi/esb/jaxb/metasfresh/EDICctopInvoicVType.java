 ...
 *         &lt;element name="DateAcct" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/&gt;
 ...
 *         &lt;element name="SurchargeAmt" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/&gt;
 *         &lt;element name="TotalLinesWithSurchargeAmt" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TotalVatWithSurchargeAmt" type="{http://www.w3.org/2001/XMLSchema}decimal"/&gt;
 *         &lt;element name="GrandTotalWithSurchargeAmt" type="{http://www.w3.org/2001/XMLSchema}decimal"/&gt;
 *       &lt;/sequence&gt;
...
public class EDICctopInvoicVType {
    ...
    @XmlElement(name = "DateAcct")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar dateAcct;
    ...
    @XmlElement(name = "TotalLinesWithSurchargeAmt")
    protected BigDecimal totalLinesWithSurchargeAmt;
    ...
    @XmlElement(name = "ReceiverGLN")
    protected String receiverGLN;
    @XmlElement(name = "SenderGLN")
    ...
    @XmlElement(name = "TotalTaxBaseAmt")
    ...
    @XmlElement(name = "TotalVatWithSurchargeAmt", required = true)
    protected BigDecimal totalVatWithSurchargeAmt;
    @XmlElement(name = "GrandTotalWithSurchargeAmt", required = true)
    protected BigDecimal grandTotalWithSurchargeAmt;
    ...
    /**
     * Gets the value of the dateAcct property.
     * 
     * @return
     *     possible object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public XMLGregorianCalendar getDateAcct() {
        return dateAcct;
    }

    /**
     * Sets the value of the dateAcct property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setDateAcct(XMLGregorianCalendar value) {
        this.dateAcct = value;
    }
    ...
    /**
     * Gets the value of the totalLinesWithSurchargeAmt property.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
    ...
    public BigDecimal getTotalLinesWithSurchargeAmt() {
        return totalLinesWithSurchargeAmt;
    }

    /**
     * Sets the value of the totalLinesWithSurchargeAmt property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setTotalLinesWithSurchargeAmt(BigDecimal value) {
        this.totalLinesWithSurchargeAmt = value;
    }
    ...
    /**
     * Gets the value of the totalVatWithSurchargeAmt property.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
    ...
    public BigDecimal getTotalVatWithSurchargeAmt() {
        return totalVatWithSurchargeAmt;
    }

    /**
     * Sets the value of the totalVatWithSurchargeAmt property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setTotalVatWithSurchargeAmt(BigDecimal value) {
        this.totalVatWithSurchargeAmt = value;
    }

    /**
     * Gets the value of the grandTotalWithSurchargeAmt property.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
    ...
    public BigDecimal getGrandTotalWithSurchargeAmt() {
        return grandTotalWithSurchargeAmt;
    }

    /**
     * Sets the value of the grandTotalWithSurchargeAmt property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setGrandTotalWithSurchargeAmt(BigDecimal value) {
        this.grandTotalWithSurchargeAmt = value;
    }
