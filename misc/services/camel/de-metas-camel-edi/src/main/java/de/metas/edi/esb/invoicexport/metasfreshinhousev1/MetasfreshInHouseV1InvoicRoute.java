...
public class MetasfreshInHouseV1InvoicRoute extends AbstractEDIRoute
{
	public static final String ROUTE_ID = "MF-Invoic-To-In-House-V1";

	public static final String EP_EDI_METASFRESH_XML_INVOIC_CONSUMER = "direct:edi.invoic.in.house.v1.consumer";
	...
	@VisibleForTesting
	static final String OUTPUT_INVOIC_LOCAL = "edi.file.invoic.in.house.v1";

	private static final String OUTPUT_INVOIC_REMOTE = "edi.file.invoic.in.house.v1.remote";

	@Override
	public void configureEDIRoute(final DataFormat jaxb, final DecimalFormat decimalFormat)
	{
		final JaxbDataFormat dataFormat = new JaxbDataFormat(de.metas.edi.esb.jaxb.metasfreshinhousev1.EDICctopInvoicVType.class.getPackage().getName());
		...
		from(EP_EDI_METASFRESH_XML_INVOIC_CONSUMER)
				...
				.bean(MetasfreshInHouseV1XMLInvoicBean.class, MetasfreshInHouseV1XMLInvoicBean.METHOD_createXMLEDIData)
				...
				.log(LoggingLevel.INFO, "Sending MetasfreshInHouseV1-XML to the " + endPointURIs.length + " endpoint(s):\r\n" + body())
				.multicast().stopOnException().parallelProcessing(false).to(endPointURIs)
				.end()

				.log(LoggingLevel.INFO, "Creating MetasfreshInHouseV1 feedback XML Java Object...")
