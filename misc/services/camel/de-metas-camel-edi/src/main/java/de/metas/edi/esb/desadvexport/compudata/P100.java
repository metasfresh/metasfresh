...
public class P100 implements Serializable
{
	...
	public void setSellBeforeDate(final Date sellBeforeDate)
	{
	...
	public void setDiscrepancyText(final String discrepancyText)
	{
	...
	{
		return "P100 [record=" + record + ", partner=" + partner + ", messageNo=" + messageNo + ", positionNo=" + positionNo + ", eanArtNo=" + eanArtNo + ", buyerArtNo=" + buyerArtNo
				...
				+ ", diffDeliveryDate=" + diffDeliveryDate + ", eanTU=" + eanTU + ", storeNumber=" + storeNumber + ", unitCode=" + unitCode + ", sellBeforeDate=" + sellBeforeDate
				+ ", productionDate=" + productionDate + ", discrepancyText=" + discrepancyText + "]";
	}
}
