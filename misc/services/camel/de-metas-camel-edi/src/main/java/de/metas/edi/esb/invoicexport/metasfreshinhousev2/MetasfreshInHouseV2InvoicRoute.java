...
package de.metas.edi.esb.invoicexport.metasfreshinhousev2;
...
public class MetasfreshInHouseV2InvoicRoute extends AbstractEDIRoute
{
	...
	public void configureEDIRoute(final DataFormat jaxb, final DecimalFormat decimalFormat)
	{
		...
		final String finalLocalEndPointURI = CoalesceUtil.firstNotBlank(
				Util.resolveProperty(getContext(), OUTPUT_INVOIC_LOCAL_NEW_VERSION, ""),
				Util.resolveProperty(getContext(), OUTPUT_INVOIC_LOCAL_OLD_VERSION, ""));

		final String remoteEndpoint = CoalesceUtil.firstNotBlank(
				Util.resolveProperty(getContext(), OUTPUT_INVOIC_REMOTE_NEW_VERSION, ""),
				Util.resolveProperty(getContext(), OUTPUT_INVOIC_REMOTE_OLD_VERSION, ""));
