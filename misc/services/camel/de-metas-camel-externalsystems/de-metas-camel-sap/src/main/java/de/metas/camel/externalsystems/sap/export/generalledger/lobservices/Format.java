...
public interface Format
{
	...
	ImmutableList<String> LINE_FIELDS = ImmutableList.copyOf("ACTYP,NEWKO,NEWUM,DCIND,WRBTR,DMBTR,MWSKZ,XSKRL,GSBER,BUPLA,VALUT,ZFBDT,ZTERM,ZBD1T,ZBD1P,ZBD2T,ZBD2P,ZBD3T,ZBFIX,WSKTO,SKFBT,REBZG,REBZJ,REBZZ,ZLSPR,ZLSCH,UZAWE,KDAUF,KDPOS,KDEIN,MATNR,WERKS,MENGE,MEINS,EBELN,EBELP,ZUONR,SGTXT,KKBER,BVTYP,XREF1,XREF2,RSTGR,XREF3,LZBKZ,ZSMFITMFGX" .split(","));
}
