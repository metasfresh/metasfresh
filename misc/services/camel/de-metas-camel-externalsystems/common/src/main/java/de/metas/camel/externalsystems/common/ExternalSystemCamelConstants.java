...
{
	public static String HEADER_ORG_CODE = "orgCode";
	public static String HEADER_BPARTNER_IDENTIFIER = "bPartnerIdentifier";
	...
	public static String MF_LOG_MESSAGE_ROUTE_ID = "Log-Message-Route";
