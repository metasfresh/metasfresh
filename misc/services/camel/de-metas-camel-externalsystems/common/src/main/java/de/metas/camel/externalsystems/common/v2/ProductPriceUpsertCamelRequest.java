...
@Value
@Builder
@JsonDeserialize(builder = ProductPriceUpsertCamelRequest.ProductPriceUpsertCamelRequestBuilder.class)
public class ProductPriceUpsertCamelRequest
{
	@NonNull
	...
	public String toString()
	{
		...
		{
			throw new RuntimeException("toString() failed for ProductPriceUpsertCamelRequest", e);
		}
	}
}
