...
@Value
@Builder
@JsonDeserialize(builder = ExternalStatusCreateCamelRequest.ExternalStatusCreateCamelRequestBuilder.class)
public class ExternalStatusCreateCamelRequest
{
	@NonNull
	...
	@NonNull
	@JsonProperty("jsonStatusRequest")
