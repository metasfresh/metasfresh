...
@Value
@Builder
@JsonDeserialize(builder = InvokeExternalSystemActionCamelRequest.InvokeExternalSystemActionCamelRequestBuilder.class)
public class InvokeExternalSystemActionCamelRequest
{
	@NonNull
