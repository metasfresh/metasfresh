...
public class LocalFileBPartnerSyncServiceRouteBuilder extends RouteBuilder implements IExternalSystemService
{
	...
	@VisibleForTesting
	public static final String START_BPARTNER_SYNC_LOCAL_FILE_ROUTE_ID = PCM_SYSTEM_NAME + "-" + START_BPARTNER_SYNC_LOCAL_FILE_ROUTE;
	@VisibleForTesting
	public static final String STOP_BPARTNER_SYNC_LOCAL_FILE_ROUTE_ID = PCM_SYSTEM_NAME + "-" + STOP_BPARTNER_SYNC_LOCAL_FILE_ROUTE;
