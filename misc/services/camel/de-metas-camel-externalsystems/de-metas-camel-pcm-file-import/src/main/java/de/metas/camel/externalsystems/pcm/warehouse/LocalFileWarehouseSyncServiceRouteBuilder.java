...
@Component
public class LocalFileWarehouseSyncServiceRouteBuilder extends RouteBuilder implements IExternalSystemService
{
	...
	public LocalFileWarehouseSyncServiceRouteBuilder(final @NonNull ProcessLogger processLogger)
	{
