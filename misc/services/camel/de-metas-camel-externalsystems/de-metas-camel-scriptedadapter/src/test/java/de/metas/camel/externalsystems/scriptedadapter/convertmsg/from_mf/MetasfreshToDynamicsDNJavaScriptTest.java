...
class MetasfreshToDynamicsDNJavaScriptTest
{
	private JavaScriptRepo javaScriptRepo;
	private JavaScriptExecutorService javaScriptExecutorService;

	private static final String JSON_VALID_REQUEST = "de/metas/camel/externalsystems/scriptedadapter/convertmsg/from_mf/m2d_dn_valid_request.json";
	private static final String JSON_VALID_RESPONSE = "de/metas/camel/externalsystems/scriptedadapter/convertmsg/from_mf/m2d_dn_valid_response.json";

	private static final String SCRIPT_IDENTIFIER = "m2d_dn_wrapper";
