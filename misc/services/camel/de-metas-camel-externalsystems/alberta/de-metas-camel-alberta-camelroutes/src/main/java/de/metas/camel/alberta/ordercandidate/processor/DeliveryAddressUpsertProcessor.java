...
import static de.metas.camel.alberta.ordercandidate.GetOrdersRouteConstants.ROUTE_PROPERTY_CURRENT_ORDER;
...
public class DeliveryAddressUpsertProcessor implements Processor
{
			...
			@NonNull final String patientId)
	{
		...
		deliveryAddressRequest.setCountryCode(COUNTRY_CODE_DE);
