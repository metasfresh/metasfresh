...
import de.metas.camel.alberta.patient.DataMapper;
...
public class CreateMissingBPartnerProcessor implements Processor
{
	...
	public void process(final Exchange exchange)
	{
		...
		final AlbertaConnectionDetails albertaConnectionDetails = ProcessorHelper.getPropertyOrThrowError(exchange, ROUTE_PROPERTY_ALBERTA_CONN_DETAILS, AlbertaConnectionDetails.class);
		final Map<String, Object> externalBPIdentifier2Api = ProcessorHelper.getPropertyOrThrowError(exchange, ROUTE_PROPERTY_EXTERNAL_BP_IDENTIFIER_TO_API, Map.class);
