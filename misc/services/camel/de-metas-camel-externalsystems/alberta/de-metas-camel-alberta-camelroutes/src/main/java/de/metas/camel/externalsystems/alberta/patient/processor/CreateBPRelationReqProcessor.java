...
public class CreateBPRelationReqProcessor implements Processor
{
	...
	public void process(final Exchange exchange) throws Exception
	{
		...
		final BPartnerRoleInfoProvider bPartnerRoleInfoProvider = exchange.getProperty(GetPatientsRouteConstants.ROUTE_PROPERTY_BP_IDENTIFIER_TO_ROLE, BPartnerRoleInfoProvider.class);
