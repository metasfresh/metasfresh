...
import static de.metas.camel.externalsystems.alberta.patient.GetPatientsRouteConstants.ROUTE_PROPERTY_ORG_CODE;
import static de.metas.camel.externalsystems.alberta.product.PushProductsRoute.PREPARE_ARTICLE_PROCESSOR_ID;
import static de.metas.camel.externalsystems.alberta.product.PushProductsRoute.PROCESS_PRODUCT_ROUTE_ID;
import static de.metas.camel.externalsystems.alberta.product.PushProductsRoute.PUSH_ARTICLE_PROCESSOR_ID;
import static de.metas.camel.externalsystems.alberta.product.PushProductsRoute.PUSH_PRODUCTS;
import static de.metas.camel.externalsystems.alberta.product.PushProductsRoute.RETRIEVE_PRODUCTS_PROCESSOR_ID;
...
public class PushProductsRouteTests extends CamelTestSupport
{
	...
	private static final String JSON_ARTICLE_MAPPINGS = "/de/metas/camel/externalsystems/alberta/product/ArticleMappings.json";
	private static final String JSON_MF_GET_PRODUCTS = "/de/metas/camel/externalsystems/alberta/product/GetProductsMetasfreshResponse.json";

	private static final String JSON_ALBERTA_ARTICLE = "/de/metas/camel/externalsystems/alberta/product/UpsertArticleRequest.json";
	private static final String JSON_INVOKE_PUSH_PRODUCTS_REQUEST = "/de/metas/camel/externalsystems/alberta/product/JsonExternalSystemRequest.json";
	private static final String JSON_MF_GET_PRODUCTS_REQUEST = "/de/metas/camel/externalsystems/alberta/product/GetProductsCamelRequest.json";
	private static final String JSON_MF_UPSERT_EXTERNAL_REF_REQUEST = "/de/metas/camel/externalsystems/alberta/product/JsonRequestExternalReferenceUpsert.json";
