...
public class GetOrdersRouteBuilder_HappyFlow_CreditOrDebit_PaymentMethod_Tests extends GetOrdersRouteBuilder_HappyFlow_Tests
{
	private static final String HAPPY_FLOW_CREDIT_OR_DEBIT_PAYMENTMENTHOD = "happyFlow_CreditOrDebit_PaymentMethod/";
	private static final String JSON_SHOPWARE_MAPPINGS = HAPPY_FLOW_CREDIT_OR_DEBIT_PAYMENTMENTHOD + "01_JsonExternalSystemShopware6ConfigMappings.json";

	private static final String JSON_ORDER_TRANSACTIONS_PATH = HAPPY_FLOW_CREDIT_OR_DEBIT_PAYMENTMENTHOD + "10_JsonOrderTransactions.json";

	private static final String JSON_PAYMENT_METHOD = HAPPY_FLOW_CREDIT_OR_DEBIT_PAYMENTMENTHOD + "20_JsonPaymentMethod.json";

	private static final String JSON_OL_CAND_CREATE_REQUEST = HAPPY_FLOW_CREDIT_OR_DEBIT_PAYMENTMENTHOD + "30_JsonOLCandCreateBulkRequest.json";
	...
	void happyFlow() throws Exception
	{
		...
		assertThat(createPaymentProcessor.called).isEqualTo(0);
			...
			final JsonExternalSystemRequest request) throws Exception
	{
		AdviceWith.adviceWith(context, GET_ORDERS_ROUTE_ID,
							  advice -> advice.weaveById(BUILD_ORDERS_CONTEXT_PROCESSOR_ID)
									  .replace()
									  .process(new MockBuildOrdersContextProcessor(request, null, 1, JSON_ORDERS_RESOURCE_PATH, ExternalSystemConstants.DEFAULT_SW6_ORDER_PAGE_SIZE, JSON_PAYMENT_METHOD, JSON_ORDER_TRANSACTIONS_PATH)));
