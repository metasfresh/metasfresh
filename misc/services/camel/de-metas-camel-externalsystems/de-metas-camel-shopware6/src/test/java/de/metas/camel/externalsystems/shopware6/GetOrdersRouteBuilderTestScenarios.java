			...
			final JsonExternalSystemRequest externalSystemRequest) throws Exception
	{
		AdviceWith.adviceWith(context, GET_ORDERS_ROUTE_ID,
							  advice -> advice.weaveById(BUILD_ORDERS_CONTEXT_PROCESSOR_ID)
									  .replace()
									  .process(new GetOrdersRouteBuilder_HappyFlow_Tests.MockBuildOrdersContextProcessor(externalSystemRequest, 1, GetOrdersRouteBuilder_HappyFlow_Tests.JSON_ORDERS_RESOURCE_PATH, ExternalSystemConstants.DEFAULT_ORDER_PAGE_SIZE)));
