...
import de.metas.camel.externalsystems.grssignum.bpartner.processor.ExportBPartnerProcessor;
...
import static de.metas.camel.externalsystems.grssignum.GRSSignumConstants.ROUTE_PROPERTY_EXPORT_BPARTNER_CONTEXT;
import static de.metas.camel.externalsystems.grssignum.client.GRSSignumDispatcherRouteBuilder.GRS_DISPATCHER_ROUTE_ID;
...
public class GRSSignumExportBPartnerRouteBuilder extends RouteBuilder
{
	...
	public void configure() throws Exception
	{
		...
		from(direct(EXPORT_BPARTNER_ROUTE_ID))
				...
				.to(direct(GRS_DISPATCHER_ROUTE_ID));
	}
	...
	private void buildAndAttachContext(@NonNull final Exchange exchange)
	{
		...
		exchange.setProperty(ROUTE_PROPERTY_EXPORT_BPARTNER_CONTEXT, context);
	}
