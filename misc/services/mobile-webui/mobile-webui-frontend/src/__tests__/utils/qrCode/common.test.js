...
describe('common tests', () => {
  describe('isBarcodeProductNoMatching', () => {
    ...
    it('EAN13 barcode - from Ean13ProductCode', () => {
      expect(
        isBarcodeProductNoMatching({ expectedProductNo: '00027_20250312T233125110', expectedEAN13ProductCode: '4888', barcodeProductNo: '4888', barcodeType: 'EAN13' })
      ).toBe(true);
    });
    it('EAN13 barcode - from Ean13ProductCode, not matching', () => {
      expect(
          isBarcodeProductNoMatching({ expectedProductNo: '00027_20250312T233125110', expectedEAN13ProductCode: '4888', barcodeProductNo: '48889', barcodeType: 'EAN13' })
      ).toBe(false);
    });
  });
});
