...
class PickAltStepButton extends PureComponent {
  ...
  render() {
    ...
    const { qtyAvailable, qtyPicked, uom, scannedHUBarcode } = genStepState;
    const completeStatus = scannedHUBarcode ? CompleteStatus.COMPLETED : CompleteStatus.NOT_STARTED;
