...
import { getApplicationLaunchers, useFacets, useFilters } from '../../reducers/launchers';
...
const useLaunchers = ({ applicationId, showFilterByQRCode, facets, filters, isEnabled }) => {
  const dispatch = useDispatch();
