...
const createMasterdata = async ({ customQRCodeFormats }) => {
...
test('Receive using custom QR Code format (1)', async ({ page }) => {
...
// noinspection JSUnusedLocalSymbols
test('Receive using custom QR Code format (2)', async ({ page }) => {
    const masterdata = await createMasterdata({
        customQRCodeFormats: [
            {
