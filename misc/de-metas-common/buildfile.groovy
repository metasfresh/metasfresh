...
def build(final MvnConf mvnConf, final Map scmVars) {
    ...
    sh "mvn --settings ${mvnConf.settingsFile} --file ${mvnConf.pomFile} --batch-mode -Dproperty=metasfresh-commons.version -DnewVersion=${env.MF_VERSION} ${VERSIONS_PLUGIN}:set-property"
