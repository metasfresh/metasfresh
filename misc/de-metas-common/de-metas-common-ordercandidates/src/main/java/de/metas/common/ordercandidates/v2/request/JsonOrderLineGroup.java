...
public class JsonOrderLineGroup
{
	...
	@Schema( //
			description = "Translates to C_OLCand.GroupCompensationDiscountPercentage")
	@JsonInclude(NON_NULL)
	BigDecimal discount;

	@Schema( //
			description = "It is taken into consideration when C_OLCand.Line is renumbered. Translates to C_OLCand.CompensationGroupOrderBy")
	@JsonInclude(NON_NULL)
