...
public class JsonProductInfo
{
	...
	@Schema( //
			description = "This translates to `M_Product.Value`. At least one of `code` or `externalId` is mandatory")
	@JsonInclude(Include.NON_NULL)
	String code;

	@Schema( //
			description = "This translates to `M_Product.ExternalId`. At least one of `code` or `externalId` is mandatory")
	@JsonInclude(Include.NON_NULL)
	String externalId;

	@Schema( //
			nullable = true, //
			description = "This translates to `M_Product.Name`.\n"
	...
	@Schema( //
			nullable = true, //
			description = "This translates to `M_Product.ProductType`.\n"
					+ "If this is empty, and a product with the given {@link #code} does not yet exist, then the request will fail.")
	Type type;
