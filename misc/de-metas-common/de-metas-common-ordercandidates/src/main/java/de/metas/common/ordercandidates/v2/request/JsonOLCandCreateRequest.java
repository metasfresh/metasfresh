...
public class JsonOLCandCreateRequest
{
	...
	@Schema(//
			description = " This translates to `C_OLCand.C_BPartner_ID`, `C_OLCand.C_BPartner_Location_ID` and `C_OLCand.AD_User_ID`.\n"
	...
	@Schema(// //
			description = " This translates to `C_OLCand.Bill_BPartner_ID`.\n"
	...
	@Schema(//
			description = " This translates to `C_OLCand.Dropship_BPartner_ID`.\n"
	...
	@Schema(//
			description = " This translates to `C_OLCand.HandOver_BPartner_ID`.\n"
	...
	@Schema(//
			description = "This translates to `C_OLCand.DateOrdered`.")
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
	@JsonInclude(Include.NON_NULL)
	LocalDate dateOrdered;

	@Schema(//
			description = "This translates to `C_OLCand.datePromised`.\n"
	...
	@Schema(//
			description = "This translates to `C_OLCand.dateCandidate`.\n")
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
	...
	@Schema(//
			description = "This translates to `C_OLCand.M_HU_PI_Item_Product_ID`\n."
	...
	@Schema(//
			description = "If a new product price needs to be created on the fly and the system can't deduce the respective pricing system from given business partner,\n"
	...
	@Schema(//
			description = "If set, then the order line candidate will be created with a manual (i.e. not coming from metasfresh) price.\n"
					+ "If the price has too many digits, it is rounded according to the price list's price precision.")
	@JsonInclude(Include.NON_NULL)
	BigDecimal price;

	@Schema(//
			description = "If a (manual) `price` is provided, then also a currencyCode needs be given.")
	@JsonInclude(Include.NON_NULL)
	String currencyCode; // shall come from pricingSystem/priceList

	@Schema(//
			description = "If set, then the order line candidate will be created with a manual (i.e. not coming from metasfresh) discount.")
	@JsonInclude(Include.NON_NULL)
	BigDecimal discount;
	...
	@Schema(//
			description = "Translates to `M_Warehouse.Value`. The looked up warehouse's ID is then set to `C_OLCand.M_Warehouse_ID`.")
	String warehouseCode;

	@Schema(//
			description = "Translates to `C_OLCand.M_Warehouse_Dest_ID`.")
	String warehouseDestCode;

	@Schema(//
			description = "Can be set if the invoice's document type is already known from the external system and shall be forwarded to the invoice candidate.\\n\""
	...
	@Schema(//
			description = "Can be set if the invoice's document date is already known from the external system. ")
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
	@JsonInclude(Include.NON_NULL)
	LocalDate presetDateInvoiced;

	@Schema(//
			description = "Can be set if the shipment's document date is already known from the external system. ")
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
	@JsonInclude(Include.NON_NULL)
	...
	@Schema(//
			description = "Translates to C_OLCand.QtyItemCapacity. If given, it overrides the capcity set in the M_HU_PI_Item_Product that might be given via packingMaterialId or \"GTIN-..\" productIdentifier.")
	@JsonInclude(Include.NON_NULL)
	BigDecimal qtyItemCapacity;

	@Schema(//
			description = "Translates to C_OLCand.ApplySalesRepFrom. If not specified default value is `CandidateFirst`")
	@JsonInclude(Include.NON_NULL)
	JsonApplySalesRepFrom applySalesRepFrom;

	@Schema(//
			description = "Translates to `C_OLCand.BPartnerName`. If omitted, it will fallback to `C_BPartner_Location.BPartnerName` of the referenced shipping location, i.e. `bpartner.bPartnerLocationIdentifier`")
	@JsonInclude(Include.NON_NULL)
	String bpartnerName;

	@Schema(//
			description = "Translates to `C_OLCand.Email`. If omitted, metasfresh will fallback to `C_BPartner_Location.Email` of the referenced shipping location`")
	@JsonInclude(Include.NON_NULL)
	String email;

	@Schema(//
			description = "Translates to `C_OLCand.Email`. If omitted, metasfresh will fallback to `C_BPartner_Location.Phone` of the referenced shipping location`")
	@JsonInclude(Include.NON_NULL)
	String phone;
