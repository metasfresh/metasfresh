...
public class JsonResponseBPartner
{
	...
	@Schema(required = false, description = "This translates to `C_BPartner.Value`.")
	@JsonProperty(CODE)
	String code;

	@Schema(required = false, description = "This translates to `C_BPartner.GlobalId`.")
	@JsonProperty(GLOBAL_ID)
	String globalId;

	@Schema(required = false, description = "This translates to `C_BPartner.IsActive`.")
	@JsonProperty(ACTIVE)
	boolean active;

	@Schema(required = false, description = "This translates to `C_BPartner.Name`.")
	@JsonProperty(NAME)
	String name;

	@Schema(required = false, description = "This translates to `C_BPartner.Name2`.")
	@JsonProperty(NAME_2)
	@JsonInclude(Include.NON_NULL)
	String name2;

	@Schema(required = false, description = "This translates to `C_BPartner.Name3`.")
	@JsonProperty(NAME_3)
	@JsonInclude(Include.NON_NULL)
	String name3;
	...
	@Schema( //
			required = false, //
			description = "This translates to `C_BPartner.CompanyName`.\n"
	...
	@Schema( //
			required = false, //
			description = "This translates to `C_BPartner.BPartner_Parent_ID`. It's a this bpartner's central/parent company",//
			type = "java.lang.Integer")
	...
	@Schema( //
			required = false, //
			description = "This translates to `C_BPartner.Phone2`. It's this bpartner's central phone number")
	@JsonProperty(PHONE)
	@JsonInclude(Include.NON_NULL)
	String phone;
	...
	@Schema(required = false, description = "This translates to `C_BPartner.URL`.")
	@JsonProperty(URL)
	@JsonInclude(Include.NON_NULL)
	String url;

	@Schema(required = false, description = "This translates to `C_BPartner.URL2`.")
	@JsonProperty(URL_2)
	@JsonInclude(Include.NON_NULL)
	private String url2;

	@Schema(required = false, description = "This translates to `C_BPartner.URL3`.")
	@JsonProperty(URL_3)
	@JsonInclude(Include.NON_NULL)
	private String url3;
	...
	@Schema( //
			required = false, //
			description = "Name of the business partner's group")
	@JsonProperty(GROUP_NAME)
	@JsonInclude(Include.NON_NULL)
	String group;

	@Schema(required = false, description = "This translates to `C_BPartner.IsVendor`.")
	@JsonProperty(VENDOR)
	boolean vendor;

	@Schema(required = false, description = "This translates to `C_BPartner.IsCustomer`.")
	...
	@Schema(required = false, description = "This translates to `C_BPartner.IsCompany`.")
	@JsonProperty(COMPANY)
	boolean company;

	@Schema(required = false, description = "This translates to `C_BPartner.VATaxID`.")
	@JsonProperty(VAT_ID)
	String vatId;

	@Schema(required = false, description = "This translates to `baseUrl/window/{specificBPartnerWindowId}/{C_BPartner_ID}`")
	@JsonProperty(METASFRESH_URL)
	@JsonInclude(Include.NON_NULL)
	String metasfreshUrl;

	@Schema(required = false, description = "This translates to `C_BPartner.CreditorId` ")
	@JsonProperty(CREDITOR_ID)
	@JsonInclude(Include.NON_NULL)
	Integer creditorId;

	@Schema(required = false, description = "This translates to `C_BPartner.DebtorId` ")
