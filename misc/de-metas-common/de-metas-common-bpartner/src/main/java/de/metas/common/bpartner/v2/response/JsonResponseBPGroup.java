...
@Value
public class JsonResponseBPGroup
{
	...
	@ApiModelProperty( //
			...
			value = "This translates to `C_BP_Group.C_BP_Group_ID`.")
	...
	@ApiModelProperty(value = "This translates to `C_BP_Group.Value`.")
	@JsonProperty(VALUE)
	String value;

	@JsonCreator
	@Builder(toBuilder = true)
	private JsonResponseBPGroup(
