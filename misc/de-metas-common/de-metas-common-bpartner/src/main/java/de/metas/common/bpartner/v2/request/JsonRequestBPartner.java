...
{
	@Schema(//
			description = BPARTNER_VALUE_DOC)
	private String code;
	...
	@Schema(//
			description = "Optional; if specified, it will be used, e.g. when a purchase order is created for this business partner.")
	...
	@Schema(//
			description = "The ID of the price list that the business partner is to use as a customer. If provided, this will be used to lookup `C_BPartner.M_PricingSystem_ID`")
	...
	@Schema(//
			description = "This translates to `C_BPartner.memo`")
	private String memo;
