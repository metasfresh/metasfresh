...
public class JsonResponseContactPosition
{
	...
	@Schema( //
			...
			description = "This translates to `C_Job.C_Job_ID`.")
	@JsonProperty(METASFRESH_ID)
	@JsonInclude(JsonInclude.Include.NON_NULL)
	JsonMetasfreshId metasfreshId;

	@Schema(required = false, description = "This translates to `C_Job.Name`.")
	@JsonProperty(NAME)
	String name;

	@Schema(required = false, description = "This translates to `C_Job.IsActive`.")
	@JsonProperty(ACTIVE)
	boolean active;
