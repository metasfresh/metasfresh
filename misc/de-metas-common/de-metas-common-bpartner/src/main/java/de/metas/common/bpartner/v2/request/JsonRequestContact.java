...
public class JsonRequestContact
{
	...
	@Schema(//
			description = "If not specified but required (e.g. because a new contact is created), then `false` is assumed")
	...
	@Schema(//
			description = "Only one location per request may have `salesDefault == true`.\n"
					+ "If not specified but required (e.g. because a new contact is created), then `false` is assumed.\n"
					+ "If `true`, then " //
	...
	@Schema(//
			description = "Only one location per request may have `purchaseDefault == true`.\n"
					+ "If not specified but required (e.g. because a new contact is created), then `false` is assumed.\n"
					+ "If `true`, then " //
	...
	@Schema(//
			description = "This translates to `AD_User.Birthday`.")
	...
	@Schema(// shall be last
			description = "Sync advise about this contact's individual properties.\n"
