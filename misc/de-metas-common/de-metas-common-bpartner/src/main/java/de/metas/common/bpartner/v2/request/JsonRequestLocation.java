...
{
	@Schema(//
			description = "If not specified but required (e.g. because a new location is created), then `true` is assumed")
	...
	@Schema(//
			description = "This translates to `C_BPartner_Location.Name`")
	private String name;
	...
	@Schema(//
			description = "This translates to `C_BPartner_Location.BPartnerName`")
	...
	@Schema(//
			description = "If specified, then metasfresh will attempt to lookup the `C_Postal` record.\n"
	...
	@Schema(//
			description = "If specified, then metasfresh will use this property (in addition to `postal`) as a filter criterion to look up `C_Postal` records.\n"
	...
	@Schema(//
			description = "This translates to `C_BPartner_Location.GLN`")
	private String gln;
	...
	@Schema(//
			description = "Only one location per request may have `shipToDefault == true`.\n"
					+ "If `true`, then " //
	...
	@Schema(//
			description = "Only one location per request may have `billToDefault == true`.\n"
					+ "If `true`, then " //
	...
	@Schema(//
			description = "Translates to C_BPartner_Location.IsEphemeral")
	...
	@Schema(//
			description = "Translates to C_BPartner_Location.VisitorsAddress")
