...
@JsonDeserialize(builder = JsonResponseReceiveFromManufacturingOrder.JsonResponseReceiveFromManufacturingOrderBuilder.class)
public class JsonResponseReceiveFromManufacturingOrder
{
	@Nullable
	String requestId;
