...
@Value
@Builder
public class JsonProductIdentifier
{
	@NonNull JsonMetasfreshId metasfreshId;

	@NonNull String externalReference;

	@JsonCreator
	public JsonProductIdentifier(
			@NonNull @JsonProperty("metasfreshId") final JsonMetasfreshId metasfreshId,
			@NonNull @JsonProperty("externalReference") final String externalReference)
	{
