...
public class ExternalSystemConstants
{
	...
	// Local, transport-agnostic archive folders (used by both SFTP and REST import) -- the
	// constant names and wire keys keep their historic values; only the endpoint's AD column
	// names changed (SftpProcessedDirectory/SftpErrorDirectory -> ProcessedDirectory/ErrorDirectory).
	public static final String PARAM_PROCESSED_DIR = "sftpProcessedDirectory";
	public static final String PARAM_ERROR_DIR = "sftpErrorDirectory";
