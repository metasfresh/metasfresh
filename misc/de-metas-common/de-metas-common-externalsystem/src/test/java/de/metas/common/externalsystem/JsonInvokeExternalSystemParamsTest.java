...
public class JsonInvokeExternalSystemParamsTest
{
	...
	{
		final Map<String, String> params = ImmutableMap.of("key", "value");

		final JsonInvokeExternalSystemParams request = JsonInvokeExternalSystemParams.builder()
				.params(params)
				.build();
