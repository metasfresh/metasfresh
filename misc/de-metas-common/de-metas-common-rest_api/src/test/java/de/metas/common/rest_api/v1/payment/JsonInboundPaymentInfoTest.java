...
class JsonInboundPaymentInfoTest
{
	...
	private void testSerializeDeserialize(final JsonInboundPaymentInfo obj) throws IOException
	{
		...
		final JsonInboundPaymentInfo objDeserialized = objectMapper.readValue(json, obj.getClass());
