...
public class JsonPInstanceLogTest
{
	...
	{
		testSerializeDeserialize(JsonPInstanceLog.builder()
										 .message("test message")
										 .build());
	}

	private void testSerializeDeserialize(final JsonPInstanceLog obj) throws IOException
	{
		...
		final JsonPInstanceLog objDeserialized = objectMapper.readValue(json, obj.getClass());
