...
public class JsonRemittanceAdviceTest
{
	...
	{
		testSerializeDeserialize(createJsonRemittanceAdviceBuilder()
										 .orgCode("test")
										 .senderId("123")
										 .recipientId("465")
										 .documentNumber("0001")
										 ...
										 .paymentDiscountAmountSum(BigDecimal.valueOf(30))
										 .build());
	}
	...
	private void testSerializeDeserialize(final JsonRemittanceAdvice obj) throws IOException
	{
		...
		final JsonRemittanceAdvice objDeserialized = objectMapper.readValue(json, obj.getClass());
