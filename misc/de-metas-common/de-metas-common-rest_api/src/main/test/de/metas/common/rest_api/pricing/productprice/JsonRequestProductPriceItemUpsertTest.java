...
public class JsonRequestProductPriceItemUpsertTest
{
	...
	public void test() throws Exception
	{
		...
		testSerializeDeserialize(createJsonRequestProductPriceItemUpsertBuilder()
	...
	private void testSerializeDeserialize(final JsonRequestProductPriceItemUpsert obj) throws IOException
	{
		...
		final JsonRequestProductPriceItemUpsert objDeserialized = objectMapper.readValue(json, obj.getClass());
