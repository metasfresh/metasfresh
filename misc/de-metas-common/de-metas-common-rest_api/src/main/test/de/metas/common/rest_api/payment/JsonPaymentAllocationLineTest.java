...
class JsonPaymentAllocationLineTest
{
	...
	private void testSerializeDeserialize(final JsonPaymentAllocationLine obj) throws IOException
	{
		...
		final JsonPaymentAllocationLine objDeserialized = objectMapper.readValue(json, obj.getClass());
