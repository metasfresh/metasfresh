...
public class JsonUnsettableInvoiceRule extends JsonUnsettableValue
{
	...
	@Schema(required = false, //
			description = "Optional, to override the invoiceRule as derived from metasfresh for the respective invoice candidate's property.\n"
	...
	@Schema(required = false, //
			description = "Optional property to *explicitly* unset a candidate's override property.\n"
