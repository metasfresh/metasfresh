...
import de.metas.common.rest_api.v1.JsonRequestAttributeSetInstance;
import de.metas.common.rest_api.v1.JsonVendor;
...
public class JsonPurchaseCandidateCreateItem
{
	...
	@Nullable
	@JsonProperty("price")
	de.metas.common.rest_api.v1.JsonPrice price;
	...
	@NonNull
	@JsonProperty("qty")
	de.metas.common.rest_api.v1.JsonQuantity qty;
