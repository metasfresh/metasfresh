...
@ToString
@EqualsAndHashCode
@Schema(description = "Contains the actual product uom conversion to insert or update.")
public class JsonRequestUOMConversionUpsert
{
	@Schema(requiredMode = REQUIRED, description = "Corresponding to C_UOM_Conversion.C_UOM_ID")
	private String fromUomCode;

	@Schema(requiredMode = REQUIRED, description = "Corresponding to C_UOM_Conversion.C_UOM_To_ID")
