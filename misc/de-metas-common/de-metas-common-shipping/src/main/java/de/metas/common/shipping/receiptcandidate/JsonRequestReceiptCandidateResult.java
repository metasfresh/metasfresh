...
@Value
@Builder
public class JsonRequestReceiptCandidateResult
{
	...
	@JsonCreator
	private JsonRequestReceiptCandidateResult(
			@JsonProperty("receiptScheduleId") @NonNull final JsonMetasfreshId receiptScheduleId,
	...
	public JsonRequestReceiptCandidateResult withError()
	{
		return JsonRequestReceiptCandidateResult.builder()
