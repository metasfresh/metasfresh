...
public class JsonProcessShipmentRequestTest
{
	...
	public void test() throws IOException
	{
		...
		final JsonProcessShipmentRequest request = JsonProcessShipmentRequest.builder()
				.createShipmentRequest(JsonCreateShipmentRequest.builder().createShipmentInfoList(ImmutableList.of(shipmentInfo)).build())
				.invoice(true)
