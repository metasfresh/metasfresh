...
/*
SELECT
    'INSERT INTO migration_data."Navision$Customer Bank Account" (' +
    '"timestamp", "Customer No_", "Code", "Name", "Name 2", "Address", "Address 2", "City", "Post Code", "Contact", "Phone No_", "Telex No_", "Bank Branch No_", "Bank Account No_", "Transit No_", "Currency Code", "Country_Region Code", "County", "Fax No_", "Telex Answer Back", "Language Code", "E-Mail", "Home Page", "IBAN", "SWIFT Code", "Inserted by Bank Import", "Payment Type Code", "Owner", "Mandate ID", "Mandate Date", "Routing No_", "Payment Method Code", "Mandate Type", "Mandate Frequency", "Mandate Is Electronic", "Mandate On Behalf of Owner", "Mandate Last Used", "Mandate Status", "Alt_ Reason Row 1", "Alt_ Reason Row 2", "Owner Contact", "Alt_ Creditor Identifier", "Bank Clearing Code", "Bank Clearing Standard", "Hash Value Branch _ Acc_ No_", "Hash Value IBAN", "Hash Value SWIFT _ Acc_ No_"' +
    ') VALUES (' +
    ...
    ');'
FROM
    [Navision$Customer Bank Account];
*/

CREATE TABLE migration_data."Navision$Customer Bank Account" (
    "timestamp" BYTEA NOT NULL,
    "Customer No_" VARCHAR(20) NOT NULL,
    "Code" VARCHAR(10) NOT NULL,
    "Name" VARCHAR(50) NOT NULL,
