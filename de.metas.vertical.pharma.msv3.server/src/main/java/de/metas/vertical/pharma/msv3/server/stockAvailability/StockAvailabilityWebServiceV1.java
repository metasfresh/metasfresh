...
@Endpoint
public class StockAvailabilityWebServiceV1
{
	...
	public StockAvailabilityWebServiceV1(
	...
	@PayloadRoot(localPart = "verfuegbarkeitAnfragen", namespace = MSV3ServerConstants.SOAP_NAMESPACE_V1)
