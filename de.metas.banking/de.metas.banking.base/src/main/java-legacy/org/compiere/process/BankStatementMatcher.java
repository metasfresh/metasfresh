...
{
	private final IBankStatementDAO bankStatementsRepo = Services.get(IBankStatementDAO.class);
	 ...
	 * @return Message
	 */
	private String match(final I_C_BankStatement bs)
	{
		...
		int count = 0;
		for (I_C_BankStatementLine line : bankStatementsRepo.retrieveLines(bankStatementId))
		{
