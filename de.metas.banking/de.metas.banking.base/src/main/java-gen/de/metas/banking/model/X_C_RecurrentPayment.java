...
public class X_C_RecurrentPayment extends org.compiere.model.PO implements I_C_RecurrentPayment, org.compiere.model.I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = -859841841L;

    /** Standard Constructor */
    public X_C_RecurrentPayment (Properties ctx, int C_RecurrentPayment_ID, String trxName)
    {
      super (ctx, C_RecurrentPayment_ID, trxName);
      /** if (C_RecurrentPayment_ID == 0)
        {
			setC_BPartner_ID (0);
    ...
    /** Load Constructor */
    public X_C_RecurrentPayment (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_RecurrentPayment[")
