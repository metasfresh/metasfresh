...
CREATE OR REPLACE VIEW edi_cctop_140_v AS 
 SELECT i.c_invoice_id AS edi_cctop_140_v_id, i.c_invoice_id, i.c_invoice_id AS edi_cctop_invoic_v_id, p.discount, p.discountdays, i.dateinvoiced::timestamp with time zone + p.discountdays AS discountdate, t.rate, i.ad_client_id, i.ad_org_id, i.created, i.createdby, i.updated, i.updatedby, i.isactive
   FROM c_invoice i
