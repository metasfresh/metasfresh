...
public class X_MSV3_BestellungAntwortAuftrag extends org.compiere.model.PO implements I_MSV3_BestellungAntwortAuftrag, org.compiere.model.I_Persistent 
{
	...
	@Override
	public de.metas.vertical.pharma.vendor.gateway.mvs3.model.I_MSV3_FaultInfo getMSV3_Auftragsfehler() throws RuntimeException
	{
		return get_ValueAsPO(COLUMNNAME_MSV3_Auftragsfehler_ID, de.metas.vertical.pharma.vendor.gateway.mvs3.model.I_MSV3_FaultInfo.class);
	}
	...
	{
		set_ValueFromPO(COLUMNNAME_MSV3_Auftragsfehler_ID, de.metas.vertical.pharma.vendor.gateway.mvs3.model.I_MSV3_FaultInfo.class, MSV3_Auftragsfehler);
	}
