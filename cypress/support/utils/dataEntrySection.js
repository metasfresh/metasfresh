...
function applyDataEntrySection(dataEntrySection)
{
    ...
    cy.writeIntoLookupListField('DataEntry_SubGroup_ID', dataEntrySection.dataEntrySubGroup, dataEntrySection.dataEntrySubGroup)
    ...
    if(dataEntrySection.dataEntryLines.length > 0)
    {
        ...
        cy.get('table tbody tr')
            .should('have.length', dataEntrySection.dataEntryLines.length);
    }
}
