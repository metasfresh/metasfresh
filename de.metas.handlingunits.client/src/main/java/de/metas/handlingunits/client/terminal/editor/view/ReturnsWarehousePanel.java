...
import de.metas.handlingunits.client.terminal.editor.model.impl.AbstractReturnsWarehouseModel;
...
public class ReturnsWarehousePanel extends AbstractMaterialMovementPanel<AbstractReturnsWarehouseModel>
{

	public ReturnsWarehousePanel(final ITerminalContext terminalContext, final AbstractReturnsWarehouseModel model)
	{
		super(model);
	...
	private void initComponents()
	{
		...
		final AbstractReturnsWarehouseModel model = getModel();
		//
		// warehouse
